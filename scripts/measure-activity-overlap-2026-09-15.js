...
//
// 배포 확인용이 아니다. 이 스크립트는 두 규칙을 자기 안에 다 들고 데이터에 대해
// 비교한다 — js/le8-score.js 를 읽지 않는다. 그래서 새 규칙을 배포한 뒤 다시
// 돌려도 출력이 똑같다. "손실이 0이 됐는지 보자"는 이 스크립트로 확인되지 않는다.
// (2026-09-15 에 그렇게 착각했다.) 배포 확인은 배포본에 규칙이 들어갔는지와
// tests/weekly-activity-target.test.js 가 한다.
