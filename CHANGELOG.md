...
## v456 · 2026-09-26 — 혈액검사 결과지를 PDF·엑셀로도 올립니다

- **[신규]** **혈액검사 결과지를 PDF나 엑셀 파일 그대로 올릴 수 있습니다.** 병원·검진기관에서 받은 PDF(15MB까지)나 엑셀(xlsx·xls·csv)을 프로필의 혈액검사 칸에서 **📄 PDF · 엑셀 파일 올리기**로 고르면, AI가 사진과 똑같이 수치를 읽어 드려요. 화면을 찍어 다시 올리지 않아도 됩니다.
- **[수정]** **이미 동의했는데 가입 전 동의 창이 다시 뜨던 문제**를 한 번 더 고쳤습니다. 이제 창을 띄우기 전에 서버에서 동의 기록을 직접 확인해, 정말 기록이 없을 때만 여쭤봅니다.
