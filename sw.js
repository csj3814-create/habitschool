...
const CACHE_NAME = 'habitschool-v279';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=279',
    './styles-base.css?v=279',
    './styles-en.css?v=279',
    './styles-features.css?v=279',
    './styles-reward-market.css?v=279',
    './styles-dashboard.css?v=279',
    './styles-dark-mode.css?v=279',
    './styles-reports.css?v=279',
    './styles-guest-demo.css?v=279',
    './js/main.js?v=279',
    './js/app.js?v=279',
    './js/app-core.js?v=279',
    './js/auth.js?v=279',
    './js/i18n.js?v=279',
    './js/app-mode.js?v=279',
    './js/auth-login-helpers.js?v=279',
    './js/blockchain-config.js?v=279',
    './js/blockchain-manager.js?v=279',
    './js/data-manager.js?v=279',
    './js/diet-program.js?v=279',
    './js/diet-analysis.js?v=279',
    './js/exercise-media.js?v=279',
    './js/firebase-config.js?v=279',
    './js/friendship-utils.js?v=279',
    './js/habit-groups.js?v=279',
    './js/health-connect-utils.js?v=279',
    './js/metabolic-score.js?v=279',
    './js/milestone-helpers.js?v=279',
    './js/monthly-mvp-reward.js?v=279',
    './js/meditation-guide.js?v=279',
    './js/reward-market.js?v=279',
    './js/guest-demo.js?v=279',
    './js/product-events.js?v=279',
    './js/activity-days.js?v=279',
    './js/pwa-install.js?v=279',
    './js/security.js?v=279',
    './js/social-challenge-readiness.js?v=279',
    './js/ui-helpers.js?v=279',
    './js/upload-performance.js?v=279',
    './js/video-thumbnail-quality.js?v=279',
    './js/webview-detect.js?v=279',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
