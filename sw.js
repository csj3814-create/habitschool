...
const CACHE_NAME = 'habitschool-v238';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=238',
    './styles-base.css?v=238',
    './styles-en.css?v=238',
    './styles-features.css?v=238',
    './styles-reward-market.css?v=238',
    './styles-dashboard.css?v=238',
    './styles-dark-mode.css?v=238',
    './styles-reports.css?v=238',
    './styles-guest-demo.css?v=238',
    './js/main.js?v=238',
    './js/app.js?v=238',
    './js/app-core.js?v=238',
    './js/auth.js?v=238',
    './js/i18n.js?v=238',
    './js/app-mode.js?v=238',
    './js/auth-login-helpers.js?v=238',
    './js/blockchain-config.js?v=238',
    './js/blockchain-manager.js?v=238',
    './js/data-manager.js?v=238',
    './js/diet-program.js?v=238',
    './js/diet-analysis.js?v=238',
    './js/exercise-media.js?v=238',
    './js/firebase-config.js?v=238',
    './js/friendship-utils.js?v=238',
    './js/habit-groups.js?v=238',
    './js/health-connect-utils.js?v=238',
    './js/metabolic-score.js?v=238',
    './js/milestone-helpers.js?v=238',
    './js/monthly-mvp-reward.js?v=238',
    './js/meditation-guide.js?v=238',
    './js/reward-market.js?v=238',
    './js/guest-demo.js?v=238',
    './js/product-events.js?v=238',
    './js/activity-days.js?v=238',
    './js/pwa-install.js?v=238',
    './js/security.js?v=238',
    './js/social-challenge-readiness.js?v=238',
    './js/ui-helpers.js?v=238',
    './js/upload-performance.js?v=238',
    './js/webview-detect.js?v=238',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
