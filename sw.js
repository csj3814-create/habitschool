...
const CACHE_NAME = 'habitschool-v202';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=202',
    './styles-base.css?v=202',
    './styles-features.css?v=202',
    './styles-reward-market.css?v=202',
    './styles-dashboard.css?v=202',
    './styles-dark-mode.css?v=202',
    './styles-reports.css?v=202',
    './js/main.js?v=202',
    './js/app.js?v=202',
    './js/app-core.js?v=202',
    './js/auth.js?v=202',
    './js/app-mode.js?v=202',
    './js/auth-login-helpers.js?v=202',
    './js/blockchain-config.js?v=202',
    './js/blockchain-manager.js?v=202',
    './js/data-manager.js?v=202',
    './js/diet-program.js?v=202',
    './js/diet-analysis.js?v=202',
    './js/exercise-media.js?v=202',
    './js/firebase-config.js?v=202',
    './js/habit-groups.js?v=202',
    './js/health-connect-utils.js?v=202',
    './js/metabolic-score.js?v=202',
    './js/milestone-helpers.js?v=202',
    './js/monthly-mvp-reward.js?v=202',
    './js/pwa-install.js?v=202',
    './js/security.js?v=202',
    './js/social-challenge-readiness.js?v=202',
    './js/ui-helpers.js?v=202',
    './js/upload-performance.js?v=202',
    './js/webview-detect.js?v=202',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
