...
const CACHE_NAME = 'habitschool-v192';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=192',
    './styles-base.css?v=192',
    './styles-features.css?v=192',
    './styles-reward-market.css?v=192',
    './styles-dashboard.css?v=192',
    './styles-dark-mode.css?v=192',
    './styles-reports.css?v=192',
    './js/main.js?v=192',
    './js/app.js?v=192',
    './js/app-core.js?v=192',
    './js/auth.js?v=192',
    './js/app-mode.js?v=192',
    './js/auth-login-helpers.js?v=192',
    './js/blockchain-config.js?v=192',
    './js/blockchain-manager.js?v=192',
    './js/data-manager.js?v=192',
    './js/diet-program.js?v=192',
    './js/diet-analysis.js?v=192',
    './js/exercise-media.js?v=192',
    './js/firebase-config.js?v=192',
    './js/health-connect-utils.js?v=192',
    './js/metabolic-score.js?v=192',
    './js/milestone-helpers.js?v=192',
    './js/monthly-mvp-reward.js?v=192',
    './js/pwa-install.js?v=192',
    './js/security.js?v=192',
    './js/social-challenge-readiness.js?v=192',
    './js/ui-helpers.js?v=192',
    './js/upload-performance.js?v=192',
    './js/webview-detect.js?v=192',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
