...
const CACHE_NAME = 'habitschool-v423';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=423',
    './styles-base.css?v=423',
    './styles-en.css?v=423',
    './styles-features.css?v=423',
    './styles-reward-market.css?v=423',
    './styles-dashboard.css?v=423',
    './styles-dark-mode.css?v=423',
    './styles-reports.css?v=423',
    './styles-guest-demo.css?v=423',
    './js/main.js?v=423',
    './js/app.js?v=423',
    './js/app-core.js?v=423',
    './js/auth.js?v=423',
    './js/i18n.js?v=423',
    './js/app-mode.js?v=423',
    './js/auth-login-helpers.js?v=423',
    './js/blockchain-config.js?v=423',
    './js/blockchain-manager.js?v=423',
    './js/challenge-claim.js?v=423',
    './js/video-compress.js?v=423',
    './js/bug-report.js?v=423',
    './js/data-manager.js?v=423',
    './js/diet-program.js?v=423',
    './js/diet-analysis.js?v=423',
    './js/exercise-media.js?v=423',
    './js/firebase-config.js?v=423',
    './js/friendship-utils.js?v=423',
    './js/habit-groups.js?v=423',
    './js/health-connect-utils.js?v=423',
    './js/metabolic-score.js?v=423',
    './js/le8-score.js?v=423',
    './js/milestone-helpers.js?v=423',
    './js/monthly-mvp-reward.js?v=423',
    './js/meditation-guide.js?v=423',
    './js/reward-market.js?v=423',
    './js/guest-demo.js?v=423',
    './js/product-events.js?v=423',
    './js/activity-days.js?v=423',
    './js/pwa-install.js?v=423',
    './js/security.js?v=423',
    './js/community-stats-view.js?v=423',
    './js/social-challenge-readiness.js?v=423',
    './js/ui-helpers.js?v=423',
    './js/upload-performance.js?v=423',
    './js/video-thumbnail-quality.js?v=423',
    './js/browser-detect.js?v=423',
    './js/webview-detect.js?v=423',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
