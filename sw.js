...
const CACHE_NAME = 'habitschool-v271';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=271',
    './styles-base.css?v=271',
    './styles-en.css?v=271',
    './styles-features.css?v=271',
    './styles-reward-market.css?v=271',
    './styles-dashboard.css?v=271',
    './styles-dark-mode.css?v=271',
    './styles-reports.css?v=271',
    './styles-guest-demo.css?v=271',
    './js/main.js?v=271',
    './js/app.js?v=271',
    './js/app-core.js?v=271',
    './js/auth.js?v=271',
    './js/i18n.js?v=271',
    './js/app-mode.js?v=271',
    './js/auth-login-helpers.js?v=271',
    './js/blockchain-config.js?v=271',
    './js/blockchain-manager.js?v=271',
    './js/data-manager.js?v=271',
    './js/diet-program.js?v=271',
    './js/diet-analysis.js?v=271',
    './js/exercise-media.js?v=271',
    './js/firebase-config.js?v=271',
    './js/friendship-utils.js?v=271',
    './js/habit-groups.js?v=271',
    './js/health-connect-utils.js?v=271',
    './js/metabolic-score.js?v=271',
    './js/milestone-helpers.js?v=271',
    './js/monthly-mvp-reward.js?v=271',
    './js/meditation-guide.js?v=271',
    './js/reward-market.js?v=271',
    './js/guest-demo.js?v=271',
    './js/product-events.js?v=271',
    './js/activity-days.js?v=271',
    './js/pwa-install.js?v=271',
    './js/security.js?v=271',
    './js/social-challenge-readiness.js?v=271',
    './js/ui-helpers.js?v=271',
    './js/upload-performance.js?v=271',
    './js/video-thumbnail-quality.js?v=271',
    './js/webview-detect.js?v=271',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
