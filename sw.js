...
const CACHE_NAME = 'habitschool-v261';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=261',
    './styles-base.css?v=261',
    './styles-en.css?v=261',
    './styles-features.css?v=261',
    './styles-reward-market.css?v=261',
    './styles-dashboard.css?v=261',
    './styles-dark-mode.css?v=261',
    './styles-reports.css?v=261',
    './styles-guest-demo.css?v=261',
    './js/main.js?v=261',
    './js/app.js?v=261',
    './js/app-core.js?v=261',
    './js/auth.js?v=261',
    './js/i18n.js?v=261',
    './js/app-mode.js?v=261',
    './js/auth-login-helpers.js?v=261',
    './js/blockchain-config.js?v=261',
    './js/blockchain-manager.js?v=261',
    './js/data-manager.js?v=261',
    './js/diet-program.js?v=261',
    './js/diet-analysis.js?v=261',
    './js/exercise-media.js?v=261',
    './js/firebase-config.js?v=261',
    './js/friendship-utils.js?v=261',
    './js/habit-groups.js?v=261',
    './js/health-connect-utils.js?v=261',
    './js/metabolic-score.js?v=261',
    './js/milestone-helpers.js?v=261',
    './js/monthly-mvp-reward.js?v=261',
    './js/meditation-guide.js?v=261',
    './js/reward-market.js?v=261',
    './js/guest-demo.js?v=261',
    './js/product-events.js?v=261',
    './js/activity-days.js?v=261',
    './js/pwa-install.js?v=261',
    './js/security.js?v=261',
    './js/social-challenge-readiness.js?v=261',
    './js/ui-helpers.js?v=261',
    './js/upload-performance.js?v=261',
    './js/video-thumbnail-quality.js?v=261',
    './js/webview-detect.js?v=261',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
