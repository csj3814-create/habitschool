...
const CACHE_NAME = 'habitschool-v398';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=398',
    './styles-base.css?v=398',
    './styles-en.css?v=398',
    './styles-features.css?v=398',
    './styles-reward-market.css?v=398',
    './styles-dashboard.css?v=398',
    './styles-dark-mode.css?v=398',
    './styles-reports.css?v=398',
    './styles-guest-demo.css?v=398',
    './js/main.js?v=398',
    './js/app.js?v=398',
    './js/app-core.js?v=398',
    './js/auth.js?v=398',
    './js/i18n.js?v=398',
    './js/app-mode.js?v=398',
    './js/auth-login-helpers.js?v=398',
    './js/blockchain-config.js?v=398',
    './js/blockchain-manager.js?v=398',
    './js/challenge-claim.js?v=398',
    './js/video-compress.js?v=398',
    './js/bug-report.js?v=398',
    './js/data-manager.js?v=398',
    './js/diet-program.js?v=398',
    './js/diet-analysis.js?v=398',
    './js/exercise-media.js?v=398',
    './js/firebase-config.js?v=398',
    './js/friendship-utils.js?v=398',
    './js/habit-groups.js?v=398',
    './js/health-connect-utils.js?v=398',
    './js/metabolic-score.js?v=398',
    './js/le8-score.js?v=398',
    './js/milestone-helpers.js?v=398',
    './js/monthly-mvp-reward.js?v=398',
    './js/meditation-guide.js?v=398',
    './js/reward-market.js?v=398',
    './js/guest-demo.js?v=398',
    './js/product-events.js?v=398',
    './js/activity-days.js?v=398',
    './js/pwa-install.js?v=398',
    './js/security.js?v=398',
    './js/community-stats-view.js?v=398',
    './js/social-challenge-readiness.js?v=398',
    './js/ui-helpers.js?v=398',
    './js/upload-performance.js?v=398',
    './js/video-thumbnail-quality.js?v=398',
    './js/browser-detect.js?v=398',
    './js/webview-detect.js?v=398',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
