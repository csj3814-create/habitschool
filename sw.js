...
const CACHE_NAME = 'habitschool-v198';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=198',
    './styles-base.css?v=198',
    './styles-features.css?v=198',
    './styles-reward-market.css?v=198',
    './styles-dashboard.css?v=198',
    './styles-dark-mode.css?v=198',
    './styles-reports.css?v=198',
    './js/main.js?v=198',
    './js/app.js?v=198',
    './js/app-core.js?v=198',
    './js/auth.js?v=198',
    './js/app-mode.js?v=198',
    './js/auth-login-helpers.js?v=198',
    './js/blockchain-config.js?v=198',
    './js/blockchain-manager.js?v=198',
    './js/data-manager.js?v=198',
    './js/diet-program.js?v=198',
    './js/diet-analysis.js?v=198',
    './js/exercise-media.js?v=198',
    './js/firebase-config.js?v=198',
    './js/habit-groups.js?v=198',
    './js/health-connect-utils.js?v=198',
    './js/metabolic-score.js?v=198',
    './js/milestone-helpers.js?v=198',
    './js/monthly-mvp-reward.js?v=198',
    './js/pwa-install.js?v=198',
    './js/security.js?v=198',
    './js/social-challenge-readiness.js?v=198',
    './js/ui-helpers.js?v=198',
    './js/upload-performance.js?v=198',
    './js/webview-detect.js?v=198',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
