...
const CACHE_NAME = 'habitschool-v256';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=256',
    './styles-base.css?v=256',
    './styles-en.css?v=256',
    './styles-features.css?v=256',
    './styles-reward-market.css?v=256',
    './styles-dashboard.css?v=256',
    './styles-dark-mode.css?v=256',
    './styles-reports.css?v=256',
    './styles-guest-demo.css?v=256',
    './js/main.js?v=256',
    './js/app.js?v=256',
    './js/app-core.js?v=256',
    './js/auth.js?v=256',
    './js/i18n.js?v=256',
    './js/app-mode.js?v=256',
    './js/auth-login-helpers.js?v=256',
    './js/blockchain-config.js?v=256',
    './js/blockchain-manager.js?v=256',
    './js/data-manager.js?v=256',
    './js/diet-program.js?v=256',
    './js/diet-analysis.js?v=256',
    './js/exercise-media.js?v=256',
    './js/firebase-config.js?v=256',
    './js/friendship-utils.js?v=256',
    './js/habit-groups.js?v=256',
    './js/health-connect-utils.js?v=256',
    './js/metabolic-score.js?v=256',
    './js/milestone-helpers.js?v=256',
    './js/monthly-mvp-reward.js?v=256',
    './js/meditation-guide.js?v=256',
    './js/reward-market.js?v=256',
    './js/guest-demo.js?v=256',
    './js/product-events.js?v=256',
    './js/activity-days.js?v=256',
    './js/pwa-install.js?v=256',
    './js/security.js?v=256',
    './js/social-challenge-readiness.js?v=256',
    './js/ui-helpers.js?v=256',
    './js/upload-performance.js?v=256',
    './js/video-thumbnail-quality.js?v=256',
    './js/webview-detect.js?v=256',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
