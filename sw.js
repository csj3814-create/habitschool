...
const CACHE_NAME = 'habitschool-v176';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=176',
    './styles-base.css?v=176',
    './styles-features.css?v=176',
    './styles-reward-market.css?v=176',
    './styles-dashboard.css?v=176',
    './styles-dark-mode.css?v=176',
    './styles-reports.css?v=176',
    './js/main.js?v=176',
    './js/app.js?v=176',
    './js/app-core.js?v=176',
    './js/auth.js?v=176',
    './js/app-mode.js?v=176',
    './js/auth-login-helpers.js?v=176',
    './js/blockchain-config.js?v=176',
    './js/blockchain-manager.js?v=176',
    './js/data-manager.js?v=176',
    './js/diet-program.js?v=176',
    './js/diet-analysis.js?v=176',
    './js/exercise-media.js?v=176',
    './js/firebase-config.js?v=176',
    './js/health-connect-utils.js?v=176',
    './js/metabolic-score.js?v=176',
    './js/milestone-helpers.js?v=176',
    './js/monthly-mvp-reward.js?v=176',
    './js/pwa-install.js?v=176',
    './js/security.js?v=176',
    './js/social-challenge-readiness.js?v=176',
    './js/ui-helpers.js?v=176',
    './js/upload-performance.js?v=176',
    './js/webview-detect.js?v=176',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
