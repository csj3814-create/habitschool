...
const CACHE_NAME = 'habitschool-v249';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=249',
    './styles-base.css?v=249',
    './styles-en.css?v=249',
    './styles-features.css?v=249',
    './styles-reward-market.css?v=249',
    './styles-dashboard.css?v=249',
    './styles-dark-mode.css?v=249',
    './styles-reports.css?v=249',
    './styles-guest-demo.css?v=249',
    './js/main.js?v=249',
    './js/app.js?v=249',
    './js/app-core.js?v=249',
    './js/auth.js?v=249',
    './js/i18n.js?v=249',
    './js/app-mode.js?v=249',
    './js/auth-login-helpers.js?v=249',
    './js/blockchain-config.js?v=249',
    './js/blockchain-manager.js?v=249',
    './js/data-manager.js?v=249',
    './js/diet-program.js?v=249',
    './js/diet-analysis.js?v=249',
    './js/exercise-media.js?v=249',
    './js/firebase-config.js?v=249',
    './js/friendship-utils.js?v=249',
    './js/habit-groups.js?v=249',
    './js/health-connect-utils.js?v=249',
    './js/metabolic-score.js?v=249',
    './js/milestone-helpers.js?v=249',
    './js/monthly-mvp-reward.js?v=249',
    './js/meditation-guide.js?v=249',
    './js/reward-market.js?v=249',
    './js/guest-demo.js?v=249',
    './js/product-events.js?v=249',
    './js/activity-days.js?v=249',
    './js/pwa-install.js?v=249',
    './js/security.js?v=249',
    './js/social-challenge-readiness.js?v=249',
    './js/ui-helpers.js?v=249',
    './js/upload-performance.js?v=249',
    './js/video-thumbnail-quality.js?v=249',
    './js/webview-detect.js?v=249',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
