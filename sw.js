...
const CACHE_NAME = 'habitschool-v403';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=403',
    './styles-base.css?v=403',
    './styles-en.css?v=403',
    './styles-features.css?v=403',
    './styles-reward-market.css?v=403',
    './styles-dashboard.css?v=403',
    './styles-dark-mode.css?v=403',
    './styles-reports.css?v=403',
    './styles-guest-demo.css?v=403',
    './js/main.js?v=403',
    './js/app.js?v=403',
    './js/app-core.js?v=403',
    './js/auth.js?v=403',
    './js/i18n.js?v=403',
    './js/app-mode.js?v=403',
    './js/auth-login-helpers.js?v=403',
    './js/blockchain-config.js?v=403',
    './js/blockchain-manager.js?v=403',
    './js/challenge-claim.js?v=403',
    './js/video-compress.js?v=403',
    './js/bug-report.js?v=403',
    './js/data-manager.js?v=403',
    './js/diet-program.js?v=403',
    './js/diet-analysis.js?v=403',
    './js/exercise-media.js?v=403',
    './js/firebase-config.js?v=403',
    './js/friendship-utils.js?v=403',
    './js/habit-groups.js?v=403',
    './js/health-connect-utils.js?v=403',
    './js/metabolic-score.js?v=403',
    './js/le8-score.js?v=403',
    './js/milestone-helpers.js?v=403',
    './js/monthly-mvp-reward.js?v=403',
    './js/meditation-guide.js?v=403',
    './js/reward-market.js?v=403',
    './js/guest-demo.js?v=403',
    './js/product-events.js?v=403',
    './js/activity-days.js?v=403',
    './js/pwa-install.js?v=403',
    './js/security.js?v=403',
    './js/community-stats-view.js?v=403',
    './js/social-challenge-readiness.js?v=403',
    './js/ui-helpers.js?v=403',
    './js/upload-performance.js?v=403',
    './js/video-thumbnail-quality.js?v=403',
    './js/browser-detect.js?v=403',
    './js/webview-detect.js?v=403',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
