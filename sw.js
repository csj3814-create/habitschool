...
const CACHE_NAME = 'habitschool-v331';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=331',
    './styles-base.css?v=331',
    './styles-en.css?v=331',
    './styles-features.css?v=331',
    './styles-reward-market.css?v=331',
    './styles-dashboard.css?v=331',
    './styles-dark-mode.css?v=331',
    './styles-reports.css?v=331',
    './styles-guest-demo.css?v=331',
    './js/main.js?v=331',
    './js/app.js?v=331',
    './js/app-core.js?v=331',
    './js/auth.js?v=331',
    './js/i18n.js?v=331',
    './js/app-mode.js?v=331',
    './js/auth-login-helpers.js?v=331',
    './js/blockchain-config.js?v=331',
    './js/blockchain-manager.js?v=331',
    './js/challenge-claim.js?v=331',
    './js/video-compress.js?v=331',
    './js/data-manager.js?v=331',
    './js/diet-program.js?v=331',
    './js/diet-analysis.js?v=331',
    './js/exercise-media.js?v=331',
    './js/firebase-config.js?v=331',
    './js/friendship-utils.js?v=331',
    './js/habit-groups.js?v=331',
    './js/health-connect-utils.js?v=331',
    './js/metabolic-score.js?v=331',
    './js/milestone-helpers.js?v=331',
    './js/monthly-mvp-reward.js?v=331',
    './js/meditation-guide.js?v=331',
    './js/reward-market.js?v=331',
    './js/guest-demo.js?v=331',
    './js/product-events.js?v=331',
    './js/activity-days.js?v=331',
    './js/pwa-install.js?v=331',
    './js/security.js?v=331',
    './js/social-challenge-readiness.js?v=331',
    './js/ui-helpers.js?v=331',
    './js/upload-performance.js?v=331',
    './js/video-thumbnail-quality.js?v=331',
    './js/webview-detect.js?v=331',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
