...
const CACHE_NAME = 'habitschool-v377';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=377',
    './styles-base.css?v=377',
    './styles-en.css?v=377',
    './styles-features.css?v=377',
    './styles-reward-market.css?v=377',
    './styles-dashboard.css?v=377',
    './styles-dark-mode.css?v=377',
    './styles-reports.css?v=377',
    './styles-guest-demo.css?v=377',
    './js/main.js?v=377',
    './js/app.js?v=377',
    './js/app-core.js?v=377',
    './js/auth.js?v=377',
    './js/i18n.js?v=377',
    './js/app-mode.js?v=377',
    './js/auth-login-helpers.js?v=377',
    './js/blockchain-config.js?v=377',
    './js/blockchain-manager.js?v=377',
    './js/challenge-claim.js?v=377',
    './js/video-compress.js?v=377',
    './js/bug-report.js?v=377',
    './js/data-manager.js?v=377',
    './js/diet-program.js?v=377',
    './js/diet-analysis.js?v=377',
    './js/exercise-media.js?v=377',
    './js/firebase-config.js?v=377',
    './js/friendship-utils.js?v=377',
    './js/habit-groups.js?v=377',
    './js/health-connect-utils.js?v=377',
    './js/metabolic-score.js?v=377',
    './js/le8-score.js?v=377',
    './js/milestone-helpers.js?v=377',
    './js/monthly-mvp-reward.js?v=377',
    './js/meditation-guide.js?v=377',
    './js/reward-market.js?v=377',
    './js/guest-demo.js?v=377',
    './js/product-events.js?v=377',
    './js/activity-days.js?v=377',
    './js/pwa-install.js?v=377',
    './js/security.js?v=377',
    './js/community-stats-view.js?v=377',
    './js/social-challenge-readiness.js?v=377',
    './js/ui-helpers.js?v=377',
    './js/upload-performance.js?v=377',
    './js/video-thumbnail-quality.js?v=377',
    './js/webview-detect.js?v=377',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
