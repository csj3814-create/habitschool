...
const CACHE_NAME = 'habitschool-v392';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=392',
    './styles-base.css?v=392',
    './styles-en.css?v=392',
    './styles-features.css?v=392',
    './styles-reward-market.css?v=392',
    './styles-dashboard.css?v=392',
    './styles-dark-mode.css?v=392',
    './styles-reports.css?v=392',
    './styles-guest-demo.css?v=392',
    './js/main.js?v=392',
    './js/app.js?v=392',
    './js/app-core.js?v=392',
    './js/auth.js?v=392',
    './js/i18n.js?v=392',
    './js/app-mode.js?v=392',
    './js/auth-login-helpers.js?v=392',
    './js/blockchain-config.js?v=392',
    './js/blockchain-manager.js?v=392',
    './js/challenge-claim.js?v=392',
    './js/video-compress.js?v=392',
    './js/bug-report.js?v=392',
    './js/data-manager.js?v=392',
    './js/diet-program.js?v=392',
    './js/diet-analysis.js?v=392',
    './js/exercise-media.js?v=392',
    './js/firebase-config.js?v=392',
    './js/friendship-utils.js?v=392',
    './js/habit-groups.js?v=392',
    './js/health-connect-utils.js?v=392',
    './js/metabolic-score.js?v=392',
    './js/le8-score.js?v=392',
    './js/milestone-helpers.js?v=392',
    './js/monthly-mvp-reward.js?v=392',
    './js/meditation-guide.js?v=392',
    './js/reward-market.js?v=392',
    './js/guest-demo.js?v=392',
    './js/product-events.js?v=392',
    './js/activity-days.js?v=392',
    './js/pwa-install.js?v=392',
    './js/security.js?v=392',
    './js/community-stats-view.js?v=392',
    './js/social-challenge-readiness.js?v=392',
    './js/ui-helpers.js?v=392',
    './js/upload-performance.js?v=392',
    './js/video-thumbnail-quality.js?v=392',
    './js/browser-detect.js?v=392',
    './js/webview-detect.js?v=392',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
