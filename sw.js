...
const CACHE_NAME = 'habitschool-v199';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=199',
    './styles-base.css?v=199',
    './styles-features.css?v=199',
    './styles-reward-market.css?v=199',
    './styles-dashboard.css?v=199',
    './styles-dark-mode.css?v=199',
    './styles-reports.css?v=199',
    './js/main.js?v=199',
    './js/app.js?v=199',
    './js/app-core.js?v=199',
    './js/auth.js?v=199',
    './js/app-mode.js?v=199',
    './js/auth-login-helpers.js?v=199',
    './js/blockchain-config.js?v=199',
    './js/blockchain-manager.js?v=199',
    './js/data-manager.js?v=199',
    './js/diet-program.js?v=199',
    './js/diet-analysis.js?v=199',
    './js/exercise-media.js?v=199',
    './js/firebase-config.js?v=199',
    './js/habit-groups.js?v=199',
    './js/health-connect-utils.js?v=199',
    './js/metabolic-score.js?v=199',
    './js/milestone-helpers.js?v=199',
    './js/monthly-mvp-reward.js?v=199',
    './js/pwa-install.js?v=199',
    './js/security.js?v=199',
    './js/social-challenge-readiness.js?v=199',
    './js/ui-helpers.js?v=199',
    './js/upload-performance.js?v=199',
    './js/webview-detect.js?v=199',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
