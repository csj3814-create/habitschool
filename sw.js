...
const CACHE_NAME = 'habitschool-v425';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=425',
    './styles-base.css?v=425',
    './styles-en.css?v=425',
    './styles-features.css?v=425',
    './styles-reward-market.css?v=425',
    './styles-dashboard.css?v=425',
    './styles-dark-mode.css?v=425',
    './styles-reports.css?v=425',
    './styles-guest-demo.css?v=425',
    './js/main.js?v=425',
    './js/app.js?v=425',
    './js/app-core.js?v=425',
    './js/auth.js?v=425',
    './js/i18n.js?v=425',
    './js/app-mode.js?v=425',
    './js/auth-login-helpers.js?v=425',
    './js/blockchain-config.js?v=425',
    './js/blockchain-manager.js?v=425',
    './js/challenge-claim.js?v=425',
    './js/video-compress.js?v=425',
    './js/bug-report.js?v=425',
    './js/data-manager.js?v=425',
    './js/diet-program.js?v=425',
    './js/diet-analysis.js?v=425',
    './js/exercise-media.js?v=425',
    './js/firebase-config.js?v=425',
    './js/friendship-utils.js?v=425',
    './js/habit-groups.js?v=425',
    './js/health-connect-utils.js?v=425',
    './js/metabolic-score.js?v=425',
    './js/le8-score.js?v=425',
    './js/milestone-helpers.js?v=425',
    './js/monthly-mvp-reward.js?v=425',
    './js/meditation-guide.js?v=425',
    './js/reward-market.js?v=425',
    './js/guest-demo.js?v=425',
    './js/product-events.js?v=425',
    './js/activity-days.js?v=425',
    './js/pwa-install.js?v=425',
    './js/security.js?v=425',
    './js/community-stats-view.js?v=425',
    './js/social-challenge-readiness.js?v=425',
    './js/ui-helpers.js?v=425',
    './js/upload-performance.js?v=425',
    './js/video-thumbnail-quality.js?v=425',
    './js/browser-detect.js?v=425',
    './js/webview-detect.js?v=425',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
