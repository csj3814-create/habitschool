...
const CACHE_NAME = 'habitschool-v369';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=369',
    './styles-base.css?v=369',
    './styles-en.css?v=369',
    './styles-features.css?v=369',
    './styles-reward-market.css?v=369',
    './styles-dashboard.css?v=369',
    './styles-dark-mode.css?v=369',
    './styles-reports.css?v=369',
    './styles-guest-demo.css?v=369',
    './js/main.js?v=369',
    './js/app.js?v=369',
    './js/app-core.js?v=369',
    './js/auth.js?v=369',
    './js/i18n.js?v=369',
    './js/app-mode.js?v=369',
    './js/auth-login-helpers.js?v=369',
    './js/blockchain-config.js?v=369',
    './js/blockchain-manager.js?v=369',
    './js/challenge-claim.js?v=369',
    './js/video-compress.js?v=369',
    './js/bug-report.js?v=369',
    './js/data-manager.js?v=369',
    './js/diet-program.js?v=369',
    './js/diet-analysis.js?v=369',
    './js/exercise-media.js?v=369',
    './js/firebase-config.js?v=369',
    './js/friendship-utils.js?v=369',
    './js/habit-groups.js?v=369',
    './js/health-connect-utils.js?v=369',
    './js/metabolic-score.js?v=369',
    './js/le8-score.js?v=369',
    './js/milestone-helpers.js?v=369',
    './js/monthly-mvp-reward.js?v=369',
    './js/meditation-guide.js?v=369',
    './js/reward-market.js?v=369',
    './js/guest-demo.js?v=369',
    './js/product-events.js?v=369',
    './js/activity-days.js?v=369',
    './js/pwa-install.js?v=369',
    './js/security.js?v=369',
    './js/community-stats-view.js?v=369',
    './js/social-challenge-readiness.js?v=369',
    './js/ui-helpers.js?v=369',
    './js/upload-performance.js?v=369',
    './js/video-thumbnail-quality.js?v=369',
    './js/webview-detect.js?v=369',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
