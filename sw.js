...
const CACHE_NAME = 'habitschool-v362';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=362',
    './styles-base.css?v=362',
    './styles-en.css?v=362',
    './styles-features.css?v=362',
    './styles-reward-market.css?v=362',
    './styles-dashboard.css?v=362',
    './styles-dark-mode.css?v=362',
    './styles-reports.css?v=362',
    './styles-guest-demo.css?v=362',
    './js/main.js?v=362',
    './js/app.js?v=362',
    './js/app-core.js?v=362',
    './js/auth.js?v=362',
    './js/i18n.js?v=362',
    './js/app-mode.js?v=362',
    './js/auth-login-helpers.js?v=362',
    './js/blockchain-config.js?v=362',
    './js/blockchain-manager.js?v=362',
    './js/challenge-claim.js?v=362',
    './js/video-compress.js?v=362',
    './js/bug-report.js?v=362',
    './js/data-manager.js?v=362',
    './js/diet-program.js?v=362',
    './js/diet-analysis.js?v=362',
    './js/exercise-media.js?v=362',
    './js/firebase-config.js?v=362',
    './js/friendship-utils.js?v=362',
    './js/habit-groups.js?v=362',
    './js/health-connect-utils.js?v=362',
    './js/metabolic-score.js?v=362',
    './js/le8-score.js?v=362',
    './js/milestone-helpers.js?v=362',
    './js/monthly-mvp-reward.js?v=362',
    './js/meditation-guide.js?v=362',
    './js/reward-market.js?v=362',
    './js/guest-demo.js?v=362',
    './js/product-events.js?v=362',
    './js/activity-days.js?v=362',
    './js/pwa-install.js?v=362',
    './js/security.js?v=362',
    './js/community-stats-view.js?v=362',
    './js/social-challenge-readiness.js?v=362',
    './js/ui-helpers.js?v=362',
    './js/upload-performance.js?v=362',
    './js/video-thumbnail-quality.js?v=362',
    './js/webview-detect.js?v=362',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
