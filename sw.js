...
const CACHE_NAME = 'habitschool-v397';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=397',
    './styles-base.css?v=397',
    './styles-en.css?v=397',
    './styles-features.css?v=397',
    './styles-reward-market.css?v=397',
    './styles-dashboard.css?v=397',
    './styles-dark-mode.css?v=397',
    './styles-reports.css?v=397',
    './styles-guest-demo.css?v=397',
    './js/main.js?v=397',
    './js/app.js?v=397',
    './js/app-core.js?v=397',
    './js/auth.js?v=397',
    './js/i18n.js?v=397',
    './js/app-mode.js?v=397',
    './js/auth-login-helpers.js?v=397',
    './js/blockchain-config.js?v=397',
    './js/blockchain-manager.js?v=397',
    './js/challenge-claim.js?v=397',
    './js/video-compress.js?v=397',
    './js/bug-report.js?v=397',
    './js/data-manager.js?v=397',
    './js/diet-program.js?v=397',
    './js/diet-analysis.js?v=397',
    './js/exercise-media.js?v=397',
    './js/firebase-config.js?v=397',
    './js/friendship-utils.js?v=397',
    './js/habit-groups.js?v=397',
    './js/health-connect-utils.js?v=397',
    './js/metabolic-score.js?v=397',
    './js/le8-score.js?v=397',
    './js/milestone-helpers.js?v=397',
    './js/monthly-mvp-reward.js?v=397',
    './js/meditation-guide.js?v=397',
    './js/reward-market.js?v=397',
    './js/guest-demo.js?v=397',
    './js/product-events.js?v=397',
    './js/activity-days.js?v=397',
    './js/pwa-install.js?v=397',
    './js/security.js?v=397',
    './js/community-stats-view.js?v=397',
    './js/social-challenge-readiness.js?v=397',
    './js/ui-helpers.js?v=397',
    './js/upload-performance.js?v=397',
    './js/video-thumbnail-quality.js?v=397',
    './js/browser-detect.js?v=397',
    './js/webview-detect.js?v=397',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
