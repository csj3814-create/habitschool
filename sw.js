...
const CACHE_NAME = 'habitschool-v278';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=278',
    './styles-base.css?v=278',
    './styles-en.css?v=278',
    './styles-features.css?v=278',
    './styles-reward-market.css?v=278',
    './styles-dashboard.css?v=278',
    './styles-dark-mode.css?v=278',
    './styles-reports.css?v=278',
    './styles-guest-demo.css?v=278',
    './js/main.js?v=278',
    './js/app.js?v=278',
    './js/app-core.js?v=278',
    './js/auth.js?v=278',
    './js/i18n.js?v=278',
    './js/app-mode.js?v=278',
    './js/auth-login-helpers.js?v=278',
    './js/blockchain-config.js?v=278',
    './js/blockchain-manager.js?v=278',
    './js/data-manager.js?v=278',
    './js/diet-program.js?v=278',
    './js/diet-analysis.js?v=278',
    './js/exercise-media.js?v=278',
    './js/firebase-config.js?v=278',
    './js/friendship-utils.js?v=278',
    './js/habit-groups.js?v=278',
    './js/health-connect-utils.js?v=278',
    './js/metabolic-score.js?v=278',
    './js/milestone-helpers.js?v=278',
    './js/monthly-mvp-reward.js?v=278',
    './js/meditation-guide.js?v=278',
    './js/reward-market.js?v=278',
    './js/guest-demo.js?v=278',
    './js/product-events.js?v=278',
    './js/activity-days.js?v=278',
    './js/pwa-install.js?v=278',
    './js/security.js?v=278',
    './js/social-challenge-readiness.js?v=278',
    './js/ui-helpers.js?v=278',
    './js/upload-performance.js?v=278',
    './js/video-thumbnail-quality.js?v=278',
    './js/webview-detect.js?v=278',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
