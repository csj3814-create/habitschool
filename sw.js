...
const CACHE_NAME = 'habitschool-v361';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=361',
    './styles-base.css?v=361',
    './styles-en.css?v=361',
    './styles-features.css?v=361',
    './styles-reward-market.css?v=361',
    './styles-dashboard.css?v=361',
    './styles-dark-mode.css?v=361',
    './styles-reports.css?v=361',
    './styles-guest-demo.css?v=361',
    './js/main.js?v=361',
    './js/app.js?v=361',
    './js/app-core.js?v=361',
    './js/auth.js?v=361',
    './js/i18n.js?v=361',
    './js/app-mode.js?v=361',
    './js/auth-login-helpers.js?v=361',
    './js/blockchain-config.js?v=361',
    './js/blockchain-manager.js?v=361',
    './js/challenge-claim.js?v=361',
    './js/video-compress.js?v=361',
    './js/bug-report.js?v=361',
    './js/data-manager.js?v=361',
    './js/diet-program.js?v=361',
    './js/diet-analysis.js?v=361',
    './js/exercise-media.js?v=361',
    './js/firebase-config.js?v=361',
    './js/friendship-utils.js?v=361',
    './js/habit-groups.js?v=361',
    './js/health-connect-utils.js?v=361',
    './js/metabolic-score.js?v=361',
    './js/le8-score.js?v=361',
    './js/milestone-helpers.js?v=361',
    './js/monthly-mvp-reward.js?v=361',
    './js/meditation-guide.js?v=361',
    './js/reward-market.js?v=361',
    './js/guest-demo.js?v=361',
    './js/product-events.js?v=361',
    './js/activity-days.js?v=361',
    './js/pwa-install.js?v=361',
    './js/security.js?v=361',
    './js/community-stats-view.js?v=361',
    './js/social-challenge-readiness.js?v=361',
    './js/ui-helpers.js?v=361',
    './js/upload-performance.js?v=361',
    './js/video-thumbnail-quality.js?v=361',
    './js/webview-detect.js?v=361',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
