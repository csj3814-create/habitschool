...
const CACHE_NAME = 'habitschool-v273';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=273',
    './styles-base.css?v=273',
    './styles-en.css?v=273',
    './styles-features.css?v=273',
    './styles-reward-market.css?v=273',
    './styles-dashboard.css?v=273',
    './styles-dark-mode.css?v=273',
    './styles-reports.css?v=273',
    './styles-guest-demo.css?v=273',
    './js/main.js?v=273',
    './js/app.js?v=273',
    './js/app-core.js?v=273',
    './js/auth.js?v=273',
    './js/i18n.js?v=273',
    './js/app-mode.js?v=273',
    './js/auth-login-helpers.js?v=273',
    './js/blockchain-config.js?v=273',
    './js/blockchain-manager.js?v=273',
    './js/data-manager.js?v=273',
    './js/diet-program.js?v=273',
    './js/diet-analysis.js?v=273',
    './js/exercise-media.js?v=273',
    './js/firebase-config.js?v=273',
    './js/friendship-utils.js?v=273',
    './js/habit-groups.js?v=273',
    './js/health-connect-utils.js?v=273',
    './js/metabolic-score.js?v=273',
    './js/milestone-helpers.js?v=273',
    './js/monthly-mvp-reward.js?v=273',
    './js/meditation-guide.js?v=273',
    './js/reward-market.js?v=273',
    './js/guest-demo.js?v=273',
    './js/product-events.js?v=273',
    './js/activity-days.js?v=273',
    './js/pwa-install.js?v=273',
    './js/security.js?v=273',
    './js/social-challenge-readiness.js?v=273',
    './js/ui-helpers.js?v=273',
    './js/upload-performance.js?v=273',
    './js/video-thumbnail-quality.js?v=273',
    './js/webview-detect.js?v=273',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
