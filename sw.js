...
const CACHE_NAME = 'habitschool-v242';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=242',
    './styles-base.css?v=242',
    './styles-en.css?v=242',
    './styles-features.css?v=242',
    './styles-reward-market.css?v=242',
    './styles-dashboard.css?v=242',
    './styles-dark-mode.css?v=242',
    './styles-reports.css?v=242',
    './styles-guest-demo.css?v=242',
    './js/main.js?v=242',
    './js/app.js?v=242',
    './js/app-core.js?v=242',
    './js/auth.js?v=242',
    './js/i18n.js?v=242',
    './js/app-mode.js?v=242',
    './js/auth-login-helpers.js?v=242',
    './js/blockchain-config.js?v=242',
    './js/blockchain-manager.js?v=242',
    './js/data-manager.js?v=242',
    './js/diet-program.js?v=242',
    './js/diet-analysis.js?v=242',
    './js/exercise-media.js?v=242',
    './js/firebase-config.js?v=242',
    './js/friendship-utils.js?v=242',
    './js/habit-groups.js?v=242',
    './js/health-connect-utils.js?v=242',
    './js/metabolic-score.js?v=242',
    './js/milestone-helpers.js?v=242',
    './js/monthly-mvp-reward.js?v=242',
    './js/meditation-guide.js?v=242',
    './js/reward-market.js?v=242',
    './js/guest-demo.js?v=242',
    './js/product-events.js?v=242',
    './js/activity-days.js?v=242',
    './js/pwa-install.js?v=242',
    './js/security.js?v=242',
    './js/social-challenge-readiness.js?v=242',
    './js/ui-helpers.js?v=242',
    './js/upload-performance.js?v=242',
    './js/webview-detect.js?v=242',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
