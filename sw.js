...
const CACHE_NAME = 'habitschool-v429';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=429',
    './styles-base.css?v=429',
    './styles-en.css?v=429',
    './styles-features.css?v=429',
    './styles-reward-market.css?v=429',
    './styles-dashboard.css?v=429',
    './styles-dark-mode.css?v=429',
    './styles-reports.css?v=429',
    './styles-guest-demo.css?v=429',
    './js/main.js?v=429',
    './js/app.js?v=429',
    './js/app-core.js?v=429',
    './js/auth.js?v=429',
    './js/i18n.js?v=429',
    './js/app-mode.js?v=429',
    './js/auth-login-helpers.js?v=429',
    './js/blockchain-config.js?v=429',
    './js/blockchain-manager.js?v=429',
    './js/challenge-claim.js?v=429',
    './js/video-compress.js?v=429',
    './js/bug-report.js?v=429',
    './js/data-manager.js?v=429',
    './js/diet-program.js?v=429',
    './js/diet-analysis.js?v=429',
    './js/exercise-media.js?v=429',
    './js/firebase-config.js?v=429',
    './js/friendship-utils.js?v=429',
    './js/habit-groups.js?v=429',
    './js/health-connect-utils.js?v=429',
    './js/metabolic-score.js?v=429',
    './js/korean.js?v=429',
    './js/le8-score.js?v=429',
    './js/milestone-helpers.js?v=429',
    './js/monthly-mvp-reward.js?v=429',
    './js/meditation-guide.js?v=429',
    './js/reward-market.js?v=429',
    './js/guest-demo.js?v=429',
    './js/product-events.js?v=429',
    './js/activity-days.js?v=429',
    './js/pwa-install.js?v=429',
    './js/security.js?v=429',
    './js/community-stats-view.js?v=429',
    './js/social-challenge-readiness.js?v=429',
    './js/ui-helpers.js?v=429',
    './js/upload-performance.js?v=429',
    './js/video-thumbnail-quality.js?v=429',
    './js/browser-detect.js?v=429',
    './js/webview-detect.js?v=429',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
