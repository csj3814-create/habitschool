...
const CACHE_NAME = 'habitschool-v414';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=414',
    './styles-base.css?v=414',
    './styles-en.css?v=414',
    './styles-features.css?v=414',
    './styles-reward-market.css?v=414',
    './styles-dashboard.css?v=414',
    './styles-dark-mode.css?v=414',
    './styles-reports.css?v=414',
    './styles-guest-demo.css?v=414',
    './js/main.js?v=414',
    './js/app.js?v=414',
    './js/app-core.js?v=414',
    './js/auth.js?v=414',
    './js/i18n.js?v=414',
    './js/app-mode.js?v=414',
    './js/auth-login-helpers.js?v=414',
    './js/blockchain-config.js?v=414',
    './js/blockchain-manager.js?v=414',
    './js/challenge-claim.js?v=414',
    './js/video-compress.js?v=414',
    './js/bug-report.js?v=414',
    './js/data-manager.js?v=414',
    './js/diet-program.js?v=414',
    './js/diet-analysis.js?v=414',
    './js/exercise-media.js?v=414',
    './js/firebase-config.js?v=414',
    './js/friendship-utils.js?v=414',
    './js/habit-groups.js?v=414',
    './js/health-connect-utils.js?v=414',
    './js/metabolic-score.js?v=414',
    './js/le8-score.js?v=414',
    './js/milestone-helpers.js?v=414',
    './js/monthly-mvp-reward.js?v=414',
    './js/meditation-guide.js?v=414',
    './js/reward-market.js?v=414',
    './js/guest-demo.js?v=414',
    './js/product-events.js?v=414',
    './js/activity-days.js?v=414',
    './js/pwa-install.js?v=414',
    './js/security.js?v=414',
    './js/community-stats-view.js?v=414',
    './js/social-challenge-readiness.js?v=414',
    './js/ui-helpers.js?v=414',
    './js/upload-performance.js?v=414',
    './js/video-thumbnail-quality.js?v=414',
    './js/browser-detect.js?v=414',
    './js/webview-detect.js?v=414',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
