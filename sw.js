...
const CACHE_NAME = 'habitschool-v184';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=184',
    './styles-base.css?v=184',
    './styles-features.css?v=184',
    './styles-reward-market.css?v=184',
    './styles-dashboard.css?v=184',
    './styles-dark-mode.css?v=184',
    './styles-reports.css?v=184',
    './js/main.js?v=184',
    './js/app.js?v=184',
    './js/app-core.js?v=184',
    './js/auth.js?v=184',
    './js/app-mode.js?v=184',
    './js/auth-login-helpers.js?v=184',
    './js/blockchain-config.js?v=184',
    './js/blockchain-manager.js?v=184',
    './js/data-manager.js?v=184',
    './js/diet-program.js?v=184',
    './js/diet-analysis.js?v=184',
    './js/exercise-media.js?v=184',
    './js/firebase-config.js?v=184',
    './js/health-connect-utils.js?v=184',
    './js/metabolic-score.js?v=184',
    './js/milestone-helpers.js?v=184',
    './js/monthly-mvp-reward.js?v=184',
    './js/pwa-install.js?v=184',
    './js/security.js?v=184',
    './js/social-challenge-readiness.js?v=184',
    './js/ui-helpers.js?v=184',
    './js/upload-performance.js?v=184',
    './js/webview-detect.js?v=184',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
