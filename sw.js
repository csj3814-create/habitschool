...
const CACHE_NAME = 'habitschool-v250';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=250',
    './styles-base.css?v=250',
    './styles-en.css?v=250',
    './styles-features.css?v=250',
    './styles-reward-market.css?v=250',
    './styles-dashboard.css?v=250',
    './styles-dark-mode.css?v=250',
    './styles-reports.css?v=250',
    './styles-guest-demo.css?v=250',
    './js/main.js?v=250',
    './js/app.js?v=250',
    './js/app-core.js?v=250',
    './js/auth.js?v=250',
    './js/i18n.js?v=250',
    './js/app-mode.js?v=250',
    './js/auth-login-helpers.js?v=250',
    './js/blockchain-config.js?v=250',
    './js/blockchain-manager.js?v=250',
    './js/data-manager.js?v=250',
    './js/diet-program.js?v=250',
    './js/diet-analysis.js?v=250',
    './js/exercise-media.js?v=250',
    './js/firebase-config.js?v=250',
    './js/friendship-utils.js?v=250',
    './js/habit-groups.js?v=250',
    './js/health-connect-utils.js?v=250',
    './js/metabolic-score.js?v=250',
    './js/milestone-helpers.js?v=250',
    './js/monthly-mvp-reward.js?v=250',
    './js/meditation-guide.js?v=250',
    './js/reward-market.js?v=250',
    './js/guest-demo.js?v=250',
    './js/product-events.js?v=250',
    './js/activity-days.js?v=250',
    './js/pwa-install.js?v=250',
    './js/security.js?v=250',
    './js/social-challenge-readiness.js?v=250',
    './js/ui-helpers.js?v=250',
    './js/upload-performance.js?v=250',
    './js/video-thumbnail-quality.js?v=250',
    './js/webview-detect.js?v=250',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
