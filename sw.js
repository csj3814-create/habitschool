...
const CACHE_NAME = 'habitschool-v408';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=408',
    './styles-base.css?v=408',
    './styles-en.css?v=408',
    './styles-features.css?v=408',
    './styles-reward-market.css?v=408',
    './styles-dashboard.css?v=408',
    './styles-dark-mode.css?v=408',
    './styles-reports.css?v=408',
    './styles-guest-demo.css?v=408',
    './js/main.js?v=408',
    './js/app.js?v=408',
    './js/app-core.js?v=408',
    './js/auth.js?v=408',
    './js/i18n.js?v=408',
    './js/app-mode.js?v=408',
    './js/auth-login-helpers.js?v=408',
    './js/blockchain-config.js?v=408',
    './js/blockchain-manager.js?v=408',
    './js/challenge-claim.js?v=408',
    './js/video-compress.js?v=408',
    './js/bug-report.js?v=408',
    './js/data-manager.js?v=408',
    './js/diet-program.js?v=408',
    './js/diet-analysis.js?v=408',
    './js/exercise-media.js?v=408',
    './js/firebase-config.js?v=408',
    './js/friendship-utils.js?v=408',
    './js/habit-groups.js?v=408',
    './js/health-connect-utils.js?v=408',
    './js/metabolic-score.js?v=408',
    './js/le8-score.js?v=408',
    './js/milestone-helpers.js?v=408',
    './js/monthly-mvp-reward.js?v=408',
    './js/meditation-guide.js?v=408',
    './js/reward-market.js?v=408',
    './js/guest-demo.js?v=408',
    './js/product-events.js?v=408',
    './js/activity-days.js?v=408',
    './js/pwa-install.js?v=408',
    './js/security.js?v=408',
    './js/community-stats-view.js?v=408',
    './js/social-challenge-readiness.js?v=408',
    './js/ui-helpers.js?v=408',
    './js/upload-performance.js?v=408',
    './js/video-thumbnail-quality.js?v=408',
    './js/browser-detect.js?v=408',
    './js/webview-detect.js?v=408',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
