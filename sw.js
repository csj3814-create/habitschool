...
const CACHE_NAME = 'habitschool-v195';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=195',
    './styles-base.css?v=195',
    './styles-features.css?v=195',
    './styles-reward-market.css?v=195',
    './styles-dashboard.css?v=195',
    './styles-dark-mode.css?v=195',
    './styles-reports.css?v=195',
    './js/main.js?v=195',
    './js/app.js?v=195',
    './js/app-core.js?v=195',
    './js/auth.js?v=195',
    './js/app-mode.js?v=195',
    './js/auth-login-helpers.js?v=195',
    './js/blockchain-config.js?v=195',
    './js/blockchain-manager.js?v=195',
    './js/data-manager.js?v=195',
    './js/diet-program.js?v=195',
    './js/diet-analysis.js?v=195',
    './js/exercise-media.js?v=195',
    './js/firebase-config.js?v=195',
    './js/health-connect-utils.js?v=195',
    './js/metabolic-score.js?v=195',
    './js/milestone-helpers.js?v=195',
    './js/monthly-mvp-reward.js?v=195',
    './js/pwa-install.js?v=195',
    './js/security.js?v=195',
    './js/social-challenge-readiness.js?v=195',
    './js/ui-helpers.js?v=195',
    './js/upload-performance.js?v=195',
    './js/webview-detect.js?v=195',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
