...
const CACHE_NAME = 'habitschool-v415';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=415',
    './styles-base.css?v=415',
    './styles-en.css?v=415',
    './styles-features.css?v=415',
    './styles-reward-market.css?v=415',
    './styles-dashboard.css?v=415',
    './styles-dark-mode.css?v=415',
    './styles-reports.css?v=415',
    './styles-guest-demo.css?v=415',
    './js/main.js?v=415',
    './js/app.js?v=415',
    './js/app-core.js?v=415',
    './js/auth.js?v=415',
    './js/i18n.js?v=415',
    './js/app-mode.js?v=415',
    './js/auth-login-helpers.js?v=415',
    './js/blockchain-config.js?v=415',
    './js/blockchain-manager.js?v=415',
    './js/challenge-claim.js?v=415',
    './js/video-compress.js?v=415',
    './js/bug-report.js?v=415',
    './js/data-manager.js?v=415',
    './js/diet-program.js?v=415',
    './js/diet-analysis.js?v=415',
    './js/exercise-media.js?v=415',
    './js/firebase-config.js?v=415',
    './js/friendship-utils.js?v=415',
    './js/habit-groups.js?v=415',
    './js/health-connect-utils.js?v=415',
    './js/metabolic-score.js?v=415',
    './js/le8-score.js?v=415',
    './js/milestone-helpers.js?v=415',
    './js/monthly-mvp-reward.js?v=415',
    './js/meditation-guide.js?v=415',
    './js/reward-market.js?v=415',
    './js/guest-demo.js?v=415',
    './js/product-events.js?v=415',
    './js/activity-days.js?v=415',
    './js/pwa-install.js?v=415',
    './js/security.js?v=415',
    './js/community-stats-view.js?v=415',
    './js/social-challenge-readiness.js?v=415',
    './js/ui-helpers.js?v=415',
    './js/upload-performance.js?v=415',
    './js/video-thumbnail-quality.js?v=415',
    './js/browser-detect.js?v=415',
    './js/webview-detect.js?v=415',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
