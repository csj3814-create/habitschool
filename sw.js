...
const CACHE_NAME = 'habitschool-v338';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=338',
    './styles-base.css?v=338',
    './styles-en.css?v=338',
    './styles-features.css?v=338',
    './styles-reward-market.css?v=338',
    './styles-dashboard.css?v=338',
    './styles-dark-mode.css?v=338',
    './styles-reports.css?v=338',
    './styles-guest-demo.css?v=338',
    './js/main.js?v=338',
    './js/app.js?v=338',
    './js/app-core.js?v=338',
    './js/auth.js?v=338',
    './js/i18n.js?v=338',
    './js/app-mode.js?v=338',
    './js/auth-login-helpers.js?v=338',
    './js/blockchain-config.js?v=338',
    './js/blockchain-manager.js?v=338',
    './js/challenge-claim.js?v=338',
    './js/video-compress.js?v=338',
    './js/data-manager.js?v=338',
    './js/diet-program.js?v=338',
    './js/diet-analysis.js?v=338',
    './js/exercise-media.js?v=338',
    './js/firebase-config.js?v=338',
    './js/friendship-utils.js?v=338',
    './js/habit-groups.js?v=338',
    './js/health-connect-utils.js?v=338',
    './js/metabolic-score.js?v=338',
    './js/milestone-helpers.js?v=338',
    './js/monthly-mvp-reward.js?v=338',
    './js/meditation-guide.js?v=338',
    './js/reward-market.js?v=338',
    './js/guest-demo.js?v=338',
    './js/product-events.js?v=338',
    './js/activity-days.js?v=338',
    './js/pwa-install.js?v=338',
    './js/security.js?v=338',
    './js/social-challenge-readiness.js?v=338',
    './js/ui-helpers.js?v=338',
    './js/upload-performance.js?v=338',
    './js/video-thumbnail-quality.js?v=338',
    './js/webview-detect.js?v=338',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
