...
const CACHE_NAME = 'habitschool-v190';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=190',
    './styles-base.css?v=190',
    './styles-features.css?v=190',
    './styles-reward-market.css?v=190',
    './styles-dashboard.css?v=190',
    './styles-dark-mode.css?v=190',
    './styles-reports.css?v=190',
    './js/main.js?v=190',
    './js/app.js?v=190',
    './js/app-core.js?v=190',
    './js/auth.js?v=190',
    './js/app-mode.js?v=190',
    './js/auth-login-helpers.js?v=190',
    './js/blockchain-config.js?v=190',
    './js/blockchain-manager.js?v=190',
    './js/data-manager.js?v=190',
    './js/diet-program.js?v=190',
    './js/diet-analysis.js?v=190',
    './js/exercise-media.js?v=190',
    './js/firebase-config.js?v=190',
    './js/health-connect-utils.js?v=190',
    './js/metabolic-score.js?v=190',
    './js/milestone-helpers.js?v=190',
    './js/monthly-mvp-reward.js?v=190',
    './js/pwa-install.js?v=190',
    './js/security.js?v=190',
    './js/social-challenge-readiness.js?v=190',
    './js/ui-helpers.js?v=190',
    './js/upload-performance.js?v=190',
    './js/webview-detect.js?v=190',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
