...
const CACHE_NAME = 'habitschool-v349';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=349',
    './styles-base.css?v=349',
    './styles-en.css?v=349',
    './styles-features.css?v=349',
    './styles-reward-market.css?v=349',
    './styles-dashboard.css?v=349',
    './styles-dark-mode.css?v=349',
    './styles-reports.css?v=349',
    './styles-guest-demo.css?v=349',
    './js/main.js?v=349',
    './js/app.js?v=349',
    './js/app-core.js?v=349',
    './js/auth.js?v=349',
    './js/i18n.js?v=349',
    './js/app-mode.js?v=349',
    './js/auth-login-helpers.js?v=349',
    './js/blockchain-config.js?v=349',
    './js/blockchain-manager.js?v=349',
    './js/challenge-claim.js?v=349',
    './js/video-compress.js?v=349',
    './js/bug-report.js?v=349',
    './js/data-manager.js?v=349',
    './js/diet-program.js?v=349',
    './js/diet-analysis.js?v=349',
    './js/exercise-media.js?v=349',
    './js/firebase-config.js?v=349',
    './js/friendship-utils.js?v=349',
    './js/habit-groups.js?v=349',
    './js/health-connect-utils.js?v=349',
    './js/metabolic-score.js?v=349',
    './js/le8-score.js?v=349',
    './js/milestone-helpers.js?v=349',
    './js/monthly-mvp-reward.js?v=349',
    './js/meditation-guide.js?v=349',
    './js/reward-market.js?v=349',
    './js/guest-demo.js?v=349',
    './js/product-events.js?v=349',
    './js/activity-days.js?v=349',
    './js/pwa-install.js?v=349',
    './js/security.js?v=349',
    './js/social-challenge-readiness.js?v=349',
    './js/ui-helpers.js?v=349',
    './js/upload-performance.js?v=349',
    './js/video-thumbnail-quality.js?v=349',
    './js/webview-detect.js?v=349',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
