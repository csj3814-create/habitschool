...
const CACHE_NAME = 'habitschool-v252';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=252',
    './styles-base.css?v=252',
    './styles-en.css?v=252',
    './styles-features.css?v=252',
    './styles-reward-market.css?v=252',
    './styles-dashboard.css?v=252',
    './styles-dark-mode.css?v=252',
    './styles-reports.css?v=252',
    './styles-guest-demo.css?v=252',
    './js/main.js?v=252',
    './js/app.js?v=252',
    './js/app-core.js?v=252',
    './js/auth.js?v=252',
    './js/i18n.js?v=252',
    './js/app-mode.js?v=252',
    './js/auth-login-helpers.js?v=252',
    './js/blockchain-config.js?v=252',
    './js/blockchain-manager.js?v=252',
    './js/data-manager.js?v=252',
    './js/diet-program.js?v=252',
    './js/diet-analysis.js?v=252',
    './js/exercise-media.js?v=252',
    './js/firebase-config.js?v=252',
    './js/friendship-utils.js?v=252',
    './js/habit-groups.js?v=252',
    './js/health-connect-utils.js?v=252',
    './js/metabolic-score.js?v=252',
    './js/milestone-helpers.js?v=252',
    './js/monthly-mvp-reward.js?v=252',
    './js/meditation-guide.js?v=252',
    './js/reward-market.js?v=252',
    './js/guest-demo.js?v=252',
    './js/product-events.js?v=252',
    './js/activity-days.js?v=252',
    './js/pwa-install.js?v=252',
    './js/security.js?v=252',
    './js/social-challenge-readiness.js?v=252',
    './js/ui-helpers.js?v=252',
    './js/upload-performance.js?v=252',
    './js/video-thumbnail-quality.js?v=252',
    './js/webview-detect.js?v=252',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
