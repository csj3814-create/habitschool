...
const CACHE_NAME = 'habitschool-v317';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=317',
    './styles-base.css?v=317',
    './styles-en.css?v=317',
    './styles-features.css?v=317',
    './styles-reward-market.css?v=317',
    './styles-dashboard.css?v=317',
    './styles-dark-mode.css?v=317',
    './styles-reports.css?v=317',
    './styles-guest-demo.css?v=317',
    './js/main.js?v=317',
    './js/app.js?v=317',
    './js/app-core.js?v=317',
    './js/auth.js?v=317',
    './js/i18n.js?v=317',
    './js/app-mode.js?v=317',
    './js/auth-login-helpers.js?v=317',
    './js/blockchain-config.js?v=317',
    './js/blockchain-manager.js?v=317',
    './js/challenge-claim.js?v=317',
    './js/data-manager.js?v=317',
    './js/diet-program.js?v=317',
    './js/diet-analysis.js?v=317',
    './js/exercise-media.js?v=317',
    './js/firebase-config.js?v=317',
    './js/friendship-utils.js?v=317',
    './js/habit-groups.js?v=317',
    './js/health-connect-utils.js?v=317',
    './js/metabolic-score.js?v=317',
    './js/milestone-helpers.js?v=317',
    './js/monthly-mvp-reward.js?v=317',
    './js/meditation-guide.js?v=317',
    './js/reward-market.js?v=317',
    './js/guest-demo.js?v=317',
    './js/product-events.js?v=317',
    './js/activity-days.js?v=317',
    './js/pwa-install.js?v=317',
    './js/security.js?v=317',
    './js/social-challenge-readiness.js?v=317',
    './js/ui-helpers.js?v=317',
    './js/upload-performance.js?v=317',
    './js/video-thumbnail-quality.js?v=317',
    './js/webview-detect.js?v=317',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
