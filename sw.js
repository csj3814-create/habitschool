...
const CACHE_NAME = 'habitschool-v167';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=167',
    './styles-base.css?v=167',
    './styles-features.css?v=167',
    './styles-dashboard.css?v=167',
    './styles-dark-mode.css?v=167',
    './styles-reports.css?v=167',
    './js/main.js?v=167',
    './js/app.js?v=167',
    './js/app-core.js?v=167',
    './js/auth.js?v=167',
    './js/app-mode.js?v=167',
    './js/auth-login-helpers.js?v=167',
    './js/blockchain-config.js?v=167',
    './js/blockchain-manager.js?v=167',
    './js/data-manager.js?v=167',
    './js/diet-program.js?v=167',
    './js/diet-analysis.js?v=167',
    './js/exercise-media.js?v=167',
    './js/firebase-config.js?v=167',
    './js/health-connect-utils.js?v=167',
    './js/metabolic-score.js?v=167',
    './js/milestone-helpers.js?v=167',
    './js/pwa-install.js?v=167',
    './js/security.js?v=167',
    './js/ui-helpers.js?v=167',
    './js/upload-performance.js?v=167',
    './js/webview-detect.js?v=167',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
