...
const CACHE_NAME = 'habitschool-v402';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=402',
    './styles-base.css?v=402',
    './styles-en.css?v=402',
    './styles-features.css?v=402',
    './styles-reward-market.css?v=402',
    './styles-dashboard.css?v=402',
    './styles-dark-mode.css?v=402',
    './styles-reports.css?v=402',
    './styles-guest-demo.css?v=402',
    './js/main.js?v=402',
    './js/app.js?v=402',
    './js/app-core.js?v=402',
    './js/auth.js?v=402',
    './js/i18n.js?v=402',
    './js/app-mode.js?v=402',
    './js/auth-login-helpers.js?v=402',
    './js/blockchain-config.js?v=402',
    './js/blockchain-manager.js?v=402',
    './js/challenge-claim.js?v=402',
    './js/video-compress.js?v=402',
    './js/bug-report.js?v=402',
    './js/data-manager.js?v=402',
    './js/diet-program.js?v=402',
    './js/diet-analysis.js?v=402',
    './js/exercise-media.js?v=402',
    './js/firebase-config.js?v=402',
    './js/friendship-utils.js?v=402',
    './js/habit-groups.js?v=402',
    './js/health-connect-utils.js?v=402',
    './js/metabolic-score.js?v=402',
    './js/le8-score.js?v=402',
    './js/milestone-helpers.js?v=402',
    './js/monthly-mvp-reward.js?v=402',
    './js/meditation-guide.js?v=402',
    './js/reward-market.js?v=402',
    './js/guest-demo.js?v=402',
    './js/product-events.js?v=402',
    './js/activity-days.js?v=402',
    './js/pwa-install.js?v=402',
    './js/security.js?v=402',
    './js/community-stats-view.js?v=402',
    './js/social-challenge-readiness.js?v=402',
    './js/ui-helpers.js?v=402',
    './js/upload-performance.js?v=402',
    './js/video-thumbnail-quality.js?v=402',
    './js/browser-detect.js?v=402',
    './js/webview-detect.js?v=402',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
