...
const CACHE_NAME = 'habitschool-v373';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=373',
    './styles-base.css?v=373',
    './styles-en.css?v=373',
    './styles-features.css?v=373',
    './styles-reward-market.css?v=373',
    './styles-dashboard.css?v=373',
    './styles-dark-mode.css?v=373',
    './styles-reports.css?v=373',
    './styles-guest-demo.css?v=373',
    './js/main.js?v=373',
    './js/app.js?v=373',
    './js/app-core.js?v=373',
    './js/auth.js?v=373',
    './js/i18n.js?v=373',
    './js/app-mode.js?v=373',
    './js/auth-login-helpers.js?v=373',
    './js/blockchain-config.js?v=373',
    './js/blockchain-manager.js?v=373',
    './js/challenge-claim.js?v=373',
    './js/video-compress.js?v=373',
    './js/bug-report.js?v=373',
    './js/data-manager.js?v=373',
    './js/diet-program.js?v=373',
    './js/diet-analysis.js?v=373',
    './js/exercise-media.js?v=373',
    './js/firebase-config.js?v=373',
    './js/friendship-utils.js?v=373',
    './js/habit-groups.js?v=373',
    './js/health-connect-utils.js?v=373',
    './js/metabolic-score.js?v=373',
    './js/le8-score.js?v=373',
    './js/milestone-helpers.js?v=373',
    './js/monthly-mvp-reward.js?v=373',
    './js/meditation-guide.js?v=373',
    './js/reward-market.js?v=373',
    './js/guest-demo.js?v=373',
    './js/product-events.js?v=373',
    './js/activity-days.js?v=373',
    './js/pwa-install.js?v=373',
    './js/security.js?v=373',
    './js/community-stats-view.js?v=373',
    './js/social-challenge-readiness.js?v=373',
    './js/ui-helpers.js?v=373',
    './js/upload-performance.js?v=373',
    './js/video-thumbnail-quality.js?v=373',
    './js/webview-detect.js?v=373',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
