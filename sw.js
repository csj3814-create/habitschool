...
const CACHE_NAME = 'habitschool-v365';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=365',
    './styles-base.css?v=365',
    './styles-en.css?v=365',
    './styles-features.css?v=365',
    './styles-reward-market.css?v=365',
    './styles-dashboard.css?v=365',
    './styles-dark-mode.css?v=365',
    './styles-reports.css?v=365',
    './styles-guest-demo.css?v=365',
    './js/main.js?v=365',
    './js/app.js?v=365',
    './js/app-core.js?v=365',
    './js/auth.js?v=365',
    './js/i18n.js?v=365',
    './js/app-mode.js?v=365',
    './js/auth-login-helpers.js?v=365',
    './js/blockchain-config.js?v=365',
    './js/blockchain-manager.js?v=365',
    './js/challenge-claim.js?v=365',
    './js/video-compress.js?v=365',
    './js/bug-report.js?v=365',
    './js/data-manager.js?v=365',
    './js/diet-program.js?v=365',
    './js/diet-analysis.js?v=365',
    './js/exercise-media.js?v=365',
    './js/firebase-config.js?v=365',
    './js/friendship-utils.js?v=365',
    './js/habit-groups.js?v=365',
    './js/health-connect-utils.js?v=365',
    './js/metabolic-score.js?v=365',
    './js/le8-score.js?v=365',
    './js/milestone-helpers.js?v=365',
    './js/monthly-mvp-reward.js?v=365',
    './js/meditation-guide.js?v=365',
    './js/reward-market.js?v=365',
    './js/guest-demo.js?v=365',
    './js/product-events.js?v=365',
    './js/activity-days.js?v=365',
    './js/pwa-install.js?v=365',
    './js/security.js?v=365',
    './js/community-stats-view.js?v=365',
    './js/social-challenge-readiness.js?v=365',
    './js/ui-helpers.js?v=365',
    './js/upload-performance.js?v=365',
    './js/video-thumbnail-quality.js?v=365',
    './js/webview-detect.js?v=365',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
