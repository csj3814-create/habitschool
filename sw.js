...
const CACHE_NAME = 'habitschool-v395';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=395',
    './styles-base.css?v=395',
    './styles-en.css?v=395',
    './styles-features.css?v=395',
    './styles-reward-market.css?v=395',
    './styles-dashboard.css?v=395',
    './styles-dark-mode.css?v=395',
    './styles-reports.css?v=395',
    './styles-guest-demo.css?v=395',
    './js/main.js?v=395',
    './js/app.js?v=395',
    './js/app-core.js?v=395',
    './js/auth.js?v=395',
    './js/i18n.js?v=395',
    './js/app-mode.js?v=395',
    './js/auth-login-helpers.js?v=395',
    './js/blockchain-config.js?v=395',
    './js/blockchain-manager.js?v=395',
    './js/challenge-claim.js?v=395',
    './js/video-compress.js?v=395',
    './js/bug-report.js?v=395',
    './js/data-manager.js?v=395',
    './js/diet-program.js?v=395',
    './js/diet-analysis.js?v=395',
    './js/exercise-media.js?v=395',
    './js/firebase-config.js?v=395',
    './js/friendship-utils.js?v=395',
    './js/habit-groups.js?v=395',
    './js/health-connect-utils.js?v=395',
    './js/metabolic-score.js?v=395',
    './js/le8-score.js?v=395',
    './js/milestone-helpers.js?v=395',
    './js/monthly-mvp-reward.js?v=395',
    './js/meditation-guide.js?v=395',
    './js/reward-market.js?v=395',
    './js/guest-demo.js?v=395',
    './js/product-events.js?v=395',
    './js/activity-days.js?v=395',
    './js/pwa-install.js?v=395',
    './js/security.js?v=395',
    './js/community-stats-view.js?v=395',
    './js/social-challenge-readiness.js?v=395',
    './js/ui-helpers.js?v=395',
    './js/upload-performance.js?v=395',
    './js/video-thumbnail-quality.js?v=395',
    './js/browser-detect.js?v=395',
    './js/webview-detect.js?v=395',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
