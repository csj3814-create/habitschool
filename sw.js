...
const CACHE_NAME = 'habitschool-v390';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=390',
    './styles-base.css?v=390',
    './styles-en.css?v=390',
    './styles-features.css?v=390',
    './styles-reward-market.css?v=390',
    './styles-dashboard.css?v=390',
    './styles-dark-mode.css?v=390',
    './styles-reports.css?v=390',
    './styles-guest-demo.css?v=390',
    './js/main.js?v=390',
    './js/app.js?v=390',
    './js/app-core.js?v=390',
    './js/auth.js?v=390',
    './js/i18n.js?v=390',
    './js/app-mode.js?v=390',
    './js/auth-login-helpers.js?v=390',
    './js/blockchain-config.js?v=390',
    './js/blockchain-manager.js?v=390',
    './js/challenge-claim.js?v=390',
    './js/video-compress.js?v=390',
    './js/bug-report.js?v=390',
    './js/data-manager.js?v=390',
    './js/diet-program.js?v=390',
    './js/diet-analysis.js?v=390',
    './js/exercise-media.js?v=390',
    './js/firebase-config.js?v=390',
    './js/friendship-utils.js?v=390',
    './js/habit-groups.js?v=390',
    './js/health-connect-utils.js?v=390',
    './js/metabolic-score.js?v=390',
    './js/le8-score.js?v=390',
    './js/milestone-helpers.js?v=390',
    './js/monthly-mvp-reward.js?v=390',
    './js/meditation-guide.js?v=390',
    './js/reward-market.js?v=390',
    './js/guest-demo.js?v=390',
    './js/product-events.js?v=390',
    './js/activity-days.js?v=390',
    './js/pwa-install.js?v=390',
    './js/security.js?v=390',
    './js/community-stats-view.js?v=390',
    './js/social-challenge-readiness.js?v=390',
    './js/ui-helpers.js?v=390',
    './js/upload-performance.js?v=390',
    './js/video-thumbnail-quality.js?v=390',
    './js/browser-detect.js?v=390',
    './js/webview-detect.js?v=390',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
