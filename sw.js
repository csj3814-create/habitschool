...
const CACHE_NAME = 'habitschool-v421';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=421',
    './styles-base.css?v=421',
    './styles-en.css?v=421',
    './styles-features.css?v=421',
    './styles-reward-market.css?v=421',
    './styles-dashboard.css?v=421',
    './styles-dark-mode.css?v=421',
    './styles-reports.css?v=421',
    './styles-guest-demo.css?v=421',
    './js/main.js?v=421',
    './js/app.js?v=421',
    './js/app-core.js?v=421',
    './js/auth.js?v=421',
    './js/i18n.js?v=421',
    './js/app-mode.js?v=421',
    './js/auth-login-helpers.js?v=421',
    './js/blockchain-config.js?v=421',
    './js/blockchain-manager.js?v=421',
    './js/challenge-claim.js?v=421',
    './js/video-compress.js?v=421',
    './js/bug-report.js?v=421',
    './js/data-manager.js?v=421',
    './js/diet-program.js?v=421',
    './js/diet-analysis.js?v=421',
    './js/exercise-media.js?v=421',
    './js/firebase-config.js?v=421',
    './js/friendship-utils.js?v=421',
    './js/habit-groups.js?v=421',
    './js/health-connect-utils.js?v=421',
    './js/metabolic-score.js?v=421',
    './js/le8-score.js?v=421',
    './js/milestone-helpers.js?v=421',
    './js/monthly-mvp-reward.js?v=421',
    './js/meditation-guide.js?v=421',
    './js/reward-market.js?v=421',
    './js/guest-demo.js?v=421',
    './js/product-events.js?v=421',
    './js/activity-days.js?v=421',
    './js/pwa-install.js?v=421',
    './js/security.js?v=421',
    './js/community-stats-view.js?v=421',
    './js/social-challenge-readiness.js?v=421',
    './js/ui-helpers.js?v=421',
    './js/upload-performance.js?v=421',
    './js/video-thumbnail-quality.js?v=421',
    './js/browser-detect.js?v=421',
    './js/webview-detect.js?v=421',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
