...
const CACHE_NAME = 'habitschool-v401';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=401',
    './styles-base.css?v=401',
    './styles-en.css?v=401',
    './styles-features.css?v=401',
    './styles-reward-market.css?v=401',
    './styles-dashboard.css?v=401',
    './styles-dark-mode.css?v=401',
    './styles-reports.css?v=401',
    './styles-guest-demo.css?v=401',
    './js/main.js?v=401',
    './js/app.js?v=401',
    './js/app-core.js?v=401',
    './js/auth.js?v=401',
    './js/i18n.js?v=401',
    './js/app-mode.js?v=401',
    './js/auth-login-helpers.js?v=401',
    './js/blockchain-config.js?v=401',
    './js/blockchain-manager.js?v=401',
    './js/challenge-claim.js?v=401',
    './js/video-compress.js?v=401',
    './js/bug-report.js?v=401',
    './js/data-manager.js?v=401',
    './js/diet-program.js?v=401',
    './js/diet-analysis.js?v=401',
    './js/exercise-media.js?v=401',
    './js/firebase-config.js?v=401',
    './js/friendship-utils.js?v=401',
    './js/habit-groups.js?v=401',
    './js/health-connect-utils.js?v=401',
    './js/metabolic-score.js?v=401',
    './js/le8-score.js?v=401',
    './js/milestone-helpers.js?v=401',
    './js/monthly-mvp-reward.js?v=401',
    './js/meditation-guide.js?v=401',
    './js/reward-market.js?v=401',
    './js/guest-demo.js?v=401',
    './js/product-events.js?v=401',
    './js/activity-days.js?v=401',
    './js/pwa-install.js?v=401',
    './js/security.js?v=401',
    './js/community-stats-view.js?v=401',
    './js/social-challenge-readiness.js?v=401',
    './js/ui-helpers.js?v=401',
    './js/upload-performance.js?v=401',
    './js/video-thumbnail-quality.js?v=401',
    './js/browser-detect.js?v=401',
    './js/webview-detect.js?v=401',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
