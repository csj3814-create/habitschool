...
const CACHE_NAME = 'habitschool-v340';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=340',
    './styles-base.css?v=340',
    './styles-en.css?v=340',
    './styles-features.css?v=340',
    './styles-reward-market.css?v=340',
    './styles-dashboard.css?v=340',
    './styles-dark-mode.css?v=340',
    './styles-reports.css?v=340',
    './styles-guest-demo.css?v=340',
    './js/main.js?v=340',
    './js/app.js?v=340',
    './js/app-core.js?v=340',
    './js/auth.js?v=340',
    './js/i18n.js?v=340',
    './js/app-mode.js?v=340',
    './js/auth-login-helpers.js?v=340',
    './js/blockchain-config.js?v=340',
    './js/blockchain-manager.js?v=340',
    './js/challenge-claim.js?v=340',
    './js/video-compress.js?v=340',
    './js/data-manager.js?v=340',
    './js/diet-program.js?v=340',
    './js/diet-analysis.js?v=340',
    './js/exercise-media.js?v=340',
    './js/firebase-config.js?v=340',
    './js/friendship-utils.js?v=340',
    './js/habit-groups.js?v=340',
    './js/health-connect-utils.js?v=340',
    './js/metabolic-score.js?v=340',
    './js/le8-score.js?v=340',
    './js/milestone-helpers.js?v=340',
    './js/monthly-mvp-reward.js?v=340',
    './js/meditation-guide.js?v=340',
    './js/reward-market.js?v=340',
    './js/guest-demo.js?v=340',
    './js/product-events.js?v=340',
    './js/activity-days.js?v=340',
    './js/pwa-install.js?v=340',
    './js/security.js?v=340',
    './js/social-challenge-readiness.js?v=340',
    './js/ui-helpers.js?v=340',
    './js/upload-performance.js?v=340',
    './js/video-thumbnail-quality.js?v=340',
    './js/webview-detect.js?v=340',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
