...
const CACHE_NAME = 'habitschool-v239';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=239',
    './styles-base.css?v=239',
    './styles-en.css?v=239',
    './styles-features.css?v=239',
    './styles-reward-market.css?v=239',
    './styles-dashboard.css?v=239',
    './styles-dark-mode.css?v=239',
    './styles-reports.css?v=239',
    './styles-guest-demo.css?v=239',
    './js/main.js?v=239',
    './js/app.js?v=239',
    './js/app-core.js?v=239',
    './js/auth.js?v=239',
    './js/i18n.js?v=239',
    './js/app-mode.js?v=239',
    './js/auth-login-helpers.js?v=239',
    './js/blockchain-config.js?v=239',
    './js/blockchain-manager.js?v=239',
    './js/data-manager.js?v=239',
    './js/diet-program.js?v=239',
    './js/diet-analysis.js?v=239',
    './js/exercise-media.js?v=239',
    './js/firebase-config.js?v=239',
    './js/friendship-utils.js?v=239',
    './js/habit-groups.js?v=239',
    './js/health-connect-utils.js?v=239',
    './js/metabolic-score.js?v=239',
    './js/milestone-helpers.js?v=239',
    './js/monthly-mvp-reward.js?v=239',
    './js/meditation-guide.js?v=239',
    './js/reward-market.js?v=239',
    './js/guest-demo.js?v=239',
    './js/product-events.js?v=239',
    './js/activity-days.js?v=239',
    './js/pwa-install.js?v=239',
    './js/security.js?v=239',
    './js/social-challenge-readiness.js?v=239',
    './js/ui-helpers.js?v=239',
    './js/upload-performance.js?v=239',
    './js/webview-detect.js?v=239',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
