...
const CACHE_NAME = 'habitschool-v426';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=426',
    './styles-base.css?v=426',
    './styles-en.css?v=426',
    './styles-features.css?v=426',
    './styles-reward-market.css?v=426',
    './styles-dashboard.css?v=426',
    './styles-dark-mode.css?v=426',
    './styles-reports.css?v=426',
    './styles-guest-demo.css?v=426',
    './js/main.js?v=426',
    './js/app.js?v=426',
    './js/app-core.js?v=426',
    './js/auth.js?v=426',
    './js/i18n.js?v=426',
    './js/app-mode.js?v=426',
    './js/auth-login-helpers.js?v=426',
    './js/blockchain-config.js?v=426',
    './js/blockchain-manager.js?v=426',
    './js/challenge-claim.js?v=426',
    './js/video-compress.js?v=426',
    './js/bug-report.js?v=426',
    './js/data-manager.js?v=426',
    './js/diet-program.js?v=426',
    './js/diet-analysis.js?v=426',
    './js/exercise-media.js?v=426',
    './js/firebase-config.js?v=426',
    './js/friendship-utils.js?v=426',
    './js/habit-groups.js?v=426',
    './js/health-connect-utils.js?v=426',
    './js/metabolic-score.js?v=426',
    './js/korean.js?v=426',
    './js/le8-score.js?v=426',
    './js/milestone-helpers.js?v=426',
    './js/monthly-mvp-reward.js?v=426',
    './js/meditation-guide.js?v=426',
    './js/reward-market.js?v=426',
    './js/guest-demo.js?v=426',
    './js/product-events.js?v=426',
    './js/activity-days.js?v=426',
    './js/pwa-install.js?v=426',
    './js/security.js?v=426',
    './js/community-stats-view.js?v=426',
    './js/social-challenge-readiness.js?v=426',
    './js/ui-helpers.js?v=426',
    './js/upload-performance.js?v=426',
    './js/video-thumbnail-quality.js?v=426',
    './js/browser-detect.js?v=426',
    './js/webview-detect.js?v=426',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
