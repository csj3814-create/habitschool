...
const CACHE_NAME = 'habitschool-v382';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=382',
    './styles-base.css?v=382',
    './styles-en.css?v=382',
    './styles-features.css?v=382',
    './styles-reward-market.css?v=382',
    './styles-dashboard.css?v=382',
    './styles-dark-mode.css?v=382',
    './styles-reports.css?v=382',
    './styles-guest-demo.css?v=382',
    './js/main.js?v=382',
    './js/app.js?v=382',
    './js/app-core.js?v=382',
    './js/auth.js?v=382',
    './js/i18n.js?v=382',
    './js/app-mode.js?v=382',
    './js/auth-login-helpers.js?v=382',
    './js/blockchain-config.js?v=382',
    './js/blockchain-manager.js?v=382',
    './js/challenge-claim.js?v=382',
    './js/video-compress.js?v=382',
    './js/bug-report.js?v=382',
    './js/data-manager.js?v=382',
    './js/diet-program.js?v=382',
    './js/diet-analysis.js?v=382',
    './js/exercise-media.js?v=382',
    './js/firebase-config.js?v=382',
    './js/friendship-utils.js?v=382',
    './js/habit-groups.js?v=382',
    './js/health-connect-utils.js?v=382',
    './js/metabolic-score.js?v=382',
    './js/le8-score.js?v=382',
    './js/milestone-helpers.js?v=382',
    './js/monthly-mvp-reward.js?v=382',
    './js/meditation-guide.js?v=382',
    './js/reward-market.js?v=382',
    './js/guest-demo.js?v=382',
    './js/product-events.js?v=382',
    './js/activity-days.js?v=382',
    './js/pwa-install.js?v=382',
    './js/security.js?v=382',
    './js/community-stats-view.js?v=382',
    './js/social-challenge-readiness.js?v=382',
    './js/ui-helpers.js?v=382',
    './js/upload-performance.js?v=382',
    './js/video-thumbnail-quality.js?v=382',
    './js/browser-detect.js?v=382',
    './js/webview-detect.js?v=382',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
