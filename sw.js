...
const CACHE_NAME = 'habitschool-v289';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=289',
    './styles-base.css?v=289',
    './styles-en.css?v=289',
    './styles-features.css?v=289',
    './styles-reward-market.css?v=289',
    './styles-dashboard.css?v=289',
    './styles-dark-mode.css?v=289',
    './styles-reports.css?v=289',
    './styles-guest-demo.css?v=289',
    './js/main.js?v=289',
    './js/app.js?v=289',
    './js/app-core.js?v=289',
    './js/auth.js?v=289',
    './js/i18n.js?v=289',
    './js/app-mode.js?v=289',
    './js/auth-login-helpers.js?v=289',
    './js/blockchain-config.js?v=289',
    './js/blockchain-manager.js?v=289',
    './js/data-manager.js?v=289',
    './js/diet-program.js?v=289',
    './js/diet-analysis.js?v=289',
    './js/exercise-media.js?v=289',
    './js/firebase-config.js?v=289',
    './js/friendship-utils.js?v=289',
    './js/habit-groups.js?v=289',
    './js/health-connect-utils.js?v=289',
    './js/metabolic-score.js?v=289',
    './js/milestone-helpers.js?v=289',
    './js/monthly-mvp-reward.js?v=289',
    './js/meditation-guide.js?v=289',
    './js/reward-market.js?v=289',
    './js/guest-demo.js?v=289',
    './js/product-events.js?v=289',
    './js/activity-days.js?v=289',
    './js/pwa-install.js?v=289',
    './js/security.js?v=289',
    './js/social-challenge-readiness.js?v=289',
    './js/ui-helpers.js?v=289',
    './js/upload-performance.js?v=289',
    './js/video-thumbnail-quality.js?v=289',
    './js/webview-detect.js?v=289',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
