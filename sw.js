...
const CACHE_NAME = 'habitschool-v247';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=247',
    './styles-base.css?v=247',
    './styles-en.css?v=247',
    './styles-features.css?v=247',
    './styles-reward-market.css?v=247',
    './styles-dashboard.css?v=247',
    './styles-dark-mode.css?v=247',
    './styles-reports.css?v=247',
    './styles-guest-demo.css?v=247',
    './js/main.js?v=247',
    './js/app.js?v=247',
    './js/app-core.js?v=247',
    './js/auth.js?v=247',
    './js/i18n.js?v=247',
    './js/app-mode.js?v=247',
    './js/auth-login-helpers.js?v=247',
    './js/blockchain-config.js?v=247',
    './js/blockchain-manager.js?v=247',
    './js/data-manager.js?v=247',
    './js/diet-program.js?v=247',
    './js/diet-analysis.js?v=247',
    './js/exercise-media.js?v=247',
    './js/firebase-config.js?v=247',
    './js/friendship-utils.js?v=247',
    './js/habit-groups.js?v=247',
    './js/health-connect-utils.js?v=247',
    './js/metabolic-score.js?v=247',
    './js/milestone-helpers.js?v=247',
    './js/monthly-mvp-reward.js?v=247',
    './js/meditation-guide.js?v=247',
    './js/reward-market.js?v=247',
    './js/guest-demo.js?v=247',
    './js/product-events.js?v=247',
    './js/activity-days.js?v=247',
    './js/pwa-install.js?v=247',
    './js/security.js?v=247',
    './js/social-challenge-readiness.js?v=247',
    './js/ui-helpers.js?v=247',
    './js/upload-performance.js?v=247',
    './js/video-thumbnail-quality.js?v=247',
    './js/webview-detect.js?v=247',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
