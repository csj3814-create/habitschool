...
const CACHE_NAME = 'habitschool-v254';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=254',
    './styles-base.css?v=254',
    './styles-en.css?v=254',
    './styles-features.css?v=254',
    './styles-reward-market.css?v=254',
    './styles-dashboard.css?v=254',
    './styles-dark-mode.css?v=254',
    './styles-reports.css?v=254',
    './styles-guest-demo.css?v=254',
    './js/main.js?v=254',
    './js/app.js?v=254',
    './js/app-core.js?v=254',
    './js/auth.js?v=254',
    './js/i18n.js?v=254',
    './js/app-mode.js?v=254',
    './js/auth-login-helpers.js?v=254',
    './js/blockchain-config.js?v=254',
    './js/blockchain-manager.js?v=254',
    './js/data-manager.js?v=254',
    './js/diet-program.js?v=254',
    './js/diet-analysis.js?v=254',
    './js/exercise-media.js?v=254',
    './js/firebase-config.js?v=254',
    './js/friendship-utils.js?v=254',
    './js/habit-groups.js?v=254',
    './js/health-connect-utils.js?v=254',
    './js/metabolic-score.js?v=254',
    './js/milestone-helpers.js?v=254',
    './js/monthly-mvp-reward.js?v=254',
    './js/meditation-guide.js?v=254',
    './js/reward-market.js?v=254',
    './js/guest-demo.js?v=254',
    './js/product-events.js?v=254',
    './js/activity-days.js?v=254',
    './js/pwa-install.js?v=254',
    './js/security.js?v=254',
    './js/social-challenge-readiness.js?v=254',
    './js/ui-helpers.js?v=254',
    './js/upload-performance.js?v=254',
    './js/video-thumbnail-quality.js?v=254',
    './js/webview-detect.js?v=254',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
