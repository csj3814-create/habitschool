...
const CACHE_NAME = 'habitschool-v257';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=257',
    './styles-base.css?v=257',
    './styles-en.css?v=257',
    './styles-features.css?v=257',
    './styles-reward-market.css?v=257',
    './styles-dashboard.css?v=257',
    './styles-dark-mode.css?v=257',
    './styles-reports.css?v=257',
    './styles-guest-demo.css?v=257',
    './js/main.js?v=257',
    './js/app.js?v=257',
    './js/app-core.js?v=257',
    './js/auth.js?v=257',
    './js/i18n.js?v=257',
    './js/app-mode.js?v=257',
    './js/auth-login-helpers.js?v=257',
    './js/blockchain-config.js?v=257',
    './js/blockchain-manager.js?v=257',
    './js/data-manager.js?v=257',
    './js/diet-program.js?v=257',
    './js/diet-analysis.js?v=257',
    './js/exercise-media.js?v=257',
    './js/firebase-config.js?v=257',
    './js/friendship-utils.js?v=257',
    './js/habit-groups.js?v=257',
    './js/health-connect-utils.js?v=257',
    './js/metabolic-score.js?v=257',
    './js/milestone-helpers.js?v=257',
    './js/monthly-mvp-reward.js?v=257',
    './js/meditation-guide.js?v=257',
    './js/reward-market.js?v=257',
    './js/guest-demo.js?v=257',
    './js/product-events.js?v=257',
    './js/activity-days.js?v=257',
    './js/pwa-install.js?v=257',
    './js/security.js?v=257',
    './js/social-challenge-readiness.js?v=257',
    './js/ui-helpers.js?v=257',
    './js/upload-performance.js?v=257',
    './js/video-thumbnail-quality.js?v=257',
    './js/webview-detect.js?v=257',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
