...
const CACHE_NAME = 'habitschool-v174';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=174',
    './styles-base.css?v=174',
    './styles-features.css?v=174',
    './styles-reward-market.css?v=174',
    './styles-dashboard.css?v=174',
    './styles-dark-mode.css?v=174',
    './styles-reports.css?v=174',
    './js/main.js?v=174',
    './js/app.js?v=174',
    './js/app-core.js?v=174',
    './js/auth.js?v=174',
    './js/app-mode.js?v=174',
    './js/auth-login-helpers.js?v=174',
    './js/blockchain-config.js?v=174',
    './js/blockchain-manager.js?v=174',
    './js/data-manager.js?v=174',
    './js/diet-program.js?v=174',
    './js/diet-analysis.js?v=174',
    './js/exercise-media.js?v=174',
    './js/firebase-config.js?v=174',
    './js/health-connect-utils.js?v=174',
    './js/metabolic-score.js?v=174',
    './js/milestone-helpers.js?v=174',
    './js/monthly-mvp-reward.js?v=174',
    './js/pwa-install.js?v=174',
    './js/security.js?v=174',
    './js/social-challenge-readiness.js?v=174',
    './js/ui-helpers.js?v=174',
    './js/upload-performance.js?v=174',
    './js/webview-detect.js?v=174',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
