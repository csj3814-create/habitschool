...
const CACHE_NAME = 'habitschool-v263';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=263',
    './styles-base.css?v=263',
    './styles-en.css?v=263',
    './styles-features.css?v=263',
    './styles-reward-market.css?v=263',
    './styles-dashboard.css?v=263',
    './styles-dark-mode.css?v=263',
    './styles-reports.css?v=263',
    './styles-guest-demo.css?v=263',
    './js/main.js?v=263',
    './js/app.js?v=263',
    './js/app-core.js?v=263',
    './js/auth.js?v=263',
    './js/i18n.js?v=263',
    './js/app-mode.js?v=263',
    './js/auth-login-helpers.js?v=263',
    './js/blockchain-config.js?v=263',
    './js/blockchain-manager.js?v=263',
    './js/data-manager.js?v=263',
    './js/diet-program.js?v=263',
    './js/diet-analysis.js?v=263',
    './js/exercise-media.js?v=263',
    './js/firebase-config.js?v=263',
    './js/friendship-utils.js?v=263',
    './js/habit-groups.js?v=263',
    './js/health-connect-utils.js?v=263',
    './js/metabolic-score.js?v=263',
    './js/milestone-helpers.js?v=263',
    './js/monthly-mvp-reward.js?v=263',
    './js/meditation-guide.js?v=263',
    './js/reward-market.js?v=263',
    './js/guest-demo.js?v=263',
    './js/product-events.js?v=263',
    './js/activity-days.js?v=263',
    './js/pwa-install.js?v=263',
    './js/security.js?v=263',
    './js/social-challenge-readiness.js?v=263',
    './js/ui-helpers.js?v=263',
    './js/upload-performance.js?v=263',
    './js/video-thumbnail-quality.js?v=263',
    './js/webview-detect.js?v=263',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
