...
const CACHE_NAME = 'habitschool-v188';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=188',
    './styles-base.css?v=188',
    './styles-features.css?v=188',
    './styles-reward-market.css?v=188',
    './styles-dashboard.css?v=188',
    './styles-dark-mode.css?v=188',
    './styles-reports.css?v=188',
    './js/main.js?v=188',
    './js/app.js?v=188',
    './js/app-core.js?v=188',
    './js/auth.js?v=188',
    './js/app-mode.js?v=188',
    './js/auth-login-helpers.js?v=188',
    './js/blockchain-config.js?v=188',
    './js/blockchain-manager.js?v=188',
    './js/data-manager.js?v=188',
    './js/diet-program.js?v=188',
    './js/diet-analysis.js?v=188',
    './js/exercise-media.js?v=188',
    './js/firebase-config.js?v=188',
    './js/health-connect-utils.js?v=188',
    './js/metabolic-score.js?v=188',
    './js/milestone-helpers.js?v=188',
    './js/monthly-mvp-reward.js?v=188',
    './js/pwa-install.js?v=188',
    './js/security.js?v=188',
    './js/social-challenge-readiness.js?v=188',
    './js/ui-helpers.js?v=188',
    './js/upload-performance.js?v=188',
    './js/webview-detect.js?v=188',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
