...
const CACHE_NAME = 'habitschool-v277';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=277',
    './styles-base.css?v=277',
    './styles-en.css?v=277',
    './styles-features.css?v=277',
    './styles-reward-market.css?v=277',
    './styles-dashboard.css?v=277',
    './styles-dark-mode.css?v=277',
    './styles-reports.css?v=277',
    './styles-guest-demo.css?v=277',
    './js/main.js?v=277',
    './js/app.js?v=277',
    './js/app-core.js?v=277',
    './js/auth.js?v=277',
    './js/i18n.js?v=277',
    './js/app-mode.js?v=277',
    './js/auth-login-helpers.js?v=277',
    './js/blockchain-config.js?v=277',
    './js/blockchain-manager.js?v=277',
    './js/data-manager.js?v=277',
    './js/diet-program.js?v=277',
    './js/diet-analysis.js?v=277',
    './js/exercise-media.js?v=277',
    './js/firebase-config.js?v=277',
    './js/friendship-utils.js?v=277',
    './js/habit-groups.js?v=277',
    './js/health-connect-utils.js?v=277',
    './js/metabolic-score.js?v=277',
    './js/milestone-helpers.js?v=277',
    './js/monthly-mvp-reward.js?v=277',
    './js/meditation-guide.js?v=277',
    './js/reward-market.js?v=277',
    './js/guest-demo.js?v=277',
    './js/product-events.js?v=277',
    './js/activity-days.js?v=277',
    './js/pwa-install.js?v=277',
    './js/security.js?v=277',
    './js/social-challenge-readiness.js?v=277',
    './js/ui-helpers.js?v=277',
    './js/upload-performance.js?v=277',
    './js/video-thumbnail-quality.js?v=277',
    './js/webview-detect.js?v=277',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
