...
const CACHE_NAME = 'habitschool-v419';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=419',
    './styles-base.css?v=419',
    './styles-en.css?v=419',
    './styles-features.css?v=419',
    './styles-reward-market.css?v=419',
    './styles-dashboard.css?v=419',
    './styles-dark-mode.css?v=419',
    './styles-reports.css?v=419',
    './styles-guest-demo.css?v=419',
    './js/main.js?v=419',
    './js/app.js?v=419',
    './js/app-core.js?v=419',
    './js/auth.js?v=419',
    './js/i18n.js?v=419',
    './js/app-mode.js?v=419',
    './js/auth-login-helpers.js?v=419',
    './js/blockchain-config.js?v=419',
    './js/blockchain-manager.js?v=419',
    './js/challenge-claim.js?v=419',
    './js/video-compress.js?v=419',
    './js/bug-report.js?v=419',
    './js/data-manager.js?v=419',
    './js/diet-program.js?v=419',
    './js/diet-analysis.js?v=419',
    './js/exercise-media.js?v=419',
    './js/firebase-config.js?v=419',
    './js/friendship-utils.js?v=419',
    './js/habit-groups.js?v=419',
    './js/health-connect-utils.js?v=419',
    './js/metabolic-score.js?v=419',
    './js/le8-score.js?v=419',
    './js/milestone-helpers.js?v=419',
    './js/monthly-mvp-reward.js?v=419',
    './js/meditation-guide.js?v=419',
    './js/reward-market.js?v=419',
    './js/guest-demo.js?v=419',
    './js/product-events.js?v=419',
    './js/activity-days.js?v=419',
    './js/pwa-install.js?v=419',
    './js/security.js?v=419',
    './js/community-stats-view.js?v=419',
    './js/social-challenge-readiness.js?v=419',
    './js/ui-helpers.js?v=419',
    './js/upload-performance.js?v=419',
    './js/video-thumbnail-quality.js?v=419',
    './js/browser-detect.js?v=419',
    './js/webview-detect.js?v=419',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
