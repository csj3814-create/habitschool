...
const CACHE_NAME = 'habitschool-v171';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=171',
    './styles-base.css?v=171',
    './styles-features.css?v=171',
    './styles-dashboard.css?v=171',
    './styles-dark-mode.css?v=171',
    './styles-reports.css?v=171',
    './js/main.js?v=171',
    './js/app.js?v=171',
    './js/app-core.js?v=171',
    './js/auth.js?v=171',
    './js/app-mode.js?v=171',
    './js/auth-login-helpers.js?v=171',
    './js/blockchain-config.js?v=171',
    './js/blockchain-manager.js?v=171',
    './js/data-manager.js?v=171',
    './js/diet-program.js?v=171',
    './js/diet-analysis.js?v=171',
    './js/exercise-media.js?v=171',
    './js/firebase-config.js?v=171',
    './js/health-connect-utils.js?v=171',
    './js/metabolic-score.js?v=171',
    './js/milestone-helpers.js?v=171',
    './js/pwa-install.js?v=171',
    './js/security.js?v=171',
    './js/ui-helpers.js?v=171',
    './js/upload-performance.js?v=171',
    './js/webview-detect.js?v=171',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
