...
const CACHE_NAME = 'habitschool-v435';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=435',
    './styles-base.css?v=435',
    './styles-en.css?v=435',
    './styles-features.css?v=435',
    './styles-reward-market.css?v=435',
    './styles-dashboard.css?v=435',
    './styles-dark-mode.css?v=435',
    './styles-reports.css?v=435',
    './styles-guest-demo.css?v=435',
    './js/main.js?v=435',
    './js/app.js?v=435',
    './js/app-core.js?v=435',
    './js/auth.js?v=435',
    './js/i18n.js?v=435',
    './js/app-mode.js?v=435',
    './js/auth-login-helpers.js?v=435',
    './js/blockchain-config.js?v=435',
    './js/blockchain-manager.js?v=435',
    './js/challenge-claim.js?v=435',
    './js/video-compress.js?v=435',
    './js/bug-report.js?v=435',
    './js/data-manager.js?v=435',
    './js/diet-program.js?v=435',
    './js/diet-analysis.js?v=435',
    './js/exercise-media.js?v=435',
    './js/firebase-config.js?v=435',
    './js/friendship-utils.js?v=435',
    './js/habit-groups.js?v=435',
    './js/health-connect-utils.js?v=435',
    './js/metabolic-score.js?v=435',
    './js/korean.js?v=435',
    './js/le8-score.js?v=435',
    './js/milestone-helpers.js?v=435',
    './js/monthly-mvp-reward.js?v=435',
    './js/meditation-guide.js?v=435',
    './js/reward-market.js?v=435',
    './js/body-composition-csv.js?v=435',
    './js/reward-pace.js?v=435',
    './js/guest-demo.js?v=435',
    './js/product-events.js?v=435',
    './js/activity-days.js?v=435',
    './js/pwa-install.js?v=435',
    './js/media-hosts.js?v=435',
    './js/security.js?v=435',
    './js/community-stats-view.js?v=435',
    './js/social-challenge-readiness.js?v=435',
    './js/ui-helpers.js?v=435',
    './js/upload-performance.js?v=435',
    './js/video-thumbnail-quality.js?v=435',
    './js/browser-detect.js?v=435',
    './js/webview-detect.js?v=435',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
