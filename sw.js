...
const CACHE_NAME = 'habitschool-v209';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=209',
    './styles-base.css?v=209',
    './styles-features.css?v=209',
    './styles-reward-market.css?v=209',
    './styles-dashboard.css?v=209',
    './styles-dark-mode.css?v=209',
    './styles-reports.css?v=209',
    './js/main.js?v=209',
    './js/app.js?v=209',
    './js/app-core.js?v=209',
    './js/auth.js?v=209',
    './js/app-mode.js?v=209',
    './js/auth-login-helpers.js?v=209',
    './js/blockchain-config.js?v=209',
    './js/blockchain-manager.js?v=209',
    './js/data-manager.js?v=209',
    './js/diet-program.js?v=209',
    './js/diet-analysis.js?v=209',
    './js/exercise-media.js?v=209',
    './js/firebase-config.js?v=209',
    './js/habit-groups.js?v=209',
    './js/health-connect-utils.js?v=209',
    './js/metabolic-score.js?v=209',
    './js/milestone-helpers.js?v=209',
    './js/monthly-mvp-reward.js?v=209',
    './js/pwa-install.js?v=209',
    './js/security.js?v=209',
    './js/social-challenge-readiness.js?v=209',
    './js/ui-helpers.js?v=209',
    './js/upload-performance.js?v=209',
    './js/webview-detect.js?v=209',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
