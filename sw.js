...
const CACHE_NAME = 'habitschool-v386';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=386',
    './styles-base.css?v=386',
    './styles-en.css?v=386',
    './styles-features.css?v=386',
    './styles-reward-market.css?v=386',
    './styles-dashboard.css?v=386',
    './styles-dark-mode.css?v=386',
    './styles-reports.css?v=386',
    './styles-guest-demo.css?v=386',
    './js/main.js?v=386',
    './js/app.js?v=386',
    './js/app-core.js?v=386',
    './js/auth.js?v=386',
    './js/i18n.js?v=386',
    './js/app-mode.js?v=386',
    './js/auth-login-helpers.js?v=386',
    './js/blockchain-config.js?v=386',
    './js/blockchain-manager.js?v=386',
    './js/challenge-claim.js?v=386',
    './js/video-compress.js?v=386',
    './js/bug-report.js?v=386',
    './js/data-manager.js?v=386',
    './js/diet-program.js?v=386',
    './js/diet-analysis.js?v=386',
    './js/exercise-media.js?v=386',
    './js/firebase-config.js?v=386',
    './js/friendship-utils.js?v=386',
    './js/habit-groups.js?v=386',
    './js/health-connect-utils.js?v=386',
    './js/metabolic-score.js?v=386',
    './js/le8-score.js?v=386',
    './js/milestone-helpers.js?v=386',
    './js/monthly-mvp-reward.js?v=386',
    './js/meditation-guide.js?v=386',
    './js/reward-market.js?v=386',
    './js/guest-demo.js?v=386',
    './js/product-events.js?v=386',
    './js/activity-days.js?v=386',
    './js/pwa-install.js?v=386',
    './js/security.js?v=386',
    './js/community-stats-view.js?v=386',
    './js/social-challenge-readiness.js?v=386',
    './js/ui-helpers.js?v=386',
    './js/upload-performance.js?v=386',
    './js/video-thumbnail-quality.js?v=386',
    './js/browser-detect.js?v=386',
    './js/webview-detect.js?v=386',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
