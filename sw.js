...
const CACHE_NAME = 'habitschool-v347';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=347',
    './styles-base.css?v=347',
    './styles-en.css?v=347',
    './styles-features.css?v=347',
    './styles-reward-market.css?v=347',
    './styles-dashboard.css?v=347',
    './styles-dark-mode.css?v=347',
    './styles-reports.css?v=347',
    './styles-guest-demo.css?v=347',
    './js/main.js?v=347',
    './js/app.js?v=347',
    './js/app-core.js?v=347',
    './js/auth.js?v=347',
    './js/i18n.js?v=347',
    './js/app-mode.js?v=347',
    './js/auth-login-helpers.js?v=347',
    './js/blockchain-config.js?v=347',
    './js/blockchain-manager.js?v=347',
    './js/challenge-claim.js?v=347',
    './js/video-compress.js?v=347',
    './js/bug-report.js?v=347',
    './js/data-manager.js?v=347',
    './js/diet-program.js?v=347',
    './js/diet-analysis.js?v=347',
    './js/exercise-media.js?v=347',
    './js/firebase-config.js?v=347',
    './js/friendship-utils.js?v=347',
    './js/habit-groups.js?v=347',
    './js/health-connect-utils.js?v=347',
    './js/metabolic-score.js?v=347',
    './js/le8-score.js?v=347',
    './js/milestone-helpers.js?v=347',
    './js/monthly-mvp-reward.js?v=347',
    './js/meditation-guide.js?v=347',
    './js/reward-market.js?v=347',
    './js/guest-demo.js?v=347',
    './js/product-events.js?v=347',
    './js/activity-days.js?v=347',
    './js/pwa-install.js?v=347',
    './js/security.js?v=347',
    './js/social-challenge-readiness.js?v=347',
    './js/ui-helpers.js?v=347',
    './js/upload-performance.js?v=347',
    './js/video-thumbnail-quality.js?v=347',
    './js/webview-detect.js?v=347',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
