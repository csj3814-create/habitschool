...
const CACHE_NAME = 'habitschool-v341';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=341',
    './styles-base.css?v=341',
    './styles-en.css?v=341',
    './styles-features.css?v=341',
    './styles-reward-market.css?v=341',
    './styles-dashboard.css?v=341',
    './styles-dark-mode.css?v=341',
    './styles-reports.css?v=341',
    './styles-guest-demo.css?v=341',
    './js/main.js?v=341',
    './js/app.js?v=341',
    './js/app-core.js?v=341',
    './js/auth.js?v=341',
    './js/i18n.js?v=341',
    './js/app-mode.js?v=341',
    './js/auth-login-helpers.js?v=341',
    './js/blockchain-config.js?v=341',
    './js/blockchain-manager.js?v=341',
    './js/challenge-claim.js?v=341',
    './js/video-compress.js?v=341',
    './js/data-manager.js?v=341',
    './js/diet-program.js?v=341',
    './js/diet-analysis.js?v=341',
    './js/exercise-media.js?v=341',
    './js/firebase-config.js?v=341',
    './js/friendship-utils.js?v=341',
    './js/habit-groups.js?v=341',
    './js/health-connect-utils.js?v=341',
    './js/metabolic-score.js?v=341',
    './js/le8-score.js?v=341',
    './js/milestone-helpers.js?v=341',
    './js/monthly-mvp-reward.js?v=341',
    './js/meditation-guide.js?v=341',
    './js/reward-market.js?v=341',
    './js/guest-demo.js?v=341',
    './js/product-events.js?v=341',
    './js/activity-days.js?v=341',
    './js/pwa-install.js?v=341',
    './js/security.js?v=341',
    './js/social-challenge-readiness.js?v=341',
    './js/ui-helpers.js?v=341',
    './js/upload-performance.js?v=341',
    './js/video-thumbnail-quality.js?v=341',
    './js/webview-detect.js?v=341',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
