...
const CACHE_NAME = 'habitschool-v275';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=275',
    './styles-base.css?v=275',
    './styles-en.css?v=275',
    './styles-features.css?v=275',
    './styles-reward-market.css?v=275',
    './styles-dashboard.css?v=275',
    './styles-dark-mode.css?v=275',
    './styles-reports.css?v=275',
    './styles-guest-demo.css?v=275',
    './js/main.js?v=275',
    './js/app.js?v=275',
    './js/app-core.js?v=275',
    './js/auth.js?v=275',
    './js/i18n.js?v=275',
    './js/app-mode.js?v=275',
    './js/auth-login-helpers.js?v=275',
    './js/blockchain-config.js?v=275',
    './js/blockchain-manager.js?v=275',
    './js/data-manager.js?v=275',
    './js/diet-program.js?v=275',
    './js/diet-analysis.js?v=275',
    './js/exercise-media.js?v=275',
    './js/firebase-config.js?v=275',
    './js/friendship-utils.js?v=275',
    './js/habit-groups.js?v=275',
    './js/health-connect-utils.js?v=275',
    './js/metabolic-score.js?v=275',
    './js/milestone-helpers.js?v=275',
    './js/monthly-mvp-reward.js?v=275',
    './js/meditation-guide.js?v=275',
    './js/reward-market.js?v=275',
    './js/guest-demo.js?v=275',
    './js/product-events.js?v=275',
    './js/activity-days.js?v=275',
    './js/pwa-install.js?v=275',
    './js/security.js?v=275',
    './js/social-challenge-readiness.js?v=275',
    './js/ui-helpers.js?v=275',
    './js/upload-performance.js?v=275',
    './js/video-thumbnail-quality.js?v=275',
    './js/webview-detect.js?v=275',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
