...
const CACHE_NAME = 'habitschool-v339';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=339',
    './styles-base.css?v=339',
    './styles-en.css?v=339',
    './styles-features.css?v=339',
    './styles-reward-market.css?v=339',
    './styles-dashboard.css?v=339',
    './styles-dark-mode.css?v=339',
    './styles-reports.css?v=339',
    './styles-guest-demo.css?v=339',
    './js/main.js?v=339',
    './js/app.js?v=339',
    './js/app-core.js?v=339',
    './js/auth.js?v=339',
    './js/i18n.js?v=339',
    './js/app-mode.js?v=339',
    './js/auth-login-helpers.js?v=339',
    './js/blockchain-config.js?v=339',
    './js/blockchain-manager.js?v=339',
    './js/challenge-claim.js?v=339',
    './js/video-compress.js?v=339',
    './js/data-manager.js?v=339',
    './js/diet-program.js?v=339',
    './js/diet-analysis.js?v=339',
    './js/exercise-media.js?v=339',
    './js/firebase-config.js?v=339',
    './js/friendship-utils.js?v=339',
    './js/habit-groups.js?v=339',
    './js/health-connect-utils.js?v=339',
    './js/metabolic-score.js?v=339',
    './js/le8-score.js?v=339',
    './js/milestone-helpers.js?v=339',
    './js/monthly-mvp-reward.js?v=339',
    './js/meditation-guide.js?v=339',
    './js/reward-market.js?v=339',
    './js/guest-demo.js?v=339',
    './js/product-events.js?v=339',
    './js/activity-days.js?v=339',
    './js/pwa-install.js?v=339',
    './js/security.js?v=339',
    './js/social-challenge-readiness.js?v=339',
    './js/ui-helpers.js?v=339',
    './js/upload-performance.js?v=339',
    './js/video-thumbnail-quality.js?v=339',
    './js/webview-detect.js?v=339',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
