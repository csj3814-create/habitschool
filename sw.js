...
const CACHE_NAME = 'habitschool-v268';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=268',
    './styles-base.css?v=268',
    './styles-en.css?v=268',
    './styles-features.css?v=268',
    './styles-reward-market.css?v=268',
    './styles-dashboard.css?v=268',
    './styles-dark-mode.css?v=268',
    './styles-reports.css?v=268',
    './styles-guest-demo.css?v=268',
    './js/main.js?v=268',
    './js/app.js?v=268',
    './js/app-core.js?v=268',
    './js/auth.js?v=268',
    './js/i18n.js?v=268',
    './js/app-mode.js?v=268',
    './js/auth-login-helpers.js?v=268',
    './js/blockchain-config.js?v=268',
    './js/blockchain-manager.js?v=268',
    './js/data-manager.js?v=268',
    './js/diet-program.js?v=268',
    './js/diet-analysis.js?v=268',
    './js/exercise-media.js?v=268',
    './js/firebase-config.js?v=268',
    './js/friendship-utils.js?v=268',
    './js/habit-groups.js?v=268',
    './js/health-connect-utils.js?v=268',
    './js/metabolic-score.js?v=268',
    './js/milestone-helpers.js?v=268',
    './js/monthly-mvp-reward.js?v=268',
    './js/meditation-guide.js?v=268',
    './js/reward-market.js?v=268',
    './js/guest-demo.js?v=268',
    './js/product-events.js?v=268',
    './js/activity-days.js?v=268',
    './js/pwa-install.js?v=268',
    './js/security.js?v=268',
    './js/social-challenge-readiness.js?v=268',
    './js/ui-helpers.js?v=268',
    './js/upload-performance.js?v=268',
    './js/video-thumbnail-quality.js?v=268',
    './js/webview-detect.js?v=268',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
