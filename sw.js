...
const CACHE_NAME = 'habitschool-v301';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=301',
    './styles-base.css?v=301',
    './styles-en.css?v=301',
    './styles-features.css?v=301',
    './styles-reward-market.css?v=301',
    './styles-dashboard.css?v=301',
    './styles-dark-mode.css?v=301',
    './styles-reports.css?v=301',
    './styles-guest-demo.css?v=301',
    './js/main.js?v=301',
    './js/app.js?v=301',
    './js/app-core.js?v=301',
    './js/auth.js?v=301',
    './js/i18n.js?v=301',
    './js/app-mode.js?v=301',
    './js/auth-login-helpers.js?v=301',
    './js/blockchain-config.js?v=301',
    './js/blockchain-manager.js?v=301',
    './js/data-manager.js?v=301',
    './js/diet-program.js?v=301',
    './js/diet-analysis.js?v=301',
    './js/exercise-media.js?v=301',
    './js/firebase-config.js?v=301',
    './js/friendship-utils.js?v=301',
    './js/habit-groups.js?v=301',
    './js/health-connect-utils.js?v=301',
    './js/metabolic-score.js?v=301',
    './js/milestone-helpers.js?v=301',
    './js/monthly-mvp-reward.js?v=301',
    './js/meditation-guide.js?v=301',
    './js/reward-market.js?v=301',
    './js/guest-demo.js?v=301',
    './js/product-events.js?v=301',
    './js/activity-days.js?v=301',
    './js/pwa-install.js?v=301',
    './js/security.js?v=301',
    './js/social-challenge-readiness.js?v=301',
    './js/ui-helpers.js?v=301',
    './js/upload-performance.js?v=301',
    './js/video-thumbnail-quality.js?v=301',
    './js/webview-detect.js?v=301',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
