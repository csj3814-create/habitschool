...
const CACHE_NAME = 'habitschool-v367';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=367',
    './styles-base.css?v=367',
    './styles-en.css?v=367',
    './styles-features.css?v=367',
    './styles-reward-market.css?v=367',
    './styles-dashboard.css?v=367',
    './styles-dark-mode.css?v=367',
    './styles-reports.css?v=367',
    './styles-guest-demo.css?v=367',
    './js/main.js?v=367',
    './js/app.js?v=367',
    './js/app-core.js?v=367',
    './js/auth.js?v=367',
    './js/i18n.js?v=367',
    './js/app-mode.js?v=367',
    './js/auth-login-helpers.js?v=367',
    './js/blockchain-config.js?v=367',
    './js/blockchain-manager.js?v=367',
    './js/challenge-claim.js?v=367',
    './js/video-compress.js?v=367',
    './js/bug-report.js?v=367',
    './js/data-manager.js?v=367',
    './js/diet-program.js?v=367',
    './js/diet-analysis.js?v=367',
    './js/exercise-media.js?v=367',
    './js/firebase-config.js?v=367',
    './js/friendship-utils.js?v=367',
    './js/habit-groups.js?v=367',
    './js/health-connect-utils.js?v=367',
    './js/metabolic-score.js?v=367',
    './js/le8-score.js?v=367',
    './js/milestone-helpers.js?v=367',
    './js/monthly-mvp-reward.js?v=367',
    './js/meditation-guide.js?v=367',
    './js/reward-market.js?v=367',
    './js/guest-demo.js?v=367',
    './js/product-events.js?v=367',
    './js/activity-days.js?v=367',
    './js/pwa-install.js?v=367',
    './js/security.js?v=367',
    './js/community-stats-view.js?v=367',
    './js/social-challenge-readiness.js?v=367',
    './js/ui-helpers.js?v=367',
    './js/upload-performance.js?v=367',
    './js/video-thumbnail-quality.js?v=367',
    './js/webview-detect.js?v=367',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
