...
const CACHE_NAME = 'habitschool-v416';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=416',
    './styles-base.css?v=416',
    './styles-en.css?v=416',
    './styles-features.css?v=416',
    './styles-reward-market.css?v=416',
    './styles-dashboard.css?v=416',
    './styles-dark-mode.css?v=416',
    './styles-reports.css?v=416',
    './styles-guest-demo.css?v=416',
    './js/main.js?v=416',
    './js/app.js?v=416',
    './js/app-core.js?v=416',
    './js/auth.js?v=416',
    './js/i18n.js?v=416',
    './js/app-mode.js?v=416',
    './js/auth-login-helpers.js?v=416',
    './js/blockchain-config.js?v=416',
    './js/blockchain-manager.js?v=416',
    './js/challenge-claim.js?v=416',
    './js/video-compress.js?v=416',
    './js/bug-report.js?v=416',
    './js/data-manager.js?v=416',
    './js/diet-program.js?v=416',
    './js/diet-analysis.js?v=416',
    './js/exercise-media.js?v=416',
    './js/firebase-config.js?v=416',
    './js/friendship-utils.js?v=416',
    './js/habit-groups.js?v=416',
    './js/health-connect-utils.js?v=416',
    './js/metabolic-score.js?v=416',
    './js/le8-score.js?v=416',
    './js/milestone-helpers.js?v=416',
    './js/monthly-mvp-reward.js?v=416',
    './js/meditation-guide.js?v=416',
    './js/reward-market.js?v=416',
    './js/guest-demo.js?v=416',
    './js/product-events.js?v=416',
    './js/activity-days.js?v=416',
    './js/pwa-install.js?v=416',
    './js/security.js?v=416',
    './js/community-stats-view.js?v=416',
    './js/social-challenge-readiness.js?v=416',
    './js/ui-helpers.js?v=416',
    './js/upload-performance.js?v=416',
    './js/video-thumbnail-quality.js?v=416',
    './js/browser-detect.js?v=416',
    './js/webview-detect.js?v=416',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
