...
const CACHE_NAME = 'habitschool-v281';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=281',
    './styles-base.css?v=281',
    './styles-en.css?v=281',
    './styles-features.css?v=281',
    './styles-reward-market.css?v=281',
    './styles-dashboard.css?v=281',
    './styles-dark-mode.css?v=281',
    './styles-reports.css?v=281',
    './styles-guest-demo.css?v=281',
    './js/main.js?v=281',
    './js/app.js?v=281',
    './js/app-core.js?v=281',
    './js/auth.js?v=281',
    './js/i18n.js?v=281',
    './js/app-mode.js?v=281',
    './js/auth-login-helpers.js?v=281',
    './js/blockchain-config.js?v=281',
    './js/blockchain-manager.js?v=281',
    './js/data-manager.js?v=281',
    './js/diet-program.js?v=281',
    './js/diet-analysis.js?v=281',
    './js/exercise-media.js?v=281',
    './js/firebase-config.js?v=281',
    './js/friendship-utils.js?v=281',
    './js/habit-groups.js?v=281',
    './js/health-connect-utils.js?v=281',
    './js/metabolic-score.js?v=281',
    './js/milestone-helpers.js?v=281',
    './js/monthly-mvp-reward.js?v=281',
    './js/meditation-guide.js?v=281',
    './js/reward-market.js?v=281',
    './js/guest-demo.js?v=281',
    './js/product-events.js?v=281',
    './js/activity-days.js?v=281',
    './js/pwa-install.js?v=281',
    './js/security.js?v=281',
    './js/social-challenge-readiness.js?v=281',
    './js/ui-helpers.js?v=281',
    './js/upload-performance.js?v=281',
    './js/video-thumbnail-quality.js?v=281',
    './js/webview-detect.js?v=281',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
