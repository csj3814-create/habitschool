...
const CACHE_NAME = 'habitschool-v255';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=255',
    './styles-base.css?v=255',
    './styles-en.css?v=255',
    './styles-features.css?v=255',
    './styles-reward-market.css?v=255',
    './styles-dashboard.css?v=255',
    './styles-dark-mode.css?v=255',
    './styles-reports.css?v=255',
    './styles-guest-demo.css?v=255',
    './js/main.js?v=255',
    './js/app.js?v=255',
    './js/app-core.js?v=255',
    './js/auth.js?v=255',
    './js/i18n.js?v=255',
    './js/app-mode.js?v=255',
    './js/auth-login-helpers.js?v=255',
    './js/blockchain-config.js?v=255',
    './js/blockchain-manager.js?v=255',
    './js/data-manager.js?v=255',
    './js/diet-program.js?v=255',
    './js/diet-analysis.js?v=255',
    './js/exercise-media.js?v=255',
    './js/firebase-config.js?v=255',
    './js/friendship-utils.js?v=255',
    './js/habit-groups.js?v=255',
    './js/health-connect-utils.js?v=255',
    './js/metabolic-score.js?v=255',
    './js/milestone-helpers.js?v=255',
    './js/monthly-mvp-reward.js?v=255',
    './js/meditation-guide.js?v=255',
    './js/reward-market.js?v=255',
    './js/guest-demo.js?v=255',
    './js/product-events.js?v=255',
    './js/activity-days.js?v=255',
    './js/pwa-install.js?v=255',
    './js/security.js?v=255',
    './js/social-challenge-readiness.js?v=255',
    './js/ui-helpers.js?v=255',
    './js/upload-performance.js?v=255',
    './js/video-thumbnail-quality.js?v=255',
    './js/webview-detect.js?v=255',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
