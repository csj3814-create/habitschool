...
const CACHE_NAME = 'habitschool-v328';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=328',
    './styles-base.css?v=328',
    './styles-en.css?v=328',
    './styles-features.css?v=328',
    './styles-reward-market.css?v=328',
    './styles-dashboard.css?v=328',
    './styles-dark-mode.css?v=328',
    './styles-reports.css?v=328',
    './styles-guest-demo.css?v=328',
    './js/main.js?v=328',
    './js/app.js?v=328',
    './js/app-core.js?v=328',
    './js/auth.js?v=328',
    './js/i18n.js?v=328',
    './js/app-mode.js?v=328',
    './js/auth-login-helpers.js?v=328',
    './js/blockchain-config.js?v=328',
    './js/blockchain-manager.js?v=328',
    './js/challenge-claim.js?v=328',
    './js/video-compress.js?v=328',
    './js/data-manager.js?v=328',
    './js/diet-program.js?v=328',
    './js/diet-analysis.js?v=328',
    './js/exercise-media.js?v=328',
    './js/firebase-config.js?v=328',
    './js/friendship-utils.js?v=328',
    './js/habit-groups.js?v=328',
    './js/health-connect-utils.js?v=328',
    './js/metabolic-score.js?v=328',
    './js/milestone-helpers.js?v=328',
    './js/monthly-mvp-reward.js?v=328',
    './js/meditation-guide.js?v=328',
    './js/reward-market.js?v=328',
    './js/guest-demo.js?v=328',
    './js/product-events.js?v=328',
    './js/activity-days.js?v=328',
    './js/pwa-install.js?v=328',
    './js/security.js?v=328',
    './js/social-challenge-readiness.js?v=328',
    './js/ui-helpers.js?v=328',
    './js/upload-performance.js?v=328',
    './js/video-thumbnail-quality.js?v=328',
    './js/webview-detect.js?v=328',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
