...
const CACHE_NAME = 'habitschool-v371';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=371',
    './styles-base.css?v=371',
    './styles-en.css?v=371',
    './styles-features.css?v=371',
    './styles-reward-market.css?v=371',
    './styles-dashboard.css?v=371',
    './styles-dark-mode.css?v=371',
    './styles-reports.css?v=371',
    './styles-guest-demo.css?v=371',
    './js/main.js?v=371',
    './js/app.js?v=371',
    './js/app-core.js?v=371',
    './js/auth.js?v=371',
    './js/i18n.js?v=371',
    './js/app-mode.js?v=371',
    './js/auth-login-helpers.js?v=371',
    './js/blockchain-config.js?v=371',
    './js/blockchain-manager.js?v=371',
    './js/challenge-claim.js?v=371',
    './js/video-compress.js?v=371',
    './js/bug-report.js?v=371',
    './js/data-manager.js?v=371',
    './js/diet-program.js?v=371',
    './js/diet-analysis.js?v=371',
    './js/exercise-media.js?v=371',
    './js/firebase-config.js?v=371',
    './js/friendship-utils.js?v=371',
    './js/habit-groups.js?v=371',
    './js/health-connect-utils.js?v=371',
    './js/metabolic-score.js?v=371',
    './js/le8-score.js?v=371',
    './js/milestone-helpers.js?v=371',
    './js/monthly-mvp-reward.js?v=371',
    './js/meditation-guide.js?v=371',
    './js/reward-market.js?v=371',
    './js/guest-demo.js?v=371',
    './js/product-events.js?v=371',
    './js/activity-days.js?v=371',
    './js/pwa-install.js?v=371',
    './js/security.js?v=371',
    './js/community-stats-view.js?v=371',
    './js/social-challenge-readiness.js?v=371',
    './js/ui-helpers.js?v=371',
    './js/upload-performance.js?v=371',
    './js/video-thumbnail-quality.js?v=371',
    './js/webview-detect.js?v=371',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
