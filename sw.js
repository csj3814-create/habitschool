...
const CACHE_NAME = 'habitschool-v211';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=211',
    './styles-base.css?v=211',
    './styles-features.css?v=211',
    './styles-reward-market.css?v=211',
    './styles-dashboard.css?v=211',
    './styles-dark-mode.css?v=211',
    './styles-reports.css?v=211',
    './js/main.js?v=211',
    './js/app.js?v=211',
    './js/app-core.js?v=211',
    './js/auth.js?v=211',
    './js/app-mode.js?v=211',
    './js/auth-login-helpers.js?v=211',
    './js/blockchain-config.js?v=211',
    './js/blockchain-manager.js?v=211',
    './js/data-manager.js?v=211',
    './js/diet-program.js?v=211',
    './js/diet-analysis.js?v=211',
    './js/exercise-media.js?v=211',
    './js/firebase-config.js?v=211',
    './js/habit-groups.js?v=211',
    './js/health-connect-utils.js?v=211',
    './js/metabolic-score.js?v=211',
    './js/milestone-helpers.js?v=211',
    './js/monthly-mvp-reward.js?v=211',
    './js/pwa-install.js?v=211',
    './js/security.js?v=211',
    './js/social-challenge-readiness.js?v=211',
    './js/ui-helpers.js?v=211',
    './js/upload-performance.js?v=211',
    './js/webview-detect.js?v=211',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
