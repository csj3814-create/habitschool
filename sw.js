...
const CACHE_NAME = 'habitschool-v335';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=335',
    './styles-base.css?v=335',
    './styles-en.css?v=335',
    './styles-features.css?v=335',
    './styles-reward-market.css?v=335',
    './styles-dashboard.css?v=335',
    './styles-dark-mode.css?v=335',
    './styles-reports.css?v=335',
    './styles-guest-demo.css?v=335',
    './js/main.js?v=335',
    './js/app.js?v=335',
    './js/app-core.js?v=335',
    './js/auth.js?v=335',
    './js/i18n.js?v=335',
    './js/app-mode.js?v=335',
    './js/auth-login-helpers.js?v=335',
    './js/blockchain-config.js?v=335',
    './js/blockchain-manager.js?v=335',
    './js/challenge-claim.js?v=335',
    './js/video-compress.js?v=335',
    './js/data-manager.js?v=335',
    './js/diet-program.js?v=335',
    './js/diet-analysis.js?v=335',
    './js/exercise-media.js?v=335',
    './js/firebase-config.js?v=335',
    './js/friendship-utils.js?v=335',
    './js/habit-groups.js?v=335',
    './js/health-connect-utils.js?v=335',
    './js/metabolic-score.js?v=335',
    './js/milestone-helpers.js?v=335',
    './js/monthly-mvp-reward.js?v=335',
    './js/meditation-guide.js?v=335',
    './js/reward-market.js?v=335',
    './js/guest-demo.js?v=335',
    './js/product-events.js?v=335',
    './js/activity-days.js?v=335',
    './js/pwa-install.js?v=335',
    './js/security.js?v=335',
    './js/social-challenge-readiness.js?v=335',
    './js/ui-helpers.js?v=335',
    './js/upload-performance.js?v=335',
    './js/video-thumbnail-quality.js?v=335',
    './js/webview-detect.js?v=335',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
