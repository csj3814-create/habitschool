...
const CACHE_NAME = 'habitschool-v363';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=363',
    './styles-base.css?v=363',
    './styles-en.css?v=363',
    './styles-features.css?v=363',
    './styles-reward-market.css?v=363',
    './styles-dashboard.css?v=363',
    './styles-dark-mode.css?v=363',
    './styles-reports.css?v=363',
    './styles-guest-demo.css?v=363',
    './js/main.js?v=363',
    './js/app.js?v=363',
    './js/app-core.js?v=363',
    './js/auth.js?v=363',
    './js/i18n.js?v=363',
    './js/app-mode.js?v=363',
    './js/auth-login-helpers.js?v=363',
    './js/blockchain-config.js?v=363',
    './js/blockchain-manager.js?v=363',
    './js/challenge-claim.js?v=363',
    './js/video-compress.js?v=363',
    './js/bug-report.js?v=363',
    './js/data-manager.js?v=363',
    './js/diet-program.js?v=363',
    './js/diet-analysis.js?v=363',
    './js/exercise-media.js?v=363',
    './js/firebase-config.js?v=363',
    './js/friendship-utils.js?v=363',
    './js/habit-groups.js?v=363',
    './js/health-connect-utils.js?v=363',
    './js/metabolic-score.js?v=363',
    './js/le8-score.js?v=363',
    './js/milestone-helpers.js?v=363',
    './js/monthly-mvp-reward.js?v=363',
    './js/meditation-guide.js?v=363',
    './js/reward-market.js?v=363',
    './js/guest-demo.js?v=363',
    './js/product-events.js?v=363',
    './js/activity-days.js?v=363',
    './js/pwa-install.js?v=363',
    './js/security.js?v=363',
    './js/community-stats-view.js?v=363',
    './js/social-challenge-readiness.js?v=363',
    './js/ui-helpers.js?v=363',
    './js/upload-performance.js?v=363',
    './js/video-thumbnail-quality.js?v=363',
    './js/webview-detect.js?v=363',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
