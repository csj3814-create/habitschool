...
const CACHE_NAME = 'habitschool-v310';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=310',
    './styles-base.css?v=310',
    './styles-en.css?v=310',
    './styles-features.css?v=310',
    './styles-reward-market.css?v=310',
    './styles-dashboard.css?v=310',
    './styles-dark-mode.css?v=310',
    './styles-reports.css?v=310',
    './styles-guest-demo.css?v=310',
    './js/main.js?v=310',
    './js/app.js?v=310',
    './js/app-core.js?v=310',
    './js/auth.js?v=310',
    './js/i18n.js?v=310',
    './js/app-mode.js?v=310',
    './js/auth-login-helpers.js?v=310',
    './js/blockchain-config.js?v=310',
    './js/blockchain-manager.js?v=310',
    './js/challenge-claim.js?v=310',
    './js/data-manager.js?v=310',
    './js/diet-program.js?v=310',
    './js/diet-analysis.js?v=310',
    './js/exercise-media.js?v=310',
    './js/firebase-config.js?v=310',
    './js/friendship-utils.js?v=310',
    './js/habit-groups.js?v=310',
    './js/health-connect-utils.js?v=310',
    './js/metabolic-score.js?v=310',
    './js/milestone-helpers.js?v=310',
    './js/monthly-mvp-reward.js?v=310',
    './js/meditation-guide.js?v=310',
    './js/reward-market.js?v=310',
    './js/guest-demo.js?v=310',
    './js/product-events.js?v=310',
    './js/activity-days.js?v=310',
    './js/pwa-install.js?v=310',
    './js/security.js?v=310',
    './js/social-challenge-readiness.js?v=310',
    './js/ui-helpers.js?v=310',
    './js/upload-performance.js?v=310',
    './js/video-thumbnail-quality.js?v=310',
    './js/webview-detect.js?v=310',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
