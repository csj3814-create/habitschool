...
const CACHE_NAME = 'habitschool-v436';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=436',
    './styles-base.css?v=436',
    './styles-en.css?v=436',
    './styles-features.css?v=436',
    './styles-reward-market.css?v=436',
    './styles-dashboard.css?v=436',
    './styles-dark-mode.css?v=436',
    './styles-reports.css?v=436',
    './styles-guest-demo.css?v=436',
    './js/main.js?v=436',
    './js/app.js?v=436',
    './js/app-core.js?v=436',
    './js/auth.js?v=436',
    './js/i18n.js?v=436',
    './js/app-mode.js?v=436',
    './js/auth-login-helpers.js?v=436',
    './js/blockchain-config.js?v=436',
    './js/blockchain-manager.js?v=436',
    './js/challenge-claim.js?v=436',
    './js/video-compress.js?v=436',
    './js/bug-report.js?v=436',
    './js/data-manager.js?v=436',
    './js/diet-program.js?v=436',
    './js/diet-analysis.js?v=436',
    './js/exercise-media.js?v=436',
    './js/firebase-config.js?v=436',
    './js/friendship-utils.js?v=436',
    './js/habit-groups.js?v=436',
    './js/health-connect-utils.js?v=436',
    './js/metabolic-score.js?v=436',
    './js/korean.js?v=436',
    './js/le8-score.js?v=436',
    './js/milestone-helpers.js?v=436',
    './js/monthly-mvp-reward.js?v=436',
    './js/meditation-guide.js?v=436',
    './js/reward-market.js?v=436',
    './js/body-composition-csv.js?v=436',
    './js/mission-gate.js?v=436',
    './js/reward-pace.js?v=436',
    './js/guest-demo.js?v=436',
    './js/product-events.js?v=436',
    './js/activity-days.js?v=436',
    './js/pwa-install.js?v=436',
    './js/media-hosts.js?v=436',
    './js/security.js?v=436',
    './js/community-stats-view.js?v=436',
    './js/social-challenge-readiness.js?v=436',
    './js/ui-helpers.js?v=436',
    './js/upload-performance.js?v=436',
    './js/video-thumbnail-quality.js?v=436',
    './js/browser-detect.js?v=436',
    './js/webview-detect.js?v=436',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
