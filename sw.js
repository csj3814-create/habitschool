...
const CACHE_NAME = 'habitschool-v445';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=445',
    './styles-base.css?v=445',
    './styles-en.css?v=445',
    './styles-features.css?v=445',
    './styles-reward-market.css?v=445',
    './styles-dashboard.css?v=445',
    './styles-dark-mode.css?v=445',
    './styles-reports.css?v=445',
    './styles-guest-demo.css?v=445',
    './js/main.js?v=445',
    './js/app.js?v=445',
    './js/app-core.js?v=445',
    './js/auth.js?v=445',
    './js/i18n.js?v=445',
    './js/app-mode.js?v=445',
    './js/auth-login-helpers.js?v=445',
    './js/blockchain-config.js?v=445',
    './js/blockchain-manager.js?v=445',
    './js/challenge-claim.js?v=445',
    './js/video-compress.js?v=445',
    './js/bug-report.js?v=445',
    './js/data-manager.js?v=445',
    './js/diet-program.js?v=445',
    './js/diet-analysis.js?v=445',
    './js/exercise-media.js?v=445',
    './js/firebase-config.js?v=445',
    './js/friendship-utils.js?v=445',
    './js/habit-groups.js?v=445',
    './js/health-connect-utils.js?v=445',
    './js/metabolic-score.js?v=445',
    './js/korean.js?v=445',
    './js/le8-score.js?v=445',
    './js/milestone-helpers.js?v=445',
    './js/monthly-mvp-reward.js?v=445',
    './js/meditation-guide.js?v=445',
    './js/reward-market.js?v=445',
    './js/body-composition-csv.js?v=445',
    './js/mission-gate.js?v=445',
    './js/health-connect-body.js?v=445',
    './js/reward-pace.js?v=445',
    './js/guest-demo.js?v=445',
    './js/product-events.js?v=445',
    './js/activity-days.js?v=445',
    './js/pwa-install.js?v=445',
    './js/media-hosts.js?v=445',
    './js/security.js?v=445',
    './js/community-stats-view.js?v=445',
    './js/social-challenge-readiness.js?v=445',
    './js/ui-helpers.js?v=445',
    './js/upload-performance.js?v=445',
    './js/video-thumbnail-quality.js?v=445',
    './js/browser-detect.js?v=445',
    './js/webview-detect.js?v=445',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
