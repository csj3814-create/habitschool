...
const CACHE_NAME = 'habitschool-v191';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=191',
    './styles-base.css?v=191',
    './styles-features.css?v=191',
    './styles-reward-market.css?v=191',
    './styles-dashboard.css?v=191',
    './styles-dark-mode.css?v=191',
    './styles-reports.css?v=191',
    './js/main.js?v=191',
    './js/app.js?v=191',
    './js/app-core.js?v=191',
    './js/auth.js?v=191',
    './js/app-mode.js?v=191',
    './js/auth-login-helpers.js?v=191',
    './js/blockchain-config.js?v=191',
    './js/blockchain-manager.js?v=191',
    './js/data-manager.js?v=191',
    './js/diet-program.js?v=191',
    './js/diet-analysis.js?v=191',
    './js/exercise-media.js?v=191',
    './js/firebase-config.js?v=191',
    './js/health-connect-utils.js?v=191',
    './js/metabolic-score.js?v=191',
    './js/milestone-helpers.js?v=191',
    './js/monthly-mvp-reward.js?v=191',
    './js/pwa-install.js?v=191',
    './js/security.js?v=191',
    './js/social-challenge-readiness.js?v=191',
    './js/ui-helpers.js?v=191',
    './js/upload-performance.js?v=191',
    './js/webview-detect.js?v=191',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
