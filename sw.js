...
const CACHE_NAME = 'habitschool-v336';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=336',
    './styles-base.css?v=336',
    './styles-en.css?v=336',
    './styles-features.css?v=336',
    './styles-reward-market.css?v=336',
    './styles-dashboard.css?v=336',
    './styles-dark-mode.css?v=336',
    './styles-reports.css?v=336',
    './styles-guest-demo.css?v=336',
    './js/main.js?v=336',
    './js/app.js?v=336',
    './js/app-core.js?v=336',
    './js/auth.js?v=336',
    './js/i18n.js?v=336',
    './js/app-mode.js?v=336',
    './js/auth-login-helpers.js?v=336',
    './js/blockchain-config.js?v=336',
    './js/blockchain-manager.js?v=336',
    './js/challenge-claim.js?v=336',
    './js/video-compress.js?v=336',
    './js/data-manager.js?v=336',
    './js/diet-program.js?v=336',
    './js/diet-analysis.js?v=336',
    './js/exercise-media.js?v=336',
    './js/firebase-config.js?v=336',
    './js/friendship-utils.js?v=336',
    './js/habit-groups.js?v=336',
    './js/health-connect-utils.js?v=336',
    './js/metabolic-score.js?v=336',
    './js/milestone-helpers.js?v=336',
    './js/monthly-mvp-reward.js?v=336',
    './js/meditation-guide.js?v=336',
    './js/reward-market.js?v=336',
    './js/guest-demo.js?v=336',
    './js/product-events.js?v=336',
    './js/activity-days.js?v=336',
    './js/pwa-install.js?v=336',
    './js/security.js?v=336',
    './js/social-challenge-readiness.js?v=336',
    './js/ui-helpers.js?v=336',
    './js/upload-performance.js?v=336',
    './js/video-thumbnail-quality.js?v=336',
    './js/webview-detect.js?v=336',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
