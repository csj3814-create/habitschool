...
const CACHE_NAME = 'habitschool-v372';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=372',
    './styles-base.css?v=372',
    './styles-en.css?v=372',
    './styles-features.css?v=372',
    './styles-reward-market.css?v=372',
    './styles-dashboard.css?v=372',
    './styles-dark-mode.css?v=372',
    './styles-reports.css?v=372',
    './styles-guest-demo.css?v=372',
    './js/main.js?v=372',
    './js/app.js?v=372',
    './js/app-core.js?v=372',
    './js/auth.js?v=372',
    './js/i18n.js?v=372',
    './js/app-mode.js?v=372',
    './js/auth-login-helpers.js?v=372',
    './js/blockchain-config.js?v=372',
    './js/blockchain-manager.js?v=372',
    './js/challenge-claim.js?v=372',
    './js/video-compress.js?v=372',
    './js/bug-report.js?v=372',
    './js/data-manager.js?v=372',
    './js/diet-program.js?v=372',
    './js/diet-analysis.js?v=372',
    './js/exercise-media.js?v=372',
    './js/firebase-config.js?v=372',
    './js/friendship-utils.js?v=372',
    './js/habit-groups.js?v=372',
    './js/health-connect-utils.js?v=372',
    './js/metabolic-score.js?v=372',
    './js/le8-score.js?v=372',
    './js/milestone-helpers.js?v=372',
    './js/monthly-mvp-reward.js?v=372',
    './js/meditation-guide.js?v=372',
    './js/reward-market.js?v=372',
    './js/guest-demo.js?v=372',
    './js/product-events.js?v=372',
    './js/activity-days.js?v=372',
    './js/pwa-install.js?v=372',
    './js/security.js?v=372',
    './js/community-stats-view.js?v=372',
    './js/social-challenge-readiness.js?v=372',
    './js/ui-helpers.js?v=372',
    './js/upload-performance.js?v=372',
    './js/video-thumbnail-quality.js?v=372',
    './js/webview-detect.js?v=372',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
