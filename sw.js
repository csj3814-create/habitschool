...
const CACHE_NAME = 'habitschool-v383';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=383',
    './styles-base.css?v=383',
    './styles-en.css?v=383',
    './styles-features.css?v=383',
    './styles-reward-market.css?v=383',
    './styles-dashboard.css?v=383',
    './styles-dark-mode.css?v=383',
    './styles-reports.css?v=383',
    './styles-guest-demo.css?v=383',
    './js/main.js?v=383',
    './js/app.js?v=383',
    './js/app-core.js?v=383',
    './js/auth.js?v=383',
    './js/i18n.js?v=383',
    './js/app-mode.js?v=383',
    './js/auth-login-helpers.js?v=383',
    './js/blockchain-config.js?v=383',
    './js/blockchain-manager.js?v=383',
    './js/challenge-claim.js?v=383',
    './js/video-compress.js?v=383',
    './js/bug-report.js?v=383',
    './js/data-manager.js?v=383',
    './js/diet-program.js?v=383',
    './js/diet-analysis.js?v=383',
    './js/exercise-media.js?v=383',
    './js/firebase-config.js?v=383',
    './js/friendship-utils.js?v=383',
    './js/habit-groups.js?v=383',
    './js/health-connect-utils.js?v=383',
    './js/metabolic-score.js?v=383',
    './js/le8-score.js?v=383',
    './js/milestone-helpers.js?v=383',
    './js/monthly-mvp-reward.js?v=383',
    './js/meditation-guide.js?v=383',
    './js/reward-market.js?v=383',
    './js/guest-demo.js?v=383',
    './js/product-events.js?v=383',
    './js/activity-days.js?v=383',
    './js/pwa-install.js?v=383',
    './js/security.js?v=383',
    './js/community-stats-view.js?v=383',
    './js/social-challenge-readiness.js?v=383',
    './js/ui-helpers.js?v=383',
    './js/upload-performance.js?v=383',
    './js/video-thumbnail-quality.js?v=383',
    './js/browser-detect.js?v=383',
    './js/webview-detect.js?v=383',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
