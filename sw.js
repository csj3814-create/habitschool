...
const CACHE_NAME = 'habitschool-v194';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=194',
    './styles-base.css?v=194',
    './styles-features.css?v=194',
    './styles-reward-market.css?v=194',
    './styles-dashboard.css?v=194',
    './styles-dark-mode.css?v=194',
    './styles-reports.css?v=194',
    './js/main.js?v=194',
    './js/app.js?v=194',
    './js/app-core.js?v=194',
    './js/auth.js?v=194',
    './js/app-mode.js?v=194',
    './js/auth-login-helpers.js?v=194',
    './js/blockchain-config.js?v=194',
    './js/blockchain-manager.js?v=194',
    './js/data-manager.js?v=194',
    './js/diet-program.js?v=194',
    './js/diet-analysis.js?v=194',
    './js/exercise-media.js?v=194',
    './js/firebase-config.js?v=194',
    './js/health-connect-utils.js?v=194',
    './js/metabolic-score.js?v=194',
    './js/milestone-helpers.js?v=194',
    './js/monthly-mvp-reward.js?v=194',
    './js/pwa-install.js?v=194',
    './js/security.js?v=194',
    './js/social-challenge-readiness.js?v=194',
    './js/ui-helpers.js?v=194',
    './js/upload-performance.js?v=194',
    './js/webview-detect.js?v=194',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
