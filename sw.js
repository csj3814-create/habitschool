...
const CACHE_NAME = 'habitschool-v193';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=193',
    './styles-base.css?v=193',
    './styles-features.css?v=193',
    './styles-reward-market.css?v=193',
    './styles-dashboard.css?v=193',
    './styles-dark-mode.css?v=193',
    './styles-reports.css?v=193',
    './js/main.js?v=193',
    './js/app.js?v=193',
    './js/app-core.js?v=193',
    './js/auth.js?v=193',
    './js/app-mode.js?v=193',
    './js/auth-login-helpers.js?v=193',
    './js/blockchain-config.js?v=193',
    './js/blockchain-manager.js?v=193',
    './js/data-manager.js?v=193',
    './js/diet-program.js?v=193',
    './js/diet-analysis.js?v=193',
    './js/exercise-media.js?v=193',
    './js/firebase-config.js?v=193',
    './js/health-connect-utils.js?v=193',
    './js/metabolic-score.js?v=193',
    './js/milestone-helpers.js?v=193',
    './js/monthly-mvp-reward.js?v=193',
    './js/pwa-install.js?v=193',
    './js/security.js?v=193',
    './js/social-challenge-readiness.js?v=193',
    './js/ui-helpers.js?v=193',
    './js/upload-performance.js?v=193',
    './js/webview-detect.js?v=193',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
