...
const CACHE_NAME = 'habitschool-v370';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=370',
    './styles-base.css?v=370',
    './styles-en.css?v=370',
    './styles-features.css?v=370',
    './styles-reward-market.css?v=370',
    './styles-dashboard.css?v=370',
    './styles-dark-mode.css?v=370',
    './styles-reports.css?v=370',
    './styles-guest-demo.css?v=370',
    './js/main.js?v=370',
    './js/app.js?v=370',
    './js/app-core.js?v=370',
    './js/auth.js?v=370',
    './js/i18n.js?v=370',
    './js/app-mode.js?v=370',
    './js/auth-login-helpers.js?v=370',
    './js/blockchain-config.js?v=370',
    './js/blockchain-manager.js?v=370',
    './js/challenge-claim.js?v=370',
    './js/video-compress.js?v=370',
    './js/bug-report.js?v=370',
    './js/data-manager.js?v=370',
    './js/diet-program.js?v=370',
    './js/diet-analysis.js?v=370',
    './js/exercise-media.js?v=370',
    './js/firebase-config.js?v=370',
    './js/friendship-utils.js?v=370',
    './js/habit-groups.js?v=370',
    './js/health-connect-utils.js?v=370',
    './js/metabolic-score.js?v=370',
    './js/le8-score.js?v=370',
    './js/milestone-helpers.js?v=370',
    './js/monthly-mvp-reward.js?v=370',
    './js/meditation-guide.js?v=370',
    './js/reward-market.js?v=370',
    './js/guest-demo.js?v=370',
    './js/product-events.js?v=370',
    './js/activity-days.js?v=370',
    './js/pwa-install.js?v=370',
    './js/security.js?v=370',
    './js/community-stats-view.js?v=370',
    './js/social-challenge-readiness.js?v=370',
    './js/ui-helpers.js?v=370',
    './js/upload-performance.js?v=370',
    './js/video-thumbnail-quality.js?v=370',
    './js/webview-detect.js?v=370',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
