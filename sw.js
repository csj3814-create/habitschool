...
const CACHE_NAME = 'habitschool-v381';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=381',
    './styles-base.css?v=381',
    './styles-en.css?v=381',
    './styles-features.css?v=381',
    './styles-reward-market.css?v=381',
    './styles-dashboard.css?v=381',
    './styles-dark-mode.css?v=381',
    './styles-reports.css?v=381',
    './styles-guest-demo.css?v=381',
    './js/main.js?v=381',
    './js/app.js?v=381',
    './js/app-core.js?v=381',
    './js/auth.js?v=381',
    './js/i18n.js?v=381',
    './js/app-mode.js?v=381',
    './js/auth-login-helpers.js?v=381',
    './js/blockchain-config.js?v=381',
    './js/blockchain-manager.js?v=381',
    './js/challenge-claim.js?v=381',
    './js/video-compress.js?v=381',
    './js/bug-report.js?v=381',
    './js/data-manager.js?v=381',
    './js/diet-program.js?v=381',
    './js/diet-analysis.js?v=381',
    './js/exercise-media.js?v=381',
    './js/firebase-config.js?v=381',
    './js/friendship-utils.js?v=381',
    './js/habit-groups.js?v=381',
    './js/health-connect-utils.js?v=381',
    './js/metabolic-score.js?v=381',
    './js/le8-score.js?v=381',
    './js/milestone-helpers.js?v=381',
    './js/monthly-mvp-reward.js?v=381',
    './js/meditation-guide.js?v=381',
    './js/reward-market.js?v=381',
    './js/guest-demo.js?v=381',
    './js/product-events.js?v=381',
    './js/activity-days.js?v=381',
    './js/pwa-install.js?v=381',
    './js/security.js?v=381',
    './js/community-stats-view.js?v=381',
    './js/social-challenge-readiness.js?v=381',
    './js/ui-helpers.js?v=381',
    './js/upload-performance.js?v=381',
    './js/video-thumbnail-quality.js?v=381',
    './js/browser-detect.js?v=381',
    './js/webview-detect.js?v=381',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
