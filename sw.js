...
const STATIC_ASSETS = [
    './',
    './styles.css?v=319',
    './styles-base.css?v=319',
    './styles-en.css?v=319',
    './styles-features.css?v=319',
    './styles-reward-market.css?v=319',
    './styles-dashboard.css?v=319',
    './styles-dark-mode.css?v=319',
    './styles-reports.css?v=319',
    './styles-guest-demo.css?v=319',
    './js/main.js?v=319',
    './js/app.js?v=319',
    './js/app-core.js?v=319',
    './js/auth.js?v=319',
    './js/i18n.js?v=319',
    './js/app-mode.js?v=319',
    './js/auth-login-helpers.js?v=319',
    './js/blockchain-config.js?v=319',
    './js/blockchain-manager.js?v=319',
    './js/challenge-claim.js?v=319',
    './js/data-manager.js?v=319',
    './js/diet-program.js?v=319',
    './js/diet-analysis.js?v=319',
    './js/exercise-media.js?v=319',
    './js/firebase-config.js?v=319',
    './js/friendship-utils.js?v=319',
    './js/habit-groups.js?v=319',
    './js/health-connect-utils.js?v=319',
    './js/metabolic-score.js?v=319',
    './js/milestone-helpers.js?v=319',
    './js/monthly-mvp-reward.js?v=319',
    './js/meditation-guide.js?v=319',
    './js/reward-market.js?v=319',
    './js/guest-demo.js?v=319',
    './js/product-events.js?v=319',
    './js/activity-days.js?v=319',
    './js/pwa-install.js?v=319',
    './js/security.js?v=319',
    './js/social-challenge-readiness.js?v=319',
    './js/ui-helpers.js?v=319',
    './js/upload-performance.js?v=319',
    './js/video-thumbnail-quality.js?v=319',
    './js/webview-detect.js?v=319',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
