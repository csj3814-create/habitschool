...
const CACHE_NAME = 'habitschool-v299';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=299',
    './styles-base.css?v=299',
    './styles-en.css?v=299',
    './styles-features.css?v=299',
    './styles-reward-market.css?v=299',
    './styles-dashboard.css?v=299',
    './styles-dark-mode.css?v=299',
    './styles-reports.css?v=299',
    './styles-guest-demo.css?v=299',
    './js/main.js?v=299',
    './js/app.js?v=299',
    './js/app-core.js?v=299',
    './js/auth.js?v=299',
    './js/i18n.js?v=299',
    './js/app-mode.js?v=299',
    './js/auth-login-helpers.js?v=299',
    './js/blockchain-config.js?v=299',
    './js/blockchain-manager.js?v=299',
    './js/data-manager.js?v=299',
    './js/diet-program.js?v=299',
    './js/diet-analysis.js?v=299',
    './js/exercise-media.js?v=299',
    './js/firebase-config.js?v=299',
    './js/friendship-utils.js?v=299',
    './js/habit-groups.js?v=299',
    './js/health-connect-utils.js?v=299',
    './js/metabolic-score.js?v=299',
    './js/milestone-helpers.js?v=299',
    './js/monthly-mvp-reward.js?v=299',
    './js/meditation-guide.js?v=299',
    './js/reward-market.js?v=299',
    './js/guest-demo.js?v=299',
    './js/product-events.js?v=299',
    './js/activity-days.js?v=299',
    './js/pwa-install.js?v=299',
    './js/security.js?v=299',
    './js/social-challenge-readiness.js?v=299',
    './js/ui-helpers.js?v=299',
    './js/upload-performance.js?v=299',
    './js/video-thumbnail-quality.js?v=299',
    './js/webview-detect.js?v=299',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
