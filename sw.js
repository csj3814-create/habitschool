...
const CACHE_NAME = 'habitschool-v452';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=452',
    './styles-base.css?v=452',
    './styles-en.css?v=452',
    './styles-features.css?v=452',
    './styles-reward-market.css?v=452',
    './styles-dashboard.css?v=452',
    './styles-dark-mode.css?v=452',
    './styles-reports.css?v=452',
    './styles-guest-demo.css?v=452',
    './js/main.js?v=452',
    './js/app.js?v=452',
    './js/app-core.js?v=452',
    './js/auth.js?v=452',
    './js/i18n.js?v=452',
    './js/app-mode.js?v=452',
    './js/auth-login-helpers.js?v=452',
    './js/blockchain-config.js?v=452',
    './js/blockchain-manager.js?v=452',
    './js/challenge-claim.js?v=452',
    './js/video-compress.js?v=452',
    './js/bug-report.js?v=452',
    './js/data-manager.js?v=452',
    './js/diet-program.js?v=452',
    './js/diet-analysis.js?v=452',
    './js/exercise-media.js?v=452',
    './js/firebase-config.js?v=452',
    './js/friendship-utils.js?v=452',
    './js/habit-groups.js?v=452',
    './js/health-connect-utils.js?v=452',
    './js/metabolic-score.js?v=452',
    './js/korean.js?v=452',
    './js/le8-score.js?v=452',
    './js/milestone-helpers.js?v=452',
    './js/monthly-mvp-reward.js?v=452',
    './js/meditation-guide.js?v=452',
    './js/reward-market.js?v=452',
    './js/body-composition-csv.js?v=452',
    './js/mission-gate.js?v=452',
    './js/health-connect-body.js?v=452',
    './js/health-connect-activity.js?v=452',
    './js/reward-pace.js?v=452',
    './js/guest-demo.js?v=452',
    './js/product-events.js?v=452',
    './js/activity-days.js?v=452',
    './js/pwa-install.js?v=452',
    './js/media-hosts.js?v=452',
    './js/security.js?v=452',
    './js/community-stats-view.js?v=452',
    './js/social-challenge-readiness.js?v=452',
    './js/ui-helpers.js?v=452',
    './js/upload-performance.js?v=452',
    './js/video-thumbnail-quality.js?v=452',
    './js/browser-detect.js?v=452',
    './js/webview-detect.js?v=452',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
