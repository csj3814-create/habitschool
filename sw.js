...
const CACHE_NAME = 'habitschool-v428';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=428',
    './styles-base.css?v=428',
    './styles-en.css?v=428',
    './styles-features.css?v=428',
    './styles-reward-market.css?v=428',
    './styles-dashboard.css?v=428',
    './styles-dark-mode.css?v=428',
    './styles-reports.css?v=428',
    './styles-guest-demo.css?v=428',
    './js/main.js?v=428',
    './js/app.js?v=428',
    './js/app-core.js?v=428',
    './js/auth.js?v=428',
    './js/i18n.js?v=428',
    './js/app-mode.js?v=428',
    './js/auth-login-helpers.js?v=428',
    './js/blockchain-config.js?v=428',
    './js/blockchain-manager.js?v=428',
    './js/challenge-claim.js?v=428',
    './js/video-compress.js?v=428',
    './js/bug-report.js?v=428',
    './js/data-manager.js?v=428',
    './js/diet-program.js?v=428',
    './js/diet-analysis.js?v=428',
    './js/exercise-media.js?v=428',
    './js/firebase-config.js?v=428',
    './js/friendship-utils.js?v=428',
    './js/habit-groups.js?v=428',
    './js/health-connect-utils.js?v=428',
    './js/metabolic-score.js?v=428',
    './js/korean.js?v=428',
    './js/le8-score.js?v=428',
    './js/milestone-helpers.js?v=428',
    './js/monthly-mvp-reward.js?v=428',
    './js/meditation-guide.js?v=428',
    './js/reward-market.js?v=428',
    './js/guest-demo.js?v=428',
    './js/product-events.js?v=428',
    './js/activity-days.js?v=428',
    './js/pwa-install.js?v=428',
    './js/security.js?v=428',
    './js/community-stats-view.js?v=428',
    './js/social-challenge-readiness.js?v=428',
    './js/ui-helpers.js?v=428',
    './js/upload-performance.js?v=428',
    './js/video-thumbnail-quality.js?v=428',
    './js/browser-detect.js?v=428',
    './js/webview-detect.js?v=428',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
