...
const CACHE_NAME = 'habitschool-v309';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=309',
    './styles-base.css?v=309',
    './styles-en.css?v=309',
    './styles-features.css?v=309',
    './styles-reward-market.css?v=309',
    './styles-dashboard.css?v=309',
    './styles-dark-mode.css?v=309',
    './styles-reports.css?v=309',
    './styles-guest-demo.css?v=309',
    './js/main.js?v=309',
    './js/app.js?v=309',
    './js/app-core.js?v=309',
    './js/auth.js?v=309',
    './js/i18n.js?v=309',
    './js/app-mode.js?v=309',
    './js/auth-login-helpers.js?v=309',
    './js/blockchain-config.js?v=309',
    './js/blockchain-manager.js?v=309',
    './js/challenge-claim.js?v=309',
    './js/data-manager.js?v=309',
    './js/diet-program.js?v=309',
    './js/diet-analysis.js?v=309',
    './js/exercise-media.js?v=309',
    './js/firebase-config.js?v=309',
    './js/friendship-utils.js?v=309',
    './js/habit-groups.js?v=309',
    './js/health-connect-utils.js?v=309',
    './js/metabolic-score.js?v=309',
    './js/milestone-helpers.js?v=309',
    './js/monthly-mvp-reward.js?v=309',
    './js/meditation-guide.js?v=309',
    './js/reward-market.js?v=309',
    './js/guest-demo.js?v=309',
    './js/product-events.js?v=309',
    './js/activity-days.js?v=309',
    './js/pwa-install.js?v=309',
    './js/security.js?v=309',
    './js/social-challenge-readiness.js?v=309',
    './js/ui-helpers.js?v=309',
    './js/upload-performance.js?v=309',
    './js/video-thumbnail-quality.js?v=309',
    './js/webview-detect.js?v=309',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
