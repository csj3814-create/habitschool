...
const CACHE_NAME = 'habitschool-v342';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=342',
    './styles-base.css?v=342',
    './styles-en.css?v=342',
    './styles-features.css?v=342',
    './styles-reward-market.css?v=342',
    './styles-dashboard.css?v=342',
    './styles-dark-mode.css?v=342',
    './styles-reports.css?v=342',
    './styles-guest-demo.css?v=342',
    './js/main.js?v=342',
    './js/app.js?v=342',
    './js/app-core.js?v=342',
    './js/auth.js?v=342',
    './js/i18n.js?v=342',
    './js/app-mode.js?v=342',
    './js/auth-login-helpers.js?v=342',
    './js/blockchain-config.js?v=342',
    './js/blockchain-manager.js?v=342',
    './js/challenge-claim.js?v=342',
    './js/video-compress.js?v=342',
    './js/data-manager.js?v=342',
    './js/diet-program.js?v=342',
    './js/diet-analysis.js?v=342',
    './js/exercise-media.js?v=342',
    './js/firebase-config.js?v=342',
    './js/friendship-utils.js?v=342',
    './js/habit-groups.js?v=342',
    './js/health-connect-utils.js?v=342',
    './js/metabolic-score.js?v=342',
    './js/le8-score.js?v=342',
    './js/milestone-helpers.js?v=342',
    './js/monthly-mvp-reward.js?v=342',
    './js/meditation-guide.js?v=342',
    './js/reward-market.js?v=342',
    './js/guest-demo.js?v=342',
    './js/product-events.js?v=342',
    './js/activity-days.js?v=342',
    './js/pwa-install.js?v=342',
    './js/security.js?v=342',
    './js/social-challenge-readiness.js?v=342',
    './js/ui-helpers.js?v=342',
    './js/upload-performance.js?v=342',
    './js/video-thumbnail-quality.js?v=342',
    './js/webview-detect.js?v=342',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
