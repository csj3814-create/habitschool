...
const CACHE_NAME = 'habitschool-v337';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=337',
    './styles-base.css?v=337',
    './styles-en.css?v=337',
    './styles-features.css?v=337',
    './styles-reward-market.css?v=337',
    './styles-dashboard.css?v=337',
    './styles-dark-mode.css?v=337',
    './styles-reports.css?v=337',
    './styles-guest-demo.css?v=337',
    './js/main.js?v=337',
    './js/app.js?v=337',
    './js/app-core.js?v=337',
    './js/auth.js?v=337',
    './js/i18n.js?v=337',
    './js/app-mode.js?v=337',
    './js/auth-login-helpers.js?v=337',
    './js/blockchain-config.js?v=337',
    './js/blockchain-manager.js?v=337',
    './js/challenge-claim.js?v=337',
    './js/video-compress.js?v=337',
    './js/data-manager.js?v=337',
    './js/diet-program.js?v=337',
    './js/diet-analysis.js?v=337',
    './js/exercise-media.js?v=337',
    './js/firebase-config.js?v=337',
    './js/friendship-utils.js?v=337',
    './js/habit-groups.js?v=337',
    './js/health-connect-utils.js?v=337',
    './js/metabolic-score.js?v=337',
    './js/milestone-helpers.js?v=337',
    './js/monthly-mvp-reward.js?v=337',
    './js/meditation-guide.js?v=337',
    './js/reward-market.js?v=337',
    './js/guest-demo.js?v=337',
    './js/product-events.js?v=337',
    './js/activity-days.js?v=337',
    './js/pwa-install.js?v=337',
    './js/security.js?v=337',
    './js/social-challenge-readiness.js?v=337',
    './js/ui-helpers.js?v=337',
    './js/upload-performance.js?v=337',
    './js/video-thumbnail-quality.js?v=337',
    './js/webview-detect.js?v=337',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
