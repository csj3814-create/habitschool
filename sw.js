...
const CACHE_NAME = 'habitschool-v420';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=420',
    './styles-base.css?v=420',
    './styles-en.css?v=420',
    './styles-features.css?v=420',
    './styles-reward-market.css?v=420',
    './styles-dashboard.css?v=420',
    './styles-dark-mode.css?v=420',
    './styles-reports.css?v=420',
    './styles-guest-demo.css?v=420',
    './js/main.js?v=420',
    './js/app.js?v=420',
    './js/app-core.js?v=420',
    './js/auth.js?v=420',
    './js/i18n.js?v=420',
    './js/app-mode.js?v=420',
    './js/auth-login-helpers.js?v=420',
    './js/blockchain-config.js?v=420',
    './js/blockchain-manager.js?v=420',
    './js/challenge-claim.js?v=420',
    './js/video-compress.js?v=420',
    './js/bug-report.js?v=420',
    './js/data-manager.js?v=420',
    './js/diet-program.js?v=420',
    './js/diet-analysis.js?v=420',
    './js/exercise-media.js?v=420',
    './js/firebase-config.js?v=420',
    './js/friendship-utils.js?v=420',
    './js/habit-groups.js?v=420',
    './js/health-connect-utils.js?v=420',
    './js/metabolic-score.js?v=420',
    './js/le8-score.js?v=420',
    './js/milestone-helpers.js?v=420',
    './js/monthly-mvp-reward.js?v=420',
    './js/meditation-guide.js?v=420',
    './js/reward-market.js?v=420',
    './js/guest-demo.js?v=420',
    './js/product-events.js?v=420',
    './js/activity-days.js?v=420',
    './js/pwa-install.js?v=420',
    './js/security.js?v=420',
    './js/community-stats-view.js?v=420',
    './js/social-challenge-readiness.js?v=420',
    './js/ui-helpers.js?v=420',
    './js/upload-performance.js?v=420',
    './js/video-thumbnail-quality.js?v=420',
    './js/browser-detect.js?v=420',
    './js/webview-detect.js?v=420',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
