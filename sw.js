...
const CACHE_NAME = 'habitschool-v384';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=384',
    './styles-base.css?v=384',
    './styles-en.css?v=384',
    './styles-features.css?v=384',
    './styles-reward-market.css?v=384',
    './styles-dashboard.css?v=384',
    './styles-dark-mode.css?v=384',
    './styles-reports.css?v=384',
    './styles-guest-demo.css?v=384',
    './js/main.js?v=384',
    './js/app.js?v=384',
    './js/app-core.js?v=384',
    './js/auth.js?v=384',
    './js/i18n.js?v=384',
    './js/app-mode.js?v=384',
    './js/auth-login-helpers.js?v=384',
    './js/blockchain-config.js?v=384',
    './js/blockchain-manager.js?v=384',
    './js/challenge-claim.js?v=384',
    './js/video-compress.js?v=384',
    './js/bug-report.js?v=384',
    './js/data-manager.js?v=384',
    './js/diet-program.js?v=384',
    './js/diet-analysis.js?v=384',
    './js/exercise-media.js?v=384',
    './js/firebase-config.js?v=384',
    './js/friendship-utils.js?v=384',
    './js/habit-groups.js?v=384',
    './js/health-connect-utils.js?v=384',
    './js/metabolic-score.js?v=384',
    './js/le8-score.js?v=384',
    './js/milestone-helpers.js?v=384',
    './js/monthly-mvp-reward.js?v=384',
    './js/meditation-guide.js?v=384',
    './js/reward-market.js?v=384',
    './js/guest-demo.js?v=384',
    './js/product-events.js?v=384',
    './js/activity-days.js?v=384',
    './js/pwa-install.js?v=384',
    './js/security.js?v=384',
    './js/community-stats-view.js?v=384',
    './js/social-challenge-readiness.js?v=384',
    './js/ui-helpers.js?v=384',
    './js/upload-performance.js?v=384',
    './js/video-thumbnail-quality.js?v=384',
    './js/browser-detect.js?v=384',
    './js/webview-detect.js?v=384',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
