...
const CACHE_NAME = 'habitschool-v315';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=315',
    './styles-base.css?v=315',
    './styles-en.css?v=315',
    './styles-features.css?v=315',
    './styles-reward-market.css?v=315',
    './styles-dashboard.css?v=315',
    './styles-dark-mode.css?v=315',
    './styles-reports.css?v=315',
    './styles-guest-demo.css?v=315',
    './js/main.js?v=315',
    './js/app.js?v=315',
    './js/app-core.js?v=315',
    './js/auth.js?v=315',
    './js/i18n.js?v=315',
    './js/app-mode.js?v=315',
    './js/auth-login-helpers.js?v=315',
    './js/blockchain-config.js?v=315',
    './js/blockchain-manager.js?v=315',
    './js/challenge-claim.js?v=315',
    './js/data-manager.js?v=315',
    './js/diet-program.js?v=315',
    './js/diet-analysis.js?v=315',
    './js/exercise-media.js?v=315',
    './js/firebase-config.js?v=315',
    './js/friendship-utils.js?v=315',
    './js/habit-groups.js?v=315',
    './js/health-connect-utils.js?v=315',
    './js/metabolic-score.js?v=315',
    './js/milestone-helpers.js?v=315',
    './js/monthly-mvp-reward.js?v=315',
    './js/meditation-guide.js?v=315',
    './js/reward-market.js?v=315',
    './js/guest-demo.js?v=315',
    './js/product-events.js?v=315',
    './js/activity-days.js?v=315',
    './js/pwa-install.js?v=315',
    './js/security.js?v=315',
    './js/social-challenge-readiness.js?v=315',
    './js/ui-helpers.js?v=315',
    './js/upload-performance.js?v=315',
    './js/video-thumbnail-quality.js?v=315',
    './js/webview-detect.js?v=315',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
