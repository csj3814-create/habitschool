...
const CACHE_NAME = 'habitschool-v177';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=177',
    './styles-base.css?v=177',
    './styles-features.css?v=177',
    './styles-reward-market.css?v=177',
    './styles-dashboard.css?v=177',
    './styles-dark-mode.css?v=177',
    './styles-reports.css?v=177',
    './js/main.js?v=177',
    './js/app.js?v=177',
    './js/app-core.js?v=177',
    './js/auth.js?v=177',
    './js/app-mode.js?v=177',
    './js/auth-login-helpers.js?v=177',
    './js/blockchain-config.js?v=177',
    './js/blockchain-manager.js?v=177',
    './js/data-manager.js?v=177',
    './js/diet-program.js?v=177',
    './js/diet-analysis.js?v=177',
    './js/exercise-media.js?v=177',
    './js/firebase-config.js?v=177',
    './js/health-connect-utils.js?v=177',
    './js/metabolic-score.js?v=177',
    './js/milestone-helpers.js?v=177',
    './js/monthly-mvp-reward.js?v=177',
    './js/pwa-install.js?v=177',
    './js/security.js?v=177',
    './js/social-challenge-readiness.js?v=177',
    './js/ui-helpers.js?v=177',
    './js/upload-performance.js?v=177',
    './js/webview-detect.js?v=177',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
