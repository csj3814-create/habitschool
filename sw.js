...
const CACHE_NAME = 'habitschool-v265';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=265',
    './styles-base.css?v=265',
    './styles-en.css?v=265',
    './styles-features.css?v=265',
    './styles-reward-market.css?v=265',
    './styles-dashboard.css?v=265',
    './styles-dark-mode.css?v=265',
    './styles-reports.css?v=265',
    './styles-guest-demo.css?v=265',
    './js/main.js?v=265',
    './js/app.js?v=265',
    './js/app-core.js?v=265',
    './js/auth.js?v=265',
    './js/i18n.js?v=265',
    './js/app-mode.js?v=265',
    './js/auth-login-helpers.js?v=265',
    './js/blockchain-config.js?v=265',
    './js/blockchain-manager.js?v=265',
    './js/data-manager.js?v=265',
    './js/diet-program.js?v=265',
    './js/diet-analysis.js?v=265',
    './js/exercise-media.js?v=265',
    './js/firebase-config.js?v=265',
    './js/friendship-utils.js?v=265',
    './js/habit-groups.js?v=265',
    './js/health-connect-utils.js?v=265',
    './js/metabolic-score.js?v=265',
    './js/milestone-helpers.js?v=265',
    './js/monthly-mvp-reward.js?v=265',
    './js/meditation-guide.js?v=265',
    './js/reward-market.js?v=265',
    './js/guest-demo.js?v=265',
    './js/product-events.js?v=265',
    './js/activity-days.js?v=265',
    './js/pwa-install.js?v=265',
    './js/security.js?v=265',
    './js/social-challenge-readiness.js?v=265',
    './js/ui-helpers.js?v=265',
    './js/upload-performance.js?v=265',
    './js/video-thumbnail-quality.js?v=265',
    './js/webview-detect.js?v=265',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
