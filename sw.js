...
const CACHE_NAME = 'habitschool-v311';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=311',
    './styles-base.css?v=311',
    './styles-en.css?v=311',
    './styles-features.css?v=311',
    './styles-reward-market.css?v=311',
    './styles-dashboard.css?v=311',
    './styles-dark-mode.css?v=311',
    './styles-reports.css?v=311',
    './styles-guest-demo.css?v=311',
    './js/main.js?v=311',
    './js/app.js?v=311',
    './js/app-core.js?v=311',
    './js/auth.js?v=311',
    './js/i18n.js?v=311',
    './js/app-mode.js?v=311',
    './js/auth-login-helpers.js?v=311',
    './js/blockchain-config.js?v=311',
    './js/blockchain-manager.js?v=311',
    './js/challenge-claim.js?v=311',
    './js/data-manager.js?v=311',
    './js/diet-program.js?v=311',
    './js/diet-analysis.js?v=311',
    './js/exercise-media.js?v=311',
    './js/firebase-config.js?v=311',
    './js/friendship-utils.js?v=311',
    './js/habit-groups.js?v=311',
    './js/health-connect-utils.js?v=311',
    './js/metabolic-score.js?v=311',
    './js/milestone-helpers.js?v=311',
    './js/monthly-mvp-reward.js?v=311',
    './js/meditation-guide.js?v=311',
    './js/reward-market.js?v=311',
    './js/guest-demo.js?v=311',
    './js/product-events.js?v=311',
    './js/activity-days.js?v=311',
    './js/pwa-install.js?v=311',
    './js/security.js?v=311',
    './js/social-challenge-readiness.js?v=311',
    './js/ui-helpers.js?v=311',
    './js/upload-performance.js?v=311',
    './js/video-thumbnail-quality.js?v=311',
    './js/webview-detect.js?v=311',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
