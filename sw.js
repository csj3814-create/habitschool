...
const CACHE_NAME = 'habitschool-v269';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=269',
    './styles-base.css?v=269',
    './styles-en.css?v=269',
    './styles-features.css?v=269',
    './styles-reward-market.css?v=269',
    './styles-dashboard.css?v=269',
    './styles-dark-mode.css?v=269',
    './styles-reports.css?v=269',
    './styles-guest-demo.css?v=269',
    './js/main.js?v=269',
    './js/app.js?v=269',
    './js/app-core.js?v=269',
    './js/auth.js?v=269',
    './js/i18n.js?v=269',
    './js/app-mode.js?v=269',
    './js/auth-login-helpers.js?v=269',
    './js/blockchain-config.js?v=269',
    './js/blockchain-manager.js?v=269',
    './js/data-manager.js?v=269',
    './js/diet-program.js?v=269',
    './js/diet-analysis.js?v=269',
    './js/exercise-media.js?v=269',
    './js/firebase-config.js?v=269',
    './js/friendship-utils.js?v=269',
    './js/habit-groups.js?v=269',
    './js/health-connect-utils.js?v=269',
    './js/metabolic-score.js?v=269',
    './js/milestone-helpers.js?v=269',
    './js/monthly-mvp-reward.js?v=269',
    './js/meditation-guide.js?v=269',
    './js/reward-market.js?v=269',
    './js/guest-demo.js?v=269',
    './js/product-events.js?v=269',
    './js/activity-days.js?v=269',
    './js/pwa-install.js?v=269',
    './js/security.js?v=269',
    './js/social-challenge-readiness.js?v=269',
    './js/ui-helpers.js?v=269',
    './js/upload-performance.js?v=269',
    './js/video-thumbnail-quality.js?v=269',
    './js/webview-detect.js?v=269',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
