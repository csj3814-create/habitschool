...
const CACHE_NAME = 'habitschool-v333';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=333',
    './styles-base.css?v=333',
    './styles-en.css?v=333',
    './styles-features.css?v=333',
    './styles-reward-market.css?v=333',
    './styles-dashboard.css?v=333',
    './styles-dark-mode.css?v=333',
    './styles-reports.css?v=333',
    './styles-guest-demo.css?v=333',
    './js/main.js?v=333',
    './js/app.js?v=333',
    './js/app-core.js?v=333',
    './js/auth.js?v=333',
    './js/i18n.js?v=333',
    './js/app-mode.js?v=333',
    './js/auth-login-helpers.js?v=333',
    './js/blockchain-config.js?v=333',
    './js/blockchain-manager.js?v=333',
    './js/challenge-claim.js?v=333',
    './js/video-compress.js?v=333',
    './js/data-manager.js?v=333',
    './js/diet-program.js?v=333',
    './js/diet-analysis.js?v=333',
    './js/exercise-media.js?v=333',
    './js/firebase-config.js?v=333',
    './js/friendship-utils.js?v=333',
    './js/habit-groups.js?v=333',
    './js/health-connect-utils.js?v=333',
    './js/metabolic-score.js?v=333',
    './js/milestone-helpers.js?v=333',
    './js/monthly-mvp-reward.js?v=333',
    './js/meditation-guide.js?v=333',
    './js/reward-market.js?v=333',
    './js/guest-demo.js?v=333',
    './js/product-events.js?v=333',
    './js/activity-days.js?v=333',
    './js/pwa-install.js?v=333',
    './js/security.js?v=333',
    './js/social-challenge-readiness.js?v=333',
    './js/ui-helpers.js?v=333',
    './js/upload-performance.js?v=333',
    './js/video-thumbnail-quality.js?v=333',
    './js/webview-detect.js?v=333',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
