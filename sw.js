...
const CACHE_NAME = 'habitschool-v297';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=297',
    './styles-base.css?v=297',
    './styles-en.css?v=297',
    './styles-features.css?v=297',
    './styles-reward-market.css?v=297',
    './styles-dashboard.css?v=297',
    './styles-dark-mode.css?v=297',
    './styles-reports.css?v=297',
    './styles-guest-demo.css?v=297',
    './js/main.js?v=297',
    './js/app.js?v=297',
    './js/app-core.js?v=297',
    './js/auth.js?v=297',
    './js/i18n.js?v=297',
    './js/app-mode.js?v=297',
    './js/auth-login-helpers.js?v=297',
    './js/blockchain-config.js?v=297',
    './js/blockchain-manager.js?v=297',
    './js/data-manager.js?v=297',
    './js/diet-program.js?v=297',
    './js/diet-analysis.js?v=297',
    './js/exercise-media.js?v=297',
    './js/firebase-config.js?v=297',
    './js/friendship-utils.js?v=297',
    './js/habit-groups.js?v=297',
    './js/health-connect-utils.js?v=297',
    './js/metabolic-score.js?v=297',
    './js/milestone-helpers.js?v=297',
    './js/monthly-mvp-reward.js?v=297',
    './js/meditation-guide.js?v=297',
    './js/reward-market.js?v=297',
    './js/guest-demo.js?v=297',
    './js/product-events.js?v=297',
    './js/activity-days.js?v=297',
    './js/pwa-install.js?v=297',
    './js/security.js?v=297',
    './js/social-challenge-readiness.js?v=297',
    './js/ui-helpers.js?v=297',
    './js/upload-performance.js?v=297',
    './js/video-thumbnail-quality.js?v=297',
    './js/webview-detect.js?v=297',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
