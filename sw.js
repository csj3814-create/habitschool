...
const CACHE_NAME = 'habitschool-v439';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=439',
    './styles-base.css?v=439',
    './styles-en.css?v=439',
    './styles-features.css?v=439',
    './styles-reward-market.css?v=439',
    './styles-dashboard.css?v=439',
    './styles-dark-mode.css?v=439',
    './styles-reports.css?v=439',
    './styles-guest-demo.css?v=439',
    './js/main.js?v=439',
    './js/app.js?v=439',
    './js/app-core.js?v=439',
    './js/auth.js?v=439',
    './js/i18n.js?v=439',
    './js/app-mode.js?v=439',
    './js/auth-login-helpers.js?v=439',
    './js/blockchain-config.js?v=439',
    './js/blockchain-manager.js?v=439',
    './js/challenge-claim.js?v=439',
    './js/video-compress.js?v=439',
    './js/bug-report.js?v=439',
    './js/data-manager.js?v=439',
    './js/diet-program.js?v=439',
    './js/diet-analysis.js?v=439',
    './js/exercise-media.js?v=439',
    './js/firebase-config.js?v=439',
    './js/friendship-utils.js?v=439',
    './js/habit-groups.js?v=439',
    './js/health-connect-utils.js?v=439',
    './js/metabolic-score.js?v=439',
    './js/korean.js?v=439',
    './js/le8-score.js?v=439',
    './js/milestone-helpers.js?v=439',
    './js/monthly-mvp-reward.js?v=439',
    './js/meditation-guide.js?v=439',
    './js/reward-market.js?v=439',
    './js/body-composition-csv.js?v=439',
    './js/mission-gate.js?v=439',
    './js/health-connect-body.js?v=439',
    './js/reward-pace.js?v=439',
    './js/guest-demo.js?v=439',
    './js/product-events.js?v=439',
    './js/activity-days.js?v=439',
    './js/pwa-install.js?v=439',
    './js/media-hosts.js?v=439',
    './js/security.js?v=439',
    './js/community-stats-view.js?v=439',
    './js/social-challenge-readiness.js?v=439',
    './js/ui-helpers.js?v=439',
    './js/upload-performance.js?v=439',
    './js/video-thumbnail-quality.js?v=439',
    './js/browser-detect.js?v=439',
    './js/webview-detect.js?v=439',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
