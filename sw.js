...
const CACHE_NAME = 'habitschool-v405';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=405',
    './styles-base.css?v=405',
    './styles-en.css?v=405',
    './styles-features.css?v=405',
    './styles-reward-market.css?v=405',
    './styles-dashboard.css?v=405',
    './styles-dark-mode.css?v=405',
    './styles-reports.css?v=405',
    './styles-guest-demo.css?v=405',
    './js/main.js?v=405',
    './js/app.js?v=405',
    './js/app-core.js?v=405',
    './js/auth.js?v=405',
    './js/i18n.js?v=405',
    './js/app-mode.js?v=405',
    './js/auth-login-helpers.js?v=405',
    './js/blockchain-config.js?v=405',
    './js/blockchain-manager.js?v=405',
    './js/challenge-claim.js?v=405',
    './js/video-compress.js?v=405',
    './js/bug-report.js?v=405',
    './js/data-manager.js?v=405',
    './js/diet-program.js?v=405',
    './js/diet-analysis.js?v=405',
    './js/exercise-media.js?v=405',
    './js/firebase-config.js?v=405',
    './js/friendship-utils.js?v=405',
    './js/habit-groups.js?v=405',
    './js/health-connect-utils.js?v=405',
    './js/metabolic-score.js?v=405',
    './js/le8-score.js?v=405',
    './js/milestone-helpers.js?v=405',
    './js/monthly-mvp-reward.js?v=405',
    './js/meditation-guide.js?v=405',
    './js/reward-market.js?v=405',
    './js/guest-demo.js?v=405',
    './js/product-events.js?v=405',
    './js/activity-days.js?v=405',
    './js/pwa-install.js?v=405',
    './js/security.js?v=405',
    './js/community-stats-view.js?v=405',
    './js/social-challenge-readiness.js?v=405',
    './js/ui-helpers.js?v=405',
    './js/upload-performance.js?v=405',
    './js/video-thumbnail-quality.js?v=405',
    './js/browser-detect.js?v=405',
    './js/webview-detect.js?v=405',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
