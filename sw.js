...
const CACHE_NAME = 'habitschool-v203';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=203',
    './styles-base.css?v=203',
    './styles-features.css?v=203',
    './styles-reward-market.css?v=203',
    './styles-dashboard.css?v=203',
    './styles-dark-mode.css?v=203',
    './styles-reports.css?v=203',
    './js/main.js?v=203',
    './js/app.js?v=203',
    './js/app-core.js?v=203',
    './js/auth.js?v=203',
    './js/app-mode.js?v=203',
    './js/auth-login-helpers.js?v=203',
    './js/blockchain-config.js?v=203',
    './js/blockchain-manager.js?v=203',
    './js/data-manager.js?v=203',
    './js/diet-program.js?v=203',
    './js/diet-analysis.js?v=203',
    './js/exercise-media.js?v=203',
    './js/firebase-config.js?v=203',
    './js/habit-groups.js?v=203',
    './js/health-connect-utils.js?v=203',
    './js/metabolic-score.js?v=203',
    './js/milestone-helpers.js?v=203',
    './js/monthly-mvp-reward.js?v=203',
    './js/pwa-install.js?v=203',
    './js/security.js?v=203',
    './js/social-challenge-readiness.js?v=203',
    './js/ui-helpers.js?v=203',
    './js/upload-performance.js?v=203',
    './js/webview-detect.js?v=203',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
