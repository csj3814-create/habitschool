...
const CACHE_NAME = 'habitschool-v424';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=424',
    './styles-base.css?v=424',
    './styles-en.css?v=424',
    './styles-features.css?v=424',
    './styles-reward-market.css?v=424',
    './styles-dashboard.css?v=424',
    './styles-dark-mode.css?v=424',
    './styles-reports.css?v=424',
    './styles-guest-demo.css?v=424',
    './js/main.js?v=424',
    './js/app.js?v=424',
    './js/app-core.js?v=424',
    './js/auth.js?v=424',
    './js/i18n.js?v=424',
    './js/app-mode.js?v=424',
    './js/auth-login-helpers.js?v=424',
    './js/blockchain-config.js?v=424',
    './js/blockchain-manager.js?v=424',
    './js/challenge-claim.js?v=424',
    './js/video-compress.js?v=424',
    './js/bug-report.js?v=424',
    './js/data-manager.js?v=424',
    './js/diet-program.js?v=424',
    './js/diet-analysis.js?v=424',
    './js/exercise-media.js?v=424',
    './js/firebase-config.js?v=424',
    './js/friendship-utils.js?v=424',
    './js/habit-groups.js?v=424',
    './js/health-connect-utils.js?v=424',
    './js/metabolic-score.js?v=424',
    './js/le8-score.js?v=424',
    './js/milestone-helpers.js?v=424',
    './js/monthly-mvp-reward.js?v=424',
    './js/meditation-guide.js?v=424',
    './js/reward-market.js?v=424',
    './js/guest-demo.js?v=424',
    './js/product-events.js?v=424',
    './js/activity-days.js?v=424',
    './js/pwa-install.js?v=424',
    './js/security.js?v=424',
    './js/community-stats-view.js?v=424',
    './js/social-challenge-readiness.js?v=424',
    './js/ui-helpers.js?v=424',
    './js/upload-performance.js?v=424',
    './js/video-thumbnail-quality.js?v=424',
    './js/browser-detect.js?v=424',
    './js/webview-detect.js?v=424',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
