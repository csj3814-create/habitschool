...
const CACHE_NAME = 'habitschool-v438';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=438',
    './styles-base.css?v=438',
    './styles-en.css?v=438',
    './styles-features.css?v=438',
    './styles-reward-market.css?v=438',
    './styles-dashboard.css?v=438',
    './styles-dark-mode.css?v=438',
    './styles-reports.css?v=438',
    './styles-guest-demo.css?v=438',
    './js/main.js?v=438',
    './js/app.js?v=438',
    './js/app-core.js?v=438',
    './js/auth.js?v=438',
    './js/i18n.js?v=438',
    './js/app-mode.js?v=438',
    './js/auth-login-helpers.js?v=438',
    './js/blockchain-config.js?v=438',
    './js/blockchain-manager.js?v=438',
    './js/challenge-claim.js?v=438',
    './js/video-compress.js?v=438',
    './js/bug-report.js?v=438',
    './js/data-manager.js?v=438',
    './js/diet-program.js?v=438',
    './js/diet-analysis.js?v=438',
    './js/exercise-media.js?v=438',
    './js/firebase-config.js?v=438',
    './js/friendship-utils.js?v=438',
    './js/habit-groups.js?v=438',
    './js/health-connect-utils.js?v=438',
    './js/metabolic-score.js?v=438',
    './js/korean.js?v=438',
    './js/le8-score.js?v=438',
    './js/milestone-helpers.js?v=438',
    './js/monthly-mvp-reward.js?v=438',
    './js/meditation-guide.js?v=438',
    './js/reward-market.js?v=438',
    './js/body-composition-csv.js?v=438',
    './js/mission-gate.js?v=438',
    './js/health-connect-body.js?v=438',
    './js/reward-pace.js?v=438',
    './js/guest-demo.js?v=438',
    './js/product-events.js?v=438',
    './js/activity-days.js?v=438',
    './js/pwa-install.js?v=438',
    './js/media-hosts.js?v=438',
    './js/security.js?v=438',
    './js/community-stats-view.js?v=438',
    './js/social-challenge-readiness.js?v=438',
    './js/ui-helpers.js?v=438',
    './js/upload-performance.js?v=438',
    './js/video-thumbnail-quality.js?v=438',
    './js/browser-detect.js?v=438',
    './js/webview-detect.js?v=438',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
