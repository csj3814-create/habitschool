...
const CACHE_NAME = 'habitschool-v175';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=175',
    './styles-base.css?v=175',
    './styles-features.css?v=175',
    './styles-reward-market.css?v=175',
    './styles-dashboard.css?v=175',
    './styles-dark-mode.css?v=175',
    './styles-reports.css?v=175',
    './js/main.js?v=175',
    './js/app.js?v=175',
    './js/app-core.js?v=175',
    './js/auth.js?v=175',
    './js/app-mode.js?v=175',
    './js/auth-login-helpers.js?v=175',
    './js/blockchain-config.js?v=175',
    './js/blockchain-manager.js?v=175',
    './js/data-manager.js?v=175',
    './js/diet-program.js?v=175',
    './js/diet-analysis.js?v=175',
    './js/exercise-media.js?v=175',
    './js/firebase-config.js?v=175',
    './js/health-connect-utils.js?v=175',
    './js/metabolic-score.js?v=175',
    './js/milestone-helpers.js?v=175',
    './js/monthly-mvp-reward.js?v=175',
    './js/pwa-install.js?v=175',
    './js/security.js?v=175',
    './js/social-challenge-readiness.js?v=175',
    './js/ui-helpers.js?v=175',
    './js/upload-performance.js?v=175',
    './js/webview-detect.js?v=175',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
