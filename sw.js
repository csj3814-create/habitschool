...
const CACHE_NAME = 'habitschool-v406';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=406',
    './styles-base.css?v=406',
    './styles-en.css?v=406',
    './styles-features.css?v=406',
    './styles-reward-market.css?v=406',
    './styles-dashboard.css?v=406',
    './styles-dark-mode.css?v=406',
    './styles-reports.css?v=406',
    './styles-guest-demo.css?v=406',
    './js/main.js?v=406',
    './js/app.js?v=406',
    './js/app-core.js?v=406',
    './js/auth.js?v=406',
    './js/i18n.js?v=406',
    './js/app-mode.js?v=406',
    './js/auth-login-helpers.js?v=406',
    './js/blockchain-config.js?v=406',
    './js/blockchain-manager.js?v=406',
    './js/challenge-claim.js?v=406',
    './js/video-compress.js?v=406',
    './js/bug-report.js?v=406',
    './js/data-manager.js?v=406',
    './js/diet-program.js?v=406',
    './js/diet-analysis.js?v=406',
    './js/exercise-media.js?v=406',
    './js/firebase-config.js?v=406',
    './js/friendship-utils.js?v=406',
    './js/habit-groups.js?v=406',
    './js/health-connect-utils.js?v=406',
    './js/metabolic-score.js?v=406',
    './js/le8-score.js?v=406',
    './js/milestone-helpers.js?v=406',
    './js/monthly-mvp-reward.js?v=406',
    './js/meditation-guide.js?v=406',
    './js/reward-market.js?v=406',
    './js/guest-demo.js?v=406',
    './js/product-events.js?v=406',
    './js/activity-days.js?v=406',
    './js/pwa-install.js?v=406',
    './js/security.js?v=406',
    './js/community-stats-view.js?v=406',
    './js/social-challenge-readiness.js?v=406',
    './js/ui-helpers.js?v=406',
    './js/upload-performance.js?v=406',
    './js/video-thumbnail-quality.js?v=406',
    './js/browser-detect.js?v=406',
    './js/webview-detect.js?v=406',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
