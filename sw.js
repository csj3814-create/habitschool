...
const CACHE_NAME = 'habitschool-v187';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=187',
    './styles-base.css?v=187',
    './styles-features.css?v=187',
    './styles-reward-market.css?v=187',
    './styles-dashboard.css?v=187',
    './styles-dark-mode.css?v=187',
    './styles-reports.css?v=187',
    './js/main.js?v=187',
    './js/app.js?v=187',
    './js/app-core.js?v=187',
    './js/auth.js?v=187',
    './js/app-mode.js?v=187',
    './js/auth-login-helpers.js?v=187',
    './js/blockchain-config.js?v=187',
    './js/blockchain-manager.js?v=187',
    './js/data-manager.js?v=187',
    './js/diet-program.js?v=187',
    './js/diet-analysis.js?v=187',
    './js/exercise-media.js?v=187',
    './js/firebase-config.js?v=187',
    './js/health-connect-utils.js?v=187',
    './js/metabolic-score.js?v=187',
    './js/milestone-helpers.js?v=187',
    './js/monthly-mvp-reward.js?v=187',
    './js/pwa-install.js?v=187',
    './js/security.js?v=187',
    './js/social-challenge-readiness.js?v=187',
    './js/ui-helpers.js?v=187',
    './js/upload-performance.js?v=187',
    './js/webview-detect.js?v=187',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
