...
const CACHE_NAME = 'habitschool-v417';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=417',
    './styles-base.css?v=417',
    './styles-en.css?v=417',
    './styles-features.css?v=417',
    './styles-reward-market.css?v=417',
    './styles-dashboard.css?v=417',
    './styles-dark-mode.css?v=417',
    './styles-reports.css?v=417',
    './styles-guest-demo.css?v=417',
    './js/main.js?v=417',
    './js/app.js?v=417',
    './js/app-core.js?v=417',
    './js/auth.js?v=417',
    './js/i18n.js?v=417',
    './js/app-mode.js?v=417',
    './js/auth-login-helpers.js?v=417',
    './js/blockchain-config.js?v=417',
    './js/blockchain-manager.js?v=417',
    './js/challenge-claim.js?v=417',
    './js/video-compress.js?v=417',
    './js/bug-report.js?v=417',
    './js/data-manager.js?v=417',
    './js/diet-program.js?v=417',
    './js/diet-analysis.js?v=417',
    './js/exercise-media.js?v=417',
    './js/firebase-config.js?v=417',
    './js/friendship-utils.js?v=417',
    './js/habit-groups.js?v=417',
    './js/health-connect-utils.js?v=417',
    './js/metabolic-score.js?v=417',
    './js/le8-score.js?v=417',
    './js/milestone-helpers.js?v=417',
    './js/monthly-mvp-reward.js?v=417',
    './js/meditation-guide.js?v=417',
    './js/reward-market.js?v=417',
    './js/guest-demo.js?v=417',
    './js/product-events.js?v=417',
    './js/activity-days.js?v=417',
    './js/pwa-install.js?v=417',
    './js/security.js?v=417',
    './js/community-stats-view.js?v=417',
    './js/social-challenge-readiness.js?v=417',
    './js/ui-helpers.js?v=417',
    './js/upload-performance.js?v=417',
    './js/video-thumbnail-quality.js?v=417',
    './js/browser-detect.js?v=417',
    './js/webview-detect.js?v=417',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
