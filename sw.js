...
const CACHE_NAME = 'habitschool-v399';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=399',
    './styles-base.css?v=399',
    './styles-en.css?v=399',
    './styles-features.css?v=399',
    './styles-reward-market.css?v=399',
    './styles-dashboard.css?v=399',
    './styles-dark-mode.css?v=399',
    './styles-reports.css?v=399',
    './styles-guest-demo.css?v=399',
    './js/main.js?v=399',
    './js/app.js?v=399',
    './js/app-core.js?v=399',
    './js/auth.js?v=399',
    './js/i18n.js?v=399',
    './js/app-mode.js?v=399',
    './js/auth-login-helpers.js?v=399',
    './js/blockchain-config.js?v=399',
    './js/blockchain-manager.js?v=399',
    './js/challenge-claim.js?v=399',
    './js/video-compress.js?v=399',
    './js/bug-report.js?v=399',
    './js/data-manager.js?v=399',
    './js/diet-program.js?v=399',
    './js/diet-analysis.js?v=399',
    './js/exercise-media.js?v=399',
    './js/firebase-config.js?v=399',
    './js/friendship-utils.js?v=399',
    './js/habit-groups.js?v=399',
    './js/health-connect-utils.js?v=399',
    './js/metabolic-score.js?v=399',
    './js/le8-score.js?v=399',
    './js/milestone-helpers.js?v=399',
    './js/monthly-mvp-reward.js?v=399',
    './js/meditation-guide.js?v=399',
    './js/reward-market.js?v=399',
    './js/guest-demo.js?v=399',
    './js/product-events.js?v=399',
    './js/activity-days.js?v=399',
    './js/pwa-install.js?v=399',
    './js/security.js?v=399',
    './js/community-stats-view.js?v=399',
    './js/social-challenge-readiness.js?v=399',
    './js/ui-helpers.js?v=399',
    './js/upload-performance.js?v=399',
    './js/video-thumbnail-quality.js?v=399',
    './js/browser-detect.js?v=399',
    './js/webview-detect.js?v=399',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
