...
const CACHE_NAME = 'habitschool-v450';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=450',
    './styles-base.css?v=450',
    './styles-en.css?v=450',
    './styles-features.css?v=450',
    './styles-reward-market.css?v=450',
    './styles-dashboard.css?v=450',
    './styles-dark-mode.css?v=450',
    './styles-reports.css?v=450',
    './styles-guest-demo.css?v=450',
    './js/main.js?v=450',
    './js/app.js?v=450',
    './js/app-core.js?v=450',
    './js/auth.js?v=450',
    './js/i18n.js?v=450',
    './js/app-mode.js?v=450',
    './js/auth-login-helpers.js?v=450',
    './js/blockchain-config.js?v=450',
    './js/blockchain-manager.js?v=450',
    './js/challenge-claim.js?v=450',
    './js/video-compress.js?v=450',
    './js/bug-report.js?v=450',
    './js/data-manager.js?v=450',
    './js/diet-program.js?v=450',
    './js/diet-analysis.js?v=450',
    './js/exercise-media.js?v=450',
    './js/firebase-config.js?v=450',
    './js/friendship-utils.js?v=450',
    './js/habit-groups.js?v=450',
    './js/health-connect-utils.js?v=450',
    './js/metabolic-score.js?v=450',
    './js/korean.js?v=450',
    './js/le8-score.js?v=450',
    './js/milestone-helpers.js?v=450',
    './js/monthly-mvp-reward.js?v=450',
    './js/meditation-guide.js?v=450',
    './js/reward-market.js?v=450',
    ...
    './js/activity-days.js?v=450',
    './js/pwa-install.js?v=450',
    './js/media-hosts.js?v=450',
    './js/security.js?v=450',
    './js/community-stats-view.js?v=450',
    './js/social-challenge-readiness.js?v=450',
    './js/ui-helpers.js?v=450',
    './js/upload-performance.js?v=450',
    './js/video-thumbnail-quality.js?v=450',
    './js/browser-detect.js?v=450',
    './js/webview-detect.js?v=450',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
