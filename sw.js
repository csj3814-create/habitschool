...
const CACHE_NAME = 'habitschool-v387';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=387',
    './styles-base.css?v=387',
    './styles-en.css?v=387',
    './styles-features.css?v=387',
    './styles-reward-market.css?v=387',
    './styles-dashboard.css?v=387',
    './styles-dark-mode.css?v=387',
    './styles-reports.css?v=387',
    './styles-guest-demo.css?v=387',
    './js/main.js?v=387',
    './js/app.js?v=387',
    './js/app-core.js?v=387',
    './js/auth.js?v=387',
    './js/i18n.js?v=387',
    './js/app-mode.js?v=387',
    './js/auth-login-helpers.js?v=387',
    './js/blockchain-config.js?v=387',
    './js/blockchain-manager.js?v=387',
    './js/challenge-claim.js?v=387',
    './js/video-compress.js?v=387',
    './js/bug-report.js?v=387',
    './js/data-manager.js?v=387',
    './js/diet-program.js?v=387',
    './js/diet-analysis.js?v=387',
    './js/exercise-media.js?v=387',
    './js/firebase-config.js?v=387',
    './js/friendship-utils.js?v=387',
    './js/habit-groups.js?v=387',
    './js/health-connect-utils.js?v=387',
    './js/metabolic-score.js?v=387',
    './js/le8-score.js?v=387',
    './js/milestone-helpers.js?v=387',
    './js/monthly-mvp-reward.js?v=387',
    './js/meditation-guide.js?v=387',
    './js/reward-market.js?v=387',
    './js/guest-demo.js?v=387',
    './js/product-events.js?v=387',
    './js/activity-days.js?v=387',
    './js/pwa-install.js?v=387',
    './js/security.js?v=387',
    './js/community-stats-view.js?v=387',
    './js/social-challenge-readiness.js?v=387',
    './js/ui-helpers.js?v=387',
    './js/upload-performance.js?v=387',
    './js/video-thumbnail-quality.js?v=387',
    './js/browser-detect.js?v=387',
    './js/webview-detect.js?v=387',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
