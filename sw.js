...
const CACHE_NAME = 'habitschool-v350';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=350',
    './styles-base.css?v=350',
    './styles-en.css?v=350',
    './styles-features.css?v=350',
    './styles-reward-market.css?v=350',
    './styles-dashboard.css?v=350',
    './styles-dark-mode.css?v=350',
    './styles-reports.css?v=350',
    './styles-guest-demo.css?v=350',
    './js/main.js?v=350',
    './js/app.js?v=350',
    './js/app-core.js?v=350',
    './js/auth.js?v=350',
    './js/i18n.js?v=350',
    './js/app-mode.js?v=350',
    './js/auth-login-helpers.js?v=350',
    './js/blockchain-config.js?v=350',
    './js/blockchain-manager.js?v=350',
    './js/challenge-claim.js?v=350',
    './js/video-compress.js?v=350',
    './js/bug-report.js?v=350',
    './js/data-manager.js?v=350',
    './js/diet-program.js?v=350',
    './js/diet-analysis.js?v=350',
    './js/exercise-media.js?v=350',
    './js/firebase-config.js?v=350',
    './js/friendship-utils.js?v=350',
    './js/habit-groups.js?v=350',
    './js/health-connect-utils.js?v=350',
    './js/metabolic-score.js?v=350',
    './js/le8-score.js?v=350',
    './js/milestone-helpers.js?v=350',
    './js/monthly-mvp-reward.js?v=350',
    './js/meditation-guide.js?v=350',
    './js/reward-market.js?v=350',
    './js/guest-demo.js?v=350',
    './js/product-events.js?v=350',
    './js/activity-days.js?v=350',
    './js/pwa-install.js?v=350',
    './js/security.js?v=350',
    './js/social-challenge-readiness.js?v=350',
    './js/ui-helpers.js?v=350',
    './js/upload-performance.js?v=350',
    './js/video-thumbnail-quality.js?v=350',
    './js/webview-detect.js?v=350',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
