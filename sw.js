...
const CACHE_NAME = 'habitschool-v376';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=376',
    './styles-base.css?v=376',
    './styles-en.css?v=376',
    './styles-features.css?v=376',
    './styles-reward-market.css?v=376',
    './styles-dashboard.css?v=376',
    './styles-dark-mode.css?v=376',
    './styles-reports.css?v=376',
    './styles-guest-demo.css?v=376',
    './js/main.js?v=376',
    './js/app.js?v=376',
    './js/app-core.js?v=376',
    './js/auth.js?v=376',
    './js/i18n.js?v=376',
    './js/app-mode.js?v=376',
    './js/auth-login-helpers.js?v=376',
    './js/blockchain-config.js?v=376',
    './js/blockchain-manager.js?v=376',
    './js/challenge-claim.js?v=376',
    './js/video-compress.js?v=376',
    './js/bug-report.js?v=376',
    './js/data-manager.js?v=376',
    './js/diet-program.js?v=376',
    './js/diet-analysis.js?v=376',
    './js/exercise-media.js?v=376',
    './js/firebase-config.js?v=376',
    './js/friendship-utils.js?v=376',
    './js/habit-groups.js?v=376',
    './js/health-connect-utils.js?v=376',
    './js/metabolic-score.js?v=376',
    './js/le8-score.js?v=376',
    './js/milestone-helpers.js?v=376',
    './js/monthly-mvp-reward.js?v=376',
    './js/meditation-guide.js?v=376',
    './js/reward-market.js?v=376',
    './js/guest-demo.js?v=376',
    './js/product-events.js?v=376',
    './js/activity-days.js?v=376',
    './js/pwa-install.js?v=376',
    './js/security.js?v=376',
    './js/community-stats-view.js?v=376',
    './js/social-challenge-readiness.js?v=376',
    './js/ui-helpers.js?v=376',
    './js/upload-performance.js?v=376',
    './js/video-thumbnail-quality.js?v=376',
    './js/webview-detect.js?v=376',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
