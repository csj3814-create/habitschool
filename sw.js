...
const CACHE_NAME = 'habitschool-v179';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=179',
    './styles-base.css?v=179',
    './styles-features.css?v=179',
    './styles-reward-market.css?v=179',
    './styles-dashboard.css?v=179',
    './styles-dark-mode.css?v=179',
    './styles-reports.css?v=179',
    './js/main.js?v=179',
    './js/app.js?v=179',
    './js/app-core.js?v=179',
    './js/auth.js?v=179',
    './js/app-mode.js?v=179',
    './js/auth-login-helpers.js?v=179',
    './js/blockchain-config.js?v=179',
    './js/blockchain-manager.js?v=179',
    './js/data-manager.js?v=179',
    './js/diet-program.js?v=179',
    './js/diet-analysis.js?v=179',
    './js/exercise-media.js?v=179',
    './js/firebase-config.js?v=179',
    './js/health-connect-utils.js?v=179',
    './js/metabolic-score.js?v=179',
    './js/milestone-helpers.js?v=179',
    './js/monthly-mvp-reward.js?v=179',
    './js/pwa-install.js?v=179',
    './js/security.js?v=179',
    './js/social-challenge-readiness.js?v=179',
    './js/ui-helpers.js?v=179',
    './js/upload-performance.js?v=179',
    './js/webview-detect.js?v=179',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
