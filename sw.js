...
const CACHE_NAME = 'habitschool-v210';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=210',
    './styles-base.css?v=210',
    './styles-features.css?v=210',
    './styles-reward-market.css?v=210',
    './styles-dashboard.css?v=210',
    './styles-dark-mode.css?v=210',
    './styles-reports.css?v=210',
    './js/main.js?v=210',
    './js/app.js?v=210',
    './js/app-core.js?v=210',
    './js/auth.js?v=210',
    './js/app-mode.js?v=210',
    './js/auth-login-helpers.js?v=210',
    './js/blockchain-config.js?v=210',
    './js/blockchain-manager.js?v=210',
    './js/data-manager.js?v=210',
    './js/diet-program.js?v=210',
    './js/diet-analysis.js?v=210',
    './js/exercise-media.js?v=210',
    './js/firebase-config.js?v=210',
    './js/habit-groups.js?v=210',
    './js/health-connect-utils.js?v=210',
    './js/metabolic-score.js?v=210',
    './js/milestone-helpers.js?v=210',
    './js/monthly-mvp-reward.js?v=210',
    './js/pwa-install.js?v=210',
    './js/security.js?v=210',
    './js/social-challenge-readiness.js?v=210',
    './js/ui-helpers.js?v=210',
    './js/upload-performance.js?v=210',
    './js/webview-detect.js?v=210',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
