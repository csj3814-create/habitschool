...
const CACHE_NAME = 'habitschool-v204';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=204',
    './styles-base.css?v=204',
    './styles-features.css?v=204',
    './styles-reward-market.css?v=204',
    './styles-dashboard.css?v=204',
    './styles-dark-mode.css?v=204',
    './styles-reports.css?v=204',
    './js/main.js?v=204',
    './js/app.js?v=204',
    './js/app-core.js?v=204',
    './js/auth.js?v=204',
    './js/app-mode.js?v=204',
    './js/auth-login-helpers.js?v=204',
    './js/blockchain-config.js?v=204',
    './js/blockchain-manager.js?v=204',
    './js/data-manager.js?v=204',
    './js/diet-program.js?v=204',
    './js/diet-analysis.js?v=204',
    './js/exercise-media.js?v=204',
    './js/firebase-config.js?v=204',
    './js/habit-groups.js?v=204',
    './js/health-connect-utils.js?v=204',
    './js/metabolic-score.js?v=204',
    './js/milestone-helpers.js?v=204',
    './js/monthly-mvp-reward.js?v=204',
    './js/pwa-install.js?v=204',
    './js/security.js?v=204',
    './js/social-challenge-readiness.js?v=204',
    './js/ui-helpers.js?v=204',
    './js/upload-performance.js?v=204',
    './js/webview-detect.js?v=204',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
