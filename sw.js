...
const CACHE_NAME = 'habitschool-v358';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=358',
    './styles-base.css?v=358',
    './styles-en.css?v=358',
    './styles-features.css?v=358',
    './styles-reward-market.css?v=358',
    './styles-dashboard.css?v=358',
    './styles-dark-mode.css?v=358',
    './styles-reports.css?v=358',
    './styles-guest-demo.css?v=358',
    './js/main.js?v=358',
    './js/app.js?v=358',
    './js/app-core.js?v=358',
    './js/auth.js?v=358',
    './js/i18n.js?v=358',
    './js/app-mode.js?v=358',
    './js/auth-login-helpers.js?v=358',
    './js/blockchain-config.js?v=358',
    './js/blockchain-manager.js?v=358',
    './js/challenge-claim.js?v=358',
    './js/video-compress.js?v=358',
    './js/bug-report.js?v=358',
    './js/data-manager.js?v=358',
    './js/diet-program.js?v=358',
    './js/diet-analysis.js?v=358',
    './js/exercise-media.js?v=358',
    './js/firebase-config.js?v=358',
    './js/friendship-utils.js?v=358',
    './js/habit-groups.js?v=358',
    './js/health-connect-utils.js?v=358',
    './js/metabolic-score.js?v=358',
    './js/le8-score.js?v=358',
    './js/milestone-helpers.js?v=358',
    './js/monthly-mvp-reward.js?v=358',
    './js/meditation-guide.js?v=358',
    './js/reward-market.js?v=358',
    './js/guest-demo.js?v=358',
    './js/product-events.js?v=358',
    './js/activity-days.js?v=358',
    './js/pwa-install.js?v=358',
    './js/security.js?v=358',
    './js/community-stats-view.js?v=358',
    './js/social-challenge-readiness.js?v=358',
    './js/ui-helpers.js?v=358',
    './js/upload-performance.js?v=358',
    './js/video-thumbnail-quality.js?v=358',
    './js/webview-detect.js?v=358',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
