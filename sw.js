...
const CACHE_NAME = 'habitschool-v206';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=206',
    './styles-base.css?v=206',
    './styles-features.css?v=206',
    './styles-reward-market.css?v=206',
    './styles-dashboard.css?v=206',
    './styles-dark-mode.css?v=206',
    './styles-reports.css?v=206',
    './js/main.js?v=206',
    './js/app.js?v=206',
    './js/app-core.js?v=206',
    './js/auth.js?v=206',
    './js/app-mode.js?v=206',
    './js/auth-login-helpers.js?v=206',
    './js/blockchain-config.js?v=206',
    './js/blockchain-manager.js?v=206',
    './js/data-manager.js?v=206',
    './js/diet-program.js?v=206',
    './js/diet-analysis.js?v=206',
    './js/exercise-media.js?v=206',
    './js/firebase-config.js?v=206',
    './js/habit-groups.js?v=206',
    './js/health-connect-utils.js?v=206',
    './js/metabolic-score.js?v=206',
    './js/milestone-helpers.js?v=206',
    './js/monthly-mvp-reward.js?v=206',
    './js/pwa-install.js?v=206',
    './js/security.js?v=206',
    './js/social-challenge-readiness.js?v=206',
    './js/ui-helpers.js?v=206',
    './js/upload-performance.js?v=206',
    './js/webview-detect.js?v=206',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
