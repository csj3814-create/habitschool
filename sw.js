...
const CACHE_NAME = 'habitschool-v316';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=316',
    './styles-base.css?v=316',
    './styles-en.css?v=316',
    './styles-features.css?v=316',
    './styles-reward-market.css?v=316',
    './styles-dashboard.css?v=316',
    './styles-dark-mode.css?v=316',
    './styles-reports.css?v=316',
    './styles-guest-demo.css?v=316',
    './js/main.js?v=316',
    './js/app.js?v=316',
    './js/app-core.js?v=316',
    './js/auth.js?v=316',
    './js/i18n.js?v=316',
    './js/app-mode.js?v=316',
    './js/auth-login-helpers.js?v=316',
    './js/blockchain-config.js?v=316',
    './js/blockchain-manager.js?v=316',
    './js/challenge-claim.js?v=316',
    './js/data-manager.js?v=316',
    './js/diet-program.js?v=316',
    './js/diet-analysis.js?v=316',
    './js/exercise-media.js?v=316',
    './js/firebase-config.js?v=316',
    './js/friendship-utils.js?v=316',
    './js/habit-groups.js?v=316',
    './js/health-connect-utils.js?v=316',
    './js/metabolic-score.js?v=316',
    './js/milestone-helpers.js?v=316',
    './js/monthly-mvp-reward.js?v=316',
    './js/meditation-guide.js?v=316',
    './js/reward-market.js?v=316',
    './js/guest-demo.js?v=316',
    './js/product-events.js?v=316',
    './js/activity-days.js?v=316',
    './js/pwa-install.js?v=316',
    './js/security.js?v=316',
    './js/social-challenge-readiness.js?v=316',
    './js/ui-helpers.js?v=316',
    './js/upload-performance.js?v=316',
    './js/video-thumbnail-quality.js?v=316',
    './js/webview-detect.js?v=316',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
