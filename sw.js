...
const CACHE_NAME = 'habitschool-v432';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=432',
    './styles-base.css?v=432',
    './styles-en.css?v=432',
    './styles-features.css?v=432',
    './styles-reward-market.css?v=432',
    './styles-dashboard.css?v=432',
    './styles-dark-mode.css?v=432',
    './styles-reports.css?v=432',
    './styles-guest-demo.css?v=432',
    './js/main.js?v=432',
    './js/app.js?v=432',
    './js/app-core.js?v=432',
    './js/auth.js?v=432',
    './js/i18n.js?v=432',
    './js/app-mode.js?v=432',
    './js/auth-login-helpers.js?v=432',
    './js/blockchain-config.js?v=432',
    './js/blockchain-manager.js?v=432',
    './js/challenge-claim.js?v=432',
    './js/video-compress.js?v=432',
    './js/bug-report.js?v=432',
    './js/data-manager.js?v=432',
    './js/diet-program.js?v=432',
    './js/diet-analysis.js?v=432',
    './js/exercise-media.js?v=432',
    './js/firebase-config.js?v=432',
    './js/friendship-utils.js?v=432',
    './js/habit-groups.js?v=432',
    './js/health-connect-utils.js?v=432',
    './js/metabolic-score.js?v=432',
    './js/korean.js?v=432',
    './js/le8-score.js?v=432',
    './js/milestone-helpers.js?v=432',
    './js/monthly-mvp-reward.js?v=432',
    './js/meditation-guide.js?v=432',
    './js/reward-market.js?v=432',
    './js/guest-demo.js?v=432',
    './js/product-events.js?v=432',
    './js/activity-days.js?v=432',
    './js/pwa-install.js?v=432',
    './js/media-hosts.js?v=432',
    './js/security.js?v=432',
    './js/community-stats-view.js?v=432',
    './js/social-challenge-readiness.js?v=432',
    './js/ui-helpers.js?v=432',
    './js/upload-performance.js?v=432',
    './js/video-thumbnail-quality.js?v=432',
    './js/browser-detect.js?v=432',
    './js/webview-detect.js?v=432',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
