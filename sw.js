...
const CACHE_NAME = 'habitschool-v183';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=183',
    './styles-base.css?v=183',
    './styles-features.css?v=183',
    './styles-reward-market.css?v=183',
    './styles-dashboard.css?v=183',
    './styles-dark-mode.css?v=183',
    './styles-reports.css?v=183',
    './js/main.js?v=183',
    './js/app.js?v=183',
    './js/app-core.js?v=183',
    './js/auth.js?v=183',
    './js/app-mode.js?v=183',
    './js/auth-login-helpers.js?v=183',
    './js/blockchain-config.js?v=183',
    './js/blockchain-manager.js?v=183',
    './js/data-manager.js?v=183',
    './js/diet-program.js?v=183',
    './js/diet-analysis.js?v=183',
    './js/exercise-media.js?v=183',
    './js/firebase-config.js?v=183',
    './js/health-connect-utils.js?v=183',
    './js/metabolic-score.js?v=183',
    './js/milestone-helpers.js?v=183',
    './js/monthly-mvp-reward.js?v=183',
    './js/pwa-install.js?v=183',
    './js/security.js?v=183',
    './js/social-challenge-readiness.js?v=183',
    './js/ui-helpers.js?v=183',
    './js/upload-performance.js?v=183',
    './js/webview-detect.js?v=183',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
