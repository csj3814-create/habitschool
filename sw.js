...
const CACHE_NAME = 'habitschool-v168';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=168',
    './styles-base.css?v=168',
    './styles-features.css?v=168',
    './styles-dashboard.css?v=168',
    './styles-dark-mode.css?v=168',
    './styles-reports.css?v=168',
    './js/main.js?v=168',
    './js/app.js?v=168',
    './js/app-core.js?v=168',
    './js/auth.js?v=168',
    './js/app-mode.js?v=168',
    './js/auth-login-helpers.js?v=168',
    './js/blockchain-config.js?v=168',
    './js/blockchain-manager.js?v=168',
    './js/data-manager.js?v=168',
    './js/diet-program.js?v=168',
    './js/diet-analysis.js?v=168',
    './js/exercise-media.js?v=168',
    './js/firebase-config.js?v=168',
    './js/health-connect-utils.js?v=168',
    './js/metabolic-score.js?v=168',
    './js/milestone-helpers.js?v=168',
    './js/pwa-install.js?v=168',
    './js/security.js?v=168',
    './js/ui-helpers.js?v=168',
    './js/upload-performance.js?v=168',
    './js/webview-detect.js?v=168',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
