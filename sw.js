...
const CACHE_NAME = 'habitschool-v262';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=262',
    './styles-base.css?v=262',
    './styles-en.css?v=262',
    './styles-features.css?v=262',
    './styles-reward-market.css?v=262',
    './styles-dashboard.css?v=262',
    './styles-dark-mode.css?v=262',
    './styles-reports.css?v=262',
    './styles-guest-demo.css?v=262',
    './js/main.js?v=262',
    './js/app.js?v=262',
    './js/app-core.js?v=262',
    './js/auth.js?v=262',
    './js/i18n.js?v=262',
    './js/app-mode.js?v=262',
    './js/auth-login-helpers.js?v=262',
    './js/blockchain-config.js?v=262',
    './js/blockchain-manager.js?v=262',
    './js/data-manager.js?v=262',
    './js/diet-program.js?v=262',
    './js/diet-analysis.js?v=262',
    './js/exercise-media.js?v=262',
    './js/firebase-config.js?v=262',
    './js/friendship-utils.js?v=262',
    './js/habit-groups.js?v=262',
    './js/health-connect-utils.js?v=262',
    './js/metabolic-score.js?v=262',
    './js/milestone-helpers.js?v=262',
    './js/monthly-mvp-reward.js?v=262',
    './js/meditation-guide.js?v=262',
    './js/reward-market.js?v=262',
    './js/guest-demo.js?v=262',
    './js/product-events.js?v=262',
    './js/activity-days.js?v=262',
    './js/pwa-install.js?v=262',
    './js/security.js?v=262',
    './js/social-challenge-readiness.js?v=262',
    './js/ui-helpers.js?v=262',
    './js/upload-performance.js?v=262',
    './js/video-thumbnail-quality.js?v=262',
    './js/webview-detect.js?v=262',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
