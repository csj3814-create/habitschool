...
const CACHE_NAME = 'habitschool-v332';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=332',
    './styles-base.css?v=332',
    './styles-en.css?v=332',
    './styles-features.css?v=332',
    './styles-reward-market.css?v=332',
    './styles-dashboard.css?v=332',
    './styles-dark-mode.css?v=332',
    './styles-reports.css?v=332',
    './styles-guest-demo.css?v=332',
    './js/main.js?v=332',
    './js/app.js?v=332',
    './js/app-core.js?v=332',
    './js/auth.js?v=332',
    './js/i18n.js?v=332',
    './js/app-mode.js?v=332',
    './js/auth-login-helpers.js?v=332',
    './js/blockchain-config.js?v=332',
    './js/blockchain-manager.js?v=332',
    './js/challenge-claim.js?v=332',
    './js/video-compress.js?v=332',
    './js/data-manager.js?v=332',
    './js/diet-program.js?v=332',
    './js/diet-analysis.js?v=332',
    './js/exercise-media.js?v=332',
    './js/firebase-config.js?v=332',
    './js/friendship-utils.js?v=332',
    './js/habit-groups.js?v=332',
    './js/health-connect-utils.js?v=332',
    './js/metabolic-score.js?v=332',
    './js/milestone-helpers.js?v=332',
    './js/monthly-mvp-reward.js?v=332',
    './js/meditation-guide.js?v=332',
    './js/reward-market.js?v=332',
    './js/guest-demo.js?v=332',
    './js/product-events.js?v=332',
    './js/activity-days.js?v=332',
    './js/pwa-install.js?v=332',
    './js/security.js?v=332',
    './js/social-challenge-readiness.js?v=332',
    './js/ui-helpers.js?v=332',
    './js/upload-performance.js?v=332',
    './js/video-thumbnail-quality.js?v=332',
    './js/webview-detect.js?v=332',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
