...
const CACHE_NAME = 'habitschool-v352';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=352',
    './styles-base.css?v=352',
    './styles-en.css?v=352',
    './styles-features.css?v=352',
    './styles-reward-market.css?v=352',
    './styles-dashboard.css?v=352',
    './styles-dark-mode.css?v=352',
    './styles-reports.css?v=352',
    './styles-guest-demo.css?v=352',
    './js/main.js?v=352',
    './js/app.js?v=352',
    './js/app-core.js?v=352',
    './js/auth.js?v=352',
    './js/i18n.js?v=352',
    './js/app-mode.js?v=352',
    './js/auth-login-helpers.js?v=352',
    './js/blockchain-config.js?v=352',
    './js/blockchain-manager.js?v=352',
    './js/challenge-claim.js?v=352',
    './js/video-compress.js?v=352',
    './js/bug-report.js?v=352',
    './js/data-manager.js?v=352',
    './js/diet-program.js?v=352',
    './js/diet-analysis.js?v=352',
    './js/exercise-media.js?v=352',
    './js/firebase-config.js?v=352',
    './js/friendship-utils.js?v=352',
    './js/habit-groups.js?v=352',
    './js/health-connect-utils.js?v=352',
    './js/metabolic-score.js?v=352',
    './js/le8-score.js?v=352',
    './js/milestone-helpers.js?v=352',
    './js/monthly-mvp-reward.js?v=352',
    './js/meditation-guide.js?v=352',
    './js/reward-market.js?v=352',
    './js/guest-demo.js?v=352',
    './js/product-events.js?v=352',
    './js/activity-days.js?v=352',
    './js/pwa-install.js?v=352',
    './js/security.js?v=352',
    './js/community-stats-view.js?v=352',
    './js/social-challenge-readiness.js?v=352',
    './js/ui-helpers.js?v=352',
    './js/upload-performance.js?v=352',
    './js/video-thumbnail-quality.js?v=352',
    './js/webview-detect.js?v=352',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
