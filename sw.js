...
const CACHE_NAME = 'habitschool-v248';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=248',
    './styles-base.css?v=248',
    './styles-en.css?v=248',
    './styles-features.css?v=248',
    './styles-reward-market.css?v=248',
    './styles-dashboard.css?v=248',
    './styles-dark-mode.css?v=248',
    './styles-reports.css?v=248',
    './styles-guest-demo.css?v=248',
    './js/main.js?v=248',
    './js/app.js?v=248',
    './js/app-core.js?v=248',
    './js/auth.js?v=248',
    './js/i18n.js?v=248',
    './js/app-mode.js?v=248',
    './js/auth-login-helpers.js?v=248',
    './js/blockchain-config.js?v=248',
    './js/blockchain-manager.js?v=248',
    './js/data-manager.js?v=248',
    './js/diet-program.js?v=248',
    './js/diet-analysis.js?v=248',
    './js/exercise-media.js?v=248',
    './js/firebase-config.js?v=248',
    './js/friendship-utils.js?v=248',
    './js/habit-groups.js?v=248',
    './js/health-connect-utils.js?v=248',
    './js/metabolic-score.js?v=248',
    './js/milestone-helpers.js?v=248',
    './js/monthly-mvp-reward.js?v=248',
    './js/meditation-guide.js?v=248',
    './js/reward-market.js?v=248',
    './js/guest-demo.js?v=248',
    './js/product-events.js?v=248',
    './js/activity-days.js?v=248',
    './js/pwa-install.js?v=248',
    './js/security.js?v=248',
    './js/social-challenge-readiness.js?v=248',
    './js/ui-helpers.js?v=248',
    './js/upload-performance.js?v=248',
    './js/video-thumbnail-quality.js?v=248',
    './js/webview-detect.js?v=248',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
