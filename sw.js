...
const CACHE_NAME = 'habitschool-v431';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=431',
    './styles-base.css?v=431',
    './styles-en.css?v=431',
    './styles-features.css?v=431',
    './styles-reward-market.css?v=431',
    './styles-dashboard.css?v=431',
    './styles-dark-mode.css?v=431',
    './styles-reports.css?v=431',
    './styles-guest-demo.css?v=431',
    './js/main.js?v=431',
    './js/app.js?v=431',
    './js/app-core.js?v=431',
    './js/auth.js?v=431',
    './js/i18n.js?v=431',
    './js/app-mode.js?v=431',
    './js/auth-login-helpers.js?v=431',
    './js/blockchain-config.js?v=431',
    './js/blockchain-manager.js?v=431',
    './js/challenge-claim.js?v=431',
    './js/video-compress.js?v=431',
    './js/bug-report.js?v=431',
    './js/data-manager.js?v=431',
    './js/diet-program.js?v=431',
    './js/diet-analysis.js?v=431',
    './js/exercise-media.js?v=431',
    './js/firebase-config.js?v=431',
    './js/friendship-utils.js?v=431',
    './js/habit-groups.js?v=431',
    './js/health-connect-utils.js?v=431',
    './js/metabolic-score.js?v=431',
    './js/korean.js?v=431',
    './js/le8-score.js?v=431',
    './js/milestone-helpers.js?v=431',
    './js/monthly-mvp-reward.js?v=431',
    './js/meditation-guide.js?v=431',
    './js/reward-market.js?v=431',
    './js/guest-demo.js?v=431',
    './js/product-events.js?v=431',
    './js/activity-days.js?v=431',
    './js/pwa-install.js?v=431',
    './js/media-hosts.js?v=431',
    './js/security.js?v=431',
    './js/community-stats-view.js?v=431',
    './js/social-challenge-readiness.js?v=431',
    './js/ui-helpers.js?v=431',
    './js/upload-performance.js?v=431',
    './js/video-thumbnail-quality.js?v=431',
    './js/browser-detect.js?v=431',
    './js/webview-detect.js?v=431',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
