...
const CACHE_NAME = 'habitschool-v221';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=221',
    './styles-base.css?v=221',
    './styles-en.css?v=221',
    './styles-features.css?v=221',
    './styles-reward-market.css?v=221',
    './styles-dashboard.css?v=221',
    './styles-dark-mode.css?v=221',
    './styles-reports.css?v=221',
    './js/main.js?v=221',
    './js/app.js?v=221',
    './js/app-core.js?v=221',
    './js/auth.js?v=221',
    './js/i18n.js?v=221',
    './js/app-mode.js?v=221',
    './js/auth-login-helpers.js?v=221',
    './js/blockchain-config.js?v=221',
    './js/blockchain-manager.js?v=221',
    './js/data-manager.js?v=221',
    './js/diet-program.js?v=221',
    './js/diet-analysis.js?v=221',
    './js/exercise-media.js?v=221',
    './js/firebase-config.js?v=221',
    './js/habit-groups.js?v=221',
    './js/health-connect-utils.js?v=221',
    './js/metabolic-score.js?v=221',
    './js/milestone-helpers.js?v=221',
    './js/monthly-mvp-reward.js?v=221',
    './js/pwa-install.js?v=221',
    './js/security.js?v=221',
    './js/social-challenge-readiness.js?v=221',
    './js/ui-helpers.js?v=221',
    './js/upload-performance.js?v=221',
    './js/webview-detect.js?v=221',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
