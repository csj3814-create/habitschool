...
const CACHE_NAME = 'habitschool-v357';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=357',
    './styles-base.css?v=357',
    './styles-en.css?v=357',
    './styles-features.css?v=357',
    './styles-reward-market.css?v=357',
    './styles-dashboard.css?v=357',
    './styles-dark-mode.css?v=357',
    './styles-reports.css?v=357',
    './styles-guest-demo.css?v=357',
    './js/main.js?v=357',
    './js/app.js?v=357',
    './js/app-core.js?v=357',
    './js/auth.js?v=357',
    './js/i18n.js?v=357',
    './js/app-mode.js?v=357',
    './js/auth-login-helpers.js?v=357',
    './js/blockchain-config.js?v=357',
    './js/blockchain-manager.js?v=357',
    './js/challenge-claim.js?v=357',
    './js/video-compress.js?v=357',
    './js/bug-report.js?v=357',
    './js/data-manager.js?v=357',
    './js/diet-program.js?v=357',
    './js/diet-analysis.js?v=357',
    './js/exercise-media.js?v=357',
    './js/firebase-config.js?v=357',
    './js/friendship-utils.js?v=357',
    './js/habit-groups.js?v=357',
    './js/health-connect-utils.js?v=357',
    './js/metabolic-score.js?v=357',
    './js/le8-score.js?v=357',
    './js/milestone-helpers.js?v=357',
    './js/monthly-mvp-reward.js?v=357',
    './js/meditation-guide.js?v=357',
    './js/reward-market.js?v=357',
    './js/guest-demo.js?v=357',
    './js/product-events.js?v=357',
    './js/activity-days.js?v=357',
    './js/pwa-install.js?v=357',
    './js/security.js?v=357',
    './js/community-stats-view.js?v=357',
    './js/social-challenge-readiness.js?v=357',
    './js/ui-helpers.js?v=357',
    './js/upload-performance.js?v=357',
    './js/video-thumbnail-quality.js?v=357',
    './js/webview-detect.js?v=357',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
