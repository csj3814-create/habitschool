...
const CACHE_NAME = 'habitschool-v246';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=246',
    './styles-base.css?v=246',
    './styles-en.css?v=246',
    './styles-features.css?v=246',
    './styles-reward-market.css?v=246',
    './styles-dashboard.css?v=246',
    './styles-dark-mode.css?v=246',
    './styles-reports.css?v=246',
    './styles-guest-demo.css?v=246',
    './js/main.js?v=246',
    './js/app.js?v=246',
    './js/app-core.js?v=246',
    './js/auth.js?v=246',
    './js/i18n.js?v=246',
    './js/app-mode.js?v=246',
    './js/auth-login-helpers.js?v=246',
    './js/blockchain-config.js?v=246',
    './js/blockchain-manager.js?v=246',
    './js/data-manager.js?v=246',
    './js/diet-program.js?v=246',
    './js/diet-analysis.js?v=246',
    './js/exercise-media.js?v=246',
    './js/firebase-config.js?v=246',
    './js/friendship-utils.js?v=246',
    './js/habit-groups.js?v=246',
    './js/health-connect-utils.js?v=246',
    './js/metabolic-score.js?v=246',
    './js/milestone-helpers.js?v=246',
    './js/monthly-mvp-reward.js?v=246',
    './js/meditation-guide.js?v=246',
    './js/reward-market.js?v=246',
    './js/guest-demo.js?v=246',
    './js/product-events.js?v=246',
    './js/activity-days.js?v=246',
    './js/pwa-install.js?v=246',
    './js/security.js?v=246',
    './js/social-challenge-readiness.js?v=246',
    './js/ui-helpers.js?v=246',
    './js/upload-performance.js?v=246',
    './js/video-thumbnail-quality.js?v=246',
    './js/webview-detect.js?v=246',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
