...
const CACHE_NAME = 'habitschool-v404';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=404',
    './styles-base.css?v=404',
    './styles-en.css?v=404',
    './styles-features.css?v=404',
    './styles-reward-market.css?v=404',
    './styles-dashboard.css?v=404',
    './styles-dark-mode.css?v=404',
    './styles-reports.css?v=404',
    './styles-guest-demo.css?v=404',
    './js/main.js?v=404',
    './js/app.js?v=404',
    './js/app-core.js?v=404',
    './js/auth.js?v=404',
    './js/i18n.js?v=404',
    './js/app-mode.js?v=404',
    './js/auth-login-helpers.js?v=404',
    './js/blockchain-config.js?v=404',
    './js/blockchain-manager.js?v=404',
    './js/challenge-claim.js?v=404',
    './js/video-compress.js?v=404',
    './js/bug-report.js?v=404',
    './js/data-manager.js?v=404',
    './js/diet-program.js?v=404',
    './js/diet-analysis.js?v=404',
    './js/exercise-media.js?v=404',
    './js/firebase-config.js?v=404',
    './js/friendship-utils.js?v=404',
    './js/habit-groups.js?v=404',
    './js/health-connect-utils.js?v=404',
    './js/metabolic-score.js?v=404',
    './js/le8-score.js?v=404',
    './js/milestone-helpers.js?v=404',
    './js/monthly-mvp-reward.js?v=404',
    './js/meditation-guide.js?v=404',
    './js/reward-market.js?v=404',
    './js/guest-demo.js?v=404',
    './js/product-events.js?v=404',
    './js/activity-days.js?v=404',
    './js/pwa-install.js?v=404',
    './js/security.js?v=404',
    './js/community-stats-view.js?v=404',
    './js/social-challenge-readiness.js?v=404',
    './js/ui-helpers.js?v=404',
    './js/upload-performance.js?v=404',
    './js/video-thumbnail-quality.js?v=404',
    './js/browser-detect.js?v=404',
    './js/webview-detect.js?v=404',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
