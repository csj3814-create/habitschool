...
const CACHE_NAME = 'habitschool-v388';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=388',
    './styles-base.css?v=388',
    './styles-en.css?v=388',
    './styles-features.css?v=388',
    './styles-reward-market.css?v=388',
    './styles-dashboard.css?v=388',
    './styles-dark-mode.css?v=388',
    './styles-reports.css?v=388',
    './styles-guest-demo.css?v=388',
    './js/main.js?v=388',
    './js/app.js?v=388',
    './js/app-core.js?v=388',
    './js/auth.js?v=388',
    './js/i18n.js?v=388',
    './js/app-mode.js?v=388',
    './js/auth-login-helpers.js?v=388',
    './js/blockchain-config.js?v=388',
    './js/blockchain-manager.js?v=388',
    './js/challenge-claim.js?v=388',
    './js/video-compress.js?v=388',
    './js/bug-report.js?v=388',
    './js/data-manager.js?v=388',
    './js/diet-program.js?v=388',
    './js/diet-analysis.js?v=388',
    './js/exercise-media.js?v=388',
    './js/firebase-config.js?v=388',
    './js/friendship-utils.js?v=388',
    './js/habit-groups.js?v=388',
    './js/health-connect-utils.js?v=388',
    './js/metabolic-score.js?v=388',
    './js/le8-score.js?v=388',
    './js/milestone-helpers.js?v=388',
    './js/monthly-mvp-reward.js?v=388',
    './js/meditation-guide.js?v=388',
    './js/reward-market.js?v=388',
    './js/guest-demo.js?v=388',
    './js/product-events.js?v=388',
    './js/activity-days.js?v=388',
    './js/pwa-install.js?v=388',
    './js/security.js?v=388',
    './js/community-stats-view.js?v=388',
    './js/social-challenge-readiness.js?v=388',
    './js/ui-helpers.js?v=388',
    './js/upload-performance.js?v=388',
    './js/video-thumbnail-quality.js?v=388',
    './js/browser-detect.js?v=388',
    './js/webview-detect.js?v=388',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
