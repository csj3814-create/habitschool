...
const CACHE_NAME = 'habitschool-v393';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=393',
    './styles-base.css?v=393',
    './styles-en.css?v=393',
    './styles-features.css?v=393',
    './styles-reward-market.css?v=393',
    './styles-dashboard.css?v=393',
    './styles-dark-mode.css?v=393',
    './styles-reports.css?v=393',
    './styles-guest-demo.css?v=393',
    './js/main.js?v=393',
    './js/app.js?v=393',
    './js/app-core.js?v=393',
    './js/auth.js?v=393',
    './js/i18n.js?v=393',
    './js/app-mode.js?v=393',
    './js/auth-login-helpers.js?v=393',
    './js/blockchain-config.js?v=393',
    './js/blockchain-manager.js?v=393',
    './js/challenge-claim.js?v=393',
    './js/video-compress.js?v=393',
    './js/bug-report.js?v=393',
    './js/data-manager.js?v=393',
    './js/diet-program.js?v=393',
    './js/diet-analysis.js?v=393',
    './js/exercise-media.js?v=393',
    './js/firebase-config.js?v=393',
    './js/friendship-utils.js?v=393',
    './js/habit-groups.js?v=393',
    './js/health-connect-utils.js?v=393',
    './js/metabolic-score.js?v=393',
    './js/le8-score.js?v=393',
    './js/milestone-helpers.js?v=393',
    './js/monthly-mvp-reward.js?v=393',
    './js/meditation-guide.js?v=393',
    './js/reward-market.js?v=393',
    './js/guest-demo.js?v=393',
    './js/product-events.js?v=393',
    './js/activity-days.js?v=393',
    './js/pwa-install.js?v=393',
    './js/security.js?v=393',
    './js/community-stats-view.js?v=393',
    './js/social-challenge-readiness.js?v=393',
    './js/ui-helpers.js?v=393',
    './js/upload-performance.js?v=393',
    './js/video-thumbnail-quality.js?v=393',
    './js/browser-detect.js?v=393',
    './js/webview-detect.js?v=393',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
