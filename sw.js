...
const CACHE_NAME = 'habitschool-v186';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=186',
    './styles-base.css?v=186',
    './styles-features.css?v=186',
    './styles-reward-market.css?v=186',
    './styles-dashboard.css?v=186',
    './styles-dark-mode.css?v=186',
    './styles-reports.css?v=186',
    './js/main.js?v=186',
    './js/app.js?v=186',
    './js/app-core.js?v=186',
    './js/auth.js?v=186',
    './js/app-mode.js?v=186',
    './js/auth-login-helpers.js?v=186',
    './js/blockchain-config.js?v=186',
    './js/blockchain-manager.js?v=186',
    './js/data-manager.js?v=186',
    './js/diet-program.js?v=186',
    './js/diet-analysis.js?v=186',
    './js/exercise-media.js?v=186',
    './js/firebase-config.js?v=186',
    './js/health-connect-utils.js?v=186',
    './js/metabolic-score.js?v=186',
    './js/milestone-helpers.js?v=186',
    './js/monthly-mvp-reward.js?v=186',
    './js/pwa-install.js?v=186',
    './js/security.js?v=186',
    './js/social-challenge-readiness.js?v=186',
    './js/ui-helpers.js?v=186',
    './js/upload-performance.js?v=186',
    './js/webview-detect.js?v=186',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
