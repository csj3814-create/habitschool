...
const CACHE_NAME = 'habitschool-v418';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=418',
    './styles-base.css?v=418',
    './styles-en.css?v=418',
    './styles-features.css?v=418',
    './styles-reward-market.css?v=418',
    './styles-dashboard.css?v=418',
    './styles-dark-mode.css?v=418',
    './styles-reports.css?v=418',
    './styles-guest-demo.css?v=418',
    './js/main.js?v=418',
    './js/app.js?v=418',
    './js/app-core.js?v=418',
    './js/auth.js?v=418',
    './js/i18n.js?v=418',
    './js/app-mode.js?v=418',
    './js/auth-login-helpers.js?v=418',
    './js/blockchain-config.js?v=418',
    './js/blockchain-manager.js?v=418',
    './js/challenge-claim.js?v=418',
    './js/video-compress.js?v=418',
    './js/bug-report.js?v=418',
    './js/data-manager.js?v=418',
    './js/diet-program.js?v=418',
    './js/diet-analysis.js?v=418',
    './js/exercise-media.js?v=418',
    './js/firebase-config.js?v=418',
    './js/friendship-utils.js?v=418',
    './js/habit-groups.js?v=418',
    './js/health-connect-utils.js?v=418',
    './js/metabolic-score.js?v=418',
    './js/le8-score.js?v=418',
    './js/milestone-helpers.js?v=418',
    './js/monthly-mvp-reward.js?v=418',
    './js/meditation-guide.js?v=418',
    './js/reward-market.js?v=418',
    './js/guest-demo.js?v=418',
    './js/product-events.js?v=418',
    './js/activity-days.js?v=418',
    './js/pwa-install.js?v=418',
    './js/security.js?v=418',
    './js/community-stats-view.js?v=418',
    './js/social-challenge-readiness.js?v=418',
    './js/ui-helpers.js?v=418',
    './js/upload-performance.js?v=418',
    './js/video-thumbnail-quality.js?v=418',
    './js/browser-detect.js?v=418',
    './js/webview-detect.js?v=418',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
