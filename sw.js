...
const CACHE_NAME = 'habitschool-v244';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=244',
    './styles-base.css?v=244',
    './styles-en.css?v=244',
    './styles-features.css?v=244',
    './styles-reward-market.css?v=244',
    './styles-dashboard.css?v=244',
    './styles-dark-mode.css?v=244',
    './styles-reports.css?v=244',
    './styles-guest-demo.css?v=244',
    './js/main.js?v=244',
    './js/app.js?v=244',
    './js/app-core.js?v=244',
    './js/auth.js?v=244',
    './js/i18n.js?v=244',
    './js/app-mode.js?v=244',
    './js/auth-login-helpers.js?v=244',
    './js/blockchain-config.js?v=244',
    './js/blockchain-manager.js?v=244',
    './js/data-manager.js?v=244',
    './js/diet-program.js?v=244',
    './js/diet-analysis.js?v=244',
    './js/exercise-media.js?v=244',
    './js/firebase-config.js?v=244',
    './js/friendship-utils.js?v=244',
    './js/habit-groups.js?v=244',
    './js/health-connect-utils.js?v=244',
    './js/metabolic-score.js?v=244',
    './js/milestone-helpers.js?v=244',
    './js/monthly-mvp-reward.js?v=244',
    './js/meditation-guide.js?v=244',
    './js/reward-market.js?v=244',
    './js/guest-demo.js?v=244',
    './js/product-events.js?v=244',
    './js/activity-days.js?v=244',
    './js/pwa-install.js?v=244',
    './js/security.js?v=244',
    './js/social-challenge-readiness.js?v=244',
    './js/ui-helpers.js?v=244',
    './js/upload-performance.js?v=244',
    './js/video-thumbnail-quality.js?v=244',
    './js/webview-detect.js?v=244',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
