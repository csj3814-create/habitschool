...
const CACHE_NAME = 'habitschool-v172';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=172',
    './styles-base.css?v=172',
    './styles-features.css?v=172',
    './styles-dashboard.css?v=172',
    './styles-dark-mode.css?v=172',
    './styles-reports.css?v=172',
    './js/main.js?v=172',
    './js/app.js?v=172',
    './js/app-core.js?v=172',
    './js/auth.js?v=172',
    './js/app-mode.js?v=172',
    './js/auth-login-helpers.js?v=172',
    './js/blockchain-config.js?v=172',
    './js/blockchain-manager.js?v=172',
    './js/data-manager.js?v=172',
    './js/diet-program.js?v=172',
    './js/diet-analysis.js?v=172',
    './js/exercise-media.js?v=172',
    './js/firebase-config.js?v=172',
    './js/health-connect-utils.js?v=172',
    './js/metabolic-score.js?v=172',
    './js/milestone-helpers.js?v=172',
    './js/pwa-install.js?v=172',
    './js/security.js?v=172',
    './js/ui-helpers.js?v=172',
    './js/upload-performance.js?v=172',
    './js/webview-detect.js?v=172',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
