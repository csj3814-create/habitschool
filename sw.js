...
const CACHE_NAME = 'habitschool-v343';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=343',
    './styles-base.css?v=343',
    './styles-en.css?v=343',
    './styles-features.css?v=343',
    './styles-reward-market.css?v=343',
    './styles-dashboard.css?v=343',
    './styles-dark-mode.css?v=343',
    './styles-reports.css?v=343',
    './styles-guest-demo.css?v=343',
    './js/main.js?v=343',
    './js/app.js?v=343',
    './js/app-core.js?v=343',
    './js/auth.js?v=343',
    './js/i18n.js?v=343',
    './js/app-mode.js?v=343',
    './js/auth-login-helpers.js?v=343',
    './js/blockchain-config.js?v=343',
    './js/blockchain-manager.js?v=343',
    './js/challenge-claim.js?v=343',
    './js/video-compress.js?v=343',
    './js/bug-report.js?v=343',
    './js/data-manager.js?v=343',
    './js/diet-program.js?v=343',
    './js/diet-analysis.js?v=343',
    './js/exercise-media.js?v=343',
    './js/firebase-config.js?v=343',
    './js/friendship-utils.js?v=343',
    './js/habit-groups.js?v=343',
    './js/health-connect-utils.js?v=343',
    './js/metabolic-score.js?v=343',
    './js/le8-score.js?v=343',
    './js/milestone-helpers.js?v=343',
    './js/monthly-mvp-reward.js?v=343',
    './js/meditation-guide.js?v=343',
    './js/reward-market.js?v=343',
    './js/guest-demo.js?v=343',
    './js/product-events.js?v=343',
    './js/activity-days.js?v=343',
    './js/pwa-install.js?v=343',
    './js/security.js?v=343',
    './js/social-challenge-readiness.js?v=343',
    './js/ui-helpers.js?v=343',
    './js/upload-performance.js?v=343',
    './js/video-thumbnail-quality.js?v=343',
    './js/webview-detect.js?v=343',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
