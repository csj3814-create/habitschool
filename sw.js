...
const CACHE_NAME = 'habitschool-v447';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=447',
    './styles-base.css?v=447',
    './styles-en.css?v=447',
    './styles-features.css?v=447',
    './styles-reward-market.css?v=447',
    './styles-dashboard.css?v=447',
    './styles-dark-mode.css?v=447',
    './styles-reports.css?v=447',
    './styles-guest-demo.css?v=447',
    './js/main.js?v=447',
    './js/app.js?v=447',
    './js/app-core.js?v=447',
    './js/auth.js?v=447',
    './js/i18n.js?v=447',
    './js/app-mode.js?v=447',
    './js/auth-login-helpers.js?v=447',
    './js/blockchain-config.js?v=447',
    './js/blockchain-manager.js?v=447',
    './js/challenge-claim.js?v=447',
    './js/video-compress.js?v=447',
    './js/bug-report.js?v=447',
    './js/data-manager.js?v=447',
    './js/diet-program.js?v=447',
    './js/diet-analysis.js?v=447',
    './js/exercise-media.js?v=447',
    './js/firebase-config.js?v=447',
    './js/friendship-utils.js?v=447',
    './js/habit-groups.js?v=447',
    './js/health-connect-utils.js?v=447',
    './js/metabolic-score.js?v=447',
    './js/korean.js?v=447',
    './js/le8-score.js?v=447',
    './js/milestone-helpers.js?v=447',
    './js/monthly-mvp-reward.js?v=447',
    './js/meditation-guide.js?v=447',
    './js/reward-market.js?v=447',
    './js/body-composition-csv.js?v=447',
    './js/mission-gate.js?v=447',
    './js/health-connect-body.js?v=447',
    './js/reward-pace.js?v=447',
    './js/guest-demo.js?v=447',
    './js/product-events.js?v=447',
    './js/activity-days.js?v=447',
    './js/pwa-install.js?v=447',
    './js/media-hosts.js?v=447',
    './js/security.js?v=447',
    './js/community-stats-view.js?v=447',
    './js/social-challenge-readiness.js?v=447',
    './js/ui-helpers.js?v=447',
    './js/upload-performance.js?v=447',
    './js/video-thumbnail-quality.js?v=447',
    './js/browser-detect.js?v=447',
    './js/webview-detect.js?v=447',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
