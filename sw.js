...
const CACHE_NAME = 'habitschool-v379';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=379',
    './styles-base.css?v=379',
    './styles-en.css?v=379',
    './styles-features.css?v=379',
    './styles-reward-market.css?v=379',
    './styles-dashboard.css?v=379',
    './styles-dark-mode.css?v=379',
    './styles-reports.css?v=379',
    './styles-guest-demo.css?v=379',
    './js/main.js?v=379',
    './js/app.js?v=379',
    './js/app-core.js?v=379',
    './js/auth.js?v=379',
    './js/i18n.js?v=379',
    './js/app-mode.js?v=379',
    './js/auth-login-helpers.js?v=379',
    './js/blockchain-config.js?v=379',
    './js/blockchain-manager.js?v=379',
    './js/challenge-claim.js?v=379',
    './js/video-compress.js?v=379',
    './js/bug-report.js?v=379',
    './js/data-manager.js?v=379',
    './js/diet-program.js?v=379',
    './js/diet-analysis.js?v=379',
    './js/exercise-media.js?v=379',
    './js/firebase-config.js?v=379',
    './js/friendship-utils.js?v=379',
    './js/habit-groups.js?v=379',
    './js/health-connect-utils.js?v=379',
    './js/metabolic-score.js?v=379',
    './js/le8-score.js?v=379',
    './js/milestone-helpers.js?v=379',
    './js/monthly-mvp-reward.js?v=379',
    './js/meditation-guide.js?v=379',
    './js/reward-market.js?v=379',
    './js/guest-demo.js?v=379',
    './js/product-events.js?v=379',
    './js/activity-days.js?v=379',
    './js/pwa-install.js?v=379',
    './js/security.js?v=379',
    './js/community-stats-view.js?v=379',
    './js/social-challenge-readiness.js?v=379',
    './js/ui-helpers.js?v=379',
    './js/upload-performance.js?v=379',
    './js/video-thumbnail-quality.js?v=379',
    './js/webview-detect.js?v=379',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
