...
const CACHE_NAME = 'habitschool-v375';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=375',
    './styles-base.css?v=375',
    './styles-en.css?v=375',
    './styles-features.css?v=375',
    './styles-reward-market.css?v=375',
    './styles-dashboard.css?v=375',
    './styles-dark-mode.css?v=375',
    './styles-reports.css?v=375',
    './styles-guest-demo.css?v=375',
    './js/main.js?v=375',
    './js/app.js?v=375',
    './js/app-core.js?v=375',
    './js/auth.js?v=375',
    './js/i18n.js?v=375',
    './js/app-mode.js?v=375',
    './js/auth-login-helpers.js?v=375',
    './js/blockchain-config.js?v=375',
    './js/blockchain-manager.js?v=375',
    './js/challenge-claim.js?v=375',
    './js/video-compress.js?v=375',
    './js/bug-report.js?v=375',
    './js/data-manager.js?v=375',
    './js/diet-program.js?v=375',
    './js/diet-analysis.js?v=375',
    './js/exercise-media.js?v=375',
    './js/firebase-config.js?v=375',
    './js/friendship-utils.js?v=375',
    './js/habit-groups.js?v=375',
    './js/health-connect-utils.js?v=375',
    './js/metabolic-score.js?v=375',
    './js/le8-score.js?v=375',
    './js/milestone-helpers.js?v=375',
    './js/monthly-mvp-reward.js?v=375',
    './js/meditation-guide.js?v=375',
    './js/reward-market.js?v=375',
    './js/guest-demo.js?v=375',
    './js/product-events.js?v=375',
    './js/activity-days.js?v=375',
    './js/pwa-install.js?v=375',
    './js/security.js?v=375',
    './js/community-stats-view.js?v=375',
    './js/social-challenge-readiness.js?v=375',
    './js/ui-helpers.js?v=375',
    './js/upload-performance.js?v=375',
    './js/video-thumbnail-quality.js?v=375',
    './js/webview-detect.js?v=375',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
