...
const CACHE_NAME = 'habitschool-v326';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=326',
    './styles-base.css?v=326',
    './styles-en.css?v=326',
    './styles-features.css?v=326',
    './styles-reward-market.css?v=326',
    './styles-dashboard.css?v=326',
    './styles-dark-mode.css?v=326',
    './styles-reports.css?v=326',
    './styles-guest-demo.css?v=326',
    './js/main.js?v=326',
    './js/app.js?v=326',
    './js/app-core.js?v=326',
    './js/auth.js?v=326',
    './js/i18n.js?v=326',
    './js/app-mode.js?v=326',
    './js/auth-login-helpers.js?v=326',
    './js/blockchain-config.js?v=326',
    './js/blockchain-manager.js?v=326',
    './js/challenge-claim.js?v=326',
    './js/data-manager.js?v=326',
    './js/diet-program.js?v=326',
    './js/diet-analysis.js?v=326',
    './js/exercise-media.js?v=326',
    './js/firebase-config.js?v=326',
    './js/friendship-utils.js?v=326',
    './js/habit-groups.js?v=326',
    './js/health-connect-utils.js?v=326',
    './js/metabolic-score.js?v=326',
    './js/milestone-helpers.js?v=326',
    './js/monthly-mvp-reward.js?v=326',
    './js/meditation-guide.js?v=326',
    './js/reward-market.js?v=326',
    './js/guest-demo.js?v=326',
    './js/product-events.js?v=326',
    './js/activity-days.js?v=326',
    './js/pwa-install.js?v=326',
    './js/security.js?v=326',
    './js/social-challenge-readiness.js?v=326',
    './js/ui-helpers.js?v=326',
    './js/upload-performance.js?v=326',
    './js/video-thumbnail-quality.js?v=326',
    './js/webview-detect.js?v=326',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
