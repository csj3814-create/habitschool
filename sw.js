...
const CACHE_NAME = 'habitschool-v327';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=327',
    './styles-base.css?v=327',
    './styles-en.css?v=327',
    './styles-features.css?v=327',
    './styles-reward-market.css?v=327',
    './styles-dashboard.css?v=327',
    './styles-dark-mode.css?v=327',
    './styles-reports.css?v=327',
    './styles-guest-demo.css?v=327',
    './js/main.js?v=327',
    './js/app.js?v=327',
    './js/app-core.js?v=327',
    './js/auth.js?v=327',
    './js/i18n.js?v=327',
    './js/app-mode.js?v=327',
    './js/auth-login-helpers.js?v=327',
    './js/blockchain-config.js?v=327',
    './js/blockchain-manager.js?v=327',
    './js/challenge-claim.js?v=327',
    './js/video-compress.js?v=327',
    './js/data-manager.js?v=327',
    './js/diet-program.js?v=327',
    './js/diet-analysis.js?v=327',
    './js/exercise-media.js?v=327',
    './js/firebase-config.js?v=327',
    './js/friendship-utils.js?v=327',
    './js/habit-groups.js?v=327',
    './js/health-connect-utils.js?v=327',
    './js/metabolic-score.js?v=327',
    './js/milestone-helpers.js?v=327',
    './js/monthly-mvp-reward.js?v=327',
    './js/meditation-guide.js?v=327',
    './js/reward-market.js?v=327',
    './js/guest-demo.js?v=327',
    './js/product-events.js?v=327',
    './js/activity-days.js?v=327',
    './js/pwa-install.js?v=327',
    './js/security.js?v=327',
    './js/social-challenge-readiness.js?v=327',
    './js/ui-helpers.js?v=327',
    './js/upload-performance.js?v=327',
    './js/video-thumbnail-quality.js?v=327',
    './js/webview-detect.js?v=327',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
