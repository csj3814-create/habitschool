...
const CACHE_NAME = 'habitschool-v258';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=258',
    './styles-base.css?v=258',
    './styles-en.css?v=258',
    './styles-features.css?v=258',
    './styles-reward-market.css?v=258',
    './styles-dashboard.css?v=258',
    './styles-dark-mode.css?v=258',
    './styles-reports.css?v=258',
    './styles-guest-demo.css?v=258',
    './js/main.js?v=258',
    './js/app.js?v=258',
    './js/app-core.js?v=258',
    './js/auth.js?v=258',
    './js/i18n.js?v=258',
    './js/app-mode.js?v=258',
    './js/auth-login-helpers.js?v=258',
    './js/blockchain-config.js?v=258',
    './js/blockchain-manager.js?v=258',
    './js/data-manager.js?v=258',
    './js/diet-program.js?v=258',
    './js/diet-analysis.js?v=258',
    './js/exercise-media.js?v=258',
    './js/firebase-config.js?v=258',
    './js/friendship-utils.js?v=258',
    './js/habit-groups.js?v=258',
    './js/health-connect-utils.js?v=258',
    './js/metabolic-score.js?v=258',
    './js/milestone-helpers.js?v=258',
    './js/monthly-mvp-reward.js?v=258',
    './js/meditation-guide.js?v=258',
    './js/reward-market.js?v=258',
    './js/guest-demo.js?v=258',
    './js/product-events.js?v=258',
    './js/activity-days.js?v=258',
    './js/pwa-install.js?v=258',
    './js/security.js?v=258',
    './js/social-challenge-readiness.js?v=258',
    './js/ui-helpers.js?v=258',
    './js/upload-performance.js?v=258',
    './js/video-thumbnail-quality.js?v=258',
    './js/webview-detect.js?v=258',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
