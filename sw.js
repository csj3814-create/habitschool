...
const CACHE_NAME = 'habitschool-v274';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=274',
    './styles-base.css?v=274',
    './styles-en.css?v=274',
    './styles-features.css?v=274',
    './styles-reward-market.css?v=274',
    './styles-dashboard.css?v=274',
    './styles-dark-mode.css?v=274',
    './styles-reports.css?v=274',
    './styles-guest-demo.css?v=274',
    './js/main.js?v=274',
    './js/app.js?v=274',
    './js/app-core.js?v=274',
    './js/auth.js?v=274',
    './js/i18n.js?v=274',
    './js/app-mode.js?v=274',
    './js/auth-login-helpers.js?v=274',
    './js/blockchain-config.js?v=274',
    './js/blockchain-manager.js?v=274',
    './js/data-manager.js?v=274',
    './js/diet-program.js?v=274',
    './js/diet-analysis.js?v=274',
    './js/exercise-media.js?v=274',
    './js/firebase-config.js?v=274',
    './js/friendship-utils.js?v=274',
    './js/habit-groups.js?v=274',
    './js/health-connect-utils.js?v=274',
    './js/metabolic-score.js?v=274',
    './js/milestone-helpers.js?v=274',
    './js/monthly-mvp-reward.js?v=274',
    './js/meditation-guide.js?v=274',
    './js/reward-market.js?v=274',
    './js/guest-demo.js?v=274',
    './js/product-events.js?v=274',
    './js/activity-days.js?v=274',
    './js/pwa-install.js?v=274',
    './js/security.js?v=274',
    './js/social-challenge-readiness.js?v=274',
    './js/ui-helpers.js?v=274',
    './js/upload-performance.js?v=274',
    './js/video-thumbnail-quality.js?v=274',
    './js/webview-detect.js?v=274',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
