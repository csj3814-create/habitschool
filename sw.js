...
const CACHE_NAME = 'habitschool-v180';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=180',
    './styles-base.css?v=180',
    './styles-features.css?v=180',
    './styles-reward-market.css?v=180',
    './styles-dashboard.css?v=180',
    './styles-dark-mode.css?v=180',
    './styles-reports.css?v=180',
    './js/main.js?v=180',
    './js/app.js?v=180',
    './js/app-core.js?v=180',
    './js/auth.js?v=180',
    './js/app-mode.js?v=180',
    './js/auth-login-helpers.js?v=180',
    './js/blockchain-config.js?v=180',
    './js/blockchain-manager.js?v=180',
    './js/data-manager.js?v=180',
    './js/diet-program.js?v=180',
    './js/diet-analysis.js?v=180',
    './js/exercise-media.js?v=180',
    './js/firebase-config.js?v=180',
    './js/health-connect-utils.js?v=180',
    './js/metabolic-score.js?v=180',
    './js/milestone-helpers.js?v=180',
    './js/monthly-mvp-reward.js?v=180',
    './js/pwa-install.js?v=180',
    './js/security.js?v=180',
    './js/social-challenge-readiness.js?v=180',
    './js/ui-helpers.js?v=180',
    './js/upload-performance.js?v=180',
    './js/webview-detect.js?v=180',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
