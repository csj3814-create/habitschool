...
const CACHE_NAME = 'habitschool-v351';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=351',
    './styles-base.css?v=351',
    './styles-en.css?v=351',
    './styles-features.css?v=351',
    './styles-reward-market.css?v=351',
    './styles-dashboard.css?v=351',
    './styles-dark-mode.css?v=351',
    './styles-reports.css?v=351',
    './styles-guest-demo.css?v=351',
    './js/main.js?v=351',
    './js/app.js?v=351',
    './js/app-core.js?v=351',
    './js/auth.js?v=351',
    './js/i18n.js?v=351',
    './js/app-mode.js?v=351',
    './js/auth-login-helpers.js?v=351',
    './js/blockchain-config.js?v=351',
    './js/blockchain-manager.js?v=351',
    './js/challenge-claim.js?v=351',
    './js/video-compress.js?v=351',
    './js/bug-report.js?v=351',
    './js/data-manager.js?v=351',
    './js/diet-program.js?v=351',
    './js/diet-analysis.js?v=351',
    './js/exercise-media.js?v=351',
    './js/firebase-config.js?v=351',
    './js/friendship-utils.js?v=351',
    './js/habit-groups.js?v=351',
    './js/health-connect-utils.js?v=351',
    './js/metabolic-score.js?v=351',
    './js/le8-score.js?v=351',
    './js/milestone-helpers.js?v=351',
    './js/monthly-mvp-reward.js?v=351',
    './js/meditation-guide.js?v=351',
    './js/reward-market.js?v=351',
    './js/guest-demo.js?v=351',
    './js/product-events.js?v=351',
    './js/activity-days.js?v=351',
    './js/pwa-install.js?v=351',
    './js/security.js?v=351',
    './js/community-stats-view.js?v=351',
    './js/social-challenge-readiness.js?v=351',
    './js/ui-helpers.js?v=351',
    './js/upload-performance.js?v=351',
    './js/video-thumbnail-quality.js?v=351',
    './js/webview-detect.js?v=351',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
