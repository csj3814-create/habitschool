...
const CACHE_NAME = 'habitschool-v293';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=293',
    './styles-base.css?v=293',
    './styles-en.css?v=293',
    './styles-features.css?v=293',
    './styles-reward-market.css?v=293',
    './styles-dashboard.css?v=293',
    './styles-dark-mode.css?v=293',
    './styles-reports.css?v=293',
    './styles-guest-demo.css?v=293',
    './js/main.js?v=293',
    './js/app.js?v=293',
    './js/app-core.js?v=293',
    './js/auth.js?v=293',
    './js/i18n.js?v=293',
    './js/app-mode.js?v=293',
    './js/auth-login-helpers.js?v=293',
    './js/blockchain-config.js?v=293',
    './js/blockchain-manager.js?v=293',
    './js/data-manager.js?v=293',
    './js/diet-program.js?v=293',
    './js/diet-analysis.js?v=293',
    './js/exercise-media.js?v=293',
    './js/firebase-config.js?v=293',
    './js/friendship-utils.js?v=293',
    './js/habit-groups.js?v=293',
    './js/health-connect-utils.js?v=293',
    './js/metabolic-score.js?v=293',
    './js/milestone-helpers.js?v=293',
    './js/monthly-mvp-reward.js?v=293',
    './js/meditation-guide.js?v=293',
    './js/reward-market.js?v=293',
    './js/guest-demo.js?v=293',
    './js/product-events.js?v=293',
    './js/activity-days.js?v=293',
    './js/pwa-install.js?v=293',
    './js/security.js?v=293',
    './js/social-challenge-readiness.js?v=293',
    './js/ui-helpers.js?v=293',
    './js/upload-performance.js?v=293',
    './js/video-thumbnail-quality.js?v=293',
    './js/webview-detect.js?v=293',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
