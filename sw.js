...
const CACHE_NAME = 'habitschool-v359';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=359',
    './styles-base.css?v=359',
    './styles-en.css?v=359',
    './styles-features.css?v=359',
    './styles-reward-market.css?v=359',
    './styles-dashboard.css?v=359',
    './styles-dark-mode.css?v=359',
    './styles-reports.css?v=359',
    './styles-guest-demo.css?v=359',
    './js/main.js?v=359',
    './js/app.js?v=359',
    './js/app-core.js?v=359',
    './js/auth.js?v=359',
    './js/i18n.js?v=359',
    './js/app-mode.js?v=359',
    './js/auth-login-helpers.js?v=359',
    './js/blockchain-config.js?v=359',
    './js/blockchain-manager.js?v=359',
    './js/challenge-claim.js?v=359',
    './js/video-compress.js?v=359',
    './js/bug-report.js?v=359',
    './js/data-manager.js?v=359',
    './js/diet-program.js?v=359',
    './js/diet-analysis.js?v=359',
    './js/exercise-media.js?v=359',
    './js/firebase-config.js?v=359',
    './js/friendship-utils.js?v=359',
    './js/habit-groups.js?v=359',
    './js/health-connect-utils.js?v=359',
    './js/metabolic-score.js?v=359',
    './js/le8-score.js?v=359',
    './js/milestone-helpers.js?v=359',
    './js/monthly-mvp-reward.js?v=359',
    './js/meditation-guide.js?v=359',
    './js/reward-market.js?v=359',
    './js/guest-demo.js?v=359',
    './js/product-events.js?v=359',
    './js/activity-days.js?v=359',
    './js/pwa-install.js?v=359',
    './js/security.js?v=359',
    './js/community-stats-view.js?v=359',
    './js/social-challenge-readiness.js?v=359',
    './js/ui-helpers.js?v=359',
    './js/upload-performance.js?v=359',
    './js/video-thumbnail-quality.js?v=359',
    './js/webview-detect.js?v=359',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
