...
const CACHE_NAME = 'habitschool-v219';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=219',
    './styles-base.css?v=219',
    './styles-en.css?v=219',
    './styles-features.css?v=219',
    './styles-reward-market.css?v=219',
    './styles-dashboard.css?v=219',
    './styles-dark-mode.css?v=219',
    './styles-reports.css?v=219',
    './js/main.js?v=219',
    './js/app.js?v=219',
    './js/app-core.js?v=219',
    './js/auth.js?v=219',
    './js/i18n.js?v=219',
    './js/app-mode.js?v=219',
    './js/auth-login-helpers.js?v=219',
    './js/blockchain-config.js?v=219',
    './js/blockchain-manager.js?v=219',
    './js/data-manager.js?v=219',
    './js/diet-program.js?v=219',
    './js/diet-analysis.js?v=219',
    './js/exercise-media.js?v=219',
    './js/firebase-config.js?v=219',
    './js/habit-groups.js?v=219',
    './js/health-connect-utils.js?v=219',
    './js/metabolic-score.js?v=219',
    './js/milestone-helpers.js?v=219',
    './js/monthly-mvp-reward.js?v=219',
    './js/pwa-install.js?v=219',
    './js/security.js?v=219',
    './js/social-challenge-readiness.js?v=219',
    './js/ui-helpers.js?v=219',
    './js/upload-performance.js?v=219',
    './js/webview-detect.js?v=219',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
