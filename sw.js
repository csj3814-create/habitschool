...
const CACHE_NAME = 'habitschool-v394';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=394',
    './styles-base.css?v=394',
    './styles-en.css?v=394',
    './styles-features.css?v=394',
    './styles-reward-market.css?v=394',
    './styles-dashboard.css?v=394',
    './styles-dark-mode.css?v=394',
    './styles-reports.css?v=394',
    './styles-guest-demo.css?v=394',
    './js/main.js?v=394',
    './js/app.js?v=394',
    './js/app-core.js?v=394',
    './js/auth.js?v=394',
    './js/i18n.js?v=394',
    './js/app-mode.js?v=394',
    './js/auth-login-helpers.js?v=394',
    './js/blockchain-config.js?v=394',
    './js/blockchain-manager.js?v=394',
    './js/challenge-claim.js?v=394',
    './js/video-compress.js?v=394',
    './js/bug-report.js?v=394',
    './js/data-manager.js?v=394',
    './js/diet-program.js?v=394',
    './js/diet-analysis.js?v=394',
    './js/exercise-media.js?v=394',
    './js/firebase-config.js?v=394',
    './js/friendship-utils.js?v=394',
    './js/habit-groups.js?v=394',
    './js/health-connect-utils.js?v=394',
    './js/metabolic-score.js?v=394',
    './js/le8-score.js?v=394',
    './js/milestone-helpers.js?v=394',
    './js/monthly-mvp-reward.js?v=394',
    './js/meditation-guide.js?v=394',
    './js/reward-market.js?v=394',
    './js/guest-demo.js?v=394',
    './js/product-events.js?v=394',
    './js/activity-days.js?v=394',
    './js/pwa-install.js?v=394',
    './js/security.js?v=394',
    './js/community-stats-view.js?v=394',
    './js/social-challenge-readiness.js?v=394',
    './js/ui-helpers.js?v=394',
    './js/upload-performance.js?v=394',
    './js/video-thumbnail-quality.js?v=394',
    './js/browser-detect.js?v=394',
    './js/webview-detect.js?v=394',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
