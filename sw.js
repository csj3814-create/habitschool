...
const CACHE_NAME = 'habitschool-v364';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=364',
    './styles-base.css?v=364',
    './styles-en.css?v=364',
    './styles-features.css?v=364',
    './styles-reward-market.css?v=364',
    './styles-dashboard.css?v=364',
    './styles-dark-mode.css?v=364',
    './styles-reports.css?v=364',
    './styles-guest-demo.css?v=364',
    './js/main.js?v=364',
    './js/app.js?v=364',
    './js/app-core.js?v=364',
    './js/auth.js?v=364',
    './js/i18n.js?v=364',
    './js/app-mode.js?v=364',
    './js/auth-login-helpers.js?v=364',
    './js/blockchain-config.js?v=364',
    './js/blockchain-manager.js?v=364',
    './js/challenge-claim.js?v=364',
    './js/video-compress.js?v=364',
    './js/bug-report.js?v=364',
    './js/data-manager.js?v=364',
    './js/diet-program.js?v=364',
    './js/diet-analysis.js?v=364',
    './js/exercise-media.js?v=364',
    './js/firebase-config.js?v=364',
    './js/friendship-utils.js?v=364',
    './js/habit-groups.js?v=364',
    './js/health-connect-utils.js?v=364',
    './js/metabolic-score.js?v=364',
    './js/le8-score.js?v=364',
    './js/milestone-helpers.js?v=364',
    './js/monthly-mvp-reward.js?v=364',
    './js/meditation-guide.js?v=364',
    './js/reward-market.js?v=364',
    './js/guest-demo.js?v=364',
    './js/product-events.js?v=364',
    './js/activity-days.js?v=364',
    './js/pwa-install.js?v=364',
    './js/security.js?v=364',
    './js/community-stats-view.js?v=364',
    './js/social-challenge-readiness.js?v=364',
    './js/ui-helpers.js?v=364',
    './js/upload-performance.js?v=364',
    './js/video-thumbnail-quality.js?v=364',
    './js/webview-detect.js?v=364',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
