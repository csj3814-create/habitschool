...
const CACHE_NAME = 'habitschool-v270';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=270',
    './styles-base.css?v=270',
    './styles-en.css?v=270',
    './styles-features.css?v=270',
    './styles-reward-market.css?v=270',
    './styles-dashboard.css?v=270',
    './styles-dark-mode.css?v=270',
    './styles-reports.css?v=270',
    './styles-guest-demo.css?v=270',
    './js/main.js?v=270',
    './js/app.js?v=270',
    './js/app-core.js?v=270',
    './js/auth.js?v=270',
    './js/i18n.js?v=270',
    './js/app-mode.js?v=270',
    './js/auth-login-helpers.js?v=270',
    './js/blockchain-config.js?v=270',
    './js/blockchain-manager.js?v=270',
    './js/data-manager.js?v=270',
    './js/diet-program.js?v=270',
    './js/diet-analysis.js?v=270',
    './js/exercise-media.js?v=270',
    './js/firebase-config.js?v=270',
    './js/friendship-utils.js?v=270',
    './js/habit-groups.js?v=270',
    './js/health-connect-utils.js?v=270',
    './js/metabolic-score.js?v=270',
    './js/milestone-helpers.js?v=270',
    './js/monthly-mvp-reward.js?v=270',
    './js/meditation-guide.js?v=270',
    './js/reward-market.js?v=270',
    './js/guest-demo.js?v=270',
    './js/product-events.js?v=270',
    './js/activity-days.js?v=270',
    './js/pwa-install.js?v=270',
    './js/security.js?v=270',
    './js/social-challenge-readiness.js?v=270',
    './js/ui-helpers.js?v=270',
    './js/upload-performance.js?v=270',
    './js/video-thumbnail-quality.js?v=270',
    './js/webview-detect.js?v=270',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
