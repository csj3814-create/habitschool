...
const CACHE_NAME = 'habitschool-v396';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=396',
    './styles-base.css?v=396',
    './styles-en.css?v=396',
    './styles-features.css?v=396',
    './styles-reward-market.css?v=396',
    './styles-dashboard.css?v=396',
    './styles-dark-mode.css?v=396',
    './styles-reports.css?v=396',
    './styles-guest-demo.css?v=396',
    './js/main.js?v=396',
    './js/app.js?v=396',
    './js/app-core.js?v=396',
    './js/auth.js?v=396',
    './js/i18n.js?v=396',
    './js/app-mode.js?v=396',
    './js/auth-login-helpers.js?v=396',
    './js/blockchain-config.js?v=396',
    './js/blockchain-manager.js?v=396',
    './js/challenge-claim.js?v=396',
    './js/video-compress.js?v=396',
    './js/bug-report.js?v=396',
    './js/data-manager.js?v=396',
    './js/diet-program.js?v=396',
    './js/diet-analysis.js?v=396',
    './js/exercise-media.js?v=396',
    './js/firebase-config.js?v=396',
    './js/friendship-utils.js?v=396',
    './js/habit-groups.js?v=396',
    './js/health-connect-utils.js?v=396',
    './js/metabolic-score.js?v=396',
    './js/le8-score.js?v=396',
    './js/milestone-helpers.js?v=396',
    './js/monthly-mvp-reward.js?v=396',
    './js/meditation-guide.js?v=396',
    './js/reward-market.js?v=396',
    './js/guest-demo.js?v=396',
    './js/product-events.js?v=396',
    './js/activity-days.js?v=396',
    './js/pwa-install.js?v=396',
    './js/security.js?v=396',
    './js/community-stats-view.js?v=396',
    './js/social-challenge-readiness.js?v=396',
    './js/ui-helpers.js?v=396',
    './js/upload-performance.js?v=396',
    './js/video-thumbnail-quality.js?v=396',
    './js/browser-detect.js?v=396',
    './js/webview-detect.js?v=396',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
