...
const CACHE_NAME = 'habitschool-v237';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=237',
    './styles-base.css?v=237',
    './styles-en.css?v=237',
    './styles-features.css?v=237',
    './styles-reward-market.css?v=237',
    './styles-dashboard.css?v=237',
    './styles-dark-mode.css?v=237',
    './styles-reports.css?v=237',
    './styles-guest-demo.css?v=237',
    './js/main.js?v=237',
    './js/app.js?v=237',
    './js/app-core.js?v=237',
    './js/auth.js?v=237',
    './js/i18n.js?v=237',
    './js/app-mode.js?v=237',
    './js/auth-login-helpers.js?v=237',
    './js/blockchain-config.js?v=237',
    './js/blockchain-manager.js?v=237',
    './js/data-manager.js?v=237',
    './js/diet-program.js?v=237',
    './js/diet-analysis.js?v=237',
    './js/exercise-media.js?v=237',
    './js/firebase-config.js?v=237',
    './js/friendship-utils.js?v=237',
    './js/habit-groups.js?v=237',
    './js/health-connect-utils.js?v=237',
    './js/metabolic-score.js?v=237',
    './js/milestone-helpers.js?v=237',
    './js/monthly-mvp-reward.js?v=237',
    './js/meditation-guide.js?v=237',
    './js/reward-market.js?v=237',
    './js/guest-demo.js?v=237',
    './js/product-events.js?v=237',
    './js/activity-days.js?v=237',
    './js/pwa-install.js?v=237',
    './js/security.js?v=237',
    './js/social-challenge-readiness.js?v=237',
    './js/ui-helpers.js?v=237',
    './js/upload-performance.js?v=237',
    './js/webview-detect.js?v=237',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
