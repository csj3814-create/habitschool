...
const CACHE_NAME = 'habitschool-v245';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=245',
    './styles-base.css?v=245',
    './styles-en.css?v=245',
    './styles-features.css?v=245',
    './styles-reward-market.css?v=245',
    './styles-dashboard.css?v=245',
    './styles-dark-mode.css?v=245',
    './styles-reports.css?v=245',
    './styles-guest-demo.css?v=245',
    './js/main.js?v=245',
    './js/app.js?v=245',
    './js/app-core.js?v=245',
    './js/auth.js?v=245',
    './js/i18n.js?v=245',
    './js/app-mode.js?v=245',
    './js/auth-login-helpers.js?v=245',
    './js/blockchain-config.js?v=245',
    './js/blockchain-manager.js?v=245',
    './js/data-manager.js?v=245',
    './js/diet-program.js?v=245',
    './js/diet-analysis.js?v=245',
    './js/exercise-media.js?v=245',
    './js/firebase-config.js?v=245',
    './js/friendship-utils.js?v=245',
    './js/habit-groups.js?v=245',
    './js/health-connect-utils.js?v=245',
    './js/metabolic-score.js?v=245',
    './js/milestone-helpers.js?v=245',
    './js/monthly-mvp-reward.js?v=245',
    './js/meditation-guide.js?v=245',
    './js/reward-market.js?v=245',
    './js/guest-demo.js?v=245',
    './js/product-events.js?v=245',
    './js/activity-days.js?v=245',
    './js/pwa-install.js?v=245',
    './js/security.js?v=245',
    './js/social-challenge-readiness.js?v=245',
    './js/ui-helpers.js?v=245',
    './js/upload-performance.js?v=245',
    './js/video-thumbnail-quality.js?v=245',
    './js/webview-detect.js?v=245',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
