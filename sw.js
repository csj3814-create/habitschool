...
const CACHE_NAME = 'habitschool-v430';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=430',
    './styles-base.css?v=430',
    './styles-en.css?v=430',
    './styles-features.css?v=430',
    './styles-reward-market.css?v=430',
    './styles-dashboard.css?v=430',
    './styles-dark-mode.css?v=430',
    './styles-reports.css?v=430',
    './styles-guest-demo.css?v=430',
    './js/main.js?v=430',
    './js/app.js?v=430',
    './js/app-core.js?v=430',
    './js/auth.js?v=430',
    './js/i18n.js?v=430',
    './js/app-mode.js?v=430',
    './js/auth-login-helpers.js?v=430',
    './js/blockchain-config.js?v=430',
    './js/blockchain-manager.js?v=430',
    './js/challenge-claim.js?v=430',
    './js/video-compress.js?v=430',
    './js/bug-report.js?v=430',
    './js/data-manager.js?v=430',
    './js/diet-program.js?v=430',
    './js/diet-analysis.js?v=430',
    './js/exercise-media.js?v=430',
    './js/firebase-config.js?v=430',
    './js/friendship-utils.js?v=430',
    './js/habit-groups.js?v=430',
    './js/health-connect-utils.js?v=430',
    './js/metabolic-score.js?v=430',
    './js/korean.js?v=430',
    './js/le8-score.js?v=430',
    './js/milestone-helpers.js?v=430',
    './js/monthly-mvp-reward.js?v=430',
    './js/meditation-guide.js?v=430',
    './js/reward-market.js?v=430',
    './js/guest-demo.js?v=430',
    ...
    './js/ui-helpers.js?v=430',
    './js/upload-performance.js?v=430',
    './js/video-thumbnail-quality.js?v=430',
    './js/browser-detect.js?v=430',
    './js/webview-detect.js?v=430',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
