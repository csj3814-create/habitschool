...
const CACHE_NAME = 'habitschool-v253';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=253',
    './styles-base.css?v=253',
    './styles-en.css?v=253',
    './styles-features.css?v=253',
    './styles-reward-market.css?v=253',
    './styles-dashboard.css?v=253',
    './styles-dark-mode.css?v=253',
    './styles-reports.css?v=253',
    './styles-guest-demo.css?v=253',
    './js/main.js?v=253',
    './js/app.js?v=253',
    './js/app-core.js?v=253',
    './js/auth.js?v=253',
    './js/i18n.js?v=253',
    './js/app-mode.js?v=253',
    './js/auth-login-helpers.js?v=253',
    './js/blockchain-config.js?v=253',
    './js/blockchain-manager.js?v=253',
    './js/data-manager.js?v=253',
    './js/diet-program.js?v=253',
    './js/diet-analysis.js?v=253',
    './js/exercise-media.js?v=253',
    './js/firebase-config.js?v=253',
    './js/friendship-utils.js?v=253',
    './js/habit-groups.js?v=253',
    './js/health-connect-utils.js?v=253',
    './js/metabolic-score.js?v=253',
    './js/milestone-helpers.js?v=253',
    './js/monthly-mvp-reward.js?v=253',
    './js/meditation-guide.js?v=253',
    './js/reward-market.js?v=253',
    './js/guest-demo.js?v=253',
    './js/product-events.js?v=253',
    './js/activity-days.js?v=253',
    './js/pwa-install.js?v=253',
    './js/security.js?v=253',
    './js/social-challenge-readiness.js?v=253',
    './js/ui-helpers.js?v=253',
    './js/upload-performance.js?v=253',
    './js/video-thumbnail-quality.js?v=253',
    './js/webview-detect.js?v=253',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
