...
const CACHE_NAME = 'habitschool-v374';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=374',
    './styles-base.css?v=374',
    './styles-en.css?v=374',
    './styles-features.css?v=374',
    './styles-reward-market.css?v=374',
    './styles-dashboard.css?v=374',
    './styles-dark-mode.css?v=374',
    './styles-reports.css?v=374',
    './styles-guest-demo.css?v=374',
    './js/main.js?v=374',
    './js/app.js?v=374',
    './js/app-core.js?v=374',
    './js/auth.js?v=374',
    './js/i18n.js?v=374',
    './js/app-mode.js?v=374',
    './js/auth-login-helpers.js?v=374',
    './js/blockchain-config.js?v=374',
    './js/blockchain-manager.js?v=374',
    './js/challenge-claim.js?v=374',
    './js/video-compress.js?v=374',
    './js/bug-report.js?v=374',
    './js/data-manager.js?v=374',
    './js/diet-program.js?v=374',
    './js/diet-analysis.js?v=374',
    './js/exercise-media.js?v=374',
    './js/firebase-config.js?v=374',
    './js/friendship-utils.js?v=374',
    './js/habit-groups.js?v=374',
    './js/health-connect-utils.js?v=374',
    './js/metabolic-score.js?v=374',
    './js/le8-score.js?v=374',
    './js/milestone-helpers.js?v=374',
    './js/monthly-mvp-reward.js?v=374',
    './js/meditation-guide.js?v=374',
    './js/reward-market.js?v=374',
    './js/guest-demo.js?v=374',
    './js/product-events.js?v=374',
    './js/activity-days.js?v=374',
    './js/pwa-install.js?v=374',
    './js/security.js?v=374',
    './js/community-stats-view.js?v=374',
    './js/social-challenge-readiness.js?v=374',
    './js/ui-helpers.js?v=374',
    './js/upload-performance.js?v=374',
    './js/video-thumbnail-quality.js?v=374',
    './js/webview-detect.js?v=374',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
