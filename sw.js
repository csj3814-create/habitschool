...
const CACHE_NAME = 'habitschool-v400';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=400',
    './styles-base.css?v=400',
    './styles-en.css?v=400',
    './styles-features.css?v=400',
    './styles-reward-market.css?v=400',
    './styles-dashboard.css?v=400',
    './styles-dark-mode.css?v=400',
    './styles-reports.css?v=400',
    './styles-guest-demo.css?v=400',
    './js/main.js?v=400',
    './js/app.js?v=400',
    './js/app-core.js?v=400',
    './js/auth.js?v=400',
    './js/i18n.js?v=400',
    './js/app-mode.js?v=400',
    './js/auth-login-helpers.js?v=400',
    './js/blockchain-config.js?v=400',
    './js/blockchain-manager.js?v=400',
    './js/challenge-claim.js?v=400',
    './js/video-compress.js?v=400',
    './js/bug-report.js?v=400',
    './js/data-manager.js?v=400',
    './js/diet-program.js?v=400',
    './js/diet-analysis.js?v=400',
    './js/exercise-media.js?v=400',
    './js/firebase-config.js?v=400',
    './js/friendship-utils.js?v=400',
    './js/habit-groups.js?v=400',
    './js/health-connect-utils.js?v=400',
    './js/metabolic-score.js?v=400',
    './js/le8-score.js?v=400',
    './js/milestone-helpers.js?v=400',
    './js/monthly-mvp-reward.js?v=400',
    './js/meditation-guide.js?v=400',
    './js/reward-market.js?v=400',
    './js/guest-demo.js?v=400',
    './js/product-events.js?v=400',
    './js/activity-days.js?v=400',
    './js/pwa-install.js?v=400',
    './js/security.js?v=400',
    './js/community-stats-view.js?v=400',
    './js/social-challenge-readiness.js?v=400',
    './js/ui-helpers.js?v=400',
    './js/upload-performance.js?v=400',
    './js/video-thumbnail-quality.js?v=400',
    './js/browser-detect.js?v=400',
    './js/webview-detect.js?v=400',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
