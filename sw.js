...
const CACHE_NAME = 'habitschool-v173';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=173',
    './styles-base.css?v=173',
    './styles-features.css?v=173',
    './styles-dashboard.css?v=173',
    './styles-dark-mode.css?v=173',
    './styles-reports.css?v=173',
    './js/main.js?v=173',
    './js/app.js?v=173',
    './js/app-core.js?v=173',
    './js/auth.js?v=173',
    './js/app-mode.js?v=173',
    './js/auth-login-helpers.js?v=173',
    './js/blockchain-config.js?v=173',
    './js/blockchain-manager.js?v=173',
    './js/data-manager.js?v=173',
    './js/diet-program.js?v=173',
    './js/diet-analysis.js?v=173',
    './js/exercise-media.js?v=173',
    './js/firebase-config.js?v=173',
    './js/health-connect-utils.js?v=173',
    './js/metabolic-score.js?v=173',
    './js/milestone-helpers.js?v=173',
    './js/pwa-install.js?v=173',
    './js/security.js?v=173',
    './js/ui-helpers.js?v=173',
    './js/upload-performance.js?v=173',
    './js/webview-detect.js?v=173',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
