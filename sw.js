...
const CACHE_NAME = 'habitschool-v422';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=422',
    './styles-base.css?v=422',
    './styles-en.css?v=422',
    './styles-features.css?v=422',
    './styles-reward-market.css?v=422',
    './styles-dashboard.css?v=422',
    './styles-dark-mode.css?v=422',
    './styles-reports.css?v=422',
    './styles-guest-demo.css?v=422',
    './js/main.js?v=422',
    './js/app.js?v=422',
    './js/app-core.js?v=422',
    './js/auth.js?v=422',
    './js/i18n.js?v=422',
    './js/app-mode.js?v=422',
    './js/auth-login-helpers.js?v=422',
    './js/blockchain-config.js?v=422',
    './js/blockchain-manager.js?v=422',
    './js/challenge-claim.js?v=422',
    './js/video-compress.js?v=422',
    './js/bug-report.js?v=422',
    './js/data-manager.js?v=422',
    './js/diet-program.js?v=422',
    './js/diet-analysis.js?v=422',
    './js/exercise-media.js?v=422',
    './js/firebase-config.js?v=422',
    './js/friendship-utils.js?v=422',
    './js/habit-groups.js?v=422',
    './js/health-connect-utils.js?v=422',
    './js/metabolic-score.js?v=422',
    './js/le8-score.js?v=422',
    './js/milestone-helpers.js?v=422',
    './js/monthly-mvp-reward.js?v=422',
    './js/meditation-guide.js?v=422',
    './js/reward-market.js?v=422',
    './js/guest-demo.js?v=422',
    './js/product-events.js?v=422',
    './js/activity-days.js?v=422',
    './js/pwa-install.js?v=422',
    './js/security.js?v=422',
    './js/community-stats-view.js?v=422',
    './js/social-challenge-readiness.js?v=422',
    './js/ui-helpers.js?v=422',
    './js/upload-performance.js?v=422',
    './js/video-thumbnail-quality.js?v=422',
    './js/browser-detect.js?v=422',
    './js/webview-detect.js?v=422',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
