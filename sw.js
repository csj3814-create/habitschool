...
const CACHE_NAME = 'habitschool-v178';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=178',
    './styles-base.css?v=178',
    './styles-features.css?v=178',
    './styles-reward-market.css?v=178',
    './styles-dashboard.css?v=178',
    './styles-dark-mode.css?v=178',
    './styles-reports.css?v=178',
    './js/main.js?v=178',
    './js/app.js?v=178',
    './js/app-core.js?v=178',
    './js/auth.js?v=178',
    './js/app-mode.js?v=178',
    './js/auth-login-helpers.js?v=178',
    './js/blockchain-config.js?v=178',
    './js/blockchain-manager.js?v=178',
    './js/data-manager.js?v=178',
    './js/diet-program.js?v=178',
    './js/diet-analysis.js?v=178',
    './js/exercise-media.js?v=178',
    './js/firebase-config.js?v=178',
    './js/health-connect-utils.js?v=178',
    './js/metabolic-score.js?v=178',
    './js/milestone-helpers.js?v=178',
    './js/monthly-mvp-reward.js?v=178',
    './js/pwa-install.js?v=178',
    './js/security.js?v=178',
    './js/social-challenge-readiness.js?v=178',
    './js/ui-helpers.js?v=178',
    './js/upload-performance.js?v=178',
    './js/webview-detect.js?v=178',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
