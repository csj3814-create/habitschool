...
const CACHE_NAME = 'habitschool-v413';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=413',
    './styles-base.css?v=413',
    './styles-en.css?v=413',
    './styles-features.css?v=413',
    './styles-reward-market.css?v=413',
    './styles-dashboard.css?v=413',
    './styles-dark-mode.css?v=413',
    './styles-reports.css?v=413',
    './styles-guest-demo.css?v=413',
    './js/main.js?v=413',
    './js/app.js?v=413',
    './js/app-core.js?v=413',
    './js/auth.js?v=413',
    './js/i18n.js?v=413',
    './js/app-mode.js?v=413',
    './js/auth-login-helpers.js?v=413',
    './js/blockchain-config.js?v=413',
    './js/blockchain-manager.js?v=413',
    './js/challenge-claim.js?v=413',
    './js/video-compress.js?v=413',
    './js/bug-report.js?v=413',
    './js/data-manager.js?v=413',
    './js/diet-program.js?v=413',
    './js/diet-analysis.js?v=413',
    './js/exercise-media.js?v=413',
    './js/firebase-config.js?v=413',
    './js/friendship-utils.js?v=413',
    './js/habit-groups.js?v=413',
    './js/health-connect-utils.js?v=413',
    './js/metabolic-score.js?v=413',
    './js/le8-score.js?v=413',
    './js/milestone-helpers.js?v=413',
    './js/monthly-mvp-reward.js?v=413',
    './js/meditation-guide.js?v=413',
    './js/reward-market.js?v=413',
    './js/guest-demo.js?v=413',
    './js/product-events.js?v=413',
    './js/activity-days.js?v=413',
    './js/pwa-install.js?v=413',
    './js/security.js?v=413',
    './js/community-stats-view.js?v=413',
    './js/social-challenge-readiness.js?v=413',
    './js/ui-helpers.js?v=413',
    './js/upload-performance.js?v=413',
    './js/video-thumbnail-quality.js?v=413',
    './js/browser-detect.js?v=413',
    './js/webview-detect.js?v=413',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
