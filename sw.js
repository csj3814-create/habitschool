...
const CACHE_NAME = 'habitschool-v411';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=411',
    './styles-base.css?v=411',
    './styles-en.css?v=411',
    './styles-features.css?v=411',
    './styles-reward-market.css?v=411',
    './styles-dashboard.css?v=411',
    './styles-dark-mode.css?v=411',
    './styles-reports.css?v=411',
    './styles-guest-demo.css?v=411',
    './js/main.js?v=411',
    './js/app.js?v=411',
    './js/app-core.js?v=411',
    './js/auth.js?v=411',
    './js/i18n.js?v=411',
    './js/app-mode.js?v=411',
    './js/auth-login-helpers.js?v=411',
    './js/blockchain-config.js?v=411',
    './js/blockchain-manager.js?v=411',
    './js/challenge-claim.js?v=411',
    './js/video-compress.js?v=411',
    './js/bug-report.js?v=411',
    './js/data-manager.js?v=411',
    './js/diet-program.js?v=411',
    './js/diet-analysis.js?v=411',
    './js/exercise-media.js?v=411',
    './js/firebase-config.js?v=411',
    './js/friendship-utils.js?v=411',
    './js/habit-groups.js?v=411',
    './js/health-connect-utils.js?v=411',
    './js/metabolic-score.js?v=411',
    './js/le8-score.js?v=411',
    './js/milestone-helpers.js?v=411',
    './js/monthly-mvp-reward.js?v=411',
    './js/meditation-guide.js?v=411',
    './js/reward-market.js?v=411',
    './js/guest-demo.js?v=411',
    './js/product-events.js?v=411',
    './js/activity-days.js?v=411',
    './js/pwa-install.js?v=411',
    './js/security.js?v=411',
    './js/community-stats-view.js?v=411',
    './js/social-challenge-readiness.js?v=411',
    './js/ui-helpers.js?v=411',
    './js/upload-performance.js?v=411',
    './js/video-thumbnail-quality.js?v=411',
    './js/browser-detect.js?v=411',
    './js/webview-detect.js?v=411',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
