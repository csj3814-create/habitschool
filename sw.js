...
const CACHE_NAME = 'habitschool-v389';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=389',
    './styles-base.css?v=389',
    './styles-en.css?v=389',
    './styles-features.css?v=389',
    './styles-reward-market.css?v=389',
    './styles-dashboard.css?v=389',
    './styles-dark-mode.css?v=389',
    './styles-reports.css?v=389',
    './styles-guest-demo.css?v=389',
    './js/main.js?v=389',
    './js/app.js?v=389',
    './js/app-core.js?v=389',
    './js/auth.js?v=389',
    './js/i18n.js?v=389',
    './js/app-mode.js?v=389',
    './js/auth-login-helpers.js?v=389',
    './js/blockchain-config.js?v=389',
    './js/blockchain-manager.js?v=389',
    './js/challenge-claim.js?v=389',
    './js/video-compress.js?v=389',
    './js/bug-report.js?v=389',
    './js/data-manager.js?v=389',
    './js/diet-program.js?v=389',
    './js/diet-analysis.js?v=389',
    './js/exercise-media.js?v=389',
    './js/firebase-config.js?v=389',
    './js/friendship-utils.js?v=389',
    './js/habit-groups.js?v=389',
    './js/health-connect-utils.js?v=389',
    './js/metabolic-score.js?v=389',
    './js/le8-score.js?v=389',
    './js/milestone-helpers.js?v=389',
    './js/monthly-mvp-reward.js?v=389',
    './js/meditation-guide.js?v=389',
    './js/reward-market.js?v=389',
    './js/guest-demo.js?v=389',
    './js/product-events.js?v=389',
    './js/activity-days.js?v=389',
    './js/pwa-install.js?v=389',
    './js/security.js?v=389',
    './js/community-stats-view.js?v=389',
    './js/social-challenge-readiness.js?v=389',
    './js/ui-helpers.js?v=389',
    './js/upload-performance.js?v=389',
    './js/video-thumbnail-quality.js?v=389',
    './js/browser-detect.js?v=389',
    './js/webview-detect.js?v=389',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
