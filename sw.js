...
const CACHE_NAME = 'habitschool-v433';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=433',
    './styles-base.css?v=433',
    './styles-en.css?v=433',
    './styles-features.css?v=433',
    './styles-reward-market.css?v=433',
    './styles-dashboard.css?v=433',
    './styles-dark-mode.css?v=433',
    './styles-reports.css?v=433',
    './styles-guest-demo.css?v=433',
    './js/main.js?v=433',
    './js/app.js?v=433',
    './js/app-core.js?v=433',
    './js/auth.js?v=433',
    './js/i18n.js?v=433',
    './js/app-mode.js?v=433',
    './js/auth-login-helpers.js?v=433',
    './js/blockchain-config.js?v=433',
    './js/blockchain-manager.js?v=433',
    './js/challenge-claim.js?v=433',
    './js/video-compress.js?v=433',
    './js/bug-report.js?v=433',
    './js/data-manager.js?v=433',
    './js/diet-program.js?v=433',
    './js/diet-analysis.js?v=433',
    './js/exercise-media.js?v=433',
    './js/firebase-config.js?v=433',
    './js/friendship-utils.js?v=433',
    './js/habit-groups.js?v=433',
    './js/health-connect-utils.js?v=433',
    './js/metabolic-score.js?v=433',
    './js/korean.js?v=433',
    './js/le8-score.js?v=433',
    './js/milestone-helpers.js?v=433',
    ...
    './js/pwa-install.js?v=433',
    './js/media-hosts.js?v=433',
    './js/security.js?v=433',
    './js/community-stats-view.js?v=433',
    './js/social-challenge-readiness.js?v=433',
    './js/ui-helpers.js?v=433',
    './js/upload-performance.js?v=433',
    './js/video-thumbnail-quality.js?v=433',
    './js/browser-detect.js?v=433',
    './js/webview-detect.js?v=433',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
