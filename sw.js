...
const CACHE_NAME = 'habitschool-v378';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=378',
    './styles-base.css?v=378',
    './styles-en.css?v=378',
    './styles-features.css?v=378',
    './styles-reward-market.css?v=378',
    './styles-dashboard.css?v=378',
    './styles-dark-mode.css?v=378',
    './styles-reports.css?v=378',
    './styles-guest-demo.css?v=378',
    './js/main.js?v=378',
    './js/app.js?v=378',
    './js/app-core.js?v=378',
    './js/auth.js?v=378',
    './js/i18n.js?v=378',
    './js/app-mode.js?v=378',
    './js/auth-login-helpers.js?v=378',
    './js/blockchain-config.js?v=378',
    './js/blockchain-manager.js?v=378',
    './js/challenge-claim.js?v=378',
    './js/video-compress.js?v=378',
    './js/bug-report.js?v=378',
    './js/data-manager.js?v=378',
    './js/diet-program.js?v=378',
    './js/diet-analysis.js?v=378',
    './js/exercise-media.js?v=378',
    './js/firebase-config.js?v=378',
    './js/friendship-utils.js?v=378',
    './js/habit-groups.js?v=378',
    './js/health-connect-utils.js?v=378',
    './js/metabolic-score.js?v=378',
    './js/le8-score.js?v=378',
    './js/milestone-helpers.js?v=378',
    './js/monthly-mvp-reward.js?v=378',
    './js/meditation-guide.js?v=378',
    './js/reward-market.js?v=378',
    './js/guest-demo.js?v=378',
    './js/product-events.js?v=378',
    './js/activity-days.js?v=378',
    './js/pwa-install.js?v=378',
    './js/security.js?v=378',
    './js/community-stats-view.js?v=378',
    './js/social-challenge-readiness.js?v=378',
    './js/ui-helpers.js?v=378',
    './js/upload-performance.js?v=378',
    './js/video-thumbnail-quality.js?v=378',
    './js/webview-detect.js?v=378',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
