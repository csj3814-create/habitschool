...
const CACHE_NAME = 'habitschool-v166';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=166',
    './styles-base.css?v=166',
    './styles-features.css?v=166',
    './styles-dashboard.css?v=166',
    './styles-dark-mode.css?v=166',
    './styles-reports.css?v=166',
    './js/main.js?v=166',
    './js/app.js?v=166',
    './js/app-core.js?v=166',
    './js/auth.js?v=166',
    './js/app-mode.js?v=166',
    './js/auth-login-helpers.js?v=166',
    './js/blockchain-config.js?v=166',
    './js/blockchain-manager.js?v=166',
    './js/data-manager.js?v=166',
    './js/diet-program.js?v=166',
    './js/diet-analysis.js?v=166',
    './js/exercise-media.js?v=166',
    './js/firebase-config.js?v=166',
    './js/health-connect-utils.js?v=166',
    './js/metabolic-score.js?v=166',
    './js/milestone-helpers.js?v=166',
    './js/pwa-install.js?v=166',
    './js/security.js?v=166',
    './js/ui-helpers.js?v=166',
    './js/upload-performance.js?v=166',
    './js/webview-detect.js?v=166',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
