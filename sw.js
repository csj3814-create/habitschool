...
const CACHE_NAME = 'habitschool-v276';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=276',
    './styles-base.css?v=276',
    './styles-en.css?v=276',
    './styles-features.css?v=276',
    './styles-reward-market.css?v=276',
    './styles-dashboard.css?v=276',
    './styles-dark-mode.css?v=276',
    './styles-reports.css?v=276',
    './styles-guest-demo.css?v=276',
    './js/main.js?v=276',
    './js/app.js?v=276',
    './js/app-core.js?v=276',
    './js/auth.js?v=276',
    './js/i18n.js?v=276',
    './js/app-mode.js?v=276',
    './js/auth-login-helpers.js?v=276',
    './js/blockchain-config.js?v=276',
    './js/blockchain-manager.js?v=276',
    './js/data-manager.js?v=276',
    './js/diet-program.js?v=276',
    './js/diet-analysis.js?v=276',
    './js/exercise-media.js?v=276',
    './js/firebase-config.js?v=276',
    './js/friendship-utils.js?v=276',
    './js/habit-groups.js?v=276',
    './js/health-connect-utils.js?v=276',
    './js/metabolic-score.js?v=276',
    './js/milestone-helpers.js?v=276',
    './js/monthly-mvp-reward.js?v=276',
    './js/meditation-guide.js?v=276',
    './js/reward-market.js?v=276',
    './js/guest-demo.js?v=276',
    './js/product-events.js?v=276',
    './js/activity-days.js?v=276',
    './js/pwa-install.js?v=276',
    './js/security.js?v=276',
    './js/social-challenge-readiness.js?v=276',
    './js/ui-helpers.js?v=276',
    './js/upload-performance.js?v=276',
    './js/video-thumbnail-quality.js?v=276',
    './js/webview-detect.js?v=276',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
