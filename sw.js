...
const CACHE_NAME = 'habitschool-v355';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=355',
    './styles-base.css?v=355',
    './styles-en.css?v=355',
    './styles-features.css?v=355',
    './styles-reward-market.css?v=355',
    './styles-dashboard.css?v=355',
    './styles-dark-mode.css?v=355',
    './styles-reports.css?v=355',
    './styles-guest-demo.css?v=355',
    './js/main.js?v=355',
    './js/app.js?v=355',
    './js/app-core.js?v=355',
    './js/auth.js?v=355',
    './js/i18n.js?v=355',
    './js/app-mode.js?v=355',
    './js/auth-login-helpers.js?v=355',
    './js/blockchain-config.js?v=355',
    './js/blockchain-manager.js?v=355',
    './js/challenge-claim.js?v=355',
    './js/video-compress.js?v=355',
    './js/bug-report.js?v=355',
    './js/data-manager.js?v=355',
    './js/diet-program.js?v=355',
    './js/diet-analysis.js?v=355',
    './js/exercise-media.js?v=355',
    './js/firebase-config.js?v=355',
    './js/friendship-utils.js?v=355',
    './js/habit-groups.js?v=355',
    './js/health-connect-utils.js?v=355',
    './js/metabolic-score.js?v=355',
    './js/le8-score.js?v=355',
    './js/milestone-helpers.js?v=355',
    './js/monthly-mvp-reward.js?v=355',
    './js/meditation-guide.js?v=355',
    './js/reward-market.js?v=355',
    './js/guest-demo.js?v=355',
    './js/product-events.js?v=355',
    './js/activity-days.js?v=355',
    './js/pwa-install.js?v=355',
    './js/security.js?v=355',
    './js/community-stats-view.js?v=355',
    './js/social-challenge-readiness.js?v=355',
    './js/ui-helpers.js?v=355',
    './js/upload-performance.js?v=355',
    './js/video-thumbnail-quality.js?v=355',
    './js/webview-detect.js?v=355',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
