...
const CACHE_NAME = 'habitschool-v407';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=407',
    './styles-base.css?v=407',
    './styles-en.css?v=407',
    './styles-features.css?v=407',
    './styles-reward-market.css?v=407',
    './styles-dashboard.css?v=407',
    './styles-dark-mode.css?v=407',
    './styles-reports.css?v=407',
    './styles-guest-demo.css?v=407',
    './js/main.js?v=407',
    './js/app.js?v=407',
    './js/app-core.js?v=407',
    './js/auth.js?v=407',
    './js/i18n.js?v=407',
    './js/app-mode.js?v=407',
    './js/auth-login-helpers.js?v=407',
    './js/blockchain-config.js?v=407',
    './js/blockchain-manager.js?v=407',
    './js/challenge-claim.js?v=407',
    './js/video-compress.js?v=407',
    './js/bug-report.js?v=407',
    './js/data-manager.js?v=407',
    './js/diet-program.js?v=407',
    './js/diet-analysis.js?v=407',
    './js/exercise-media.js?v=407',
    './js/firebase-config.js?v=407',
    './js/friendship-utils.js?v=407',
    './js/habit-groups.js?v=407',
    './js/health-connect-utils.js?v=407',
    './js/metabolic-score.js?v=407',
    './js/le8-score.js?v=407',
    './js/milestone-helpers.js?v=407',
    './js/monthly-mvp-reward.js?v=407',
    './js/meditation-guide.js?v=407',
    './js/reward-market.js?v=407',
    './js/guest-demo.js?v=407',
    './js/product-events.js?v=407',
    './js/activity-days.js?v=407',
    './js/pwa-install.js?v=407',
    './js/security.js?v=407',
    './js/community-stats-view.js?v=407',
    './js/social-challenge-readiness.js?v=407',
    './js/ui-helpers.js?v=407',
    './js/upload-performance.js?v=407',
    './js/video-thumbnail-quality.js?v=407',
    './js/browser-detect.js?v=407',
    './js/webview-detect.js?v=407',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
