...
const CACHE_NAME = 'habitschool-v380';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=380',
    './styles-base.css?v=380',
    './styles-en.css?v=380',
    './styles-features.css?v=380',
    './styles-reward-market.css?v=380',
    './styles-dashboard.css?v=380',
    './styles-dark-mode.css?v=380',
    './styles-reports.css?v=380',
    './styles-guest-demo.css?v=380',
    './js/main.js?v=380',
    './js/app.js?v=380',
    './js/app-core.js?v=380',
    './js/auth.js?v=380',
    './js/i18n.js?v=380',
    './js/app-mode.js?v=380',
    './js/auth-login-helpers.js?v=380',
    './js/blockchain-config.js?v=380',
    './js/blockchain-manager.js?v=380',
    './js/challenge-claim.js?v=380',
    './js/video-compress.js?v=380',
    './js/bug-report.js?v=380',
    './js/data-manager.js?v=380',
    './js/diet-program.js?v=380',
    './js/diet-analysis.js?v=380',
    './js/exercise-media.js?v=380',
    './js/firebase-config.js?v=380',
    './js/friendship-utils.js?v=380',
    './js/habit-groups.js?v=380',
    './js/health-connect-utils.js?v=380',
    './js/metabolic-score.js?v=380',
    './js/le8-score.js?v=380',
    './js/milestone-helpers.js?v=380',
    './js/monthly-mvp-reward.js?v=380',
    './js/meditation-guide.js?v=380',
    './js/reward-market.js?v=380',
    './js/guest-demo.js?v=380',
    './js/product-events.js?v=380',
    './js/activity-days.js?v=380',
    './js/pwa-install.js?v=380',
    './js/security.js?v=380',
    './js/community-stats-view.js?v=380',
    './js/social-challenge-readiness.js?v=380',
    './js/ui-helpers.js?v=380',
    './js/upload-performance.js?v=380',
    './js/video-thumbnail-quality.js?v=380',
    './js/browser-detect.js?v=380',
    './js/webview-detect.js?v=380',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
