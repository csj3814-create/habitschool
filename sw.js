...
const CACHE_NAME = 'habitschool-v251';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=251',
    './styles-base.css?v=251',
    './styles-en.css?v=251',
    './styles-features.css?v=251',
    './styles-reward-market.css?v=251',
    './styles-dashboard.css?v=251',
    './styles-dark-mode.css?v=251',
    './styles-reports.css?v=251',
    './styles-guest-demo.css?v=251',
    './js/main.js?v=251',
    './js/app.js?v=251',
    './js/app-core.js?v=251',
    './js/auth.js?v=251',
    './js/i18n.js?v=251',
    './js/app-mode.js?v=251',
    './js/auth-login-helpers.js?v=251',
    './js/blockchain-config.js?v=251',
    './js/blockchain-manager.js?v=251',
    './js/data-manager.js?v=251',
    './js/diet-program.js?v=251',
    './js/diet-analysis.js?v=251',
    './js/exercise-media.js?v=251',
    './js/firebase-config.js?v=251',
    './js/friendship-utils.js?v=251',
    './js/habit-groups.js?v=251',
    './js/health-connect-utils.js?v=251',
    './js/metabolic-score.js?v=251',
    './js/milestone-helpers.js?v=251',
    './js/monthly-mvp-reward.js?v=251',
    './js/meditation-guide.js?v=251',
    './js/reward-market.js?v=251',
    './js/guest-demo.js?v=251',
    './js/product-events.js?v=251',
    './js/activity-days.js?v=251',
    './js/pwa-install.js?v=251',
    './js/security.js?v=251',
    './js/social-challenge-readiness.js?v=251',
    './js/ui-helpers.js?v=251',
    './js/upload-performance.js?v=251',
    './js/video-thumbnail-quality.js?v=251',
    './js/webview-detect.js?v=251',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
