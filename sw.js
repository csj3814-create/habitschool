...
const CACHE_NAME = 'habitschool-v272';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=272',
    './styles-base.css?v=272',
    './styles-en.css?v=272',
    './styles-features.css?v=272',
    './styles-reward-market.css?v=272',
    './styles-dashboard.css?v=272',
    './styles-dark-mode.css?v=272',
    './styles-reports.css?v=272',
    './styles-guest-demo.css?v=272',
    './js/main.js?v=272',
    './js/app.js?v=272',
    './js/app-core.js?v=272',
    './js/auth.js?v=272',
    './js/i18n.js?v=272',
    './js/app-mode.js?v=272',
    './js/auth-login-helpers.js?v=272',
    './js/blockchain-config.js?v=272',
    './js/blockchain-manager.js?v=272',
    './js/data-manager.js?v=272',
    './js/diet-program.js?v=272',
    './js/diet-analysis.js?v=272',
    './js/exercise-media.js?v=272',
    './js/firebase-config.js?v=272',
    './js/friendship-utils.js?v=272',
    './js/habit-groups.js?v=272',
    './js/health-connect-utils.js?v=272',
    './js/metabolic-score.js?v=272',
    './js/milestone-helpers.js?v=272',
    './js/monthly-mvp-reward.js?v=272',
    './js/meditation-guide.js?v=272',
    './js/reward-market.js?v=272',
    './js/guest-demo.js?v=272',
    './js/product-events.js?v=272',
    './js/activity-days.js?v=272',
    './js/pwa-install.js?v=272',
    './js/security.js?v=272',
    './js/social-challenge-readiness.js?v=272',
    './js/ui-helpers.js?v=272',
    './js/upload-performance.js?v=272',
    './js/video-thumbnail-quality.js?v=272',
    './js/webview-detect.js?v=272',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
