...
const CACHE_NAME = 'habitschool-v442';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=442',
    './styles-base.css?v=442',
    './styles-en.css?v=442',
    './styles-features.css?v=442',
    './styles-reward-market.css?v=442',
    './styles-dashboard.css?v=442',
    './styles-dark-mode.css?v=442',
    './styles-reports.css?v=442',
    './styles-guest-demo.css?v=442',
    './js/main.js?v=442',
    './js/app.js?v=442',
    './js/app-core.js?v=442',
    './js/auth.js?v=442',
    './js/i18n.js?v=442',
    './js/app-mode.js?v=442',
    './js/auth-login-helpers.js?v=442',
    './js/blockchain-config.js?v=442',
    './js/blockchain-manager.js?v=442',
    './js/challenge-claim.js?v=442',
    './js/video-compress.js?v=442',
    './js/bug-report.js?v=442',
    './js/data-manager.js?v=442',
    './js/diet-program.js?v=442',
    './js/diet-analysis.js?v=442',
    './js/exercise-media.js?v=442',
    './js/firebase-config.js?v=442',
    './js/friendship-utils.js?v=442',
    './js/habit-groups.js?v=442',
    './js/health-connect-utils.js?v=442',
    './js/metabolic-score.js?v=442',
    './js/korean.js?v=442',
    './js/le8-score.js?v=442',
    './js/milestone-helpers.js?v=442',
    './js/monthly-mvp-reward.js?v=442',
    './js/meditation-guide.js?v=442',
    './js/reward-market.js?v=442',
    './js/body-composition-csv.js?v=442',
    './js/mission-gate.js?v=442',
    './js/health-connect-body.js?v=442',
    './js/reward-pace.js?v=442',
    './js/guest-demo.js?v=442',
    './js/product-events.js?v=442',
    './js/activity-days.js?v=442',
    './js/pwa-install.js?v=442',
    './js/media-hosts.js?v=442',
    './js/security.js?v=442',
    './js/community-stats-view.js?v=442',
    './js/social-challenge-readiness.js?v=442',
    './js/ui-helpers.js?v=442',
    './js/upload-performance.js?v=442',
    './js/video-thumbnail-quality.js?v=442',
    './js/browser-detect.js?v=442',
    './js/webview-detect.js?v=442',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
