...
const CACHE_NAME = 'habitschool-v427';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=427',
    './styles-base.css?v=427',
    './styles-en.css?v=427',
    './styles-features.css?v=427',
    './styles-reward-market.css?v=427',
    './styles-dashboard.css?v=427',
    './styles-dark-mode.css?v=427',
    './styles-reports.css?v=427',
    './styles-guest-demo.css?v=427',
    './js/main.js?v=427',
    './js/app.js?v=427',
    './js/app-core.js?v=427',
    './js/auth.js?v=427',
    './js/i18n.js?v=427',
    './js/app-mode.js?v=427',
    './js/auth-login-helpers.js?v=427',
    './js/blockchain-config.js?v=427',
    './js/blockchain-manager.js?v=427',
    './js/challenge-claim.js?v=427',
    './js/video-compress.js?v=427',
    './js/bug-report.js?v=427',
    './js/data-manager.js?v=427',
    './js/diet-program.js?v=427',
    './js/diet-analysis.js?v=427',
    './js/exercise-media.js?v=427',
    './js/firebase-config.js?v=427',
    './js/friendship-utils.js?v=427',
    './js/habit-groups.js?v=427',
    './js/health-connect-utils.js?v=427',
    './js/metabolic-score.js?v=427',
    './js/korean.js?v=427',
    './js/le8-score.js?v=427',
    './js/milestone-helpers.js?v=427',
    './js/monthly-mvp-reward.js?v=427',
    './js/meditation-guide.js?v=427',
    './js/reward-market.js?v=427',
    './js/guest-demo.js?v=427',
    './js/product-events.js?v=427',
    './js/activity-days.js?v=427',
    './js/pwa-install.js?v=427',
    './js/security.js?v=427',
    './js/community-stats-view.js?v=427',
    './js/social-challenge-readiness.js?v=427',
    './js/ui-helpers.js?v=427',
    './js/upload-performance.js?v=427',
    './js/video-thumbnail-quality.js?v=427',
    './js/browser-detect.js?v=427',
    './js/webview-detect.js?v=427',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
