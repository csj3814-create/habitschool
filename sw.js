...
const CACHE_NAME = 'habitschool-v409';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=409',
    './styles-base.css?v=409',
    './styles-en.css?v=409',
    './styles-features.css?v=409',
    './styles-reward-market.css?v=409',
    './styles-dashboard.css?v=409',
    './styles-dark-mode.css?v=409',
    './styles-reports.css?v=409',
    './styles-guest-demo.css?v=409',
    './js/main.js?v=409',
    './js/app.js?v=409',
    './js/app-core.js?v=409',
    './js/auth.js?v=409',
    './js/i18n.js?v=409',
    './js/app-mode.js?v=409',
    './js/auth-login-helpers.js?v=409',
    './js/blockchain-config.js?v=409',
    './js/blockchain-manager.js?v=409',
    './js/challenge-claim.js?v=409',
    './js/video-compress.js?v=409',
    './js/bug-report.js?v=409',
    './js/data-manager.js?v=409',
    './js/diet-program.js?v=409',
    './js/diet-analysis.js?v=409',
    './js/exercise-media.js?v=409',
    './js/firebase-config.js?v=409',
    './js/friendship-utils.js?v=409',
    './js/habit-groups.js?v=409',
    './js/health-connect-utils.js?v=409',
    './js/metabolic-score.js?v=409',
    './js/le8-score.js?v=409',
    './js/milestone-helpers.js?v=409',
    './js/monthly-mvp-reward.js?v=409',
    './js/meditation-guide.js?v=409',
    './js/reward-market.js?v=409',
    './js/guest-demo.js?v=409',
    './js/product-events.js?v=409',
    './js/activity-days.js?v=409',
    './js/pwa-install.js?v=409',
    './js/security.js?v=409',
    './js/community-stats-view.js?v=409',
    './js/social-challenge-readiness.js?v=409',
    './js/ui-helpers.js?v=409',
    './js/upload-performance.js?v=409',
    './js/video-thumbnail-quality.js?v=409',
    './js/browser-detect.js?v=409',
    './js/webview-detect.js?v=409',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
