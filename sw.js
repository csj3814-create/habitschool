...
const CACHE_NAME = 'habitschool-v330';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=330',
    './styles-base.css?v=330',
    './styles-en.css?v=330',
    './styles-features.css?v=330',
    './styles-reward-market.css?v=330',
    './styles-dashboard.css?v=330',
    './styles-dark-mode.css?v=330',
    './styles-reports.css?v=330',
    './styles-guest-demo.css?v=330',
    './js/main.js?v=330',
    './js/app.js?v=330',
    './js/app-core.js?v=330',
    './js/auth.js?v=330',
    './js/i18n.js?v=330',
    './js/app-mode.js?v=330',
    './js/auth-login-helpers.js?v=330',
    './js/blockchain-config.js?v=330',
    './js/blockchain-manager.js?v=330',
    './js/challenge-claim.js?v=330',
    './js/video-compress.js?v=330',
    './js/data-manager.js?v=330',
    './js/diet-program.js?v=330',
    './js/diet-analysis.js?v=330',
    './js/exercise-media.js?v=330',
    './js/firebase-config.js?v=330',
    './js/friendship-utils.js?v=330',
    './js/habit-groups.js?v=330',
    './js/health-connect-utils.js?v=330',
    './js/metabolic-score.js?v=330',
    './js/milestone-helpers.js?v=330',
    './js/monthly-mvp-reward.js?v=330',
    './js/meditation-guide.js?v=330',
    './js/reward-market.js?v=330',
    './js/guest-demo.js?v=330',
    './js/product-events.js?v=330',
    './js/activity-days.js?v=330',
    './js/pwa-install.js?v=330',
    './js/security.js?v=330',
    './js/social-challenge-readiness.js?v=330',
    './js/ui-helpers.js?v=330',
    './js/upload-performance.js?v=330',
    './js/video-thumbnail-quality.js?v=330',
    './js/webview-detect.js?v=330',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
