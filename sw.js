...
const CACHE_NAME = 'habitschool-v368';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=368',
    './styles-base.css?v=368',
    './styles-en.css?v=368',
    './styles-features.css?v=368',
    './styles-reward-market.css?v=368',
    './styles-dashboard.css?v=368',
    './styles-dark-mode.css?v=368',
    './styles-reports.css?v=368',
    './styles-guest-demo.css?v=368',
    './js/main.js?v=368',
    './js/app.js?v=368',
    './js/app-core.js?v=368',
    './js/auth.js?v=368',
    './js/i18n.js?v=368',
    './js/app-mode.js?v=368',
    './js/auth-login-helpers.js?v=368',
    './js/blockchain-config.js?v=368',
    './js/blockchain-manager.js?v=368',
    './js/challenge-claim.js?v=368',
    './js/video-compress.js?v=368',
    './js/bug-report.js?v=368',
    './js/data-manager.js?v=368',
    './js/diet-program.js?v=368',
    './js/diet-analysis.js?v=368',
    './js/exercise-media.js?v=368',
    './js/firebase-config.js?v=368',
    './js/friendship-utils.js?v=368',
    './js/habit-groups.js?v=368',
    './js/health-connect-utils.js?v=368',
    './js/metabolic-score.js?v=368',
    './js/le8-score.js?v=368',
    './js/milestone-helpers.js?v=368',
    './js/monthly-mvp-reward.js?v=368',
    './js/meditation-guide.js?v=368',
    './js/reward-market.js?v=368',
    './js/guest-demo.js?v=368',
    './js/product-events.js?v=368',
    './js/activity-days.js?v=368',
    './js/pwa-install.js?v=368',
    './js/security.js?v=368',
    './js/community-stats-view.js?v=368',
    './js/social-challenge-readiness.js?v=368',
    './js/ui-helpers.js?v=368',
    './js/upload-performance.js?v=368',
    './js/video-thumbnail-quality.js?v=368',
    './js/webview-detect.js?v=368',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
