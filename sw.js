...
const CACHE_NAME = 'habitschool-v266';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=266',
    './styles-base.css?v=266',
    './styles-en.css?v=266',
    './styles-features.css?v=266',
    './styles-reward-market.css?v=266',
    './styles-dashboard.css?v=266',
    './styles-dark-mode.css?v=266',
    './styles-reports.css?v=266',
    './styles-guest-demo.css?v=266',
    './js/main.js?v=266',
    './js/app.js?v=266',
    './js/app-core.js?v=266',
    './js/auth.js?v=266',
    './js/i18n.js?v=266',
    './js/app-mode.js?v=266',
    './js/auth-login-helpers.js?v=266',
    './js/blockchain-config.js?v=266',
    './js/blockchain-manager.js?v=266',
    './js/data-manager.js?v=266',
    './js/diet-program.js?v=266',
    './js/diet-analysis.js?v=266',
    './js/exercise-media.js?v=266',
    './js/firebase-config.js?v=266',
    './js/friendship-utils.js?v=266',
    './js/habit-groups.js?v=266',
    './js/health-connect-utils.js?v=266',
    './js/metabolic-score.js?v=266',
    './js/milestone-helpers.js?v=266',
    './js/monthly-mvp-reward.js?v=266',
    './js/meditation-guide.js?v=266',
    './js/reward-market.js?v=266',
    './js/guest-demo.js?v=266',
    './js/product-events.js?v=266',
    './js/activity-days.js?v=266',
    './js/pwa-install.js?v=266',
    './js/security.js?v=266',
    './js/social-challenge-readiness.js?v=266',
    './js/ui-helpers.js?v=266',
    './js/upload-performance.js?v=266',
    './js/video-thumbnail-quality.js?v=266',
    './js/webview-detect.js?v=266',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
