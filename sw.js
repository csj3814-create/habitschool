...
const CACHE_NAME = 'habitschool-v437';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=437',
    './styles-base.css?v=437',
    './styles-en.css?v=437',
    './styles-features.css?v=437',
    './styles-reward-market.css?v=437',
    './styles-dashboard.css?v=437',
    './styles-dark-mode.css?v=437',
    './styles-reports.css?v=437',
    './styles-guest-demo.css?v=437',
    './js/main.js?v=437',
    './js/app.js?v=437',
    './js/app-core.js?v=437',
    './js/auth.js?v=437',
    './js/i18n.js?v=437',
    './js/app-mode.js?v=437',
    './js/auth-login-helpers.js?v=437',
    './js/blockchain-config.js?v=437',
    './js/blockchain-manager.js?v=437',
    './js/challenge-claim.js?v=437',
    './js/video-compress.js?v=437',
    './js/bug-report.js?v=437',
    './js/data-manager.js?v=437',
    './js/diet-program.js?v=437',
    './js/diet-analysis.js?v=437',
    './js/exercise-media.js?v=437',
    './js/firebase-config.js?v=437',
    './js/friendship-utils.js?v=437',
    './js/habit-groups.js?v=437',
    './js/health-connect-utils.js?v=437',
    './js/metabolic-score.js?v=437',
    './js/korean.js?v=437',
    './js/le8-score.js?v=437',
    './js/milestone-helpers.js?v=437',
    './js/monthly-mvp-reward.js?v=437',
    './js/meditation-guide.js?v=437',
    ...
    './js/activity-days.js?v=437',
    './js/pwa-install.js?v=437',
    './js/media-hosts.js?v=437',
    './js/security.js?v=437',
    './js/community-stats-view.js?v=437',
    './js/social-challenge-readiness.js?v=437',
    './js/ui-helpers.js?v=437',
    './js/upload-performance.js?v=437',
    './js/video-thumbnail-quality.js?v=437',
    './js/browser-detect.js?v=437',
    './js/webview-detect.js?v=437',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
