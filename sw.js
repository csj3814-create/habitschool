...
const CACHE_NAME = 'habitschool-v385';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=385',
    './styles-base.css?v=385',
    './styles-en.css?v=385',
    './styles-features.css?v=385',
    './styles-reward-market.css?v=385',
    './styles-dashboard.css?v=385',
    './styles-dark-mode.css?v=385',
    './styles-reports.css?v=385',
    './styles-guest-demo.css?v=385',
    './js/main.js?v=385',
    './js/app.js?v=385',
    './js/app-core.js?v=385',
    './js/auth.js?v=385',
    './js/i18n.js?v=385',
    './js/app-mode.js?v=385',
    './js/auth-login-helpers.js?v=385',
    './js/blockchain-config.js?v=385',
    './js/blockchain-manager.js?v=385',
    './js/challenge-claim.js?v=385',
    './js/video-compress.js?v=385',
    './js/bug-report.js?v=385',
    './js/data-manager.js?v=385',
    './js/diet-program.js?v=385',
    './js/diet-analysis.js?v=385',
    './js/exercise-media.js?v=385',
    './js/firebase-config.js?v=385',
    './js/friendship-utils.js?v=385',
    './js/habit-groups.js?v=385',
    './js/health-connect-utils.js?v=385',
    './js/metabolic-score.js?v=385',
    './js/le8-score.js?v=385',
    './js/milestone-helpers.js?v=385',
    './js/monthly-mvp-reward.js?v=385',
    './js/meditation-guide.js?v=385',
    './js/reward-market.js?v=385',
    './js/guest-demo.js?v=385',
    './js/product-events.js?v=385',
    './js/activity-days.js?v=385',
    './js/pwa-install.js?v=385',
    './js/security.js?v=385',
    './js/community-stats-view.js?v=385',
    './js/social-challenge-readiness.js?v=385',
    './js/ui-helpers.js?v=385',
    './js/upload-performance.js?v=385',
    './js/video-thumbnail-quality.js?v=385',
    './js/browser-detect.js?v=385',
    './js/webview-detect.js?v=385',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
