...
const CACHE_NAME = 'habitschool-v344';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=344',
    './styles-base.css?v=344',
    './styles-en.css?v=344',
    './styles-features.css?v=344',
    './styles-reward-market.css?v=344',
    './styles-dashboard.css?v=344',
    './styles-dark-mode.css?v=344',
    './styles-reports.css?v=344',
    './styles-guest-demo.css?v=344',
    './js/main.js?v=344',
    './js/app.js?v=344',
    './js/app-core.js?v=344',
    './js/auth.js?v=344',
    './js/i18n.js?v=344',
    './js/app-mode.js?v=344',
    './js/auth-login-helpers.js?v=344',
    './js/blockchain-config.js?v=344',
    './js/blockchain-manager.js?v=344',
    './js/challenge-claim.js?v=344',
    './js/video-compress.js?v=344',
    './js/bug-report.js?v=344',
    './js/data-manager.js?v=344',
    './js/diet-program.js?v=344',
    './js/diet-analysis.js?v=344',
    './js/exercise-media.js?v=344',
    './js/firebase-config.js?v=344',
    './js/friendship-utils.js?v=344',
    './js/habit-groups.js?v=344',
    './js/health-connect-utils.js?v=344',
    './js/metabolic-score.js?v=344',
    './js/le8-score.js?v=344',
    './js/milestone-helpers.js?v=344',
    './js/monthly-mvp-reward.js?v=344',
    './js/meditation-guide.js?v=344',
    './js/reward-market.js?v=344',
    './js/guest-demo.js?v=344',
    './js/product-events.js?v=344',
    './js/activity-days.js?v=344',
    './js/pwa-install.js?v=344',
    './js/security.js?v=344',
    './js/social-challenge-readiness.js?v=344',
    './js/ui-helpers.js?v=344',
    './js/upload-performance.js?v=344',
    './js/video-thumbnail-quality.js?v=344',
    './js/webview-detect.js?v=344',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
