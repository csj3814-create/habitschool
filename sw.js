...
const CACHE_NAME = 'habitschool-v354';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=354',
    './styles-base.css?v=354',
    './styles-en.css?v=354',
    './styles-features.css?v=354',
    './styles-reward-market.css?v=354',
    './styles-dashboard.css?v=354',
    './styles-dark-mode.css?v=354',
    './styles-reports.css?v=354',
    './styles-guest-demo.css?v=354',
    './js/main.js?v=354',
    './js/app.js?v=354',
    './js/app-core.js?v=354',
    './js/auth.js?v=354',
    './js/i18n.js?v=354',
    './js/app-mode.js?v=354',
    './js/auth-login-helpers.js?v=354',
    './js/blockchain-config.js?v=354',
    './js/blockchain-manager.js?v=354',
    './js/challenge-claim.js?v=354',
    './js/video-compress.js?v=354',
    './js/bug-report.js?v=354',
    './js/data-manager.js?v=354',
    './js/diet-program.js?v=354',
    './js/diet-analysis.js?v=354',
    './js/exercise-media.js?v=354',
    './js/firebase-config.js?v=354',
    './js/friendship-utils.js?v=354',
    './js/habit-groups.js?v=354',
    './js/health-connect-utils.js?v=354',
    './js/metabolic-score.js?v=354',
    './js/le8-score.js?v=354',
    './js/milestone-helpers.js?v=354',
    './js/monthly-mvp-reward.js?v=354',
    './js/meditation-guide.js?v=354',
    './js/reward-market.js?v=354',
    './js/guest-demo.js?v=354',
    './js/product-events.js?v=354',
    './js/activity-days.js?v=354',
    './js/pwa-install.js?v=354',
    './js/security.js?v=354',
    './js/community-stats-view.js?v=354',
    './js/social-challenge-readiness.js?v=354',
    './js/ui-helpers.js?v=354',
    './js/upload-performance.js?v=354',
    './js/video-thumbnail-quality.js?v=354',
    './js/webview-detect.js?v=354',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
