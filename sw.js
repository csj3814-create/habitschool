...
const CACHE_NAME = 'habitschool-v329';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=329',
    './styles-base.css?v=329',
    './styles-en.css?v=329',
    './styles-features.css?v=329',
    './styles-reward-market.css?v=329',
    './styles-dashboard.css?v=329',
    './styles-dark-mode.css?v=329',
    './styles-reports.css?v=329',
    './styles-guest-demo.css?v=329',
    './js/main.js?v=329',
    './js/app.js?v=329',
    './js/app-core.js?v=329',
    './js/auth.js?v=329',
    './js/i18n.js?v=329',
    './js/app-mode.js?v=329',
    './js/auth-login-helpers.js?v=329',
    './js/blockchain-config.js?v=329',
    './js/blockchain-manager.js?v=329',
    './js/challenge-claim.js?v=329',
    './js/video-compress.js?v=329',
    './js/data-manager.js?v=329',
    './js/diet-program.js?v=329',
    './js/diet-analysis.js?v=329',
    './js/exercise-media.js?v=329',
    './js/firebase-config.js?v=329',
    './js/friendship-utils.js?v=329',
    './js/habit-groups.js?v=329',
    './js/health-connect-utils.js?v=329',
    './js/metabolic-score.js?v=329',
    './js/milestone-helpers.js?v=329',
    './js/monthly-mvp-reward.js?v=329',
    './js/meditation-guide.js?v=329',
    './js/reward-market.js?v=329',
    './js/guest-demo.js?v=329',
    './js/product-events.js?v=329',
    './js/activity-days.js?v=329',
    './js/pwa-install.js?v=329',
    './js/security.js?v=329',
    './js/social-challenge-readiness.js?v=329',
    './js/ui-helpers.js?v=329',
    './js/upload-performance.js?v=329',
    './js/video-thumbnail-quality.js?v=329',
    './js/webview-detect.js?v=329',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
