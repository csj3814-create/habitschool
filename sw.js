...
const CACHE_NAME = 'habitschool-v264';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=264',
    './styles-base.css?v=264',
    './styles-en.css?v=264',
    './styles-features.css?v=264',
    './styles-reward-market.css?v=264',
    './styles-dashboard.css?v=264',
    './styles-dark-mode.css?v=264',
    './styles-reports.css?v=264',
    './styles-guest-demo.css?v=264',
    './js/main.js?v=264',
    './js/app.js?v=264',
    './js/app-core.js?v=264',
    './js/auth.js?v=264',
    './js/i18n.js?v=264',
    './js/app-mode.js?v=264',
    './js/auth-login-helpers.js?v=264',
    './js/blockchain-config.js?v=264',
    './js/blockchain-manager.js?v=264',
    './js/data-manager.js?v=264',
    './js/diet-program.js?v=264',
    './js/diet-analysis.js?v=264',
    './js/exercise-media.js?v=264',
    './js/firebase-config.js?v=264',
    './js/friendship-utils.js?v=264',
    './js/habit-groups.js?v=264',
    './js/health-connect-utils.js?v=264',
    './js/metabolic-score.js?v=264',
    './js/milestone-helpers.js?v=264',
    './js/monthly-mvp-reward.js?v=264',
    './js/meditation-guide.js?v=264',
    './js/reward-market.js?v=264',
    './js/guest-demo.js?v=264',
    './js/product-events.js?v=264',
    './js/activity-days.js?v=264',
    './js/pwa-install.js?v=264',
    './js/security.js?v=264',
    './js/social-challenge-readiness.js?v=264',
    './js/ui-helpers.js?v=264',
    './js/upload-performance.js?v=264',
    './js/video-thumbnail-quality.js?v=264',
    './js/webview-detect.js?v=264',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
