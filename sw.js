...
const CACHE_NAME = 'habitschool-v412';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=412',
    './styles-base.css?v=412',
    './styles-en.css?v=412',
    './styles-features.css?v=412',
    './styles-reward-market.css?v=412',
    './styles-dashboard.css?v=412',
    './styles-dark-mode.css?v=412',
    './styles-reports.css?v=412',
    './styles-guest-demo.css?v=412',
    './js/main.js?v=412',
    './js/app.js?v=412',
    './js/app-core.js?v=412',
    './js/auth.js?v=412',
    './js/i18n.js?v=412',
    './js/app-mode.js?v=412',
    './js/auth-login-helpers.js?v=412',
    './js/blockchain-config.js?v=412',
    './js/blockchain-manager.js?v=412',
    './js/challenge-claim.js?v=412',
    './js/video-compress.js?v=412',
    './js/bug-report.js?v=412',
    './js/data-manager.js?v=412',
    './js/diet-program.js?v=412',
    './js/diet-analysis.js?v=412',
    './js/exercise-media.js?v=412',
    './js/firebase-config.js?v=412',
    './js/friendship-utils.js?v=412',
    './js/habit-groups.js?v=412',
    './js/health-connect-utils.js?v=412',
    './js/metabolic-score.js?v=412',
    './js/le8-score.js?v=412',
    './js/milestone-helpers.js?v=412',
    './js/monthly-mvp-reward.js?v=412',
    './js/meditation-guide.js?v=412',
    './js/reward-market.js?v=412',
    './js/guest-demo.js?v=412',
    './js/product-events.js?v=412',
    './js/activity-days.js?v=412',
    './js/pwa-install.js?v=412',
    './js/security.js?v=412',
    './js/community-stats-view.js?v=412',
    './js/social-challenge-readiness.js?v=412',
    './js/ui-helpers.js?v=412',
    './js/upload-performance.js?v=412',
    './js/video-thumbnail-quality.js?v=412',
    './js/browser-detect.js?v=412',
    './js/webview-detect.js?v=412',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
