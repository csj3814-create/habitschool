...
const CACHE_NAME = 'habitschool-v366';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=366',
    './styles-base.css?v=366',
    './styles-en.css?v=366',
    './styles-features.css?v=366',
    './styles-reward-market.css?v=366',
    './styles-dashboard.css?v=366',
    './styles-dark-mode.css?v=366',
    './styles-reports.css?v=366',
    './styles-guest-demo.css?v=366',
    './js/main.js?v=366',
    './js/app.js?v=366',
    './js/app-core.js?v=366',
    './js/auth.js?v=366',
    './js/i18n.js?v=366',
    './js/app-mode.js?v=366',
    './js/auth-login-helpers.js?v=366',
    './js/blockchain-config.js?v=366',
    './js/blockchain-manager.js?v=366',
    './js/challenge-claim.js?v=366',
    './js/video-compress.js?v=366',
    './js/bug-report.js?v=366',
    './js/data-manager.js?v=366',
    './js/diet-program.js?v=366',
    './js/diet-analysis.js?v=366',
    './js/exercise-media.js?v=366',
    './js/firebase-config.js?v=366',
    './js/friendship-utils.js?v=366',
    './js/habit-groups.js?v=366',
    './js/health-connect-utils.js?v=366',
    './js/metabolic-score.js?v=366',
    './js/le8-score.js?v=366',
    './js/milestone-helpers.js?v=366',
    './js/monthly-mvp-reward.js?v=366',
    './js/meditation-guide.js?v=366',
    './js/reward-market.js?v=366',
    './js/guest-demo.js?v=366',
    './js/product-events.js?v=366',
    './js/activity-days.js?v=366',
    './js/pwa-install.js?v=366',
    './js/security.js?v=366',
    './js/community-stats-view.js?v=366',
    './js/social-challenge-readiness.js?v=366',
    './js/ui-helpers.js?v=366',
    './js/upload-performance.js?v=366',
    './js/video-thumbnail-quality.js?v=366',
    './js/webview-detect.js?v=366',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
