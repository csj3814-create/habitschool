...
const CACHE_NAME = 'habitschool-v305';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=305',
    './styles-base.css?v=305',
    './styles-en.css?v=305',
    './styles-features.css?v=305',
    './styles-reward-market.css?v=305',
    './styles-dashboard.css?v=305',
    './styles-dark-mode.css?v=305',
    './styles-reports.css?v=305',
    './styles-guest-demo.css?v=305',
    './js/main.js?v=305',
    './js/app.js?v=305',
    './js/app-core.js?v=305',
    './js/auth.js?v=305',
    './js/i18n.js?v=305',
    './js/app-mode.js?v=305',
    './js/auth-login-helpers.js?v=305',
    './js/blockchain-config.js?v=305',
    './js/blockchain-manager.js?v=305',
    './js/challenge-claim.js?v=305',
    './js/data-manager.js?v=305',
    './js/diet-program.js?v=305',
    './js/diet-analysis.js?v=305',
    './js/exercise-media.js?v=305',
    './js/firebase-config.js?v=305',
    './js/friendship-utils.js?v=305',
    './js/habit-groups.js?v=305',
    './js/health-connect-utils.js?v=305',
    './js/metabolic-score.js?v=305',
    './js/milestone-helpers.js?v=305',
    './js/monthly-mvp-reward.js?v=305',
    './js/meditation-guide.js?v=305',
    './js/reward-market.js?v=305',
    './js/guest-demo.js?v=305',
    './js/product-events.js?v=305',
    './js/activity-days.js?v=305',
    './js/pwa-install.js?v=305',
    './js/security.js?v=305',
    './js/social-challenge-readiness.js?v=305',
    './js/ui-helpers.js?v=305',
    './js/upload-performance.js?v=305',
    './js/video-thumbnail-quality.js?v=305',
    './js/webview-detect.js?v=305',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
