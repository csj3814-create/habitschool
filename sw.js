...
const CACHE_NAME = 'habitschool-v182';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=182',
    './styles-base.css?v=182',
    './styles-features.css?v=182',
    './styles-reward-market.css?v=182',
    './styles-dashboard.css?v=182',
    './styles-dark-mode.css?v=182',
    './styles-reports.css?v=182',
    './js/main.js?v=182',
    './js/app.js?v=182',
    './js/app-core.js?v=182',
    './js/auth.js?v=182',
    './js/app-mode.js?v=182',
    './js/auth-login-helpers.js?v=182',
    './js/blockchain-config.js?v=182',
    './js/blockchain-manager.js?v=182',
    './js/data-manager.js?v=182',
    './js/diet-program.js?v=182',
    './js/diet-analysis.js?v=182',
    './js/exercise-media.js?v=182',
    './js/firebase-config.js?v=182',
    './js/health-connect-utils.js?v=182',
    './js/metabolic-score.js?v=182',
    './js/milestone-helpers.js?v=182',
    './js/monthly-mvp-reward.js?v=182',
    './js/pwa-install.js?v=182',
    './js/security.js?v=182',
    './js/social-challenge-readiness.js?v=182',
    './js/ui-helpers.js?v=182',
    './js/upload-performance.js?v=182',
    './js/webview-detect.js?v=182',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
