...
const CACHE_NAME = 'habitschool-v185';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=185',
    './styles-base.css?v=185',
    './styles-features.css?v=185',
    './styles-reward-market.css?v=185',
    './styles-dashboard.css?v=185',
    './styles-dark-mode.css?v=185',
    './styles-reports.css?v=185',
    './js/main.js?v=185',
    './js/app.js?v=185',
    './js/app-core.js?v=185',
    './js/auth.js?v=185',
    './js/app-mode.js?v=185',
    './js/auth-login-helpers.js?v=185',
    './js/blockchain-config.js?v=185',
    './js/blockchain-manager.js?v=185',
    './js/data-manager.js?v=185',
    './js/diet-program.js?v=185',
    './js/diet-analysis.js?v=185',
    './js/exercise-media.js?v=185',
    './js/firebase-config.js?v=185',
    './js/health-connect-utils.js?v=185',
    './js/metabolic-score.js?v=185',
    './js/milestone-helpers.js?v=185',
    './js/monthly-mvp-reward.js?v=185',
    './js/pwa-install.js?v=185',
    './js/security.js?v=185',
    './js/social-challenge-readiness.js?v=185',
    './js/ui-helpers.js?v=185',
    './js/upload-performance.js?v=185',
    './js/webview-detect.js?v=185',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
