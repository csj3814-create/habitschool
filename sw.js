...
const CACHE_NAME = 'habitschool-v360';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=360',
    './styles-base.css?v=360',
    './styles-en.css?v=360',
    './styles-features.css?v=360',
    './styles-reward-market.css?v=360',
    './styles-dashboard.css?v=360',
    './styles-dark-mode.css?v=360',
    './styles-reports.css?v=360',
    './styles-guest-demo.css?v=360',
    './js/main.js?v=360',
    './js/app.js?v=360',
    './js/app-core.js?v=360',
    './js/auth.js?v=360',
    './js/i18n.js?v=360',
    './js/app-mode.js?v=360',
    './js/auth-login-helpers.js?v=360',
    './js/blockchain-config.js?v=360',
    './js/blockchain-manager.js?v=360',
    './js/challenge-claim.js?v=360',
    './js/video-compress.js?v=360',
    './js/bug-report.js?v=360',
    './js/data-manager.js?v=360',
    './js/diet-program.js?v=360',
    './js/diet-analysis.js?v=360',
    './js/exercise-media.js?v=360',
    './js/firebase-config.js?v=360',
    './js/friendship-utils.js?v=360',
    './js/habit-groups.js?v=360',
    './js/health-connect-utils.js?v=360',
    './js/metabolic-score.js?v=360',
    './js/le8-score.js?v=360',
    './js/milestone-helpers.js?v=360',
    './js/monthly-mvp-reward.js?v=360',
    './js/meditation-guide.js?v=360',
    './js/reward-market.js?v=360',
    './js/guest-demo.js?v=360',
    './js/product-events.js?v=360',
    './js/activity-days.js?v=360',
    './js/pwa-install.js?v=360',
    './js/security.js?v=360',
    './js/community-stats-view.js?v=360',
    './js/social-challenge-readiness.js?v=360',
    './js/ui-helpers.js?v=360',
    './js/upload-performance.js?v=360',
    './js/video-thumbnail-quality.js?v=360',
    './js/webview-detect.js?v=360',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
