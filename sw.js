...
const CACHE_NAME = 'habitschool-v391';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=391',
    './styles-base.css?v=391',
    './styles-en.css?v=391',
    './styles-features.css?v=391',
    './styles-reward-market.css?v=391',
    './styles-dashboard.css?v=391',
    './styles-dark-mode.css?v=391',
    './styles-reports.css?v=391',
    './styles-guest-demo.css?v=391',
    './js/main.js?v=391',
    './js/app.js?v=391',
    './js/app-core.js?v=391',
    './js/auth.js?v=391',
    './js/i18n.js?v=391',
    './js/app-mode.js?v=391',
    './js/auth-login-helpers.js?v=391',
    './js/blockchain-config.js?v=391',
    './js/blockchain-manager.js?v=391',
    './js/challenge-claim.js?v=391',
    './js/video-compress.js?v=391',
    './js/bug-report.js?v=391',
    './js/data-manager.js?v=391',
    './js/diet-program.js?v=391',
    './js/diet-analysis.js?v=391',
    './js/exercise-media.js?v=391',
    './js/firebase-config.js?v=391',
    './js/friendship-utils.js?v=391',
    './js/habit-groups.js?v=391',
    './js/health-connect-utils.js?v=391',
    './js/metabolic-score.js?v=391',
    './js/le8-score.js?v=391',
    './js/milestone-helpers.js?v=391',
    './js/monthly-mvp-reward.js?v=391',
    './js/meditation-guide.js?v=391',
    './js/reward-market.js?v=391',
    './js/guest-demo.js?v=391',
    './js/product-events.js?v=391',
    './js/activity-days.js?v=391',
    './js/pwa-install.js?v=391',
    './js/security.js?v=391',
    './js/community-stats-view.js?v=391',
    './js/social-challenge-readiness.js?v=391',
    './js/ui-helpers.js?v=391',
    './js/upload-performance.js?v=391',
    './js/video-thumbnail-quality.js?v=391',
    './js/browser-detect.js?v=391',
    './js/webview-detect.js?v=391',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
