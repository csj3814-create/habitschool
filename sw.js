...
const CACHE_NAME = 'habitschool-v410';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=410',
    './styles-base.css?v=410',
    './styles-en.css?v=410',
    './styles-features.css?v=410',
    './styles-reward-market.css?v=410',
    './styles-dashboard.css?v=410',
    './styles-dark-mode.css?v=410',
    './styles-reports.css?v=410',
    './styles-guest-demo.css?v=410',
    './js/main.js?v=410',
    './js/app.js?v=410',
    './js/app-core.js?v=410',
    './js/auth.js?v=410',
    './js/i18n.js?v=410',
    './js/app-mode.js?v=410',
    './js/auth-login-helpers.js?v=410',
    './js/blockchain-config.js?v=410',
    './js/blockchain-manager.js?v=410',
    './js/challenge-claim.js?v=410',
    './js/video-compress.js?v=410',
    './js/bug-report.js?v=410',
    './js/data-manager.js?v=410',
    './js/diet-program.js?v=410',
    './js/diet-analysis.js?v=410',
    './js/exercise-media.js?v=410',
    './js/firebase-config.js?v=410',
    './js/friendship-utils.js?v=410',
    './js/habit-groups.js?v=410',
    './js/health-connect-utils.js?v=410',
    './js/metabolic-score.js?v=410',
    './js/le8-score.js?v=410',
    './js/milestone-helpers.js?v=410',
    './js/monthly-mvp-reward.js?v=410',
    './js/meditation-guide.js?v=410',
    './js/reward-market.js?v=410',
    './js/guest-demo.js?v=410',
    './js/product-events.js?v=410',
    './js/activity-days.js?v=410',
    './js/pwa-install.js?v=410',
    './js/security.js?v=410',
    './js/community-stats-view.js?v=410',
    './js/social-challenge-readiness.js?v=410',
    './js/ui-helpers.js?v=410',
    './js/upload-performance.js?v=410',
    './js/video-thumbnail-quality.js?v=410',
    './js/browser-detect.js?v=410',
    './js/webview-detect.js?v=410',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
