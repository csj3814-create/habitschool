...
const CACHE_NAME = 'habitschool-v346';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=346',
    './styles-base.css?v=346',
    './styles-en.css?v=346',
    './styles-features.css?v=346',
    './styles-reward-market.css?v=346',
    './styles-dashboard.css?v=346',
    './styles-dark-mode.css?v=346',
    './styles-reports.css?v=346',
    './styles-guest-demo.css?v=346',
    './js/main.js?v=346',
    './js/app.js?v=346',
    './js/app-core.js?v=346',
    './js/auth.js?v=346',
    './js/i18n.js?v=346',
    './js/app-mode.js?v=346',
    './js/auth-login-helpers.js?v=346',
    './js/blockchain-config.js?v=346',
    './js/blockchain-manager.js?v=346',
    './js/challenge-claim.js?v=346',
    './js/video-compress.js?v=346',
    './js/bug-report.js?v=346',
    './js/data-manager.js?v=346',
    './js/diet-program.js?v=346',
    './js/diet-analysis.js?v=346',
    './js/exercise-media.js?v=346',
    './js/firebase-config.js?v=346',
    './js/friendship-utils.js?v=346',
    './js/habit-groups.js?v=346',
    './js/health-connect-utils.js?v=346',
    './js/metabolic-score.js?v=346',
    './js/le8-score.js?v=346',
    './js/milestone-helpers.js?v=346',
    './js/monthly-mvp-reward.js?v=346',
    './js/meditation-guide.js?v=346',
    './js/reward-market.js?v=346',
    './js/guest-demo.js?v=346',
    './js/product-events.js?v=346',
    './js/activity-days.js?v=346',
    './js/pwa-install.js?v=346',
    './js/security.js?v=346',
    './js/social-challenge-readiness.js?v=346',
    './js/ui-helpers.js?v=346',
    './js/upload-performance.js?v=346',
    './js/video-thumbnail-quality.js?v=346',
    './js/webview-detect.js?v=346',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
