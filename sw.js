...
const CACHE_NAME = 'habitschool-v324';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=324',
    './styles-base.css?v=324',
    './styles-en.css?v=324',
    './styles-features.css?v=324',
    './styles-reward-market.css?v=324',
    './styles-dashboard.css?v=324',
    './styles-dark-mode.css?v=324',
    './styles-reports.css?v=324',
    './styles-guest-demo.css?v=324',
    './js/main.js?v=324',
    './js/app.js?v=324',
    './js/app-core.js?v=324',
    './js/auth.js?v=324',
    './js/i18n.js?v=324',
    './js/app-mode.js?v=324',
    './js/auth-login-helpers.js?v=324',
    './js/blockchain-config.js?v=324',
    './js/blockchain-manager.js?v=324',
    './js/challenge-claim.js?v=324',
    './js/data-manager.js?v=324',
    './js/diet-program.js?v=324',
    './js/diet-analysis.js?v=324',
    './js/exercise-media.js?v=324',
    './js/firebase-config.js?v=324',
    './js/friendship-utils.js?v=324',
    './js/habit-groups.js?v=324',
    './js/health-connect-utils.js?v=324',
    './js/metabolic-score.js?v=324',
    './js/milestone-helpers.js?v=324',
    './js/monthly-mvp-reward.js?v=324',
    './js/meditation-guide.js?v=324',
    './js/reward-market.js?v=324',
    './js/guest-demo.js?v=324',
    './js/product-events.js?v=324',
    './js/activity-days.js?v=324',
    './js/pwa-install.js?v=324',
    './js/security.js?v=324',
    './js/social-challenge-readiness.js?v=324',
    './js/ui-helpers.js?v=324',
    './js/upload-performance.js?v=324',
    './js/video-thumbnail-quality.js?v=324',
    './js/webview-detect.js?v=324',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
