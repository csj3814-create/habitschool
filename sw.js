...
const CACHE_NAME = 'habitschool-v345';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=345',
    './styles-base.css?v=345',
    './styles-en.css?v=345',
    './styles-features.css?v=345',
    './styles-reward-market.css?v=345',
    './styles-dashboard.css?v=345',
    './styles-dark-mode.css?v=345',
    './styles-reports.css?v=345',
    './styles-guest-demo.css?v=345',
    './js/main.js?v=345',
    './js/app.js?v=345',
    './js/app-core.js?v=345',
    './js/auth.js?v=345',
    './js/i18n.js?v=345',
    './js/app-mode.js?v=345',
    './js/auth-login-helpers.js?v=345',
    './js/blockchain-config.js?v=345',
    './js/blockchain-manager.js?v=345',
    './js/challenge-claim.js?v=345',
    './js/video-compress.js?v=345',
    './js/bug-report.js?v=345',
    './js/data-manager.js?v=345',
    './js/diet-program.js?v=345',
    './js/diet-analysis.js?v=345',
    './js/exercise-media.js?v=345',
    './js/firebase-config.js?v=345',
    './js/friendship-utils.js?v=345',
    './js/habit-groups.js?v=345',
    './js/health-connect-utils.js?v=345',
    './js/metabolic-score.js?v=345',
    './js/le8-score.js?v=345',
    './js/milestone-helpers.js?v=345',
    './js/monthly-mvp-reward.js?v=345',
    './js/meditation-guide.js?v=345',
    './js/reward-market.js?v=345',
    './js/guest-demo.js?v=345',
    './js/product-events.js?v=345',
    './js/activity-days.js?v=345',
    './js/pwa-install.js?v=345',
    './js/security.js?v=345',
    './js/social-challenge-readiness.js?v=345',
    './js/ui-helpers.js?v=345',
    './js/upload-performance.js?v=345',
    './js/video-thumbnail-quality.js?v=345',
    './js/webview-detect.js?v=345',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
