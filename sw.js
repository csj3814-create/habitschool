...
const CACHE_NAME = 'habitschool-v353';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=353',
    './styles-base.css?v=353',
    './styles-en.css?v=353',
    './styles-features.css?v=353',
    './styles-reward-market.css?v=353',
    './styles-dashboard.css?v=353',
    './styles-dark-mode.css?v=353',
    './styles-reports.css?v=353',
    './styles-guest-demo.css?v=353',
    './js/main.js?v=353',
    './js/app.js?v=353',
    './js/app-core.js?v=353',
    './js/auth.js?v=353',
    './js/i18n.js?v=353',
    './js/app-mode.js?v=353',
    './js/auth-login-helpers.js?v=353',
    './js/blockchain-config.js?v=353',
    './js/blockchain-manager.js?v=353',
    './js/challenge-claim.js?v=353',
    './js/video-compress.js?v=353',
    './js/bug-report.js?v=353',
    './js/data-manager.js?v=353',
    './js/diet-program.js?v=353',
    './js/diet-analysis.js?v=353',
    './js/exercise-media.js?v=353',
    './js/firebase-config.js?v=353',
    './js/friendship-utils.js?v=353',
    './js/habit-groups.js?v=353',
    './js/health-connect-utils.js?v=353',
    './js/metabolic-score.js?v=353',
    './js/le8-score.js?v=353',
    './js/milestone-helpers.js?v=353',
    './js/monthly-mvp-reward.js?v=353',
    './js/meditation-guide.js?v=353',
    './js/reward-market.js?v=353',
    './js/guest-demo.js?v=353',
    './js/product-events.js?v=353',
    './js/activity-days.js?v=353',
    './js/pwa-install.js?v=353',
    './js/security.js?v=353',
    './js/community-stats-view.js?v=353',
    './js/social-challenge-readiness.js?v=353',
    './js/ui-helpers.js?v=353',
    './js/upload-performance.js?v=353',
    './js/video-thumbnail-quality.js?v=353',
    './js/webview-detect.js?v=353',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
