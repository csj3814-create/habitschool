...
const CACHE_NAME = 'habitschool-v334';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=334',
    './styles-base.css?v=334',
    './styles-en.css?v=334',
    './styles-features.css?v=334',
    './styles-reward-market.css?v=334',
    './styles-dashboard.css?v=334',
    './styles-dark-mode.css?v=334',
    './styles-reports.css?v=334',
    './styles-guest-demo.css?v=334',
    './js/main.js?v=334',
    './js/app.js?v=334',
    './js/app-core.js?v=334',
    './js/auth.js?v=334',
    './js/i18n.js?v=334',
    './js/app-mode.js?v=334',
    './js/auth-login-helpers.js?v=334',
    './js/blockchain-config.js?v=334',
    './js/blockchain-manager.js?v=334',
    './js/challenge-claim.js?v=334',
    './js/video-compress.js?v=334',
    './js/data-manager.js?v=334',
    './js/diet-program.js?v=334',
    './js/diet-analysis.js?v=334',
    './js/exercise-media.js?v=334',
    './js/firebase-config.js?v=334',
    './js/friendship-utils.js?v=334',
    './js/habit-groups.js?v=334',
    './js/health-connect-utils.js?v=334',
    './js/metabolic-score.js?v=334',
    './js/milestone-helpers.js?v=334',
    './js/monthly-mvp-reward.js?v=334',
    './js/meditation-guide.js?v=334',
    './js/reward-market.js?v=334',
    './js/guest-demo.js?v=334',
    './js/product-events.js?v=334',
    './js/activity-days.js?v=334',
    './js/pwa-install.js?v=334',
    './js/security.js?v=334',
    './js/social-challenge-readiness.js?v=334',
    './js/ui-helpers.js?v=334',
    './js/upload-performance.js?v=334',
    './js/video-thumbnail-quality.js?v=334',
    './js/webview-detect.js?v=334',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
