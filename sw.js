...
const CACHE_NAME = 'habitschool-v446';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=446',
    './styles-base.css?v=446',
    './styles-en.css?v=446',
    './styles-features.css?v=446',
    './styles-reward-market.css?v=446',
    './styles-dashboard.css?v=446',
    './styles-dark-mode.css?v=446',
    './styles-reports.css?v=446',
    './styles-guest-demo.css?v=446',
    './js/main.js?v=446',
    './js/app.js?v=446',
    './js/app-core.js?v=446',
    './js/auth.js?v=446',
    './js/i18n.js?v=446',
    './js/app-mode.js?v=446',
    './js/auth-login-helpers.js?v=446',
    './js/blockchain-config.js?v=446',
    './js/blockchain-manager.js?v=446',
    './js/challenge-claim.js?v=446',
    './js/video-compress.js?v=446',
    './js/bug-report.js?v=446',
    './js/data-manager.js?v=446',
    './js/diet-program.js?v=446',
    './js/diet-analysis.js?v=446',
    './js/exercise-media.js?v=446',
    './js/firebase-config.js?v=446',
    './js/friendship-utils.js?v=446',
    './js/habit-groups.js?v=446',
    './js/health-connect-utils.js?v=446',
    './js/metabolic-score.js?v=446',
    './js/korean.js?v=446',
    './js/le8-score.js?v=446',
    './js/milestone-helpers.js?v=446',
    './js/monthly-mvp-reward.js?v=446',
    './js/meditation-guide.js?v=446',
    './js/reward-market.js?v=446',
    './js/body-composition-csv.js?v=446',
    './js/mission-gate.js?v=446',
    './js/health-connect-body.js?v=446',
    './js/reward-pace.js?v=446',
    './js/guest-demo.js?v=446',
    './js/product-events.js?v=446',
    './js/activity-days.js?v=446',
    './js/pwa-install.js?v=446',
    './js/media-hosts.js?v=446',
    './js/security.js?v=446',
    './js/community-stats-view.js?v=446',
    './js/social-challenge-readiness.js?v=446',
    './js/ui-helpers.js?v=446',
    './js/upload-performance.js?v=446',
    './js/video-thumbnail-quality.js?v=446',
    './js/browser-detect.js?v=446',
    './js/webview-detect.js?v=446',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
