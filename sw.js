...
const CACHE_NAME = 'habitschool-v356';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=356',
    './styles-base.css?v=356',
    './styles-en.css?v=356',
    './styles-features.css?v=356',
    './styles-reward-market.css?v=356',
    './styles-dashboard.css?v=356',
    './styles-dark-mode.css?v=356',
    './styles-reports.css?v=356',
    './styles-guest-demo.css?v=356',
    './js/main.js?v=356',
    './js/app.js?v=356',
    './js/app-core.js?v=356',
    './js/auth.js?v=356',
    './js/i18n.js?v=356',
    './js/app-mode.js?v=356',
    './js/auth-login-helpers.js?v=356',
    './js/blockchain-config.js?v=356',
    './js/blockchain-manager.js?v=356',
    './js/challenge-claim.js?v=356',
    './js/video-compress.js?v=356',
    './js/bug-report.js?v=356',
    './js/data-manager.js?v=356',
    './js/diet-program.js?v=356',
    './js/diet-analysis.js?v=356',
    './js/exercise-media.js?v=356',
    './js/firebase-config.js?v=356',
    './js/friendship-utils.js?v=356',
    './js/habit-groups.js?v=356',
    './js/health-connect-utils.js?v=356',
    './js/metabolic-score.js?v=356',
    './js/le8-score.js?v=356',
    './js/milestone-helpers.js?v=356',
    './js/monthly-mvp-reward.js?v=356',
    './js/meditation-guide.js?v=356',
    './js/reward-market.js?v=356',
    './js/guest-demo.js?v=356',
    './js/product-events.js?v=356',
    './js/activity-days.js?v=356',
    './js/pwa-install.js?v=356',
    './js/security.js?v=356',
    './js/community-stats-view.js?v=356',
    './js/social-challenge-readiness.js?v=356',
    './js/ui-helpers.js?v=356',
    './js/upload-performance.js?v=356',
    './js/video-thumbnail-quality.js?v=356',
    './js/webview-detect.js?v=356',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
