...
const CACHE_NAME = 'habitschool-v196';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=196',
    './styles-base.css?v=196',
    './styles-features.css?v=196',
    './styles-reward-market.css?v=196',
    './styles-dashboard.css?v=196',
    './styles-dark-mode.css?v=196',
    './styles-reports.css?v=196',
    './js/main.js?v=196',
    './js/app.js?v=196',
    './js/app-core.js?v=196',
    './js/auth.js?v=196',
    './js/app-mode.js?v=196',
    './js/auth-login-helpers.js?v=196',
    './js/blockchain-config.js?v=196',
    './js/blockchain-manager.js?v=196',
    './js/data-manager.js?v=196',
    './js/diet-program.js?v=196',
    './js/diet-analysis.js?v=196',
    './js/exercise-media.js?v=196',
    './js/firebase-config.js?v=196',
    './js/health-connect-utils.js?v=196',
    './js/metabolic-score.js?v=196',
    './js/milestone-helpers.js?v=196',
    './js/monthly-mvp-reward.js?v=196',
    './js/pwa-install.js?v=196',
    './js/security.js?v=196',
    './js/social-challenge-readiness.js?v=196',
    './js/ui-helpers.js?v=196',
    './js/upload-performance.js?v=196',
    './js/webview-detect.js?v=196',
    './manifest.json',
    './icons/icon-192.png',
    './icons/icon-192.svg',
    './icons/icon-512.png',
