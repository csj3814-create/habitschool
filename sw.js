...
const CACHE_NAME = 'habitschool-v348';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=348',
    './styles-base.css?v=348',
    './styles-en.css?v=348',
    './styles-features.css?v=348',
    './styles-reward-market.css?v=348',
    './styles-dashboard.css?v=348',
    './styles-dark-mode.css?v=348',
    './styles-reports.css?v=348',
    './styles-guest-demo.css?v=348',
    './js/main.js?v=348',
    './js/app.js?v=348',
    './js/app-core.js?v=348',
    './js/auth.js?v=348',
    './js/i18n.js?v=348',
    './js/app-mode.js?v=348',
    './js/auth-login-helpers.js?v=348',
    './js/blockchain-config.js?v=348',
    './js/blockchain-manager.js?v=348',
    './js/challenge-claim.js?v=348',
    './js/video-compress.js?v=348',
    './js/bug-report.js?v=348',
    './js/data-manager.js?v=348',
    './js/diet-program.js?v=348',
    './js/diet-analysis.js?v=348',
    './js/exercise-media.js?v=348',
    './js/firebase-config.js?v=348',
    './js/friendship-utils.js?v=348',
    './js/habit-groups.js?v=348',
    './js/health-connect-utils.js?v=348',
    './js/metabolic-score.js?v=348',
    './js/le8-score.js?v=348',
    './js/milestone-helpers.js?v=348',
    './js/monthly-mvp-reward.js?v=348',
    './js/meditation-guide.js?v=348',
    './js/reward-market.js?v=348',
    './js/guest-demo.js?v=348',
    './js/product-events.js?v=348',
    './js/activity-days.js?v=348',
    './js/pwa-install.js?v=348',
    './js/security.js?v=348',
    './js/social-challenge-readiness.js?v=348',
    './js/ui-helpers.js?v=348',
    './js/upload-performance.js?v=348',
    './js/video-thumbnail-quality.js?v=348',
    './js/webview-detect.js?v=348',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
