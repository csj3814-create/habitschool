...
const CACHE_NAME = 'habitschool-v240';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=240',
    './styles-base.css?v=240',
    './styles-en.css?v=240',
    './styles-features.css?v=240',
    './styles-reward-market.css?v=240',
    './styles-dashboard.css?v=240',
    './styles-dark-mode.css?v=240',
    './styles-reports.css?v=240',
    './styles-guest-demo.css?v=240',
    './js/main.js?v=240',
    './js/app.js?v=240',
    './js/app-core.js?v=240',
    './js/auth.js?v=240',
    './js/i18n.js?v=240',
    './js/app-mode.js?v=240',
    './js/auth-login-helpers.js?v=240',
    './js/blockchain-config.js?v=240',
    './js/blockchain-manager.js?v=240',
    './js/data-manager.js?v=240',
    './js/diet-program.js?v=240',
    './js/diet-analysis.js?v=240',
    './js/exercise-media.js?v=240',
    './js/firebase-config.js?v=240',
    './js/friendship-utils.js?v=240',
    './js/habit-groups.js?v=240',
    './js/health-connect-utils.js?v=240',
    './js/metabolic-score.js?v=240',
    './js/milestone-helpers.js?v=240',
    './js/monthly-mvp-reward.js?v=240',
    './js/meditation-guide.js?v=240',
    './js/reward-market.js?v=240',
    './js/guest-demo.js?v=240',
    './js/product-events.js?v=240',
    './js/activity-days.js?v=240',
    './js/pwa-install.js?v=240',
    './js/security.js?v=240',
    './js/social-challenge-readiness.js?v=240',
    './js/ui-helpers.js?v=240',
    './js/upload-performance.js?v=240',
    './js/webview-detect.js?v=240',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
