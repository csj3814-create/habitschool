...
const CACHE_NAME = 'habitschool-v232';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=232',
    './styles-base.css?v=232',
    './styles-en.css?v=232',
    './styles-features.css?v=232',
    './styles-reward-market.css?v=232',
    './styles-dashboard.css?v=232',
    './styles-dark-mode.css?v=232',
    './styles-reports.css?v=232',
    './styles-guest-demo.css?v=232',
    './js/main.js?v=232',
    './js/app.js?v=232',
    './js/app-core.js?v=232',
    './js/auth.js?v=232',
    './js/i18n.js?v=232',
    './js/app-mode.js?v=232',
    './js/auth-login-helpers.js?v=232',
    './js/blockchain-config.js?v=232',
    './js/blockchain-manager.js?v=232',
    './js/data-manager.js?v=232',
    './js/diet-program.js?v=232',
    './js/diet-analysis.js?v=232',
    './js/exercise-media.js?v=232',
    './js/firebase-config.js?v=232',
    './js/friendship-utils.js?v=232',
    './js/habit-groups.js?v=232',
    './js/health-connect-utils.js?v=232',
    './js/metabolic-score.js?v=232',
    './js/milestone-helpers.js?v=232',
    './js/monthly-mvp-reward.js?v=232',
    './js/meditation-guide.js?v=232',
    './js/reward-market.js?v=232',
    './js/guest-demo.js?v=232',
    './js/product-events.js?v=232',
    './js/activity-days.js?v=232',
    './js/pwa-install.js?v=232',
    './js/security.js?v=232',
    './js/social-challenge-readiness.js?v=232',
    './js/ui-helpers.js?v=232',
    './js/upload-performance.js?v=232',
    './js/webview-detect.js?v=232',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
