...
const CACHE_NAME = 'habitschool-v285';
...
const STATIC_ASSETS = [
    './',
    './styles.css?v=285',
    './styles-base.css?v=285',
    './styles-en.css?v=285',
    './styles-features.css?v=285',
    './styles-reward-market.css?v=285',
    './styles-dashboard.css?v=285',
    './styles-dark-mode.css?v=285',
    './styles-reports.css?v=285',
    './styles-guest-demo.css?v=285',
    './js/main.js?v=285',
    './js/app.js?v=285',
    './js/app-core.js?v=285',
    './js/auth.js?v=285',
    './js/i18n.js?v=285',
    './js/app-mode.js?v=285',
    './js/auth-login-helpers.js?v=285',
    './js/blockchain-config.js?v=285',
    './js/blockchain-manager.js?v=285',
    './js/data-manager.js?v=285',
    './js/diet-program.js?v=285',
    './js/diet-analysis.js?v=285',
    './js/exercise-media.js?v=285',
    './js/firebase-config.js?v=285',
    './js/friendship-utils.js?v=285',
    './js/habit-groups.js?v=285',
    './js/health-connect-utils.js?v=285',
    './js/metabolic-score.js?v=285',
    './js/milestone-helpers.js?v=285',
    './js/monthly-mvp-reward.js?v=285',
    './js/meditation-guide.js?v=285',
    './js/reward-market.js?v=285',
    './js/guest-demo.js?v=285',
    './js/product-events.js?v=285',
    './js/activity-days.js?v=285',
    './js/pwa-install.js?v=285',
    './js/security.js?v=285',
    './js/social-challenge-readiness.js?v=285',
    './js/ui-helpers.js?v=285',
    './js/upload-performance.js?v=285',
    './js/video-thumbnail-quality.js?v=285',
    './js/webview-detect.js?v=285',
    './manifest.json',
    './manifest-en.json',
    './en/index.html',
    './en/privacy.html',
