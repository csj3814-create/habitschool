...
import { initAuth, setupAuthListener } from './auth.js?v=307';
import { APP_ENV } from './firebase-config.js?v=307';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=307';
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=307')
