...
import { initAuth, setupAuthListener } from './auth.js?v=266';
import { APP_ENV } from './firebase-config.js?v=266';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=266';
