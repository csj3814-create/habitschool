...
import { initAuth, setupAuthListener } from './auth.js?v=304';
import { APP_ENV } from './firebase-config.js?v=304';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=304';
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=304')
