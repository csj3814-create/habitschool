...
import { initAuth, setupAuthListener } from './auth.js?v=322';
import { APP_ENV } from './firebase-config.js?v=322';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=322';
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=322')
