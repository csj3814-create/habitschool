...
import { initAuth, setupAuthListener } from './auth.js?v=317';
import { APP_ENV } from './firebase-config.js?v=317';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=317';
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=317')
