...
import { initAuth, setupAuthListener } from './auth.js?v=351';
import { APP_ENV } from './firebase-config.js?v=351';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=351';
...
window.startChallenge30D = (challengeId) => import('./challenge-claim.js?v=351')
    .then(mod => {
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=351')
