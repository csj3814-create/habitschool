...
import { initAuth, setupAuthListener } from './auth.js?v=309';
import { APP_ENV } from './firebase-config.js?v=309';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=309';
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=309')
