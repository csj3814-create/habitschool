...
import { initAuth, setupAuthListener } from './auth.js?v=375';
import { APP_ENV } from './firebase-config.js?v=375';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=375';
...
window.startChallenge30D = (challengeId) => import('./challenge-claim.js?v=375')
    .then(mod => {
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=375')
