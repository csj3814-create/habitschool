...
import { initAuth, setupAuthListener } from './auth.js?v=342';
import { APP_ENV } from './firebase-config.js?v=342';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=342';
...
window.startChallenge30D = (challengeId) => import('./challenge-claim.js?v=342')
    .then(mod => {
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=342')
