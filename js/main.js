...
import { initAuth, setupAuthListener } from './auth.js?v=306';
import { APP_ENV } from './firebase-config.js?v=306';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=306';
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=306')
