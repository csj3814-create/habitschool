...
import { initAuth, setupAuthListener } from './auth.js?v=294';
import { APP_ENV } from './firebase-config.js?v=294';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=294';
