...
import { initAuth, setupAuthListener } from './auth.js?v=312';
import { APP_ENV } from './firebase-config.js?v=312';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=312';
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=312')
