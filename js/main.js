...
import { initAuth, setupAuthListener } from './auth.js?v=316';
import { APP_ENV } from './firebase-config.js?v=316';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=316';
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=316')
