...
import { initAuth, setupAuthListener } from './auth.js?v=325';
import { APP_ENV } from './firebase-config.js?v=325';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=325';
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=325')
