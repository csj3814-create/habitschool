...
import { initAuth, setupAuthListener } from './auth.js?v=402';
import { APP_ENV } from './firebase-config.js?v=402';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=402';
...
window.startChallenge30D = (challengeId) => import('./challenge-claim.js?v=402')
    .then(mod => {
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=402')
