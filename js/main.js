...
import { initAuth, setupAuthListener } from './auth.js?v=315';
import { APP_ENV } from './firebase-config.js?v=315';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=315';
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=315')
