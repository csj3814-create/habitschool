...
import { initAuth, setupAuthListener } from './auth.js?v=405';
import { APP_ENV } from './firebase-config.js?v=405';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=405';
...
window.startChallenge30D = (challengeId) => import('./challenge-claim.js?v=405')
    .then(mod => {
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=405')
