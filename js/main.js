...
import { initAuth, setupAuthListener } from './auth.js?v=305';
import { APP_ENV } from './firebase-config.js?v=305';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=305';
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=305')
