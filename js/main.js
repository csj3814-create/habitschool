...
import { initAuth, setupAuthListener } from './auth.js?v=303';
import { APP_ENV } from './firebase-config.js?v=303';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=303';
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=303')
