...
import { initAuth, setupAuthListener } from './auth.js?v=417';
import { APP_ENV } from './firebase-config.js?v=417';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=417';
...
window.startChallenge30D = (challengeId) => import('./challenge-claim.js?v=417')
    .then(mod => {
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=417')
