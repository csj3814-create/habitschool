...
import { initAuth, setupAuthListener } from './auth.js?v=363';
import { APP_ENV } from './firebase-config.js?v=363';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=363';
...
window.startChallenge30D = (challengeId) => import('./challenge-claim.js?v=363')
    .then(mod => {
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=363')
