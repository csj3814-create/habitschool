...
import { initAuth, setupAuthListener } from './auth.js?v=318';
import { APP_ENV } from './firebase-config.js?v=318';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=318';
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=318')
