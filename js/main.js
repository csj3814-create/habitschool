...
import { initAuth, setupAuthListener } from './auth.js?v=366';
import { APP_ENV } from './firebase-config.js?v=366';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=366';
...
window.startChallenge30D = (challengeId) => import('./challenge-claim.js?v=366')
    .then(mod => {
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=366')
