...
import { initAuth, setupAuthListener } from './auth.js?v=382';
import { APP_ENV } from './firebase-config.js?v=382';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=382';
...
window.startChallenge30D = (challengeId) => import('./challenge-claim.js?v=382')
    .then(mod => {
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=382')
