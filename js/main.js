...
import { initAuth, setupAuthListener } from './auth.js?v=456';
import { APP_ENV } from './firebase-config.js?v=456';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=456';
...
window.startChallenge30D = (challengeId) => import('./challenge-claim.js?v=456')
    .then(mod => {
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=456')
