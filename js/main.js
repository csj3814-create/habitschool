...
import { initAuth, setupAuthListener } from './auth.js?v=426';
import { APP_ENV } from './firebase-config.js?v=426';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=426';
...
window.startChallenge30D = (challengeId) => import('./challenge-claim.js?v=426')
    .then(mod => {
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=426')
