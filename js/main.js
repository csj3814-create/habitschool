...
import { initAuth, setupAuthListener } from './auth.js?v=311';
import { APP_ENV } from './firebase-config.js?v=311';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=311';
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=311')
