...
import { initAuth, setupAuthListener } from './auth.js?v=321';
import { APP_ENV } from './firebase-config.js?v=321';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=321';
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=321')
