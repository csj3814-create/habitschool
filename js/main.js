...
import { initAuth, setupAuthListener } from './auth.js?v=433';
import { APP_ENV } from './firebase-config.js?v=433';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=433';
...
window.startChallenge30D = (challengeId) => import('./challenge-claim.js?v=433')
    .then(mod => {
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=433')
