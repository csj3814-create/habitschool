...
import { initAuth, setupAuthListener } from './auth.js?v=319';
import { APP_ENV } from './firebase-config.js?v=319';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=319';
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=319')
