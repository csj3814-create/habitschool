...
import { initAuth, setupAuthListener } from './auth.js?v=391';
import { APP_ENV } from './firebase-config.js?v=391';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=391';
...
window.startChallenge30D = (challengeId) => import('./challenge-claim.js?v=391')
    .then(mod => {
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=391')
