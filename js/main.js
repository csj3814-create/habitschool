...
import { initAuth, setupAuthListener } from './auth.js?v=439';
import { APP_ENV } from './firebase-config.js?v=439';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=439';
...
window.startChallenge30D = (challengeId) => import('./challenge-claim.js?v=439')
    .then(mod => {
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=439')
