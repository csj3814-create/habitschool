...
import { initAuth, setupAuthListener } from './auth.js?v=165';
import { APP_ENV } from './firebase-config.js?v=165';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=165';
