...
import { initAuth, setupAuthListener } from './auth.js?v=308';
import { APP_ENV } from './firebase-config.js?v=308';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=308';
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=308')
