...
import { initAuth, setupAuthListener } from './auth.js?v=310';
import { APP_ENV } from './firebase-config.js?v=310';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=310';
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=310')
