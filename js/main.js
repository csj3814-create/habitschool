...
import { initAuth, setupAuthListener } from './auth.js?v=394';
import { APP_ENV } from './firebase-config.js?v=394';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=394';
...
window.startChallenge30D = (challengeId) => import('./challenge-claim.js?v=394')
    .then(mod => {
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=394')
