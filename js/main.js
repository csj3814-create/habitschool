...
import { initAuth, setupAuthListener } from './auth.js?v=340';
import { APP_ENV } from './firebase-config.js?v=340';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=340';
...
window.startChallenge30D = (challengeId) => import('./challenge-claim.js?v=340')
    .then(mod => {
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=340')
