...
import { initAuth, setupAuthListener } from './auth.js?v=274';
import { APP_ENV } from './firebase-config.js?v=274';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=274';
