...
import { initAuth, setupAuthListener } from './auth.js?v=372';
import { APP_ENV } from './firebase-config.js?v=372';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=372';
...
window.startChallenge30D = (challengeId) => import('./challenge-claim.js?v=372')
    .then(mod => {
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=372')
