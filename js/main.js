...
import { initAuth, setupAuthListener } from './auth.js?v=358';
import { APP_ENV } from './firebase-config.js?v=358';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=358';
...
window.startChallenge30D = (challengeId) => import('./challenge-claim.js?v=358')
    .then(mod => {
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=358')
