...
import { initAuth, setupAuthListener } from './auth.js?v=343';
import { APP_ENV } from './firebase-config.js?v=343';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=343';
...
window.startChallenge30D = (challengeId) => import('./challenge-claim.js?v=343')
    .then(mod => {
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=343')
