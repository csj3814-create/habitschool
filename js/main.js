...
import { initAuth, setupAuthListener } from './auth.js?v=328';
import { APP_ENV } from './firebase-config.js?v=328';
import { getActiveBscNetwork, getActiveHbtTokenAddress } from './blockchain-config.js?v=328';
...
window.startChallenge30D = (challengeId) => import('./challenge-claim.js?v=328')
    .then(mod => {
...
window.claimChallengeReward = (tier) => import('./challenge-claim.js?v=328')
