...
import { showToast } from './ui-helpers.js?v=456';
import { escapeHtml } from './security.js?v=456';
import { getLocale, isEnglishLocale, t } from './i18n.js?v=456';
import { WEEKLY_ACTIVITY_TARGET_MINUTES } from './le8-score.js?v=456';
