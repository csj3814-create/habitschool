...
import { showToast } from './ui-helpers.js?v=414';
import { escapeHtml } from './security.js?v=414';
import { getLocale, isEnglishLocale, t } from './i18n.js?v=414';
import { WEEKLY_ACTIVITY_TARGET_MINUTES } from './le8-score.js?v=414';
