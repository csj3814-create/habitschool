...
import { showToast } from './ui-helpers.js?v=427';
import { escapeHtml } from './security.js?v=427';
import { getLocale, isEnglishLocale, t } from './i18n.js?v=427';
import { WEEKLY_ACTIVITY_TARGET_MINUTES } from './le8-score.js?v=427';
