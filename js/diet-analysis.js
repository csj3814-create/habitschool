...
import { showToast } from './ui-helpers.js?v=426';
import { escapeHtml } from './security.js?v=426';
import { getLocale, isEnglishLocale, t } from './i18n.js?v=426';
import { WEEKLY_ACTIVITY_TARGET_MINUTES } from './le8-score.js?v=426';
