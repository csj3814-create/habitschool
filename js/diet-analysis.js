...
import { showToast } from './ui-helpers.js?v=416';
import { escapeHtml } from './security.js?v=416';
import { getLocale, isEnglishLocale, t } from './i18n.js?v=416';
import { WEEKLY_ACTIVITY_TARGET_MINUTES } from './le8-score.js?v=416';
