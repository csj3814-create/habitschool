...
import { auth, functions } from './firebase-config.js?v=429';
import { httpsCallable } from 'https://www.gstatic.com/firebasejs/10.8.0/firebase-functions.js';
import { showToast } from './ui-helpers.js?v=429';
import { escapeHtml } from './security.js?v=429';
import { getLocale, isEnglishLocale, t } from './i18n.js?v=429';
import { WEEKLY_ACTIVITY_TARGET_MINUTES } from './le8-score.js?v=429';
