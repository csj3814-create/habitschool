...
// 프로젝트 모듈 임포트
import { app, auth, db, storage, functions, APP_ENV, APP_ORIGIN, APP_OG_IMAGE_URL, MILESTONES, MISSIONS, MISSION_BADGES, MAX_IMG_SIZE, MAX_VID_SIZE, getWeekId, noteFirestoreConnectivityFailure, isFirestoreConnectivityIssue } from './firebase-config.js?v=232';
import { applyAppModeChrome, buildAppModeUrl, buildLocalizedUrl, getAllowedTabsForMode, getAppModeFromPath, getDefaultTabForMode, getRouteContext, isSimpleMode, normalizeTabForRoute } from './app-mode.js?v=232';
import {
    isSamsungInternetUserAgent,
    parsePendingSignupOnboardingState,
    shouldAutoGrantWelcomeBonus,
    shouldShowSignupOnboarding
} from './auth-login-helpers.js?v=232';
import { formatChallengeQualificationLabel, getActiveChainKey, getActiveOnchainLabel, getChallengeCompletedDays, getChallengeDateRange, normalizeChallengeQualificationPolicy, reconcileActiveChallengesWithDailyLogs } from './blockchain-config.js?v=232';
import {
...
} from './health-connect-utils.js?v=232';
import {
...
} from './habit-groups.js?v=232';
import { reconcileMilestoneState } from './milestone-helpers.js?v=232';
import { getDatesInfo, showToast, getKstDateString } from './ui-helpers.js?v=232';
import { applyDomTranslations, getLocale, installLocaleDomObserver, isEnglishLocale, t, translateText } from './i18n.js?v=232';
import { sanitize, compressImage } from './data-manager.js?v=232';
import { getResumableUploadTimeouts } from './upload-performance.js?v=232';
import { escapeHtml, isValidStorageUrl, isPersistedStorageUrl, sanitizeText, isValidFileType, checkRateLimit } from './security.js?v=232';
import { toDateSafe, getFriendshipOtherUid, isFriendshipExpired, getEffectiveFriendshipStatus, getFriendshipName } from './friendship-utils.js?v=232';
import { requestDietAnalysis, renderDietAnalysisResult, renderDietDaySummary, renderExerciseAnalysisResult, requestSleepMindAnalysis, renderSleepMindAnalysisResult, requestBloodTestAnalysis, renderBloodTestResult, requestStepScreenshotAnalysis, requestSharedTargetClassification } from './diet-analysis.js?v=232';
import {
    ...
    normalizeDemoTab
} from './guest-demo.js?v=232';
import { trackProductEvent } from './product-events.js?v=232';
import { addCalendarDays, calculateActivityStreak, countActiveDays } from './activity-days.js?v=232';
import {
...
} from './meditation-guide.js?v=232';
import { calculateMetabolicScore, renderMetabolicScoreCard } from './metabolic-score.js?v=232';
import { loadRewardMarketSnapshot } from './reward-market.js?v=232';
import {
    SOCIAL_CHALLENGE_ACTIVITY_LOOKBACK_DAYS,
    buildSocialChallengeLookbackDateStrings,
    summarizeSocialChallengeReadinessLogs
} from './social-challenge-readiness.js?v=232';
import {
    getPreviousMonthIdFromKstDateString,
    shouldAttemptMonthlyMvpRewardFromKstDateString
} from './monthly-mvp-reward.js?v=232';
...
const BLOCKCHAIN_MANAGER_MODULE_PATH = './blockchain-manager.js?v=232';
