...
import { 
    ...
    getActiveChainKey
} from './blockchain-config.js?v=177';
...
import { auth, db, functions, FIREBASE_REGION, APP_ENV, noteFirestoreConnectivityFailure, isFirestoreConnectivityIssue } from './firebase-config.js?v=177';
...
import { getKstDateString } from './ui-helpers.js?v=177';
import { checkRateLimit } from './security.js?v=177';
