...
import { 
    ...
    getActiveChainKey
} from './blockchain-config.js?v=205';
...
import { auth, db, functions, FIREBASE_REGION, APP_ENV, noteFirestoreConnectivityFailure, isFirestoreConnectivityIssue } from './firebase-config.js?v=205';
...
import { getKstDateString } from './ui-helpers.js?v=205';
import { checkRateLimit } from './security.js?v=205';
