...
import { 
    ...
    getActiveChainKey
} from './blockchain-config.js?v=167';
...
import { auth, db, functions, FIREBASE_REGION, APP_ENV, noteFirestoreConnectivityFailure } from './firebase-config.js?v=167';
...
import { getKstDateString } from './ui-helpers.js?v=167';
import { checkRateLimit } from './security.js?v=167';
