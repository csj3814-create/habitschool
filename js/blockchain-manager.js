...
import { 
    ...
    getActiveChainKey
} from './blockchain-config.js?v=253';
...
import { auth, db, functions, FIREBASE_REGION, APP_ENV, noteFirestoreConnectivityFailure, isFirestoreConnectivityIssue } from './firebase-config.js?v=253';
...
import { getKstDateString } from './ui-helpers.js?v=253';
import { checkRateLimit } from './security.js?v=253';
