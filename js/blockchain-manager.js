...
import { 
    ...
    getActiveChainKey
} from './blockchain-config.js?v=248';
...
import { auth, db, functions, FIREBASE_REGION, APP_ENV, noteFirestoreConnectivityFailure, isFirestoreConnectivityIssue } from './firebase-config.js?v=248';
...
import { getKstDateString } from './ui-helpers.js?v=248';
import { checkRateLimit } from './security.js?v=248';
