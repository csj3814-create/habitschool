...
import { 
    ...
    getActiveChainKey
} from './blockchain-config.js?v=234';
...
import { auth, db, functions, FIREBASE_REGION, APP_ENV, noteFirestoreConnectivityFailure, isFirestoreConnectivityIssue } from './firebase-config.js?v=234';
...
import { getKstDateString } from './ui-helpers.js?v=234';
import { checkRateLimit } from './security.js?v=234';
