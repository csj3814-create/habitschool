...
import { 
    ...
    getActiveChainKey
} from './blockchain-config.js?v=165';
...
import { auth, db, functions, FIREBASE_REGION, APP_ENV, noteFirestoreConnectivityFailure } from './firebase-config.js?v=165';
...
import { getKstDateString } from './ui-helpers.js?v=165';
import { checkRateLimit } from './security.js?v=165';
