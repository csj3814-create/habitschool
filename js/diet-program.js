import { isEnglishLocale, t } from './i18n.js?v=456';
...
const METHOD_CATALOG = Object.freeze([
    ...
    },
    {
        ...
        name: '저탄수 고단백 식단',
        difficultyLabel: '보통',
        summary: '밥·빵은 줄이고 단백질 반찬으로 배 채우기',
        mealGuide: '밥·빵은 줄이고 단백질 반찬으로 배 채우기',
        dashboardTip: '밥·빵은 줄이고 단백질 반찬으로 배 채우기',
    ...
    },
    {
        ...
        name: '16:8 간헐적 단식',
        difficultyLabel: '도전',
        summary: '하루 8시간 안에만 먹고 나머지 시간은 비우기',
        mealGuide: '하루 8시간 안에만 먹고 나머지 시간은 비우기',
        dashboardTip: '하루 8시간 안에만 먹고 나머지 시간은 비우기',
