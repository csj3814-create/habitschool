import { buildLocalizedUrl, getLocale as getRouteLocale } from './app-mode.js?v=454';
...
const MESSAGES = {
    ...
    en: {
        ...
        'diet.method.none.dashboardTip': 'Your guide and reminders will change.',
        'diet.method.brown_rice_green_veggies.exerciseSupportTip': 'Start with easy walks.',
        'diet.method.brown_rice_green_veggies.mindSleepSupportTip': 'Just cutting late-night snacks helps.',
        'diet.method.mediterranean.exerciseSupportTip': 'Pairs well with short walks.',
        'diet.method.mediterranean.mindSleepSupportTip': 'Goes well with regular sleep.',
        'diet.method.low_carb.exerciseSupportTip': 'Keep movement light while you adjust.',
        'diet.method.low_carb.mindSleepSupportTip': 'Avoid restricting too hard.',
        'diet.method.intermittent_fasting.exerciseSupportTip': 'Move gently during fasting hours.',
        'diet.method.intermittent_fasting.mindSleepSupportTip': 'Try to keep a steady sleep schedule.',
        'diet.method.switch_on.exerciseSupportTip': 'Start light in the first days.',
        'diet.method.switch_on.mindSleepSupportTip': 'Keep your daily rhythm steady first.',
        // 식단 탭 안내 카드(js/diet-program.js)
        'dietGuide.badge': 'Photos {count}/4',
        'dietGuide.helper.empty': 'You can save with just one meal photo.',
        'dietGuide.status.empty': 'Add your first meal photo to start today’s food log.',
        'dietGuide.status.partial': '{count} meal photo(s) ready. Add more for up to 30P.',
        'dietGuide.helper.partialWithMetrics': '{count} meal photo(s) and your fasting metrics are ready to save.',
        'dietGuide.helper.partial': '{count} meal photo(s) ready to save now.',
        'dietGuide.status.metricsOnly': 'Fasting metrics entered. Add meal photos to save them together.',
        'dietGuide.helper.metricsOnly': 'You can save your fasting metrics now.',
        'dietGuide.status.full': 'All meal slots are filled. Save to add today’s food points.',
        'dietGuide.helper.full': 'Food log ready. Save to apply.',
        'dietGuide.fasting.label': 'Fasting',
        'dietGuide.fasting.status': 'You are in your fasting hours.',
        'dietGuide.window': 'Your eating window is {start}–{end}.',
        'dietGuide.eating.label': 'Eating',
        'dietGuide.eating.status': 'You are in your eating window.',
        'dietGuide.finishBy': 'Try to finish by {end}.',
        'dietGuide.closing.label': 'Closing soon',
        'dietGuide.closing.status': 'Your eating window is about to close.',
        'dietGuide.closed.status': 'Today’s eating window is over.',
        'dietGuide.closed.helper': 'You can keep logging.',
        'dietGuide.preset.helper': 'Log whenever you like.',
        'dietGuide.helper.metricsFirst': 'You can save just your fasting metrics first.',
        'dietProgram.noReminders': 'No reminders',
        'dietProgram.chooseMethod': 'Choose a food method',
        'dietProgram.remindersOff': 'Meal-time reminders are off.',
        'dietProgram.analysisTip': 'Food tip · {guide}',
        'dietProgram.toggle.needMethod': 'Choose a food method first to turn on reminders.',
        'dietProgram.toggle.deviceOff': 'Meal-time reminders are on, but notifications are off on this device.',
        'dietProgram.toggle.on': 'This device gets reminders matched to your food method.',
        'dietProgram.toggle.off': 'Keep your food method and turn on reminders whenever you need them.',
        ...
        'common.gotIt': 'Got it',
        'tab.menu': 'Main menu',
        'sleepHours.note': 'Used for the sleep part of your healthy habits score. It may also fill in automatically when you upload a screenshot and run AI analysis.',
        'meditation.methodList': 'Choose a meditation method',
        // 로그인 화면: 인앱 브라우저 안내
        'webview.title': 'Google sign-in is limited in in-app browsers',
        'webview.body': 'Google’s security policy blocks sign-in inside in-app browsers such as KakaoTalk or Instagram.<br>Please open this page in <strong>Chrome or Safari</strong>.',
        'webview.openExternal': '🌐 Open in browser',
        'webview.copyLink': '📋 Copy link',
        // 공유 가져오기(다른 앱에서 공유)
        'sharedImport.kicker': 'Shared import',
        'sharedImport.title': 'Where should this photo go?',
        'sharedImport.diet.title': 'Food',
        'sharedImport.diet.desc': 'Placed in an empty meal slot',
        'sharedImport.exercise.title': 'Exercise',
        'sharedImport.exercise.desc': 'Step screenshot or workout photo',
        'sharedImport.sleep.title': 'Sleep',
        'sharedImport.sleep.desc': 'Linked as a sleep screenshot',
        'sharedImport.body.title': 'Body composition',
        'sharedImport.body.desc': 'Reads a scale or Fitdays result',
        // 오류 제보
        'bugReport.title': '🐞 Report a problem',
        'bugReport.copy': 'Tell us what happened: which screen you were on, what you tapped, and what went wrong. That helps us fix it fastest.',
        'bugReport.placeholder': 'e.g. I uploaded a video in the Exercise tab, but it keeps saying the upload is delayed and will not save.',
        'bugReport.screenshot': '📷 Screenshot (optional)',
        'bugReport.note': 'Your device, browser, app version and recent error logs are sent along. Your records and photos are not included.',
        'bugReport.send': 'Send',
        // 공유 창
        'share.modalTitle': 'Share ✨',
        'share.previewTitle': 'Today’s Habit School check-in 🌞',
        'share.previewText': 'Show your friends<br>your healthy habits!',
        'share.tip': '<strong>On mobile</strong>, system sharing is easiest. <span>On a computer, save the image and copy the caption, then post them in the platform window.</span>',
        'share.openPlatform': 'Open a platform',
        'share.platform.kakao': 'KakaoTalk',
        'share.platform.instagram': 'Instagram',
        'share.platform.facebook': 'Facebook',
        'share.platform.blog': 'Blog',
        'share.quick': 'Quick actions',
        'share.action.system': 'System share',
        'share.action.caption': 'Copy caption',
        'share.action.link': 'Copy link',
        'share.action.save': 'Save image',
        // 첫 로그인: 시작할 습관 고르기
        'onboarding.kicker': 'Getting started',
        'onboarding.title': 'Pick one habit to start with',
        'onboarding.desc': 'Start with one habit today. You can add the others whenever you like.',
        'onboarding.groupLabel': 'Choose your first habit',
        'onboarding.diet.title': 'Meal photos',
        'onboarding.diet.desc': 'Start with one photo',
        'onboarding.exercise.title': 'Exercise',
        'onboarding.exercise.desc': 'Steps or workout media',
        'onboarding.sleep.title': 'Mind',
        'onboarding.sleep.desc': 'Sleep, meditation, gratitude',
        'onboarding.gift.title': '200P welcome gift',
        'onboarding.gift.desc': 'Given on top of your first log points.',
        'onboarding.start': 'Get started',
        // 첫 기록 결과
        'firstRecord.kicker': 'First log done',
        'firstRecord.title': 'You finished your first step toward this week’s health goal.',
        'firstRecord.earned': 'Points for this log',
        'firstRecord.welcome': 'Welcome gift',
        'firstRecord.current': 'Current points',
        'firstRecord.remaining': 'To 2,000P',
        'firstRecord.finish': 'Done for today',
        'firstRecord.continue': 'Continue'
    }
};
...
const SELECTOR_ATTRS = [
    ...
    ['#shared-import-preview', 'alt', 'Shared photo preview'],
    ['#share-preview-thumb', 'alt', 'Share preview'],
    ['#bug-report-modal .close-btn', 'aria-label', 'Close'],
    ['#share-platform-modal .share-modal-close-x', 'aria-label', 'Close'],
