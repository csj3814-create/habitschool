...
import { auth, functions } from './firebase-config.js?v=345';
import { CHALLENGES, CHALLENGE_ID_MAP, formatChallengeQualificationLabel } from './blockchain-config.js?v=345';
