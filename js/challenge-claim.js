...
import { auth, functions } from './firebase-config.js?v=378';
import { CHALLENGES, CHALLENGE_ID_MAP, formatChallengeQualificationLabel } from './blockchain-config.js?v=378';
