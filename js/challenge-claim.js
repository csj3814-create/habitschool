...
import { auth, functions } from './firebase-config.js?v=357';
import { CHALLENGES, CHALLENGE_ID_MAP, formatChallengeQualificationLabel } from './blockchain-config.js?v=357';
