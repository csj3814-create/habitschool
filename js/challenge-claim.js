...
import { auth, functions } from './firebase-config.js?v=328';
import { CHALLENGES, CHALLENGE_ID_MAP, formatChallengeQualificationLabel } from './blockchain-config.js?v=328';
