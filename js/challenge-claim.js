...
import { auth, functions } from './firebase-config.js?v=333';
import { CHALLENGES, CHALLENGE_ID_MAP, formatChallengeQualificationLabel } from './blockchain-config.js?v=333';
