...
import { auth, functions } from './firebase-config.js?v=426';
import { CHALLENGES, CHALLENGE_ID_MAP, formatChallengeQualificationLabel } from './blockchain-config.js?v=426';
import { httpsCallable } from 'https://www.gstatic.com/firebasejs/10.8.0/firebase-functions.js';
import { showToast, hideToast, onRefreshFailure } from './ui-helpers.js?v=426';
