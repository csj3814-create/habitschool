// 인증 관리 모듈
import { auth, db, functions, FCM_PUBLIC_VAPID_KEY, APP_ORIGIN, IS_LOCAL_ENV, noteFirestoreConnectivityFailure, forceFirestoreReconnect } from './firebase-config.js?v=440';
...
import { showToast, onRefreshFailure, withAsyncTimeout } from './ui-helpers.js?v=440';
import { getDatesInfo } from './ui-helpers.js?v=440';
import { escapeHtml } from './security.js?v=440';
import { applyDomTranslations, buildLocalizedUrl, getLocale, isEnglishLocale, t } from './i18n.js?v=440';
import {
...
} from './auth-login-helpers.js?v=440';
import { getAllowedTabsForMode, getDefaultTabForMode, getAppModeFromPath, getRouteContext, normalizeTabForRoute } from './app-mode.js?v=440';
import { trackProductEvent } from './product-events.js?v=440';
// blockchain-manager는 동적 import한다. 로드 실패가 인증 흐름에 영향을 주지 않게 분리한다.

const BLOCKCHAIN_MANAGER_MODULE_PATH = './blockchain-manager.js?v=440';
