// 인증 관리 모듈
import { auth, db, functions, FCM_PUBLIC_VAPID_KEY, APP_ORIGIN, IS_LOCAL_ENV, noteFirestoreConnectivityFailure } from './firebase-config.js?v=324';
...
import { getDatesInfo } from './ui-helpers.js?v=324';
import { escapeHtml } from './security.js?v=324';
import { applyDomTranslations, buildLocalizedUrl, getLocale, isEnglishLocale, t } from './i18n.js?v=324';
import {
...
import { getAllowedTabsForMode, getDefaultTabForMode, getAppModeFromPath, getRouteContext, normalizeTabForRoute } from './app-mode.js?v=324';
import { trackProductEvent } from './product-events.js?v=324';
