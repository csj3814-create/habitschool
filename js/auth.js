// 인증 관리 모듈
import { auth, db, functions, FCM_PUBLIC_VAPID_KEY, APP_ORIGIN, IS_LOCAL_ENV, noteFirestoreConnectivityFailure } from './firebase-config.js?v=174';
...
import { showToast } from './ui-helpers.js?v=174';
import { getDatesInfo } from './ui-helpers.js?v=174';
import { escapeHtml } from './security.js?v=174';
import {
...
import { getAllowedTabsForMode, getDefaultTabForMode, getAppModeFromPath, normalizeTabForMode } from './app-mode.js?v=174';
