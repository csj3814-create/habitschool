// 인증 관리 모듈
import { auth, db, functions, FCM_PUBLIC_VAPID_KEY, APP_ORIGIN, IS_LOCAL_ENV, noteFirestoreConnectivityFailure } from './firebase-config.js?v=394';
...
import { getDatesInfo } from './ui-helpers.js?v=394';
import { escapeHtml } from './security.js?v=394';
import { applyDomTranslations, buildLocalizedUrl, getLocale, isEnglishLocale, t } from './i18n.js?v=394';
import {
...
} from './auth-login-helpers.js?v=394';
import { getAllowedTabsForMode, getDefaultTabForMode, getAppModeFromPath, getRouteContext, normalizeTabForRoute } from './app-mode.js?v=394';
import { trackProductEvent } from './product-events.js?v=394';
// blockchain-manager는 동적 import한다. 로드 실패가 인증 흐름에 영향을 주지 않게 분리한다.

const BLOCKCHAIN_MANAGER_MODULE_PATH = './blockchain-manager.js?v=394';
