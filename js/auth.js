...
import { showToast, onRefreshFailure, withAsyncTimeout } from './ui-helpers.js?v=429';
import { getDatesInfo } from './ui-helpers.js?v=429';
import { escapeHtml } from './security.js?v=429';
import { applyDomTranslations, buildLocalizedUrl, getLocale, isEnglishLocale, t } from './i18n.js?v=429';
import {
...
import { getAllowedTabsForMode, getDefaultTabForMode, getAppModeFromPath, getRouteContext, normalizeTabForRoute } from './app-mode.js?v=429';
import { trackProductEvent } from './product-events.js?v=429';
